...
use RectorPrefix20211217\Composer\EventDispatcher\Event;
use RectorPrefix20211217\Composer\Package\PackageInterface;
class PatchEvent extends \RectorPrefix20211217\Composer\EventDispatcher\Event
{
    /**
     ...
     */
    public function __construct($eventName, \RectorPrefix20211217\Composer\Package\PackageInterface $package, $url, $description)
    {
