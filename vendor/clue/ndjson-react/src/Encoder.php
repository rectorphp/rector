 ...
 */
class Encoder extends \RectorPrefix20220328\Evenement\EventEmitter implements \RectorPrefix20220328\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\RectorPrefix20220328\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
