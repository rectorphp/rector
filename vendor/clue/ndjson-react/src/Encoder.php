 ...
 */
class Encoder extends \RectorPrefix20220306\Evenement\EventEmitter implements \RectorPrefix20220306\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\RectorPrefix20220306\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
