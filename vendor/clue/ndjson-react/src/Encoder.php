 ...
 */
class Encoder extends \RectorPrefix20220530\Evenement\EventEmitter implements \RectorPrefix20220530\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\RectorPrefix20220530\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
