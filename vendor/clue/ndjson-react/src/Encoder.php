 ...
 */
class Encoder extends \RectorPrefix20220501\Evenement\EventEmitter implements \RectorPrefix20220501\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\RectorPrefix20220501\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
