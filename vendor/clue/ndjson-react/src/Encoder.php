 ...
 */
class Encoder extends \RectorPrefix20220503\Evenement\EventEmitter implements \RectorPrefix20220503\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\RectorPrefix20220503\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
