 ...
 */
class Encoder extends \RectorPrefix20211225\Evenement\EventEmitter implements \RectorPrefix20211225\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\RectorPrefix20211225\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
