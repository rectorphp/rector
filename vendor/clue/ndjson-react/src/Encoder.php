 ...
 */
class Encoder extends \RectorPrefix20211205\Evenement\EventEmitter implements \RectorPrefix20211205\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\RectorPrefix20211205\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
