...
namespace RectorPrefix20211210\Clue\React\NDJson;
 ...
 */
class Decoder extends \RectorPrefix20211210\Evenement\EventEmitter implements \RectorPrefix20211210\React\Stream\ReadableStreamInterface
{
    private $input;
    private $assoc;
    private $depth;
     ...
     */
    public function __construct(\RectorPrefix20211210\React\Stream\ReadableStreamInterface $input, $assoc = \false, $depth = 512, $options = 0, $maxlength = 65536)
    {
