...
namespace RectorPrefix20220412\Clue\React\NDJson;
 ...
 */
class Decoder extends \RectorPrefix20220412\Evenement\EventEmitter implements \RectorPrefix20220412\React\Stream\ReadableStreamInterface
{
    private $input;
    private $assoc;
    private $depth;
     ...
     */
    public function __construct(\RectorPrefix20220412\React\Stream\ReadableStreamInterface $input, $assoc = \false, $depth = 512, $options = 0, $maxlength = 65536)
    {
    ...
    {
        \RectorPrefix20220412\React\Stream\Util::pipe($this, $dest, $options);
        return $dest;
    }
    /** @internal */
