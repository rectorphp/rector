...
namespace RectorPrefix20220101\Clue\React\NDJson;

use RectorPrefix20220101\Evenement\EventEmitter;
use RectorPrefix20220101\React\Stream\ReadableStreamInterface;
 ...
 */
class Decoder extends \RectorPrefix20220101\Evenement\EventEmitter implements \RectorPrefix20220101\React\Stream\ReadableStreamInterface
{
    private $input;
    private $assoc;
    private $depth;
     ...
     */
    public function __construct(\RectorPrefix20220101\React\Stream\ReadableStreamInterface $input, $assoc = \false, $depth = 512, $options = 0, $maxlength = 65536)
    {
    ...
    {
        \RectorPrefix20220101\React\Stream\Util::pipe($this, $dest, $options);
        return $dest;
    }
    /** @internal */
