...
class SectionTest extends \RectorPrefix20210820\PHPUnit\Framework\TestCase
{
    public function testGetDeclaration() : void
    {
        $section = new \RectorPrefix20210820\Idiosyncratic\EditorConfig\Section('**/', '*.php', ['indent_size' => '4', 'indent_style' => 'space'], new \RectorPrefix20210820\Idiosyncratic\EditorConfig\Declaration\Factory());
