...
class SectionTest extends \RectorPrefix20210526\PHPUnit\Framework\TestCase
{
    public function testGetDeclaration() : void
    {
        $section = new \RectorPrefix20210526\Idiosyncratic\EditorConfig\Section('**/', '*.php', ['indent_size' => '4', 'indent_style' => 'space'], new \RectorPrefix20210526\Idiosyncratic\EditorConfig\Declaration\Factory());
