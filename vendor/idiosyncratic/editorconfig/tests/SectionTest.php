...
class SectionTest extends \RectorPrefix20210510\PHPUnit\Framework\TestCase
{
    public function testGetDeclaration() : void
    {
        $section = new \RectorPrefix20210510\Idiosyncratic\EditorConfig\Section('**/', '*.php', ['indent_size' => '4', 'indent_style' => 'space'], new \RectorPrefix20210510\Idiosyncratic\EditorConfig\Declaration\Factory());
