...
class SectionTest extends \RectorPrefix20220329\PHPUnit\Framework\TestCase
{
    public function testGetDeclaration() : void
    {
        $section = new \RectorPrefix20220329\Idiosyncratic\EditorConfig\Section('**/', '*.php', ['indent_size' => '4', 'indent_style' => 'space'], new \RectorPrefix20220329\Idiosyncratic\EditorConfig\Declaration\Factory());
