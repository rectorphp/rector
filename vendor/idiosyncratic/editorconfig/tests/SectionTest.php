...
class SectionTest extends \RectorPrefix20210919\PHPUnit\Framework\TestCase
{
    public function testGetDeclaration() : void
    {
        $section = new \RectorPrefix20210919\Idiosyncratic\EditorConfig\Section('**/', '*.php', ['indent_size' => '4', 'indent_style' => 'space'], new \RectorPrefix20210919\Idiosyncratic\EditorConfig\Declaration\Factory());
