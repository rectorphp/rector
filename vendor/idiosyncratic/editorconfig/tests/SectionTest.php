...
class SectionTest extends \RectorPrefix20220330\PHPUnit\Framework\TestCase
{
    public function testGetDeclaration() : void
    {
        $section = new \RectorPrefix20220330\Idiosyncratic\EditorConfig\Section('**/', '*.php', ['indent_size' => '4', 'indent_style' => 'space'], new \RectorPrefix20220330\Idiosyncratic\EditorConfig\Declaration\Factory());
