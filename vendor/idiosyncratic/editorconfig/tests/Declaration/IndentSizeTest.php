...
class IndentSizeTest extends \RectorPrefix20220101\PHPUnit\Framework\TestCase
{
    public function testValidValues()
    {
        $declaration = new \RectorPrefix20220101\Idiosyncratic\EditorConfig\Declaration\IndentSize('tab');
