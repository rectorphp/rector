...
class IndentSizeTest extends \RectorPrefix20220218\PHPUnit\Framework\TestCase
{
    public function testValidValues()
    {
        $declaration = new \RectorPrefix20220218\Idiosyncratic\EditorConfig\Declaration\IndentSize('tab');
