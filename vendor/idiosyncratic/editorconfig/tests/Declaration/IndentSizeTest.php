...
class IndentSizeTest extends \RectorPrefix20220217\PHPUnit\Framework\TestCase
{
    public function testValidValues()
    {
        $declaration = new \RectorPrefix20220217\Idiosyncratic\EditorConfig\Declaration\IndentSize('tab');
