...
class EndOfLineTest extends \RectorPrefix20220102\PHPUnit\Framework\TestCase
{
    public function testValidValues()
    {
        foreach (\RectorPrefix20220102\Idiosyncratic\EditorConfig\Declaration\EndOfLine::LINE_ENDINGS as $eol) {
            $declaration = new \RectorPrefix20220102\Idiosyncratic\EditorConfig\Declaration\EndOfLine($eol);
