...
class IndentStyleTest extends \RectorPrefix20220102\PHPUnit\Framework\TestCase
{
    public function testValidValues()
    {
        $declaration = new \RectorPrefix20220102\Idiosyncratic\EditorConfig\Declaration\IndentStyle('tab');
