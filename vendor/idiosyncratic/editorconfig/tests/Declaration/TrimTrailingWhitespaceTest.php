...
class TrimTrailingWhitespaceTest extends \RectorPrefix20220217\PHPUnit\Framework\TestCase
{
    public function testValidValues()
    {
        $declaration = new \RectorPrefix20220217\Idiosyncratic\EditorConfig\Declaration\TrimTrailingWhitespace('false');
