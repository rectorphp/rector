...
class UnsetDeclarationTest extends \RectorPrefix20210804\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20210804\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
