...
class UnsetDeclarationTest extends \RectorPrefix20211123\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20211123\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
