...
class UnsetDeclarationTest extends \RectorPrefix20211007\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20211007\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
