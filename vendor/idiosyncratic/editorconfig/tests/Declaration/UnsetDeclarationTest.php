...
class UnsetDeclarationTest extends \RectorPrefix20210515\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20210515\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
