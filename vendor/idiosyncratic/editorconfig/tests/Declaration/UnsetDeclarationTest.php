...
class UnsetDeclarationTest extends \RectorPrefix20210721\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20210721\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
