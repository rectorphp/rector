...
class UnsetDeclarationTest extends \RectorPrefix20220209\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220209\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
