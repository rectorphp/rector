...
class UnsetDeclarationTest extends \RectorPrefix20220107\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220107\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
