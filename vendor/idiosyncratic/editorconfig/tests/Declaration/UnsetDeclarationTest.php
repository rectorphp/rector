...
class UnsetDeclarationTest extends \RectorPrefix20220102\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220102\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
