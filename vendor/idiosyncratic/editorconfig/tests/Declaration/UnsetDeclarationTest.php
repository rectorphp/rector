...
class UnsetDeclarationTest extends \RectorPrefix20220303\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220303\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
