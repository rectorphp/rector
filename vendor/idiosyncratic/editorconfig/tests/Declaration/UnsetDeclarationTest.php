...
class UnsetDeclarationTest extends \RectorPrefix20220202\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220202\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
