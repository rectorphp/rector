...
class UnsetDeclarationTest extends \RectorPrefix20220213\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220213\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
