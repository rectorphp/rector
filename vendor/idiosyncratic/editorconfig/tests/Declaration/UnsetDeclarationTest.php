...
class UnsetDeclarationTest extends \RectorPrefix20211213\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20211213\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
