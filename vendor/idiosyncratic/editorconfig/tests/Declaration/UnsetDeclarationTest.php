...
class UnsetDeclarationTest extends \RectorPrefix20220216\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220216\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
