...
class UnsetDeclarationTest extends \RectorPrefix20220308\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220308\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
