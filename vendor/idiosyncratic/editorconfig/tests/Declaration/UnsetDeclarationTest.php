...
class UnsetDeclarationTest extends \RectorPrefix20210630\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20210630\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
