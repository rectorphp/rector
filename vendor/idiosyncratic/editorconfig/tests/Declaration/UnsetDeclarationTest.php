...
class UnsetDeclarationTest extends \RectorPrefix20220516\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220516\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
