...
class UnsetDeclarationTest extends \RectorPrefix20220126\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220126\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
