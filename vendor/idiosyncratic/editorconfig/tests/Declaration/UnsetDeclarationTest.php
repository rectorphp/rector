...
class UnsetDeclarationTest extends \RectorPrefix20210512\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20210512\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
