...
class UnsetDeclarationTest extends \RectorPrefix20220105\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220105\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
