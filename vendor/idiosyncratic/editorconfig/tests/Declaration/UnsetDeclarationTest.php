...
class UnsetDeclarationTest extends \RectorPrefix20220112\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220112\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
