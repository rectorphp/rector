...
class UnsetDeclarationTest extends \RectorPrefix20220310\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220310\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
