...
class UnsetDeclarationTest extends \RectorPrefix20211226\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20211226\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
