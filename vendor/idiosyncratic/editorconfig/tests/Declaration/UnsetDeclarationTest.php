...
class UnsetDeclarationTest extends \RectorPrefix20220211\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220211\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
