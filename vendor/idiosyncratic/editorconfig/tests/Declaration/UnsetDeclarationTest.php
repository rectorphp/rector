...
class UnsetDeclarationTest extends \RectorPrefix20220317\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220317\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
