...
class UnsetDeclarationTest extends \RectorPrefix20220212\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220212\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
