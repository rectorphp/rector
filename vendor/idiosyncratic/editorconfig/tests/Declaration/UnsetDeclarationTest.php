...
class UnsetDeclarationTest extends \RectorPrefix20220219\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20220219\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
