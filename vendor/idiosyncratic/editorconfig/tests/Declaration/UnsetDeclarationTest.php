...
class UnsetDeclarationTest extends \RectorPrefix20210725\PHPUnit\Framework\TestCase
{
    public function testDeclaration()
    {
        $declaration = new \RectorPrefix20210725\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration('indent_style');
