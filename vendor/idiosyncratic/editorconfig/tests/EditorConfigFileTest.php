...
namespace RectorPrefix20210827\Idiosyncratic\EditorConfig;
...
class EditorConfigFileTest extends \RectorPrefix20210827\PHPUnit\Framework\TestCase
{
    public function testParseEditorConfigFile() : void
    {
        $path = __DIR__ . '/data/editorconfig';
        $file = new \RectorPrefix20210827\Idiosyncratic\EditorConfig\EditorConfigFile($path);
        $this->assertInstanceOf(\RectorPrefix20210827\Idiosyncratic\EditorConfig\EditorConfigFile::class, $file);
    ...
    public function testFileDoesNotExist() : void
    {
        ...
        $file = new \RectorPrefix20210827\Idiosyncratic\EditorConfig\EditorConfigFile(__DIR__);
    }
