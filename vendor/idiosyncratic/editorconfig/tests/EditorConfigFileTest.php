...
namespace RectorPrefix20211007\Idiosyncratic\EditorConfig;
...
class EditorConfigFileTest extends \RectorPrefix20211007\PHPUnit\Framework\TestCase
{
    public function testParseEditorConfigFile() : void
    {
        $path = __DIR__ . '/data/editorconfig';
        $file = new \RectorPrefix20211007\Idiosyncratic\EditorConfig\EditorConfigFile($path);
        $this->assertInstanceOf(\RectorPrefix20211007\Idiosyncratic\EditorConfig\EditorConfigFile::class, $file);
    ...
    public function testFileDoesNotExist() : void
    {
        ...
        $file = new \RectorPrefix20211007\Idiosyncratic\EditorConfig\EditorConfigFile(__DIR__);
    }
