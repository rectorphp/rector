...
namespace RectorPrefix20210901\Idiosyncratic\EditorConfig;

use RectorPrefix20210901\Idiosyncratic\EditorConfig\Exception\InvalidValue;
use RectorPrefix20210901\PHPUnit\Framework\TestCase;
use RuntimeException;
class EditorConfigFileTest extends \RectorPrefix20210901\PHPUnit\Framework\TestCase
{
    public function testParseEditorConfigFile() : void
    {
        $path = __DIR__ . '/data/editorconfig';
        $file = new \RectorPrefix20210901\Idiosyncratic\EditorConfig\EditorConfigFile($path);
        $this->assertInstanceOf(\RectorPrefix20210901\Idiosyncratic\EditorConfig\EditorConfigFile::class, $file);
    ...
    public function testInvalidRootValue() : void
    {
        ...
        $this->expectException(\RectorPrefix20210901\Idiosyncratic\EditorConfig\Exception\InvalidValue::class);
        $file = new \RectorPrefix20210901\Idiosyncratic\EditorConfig\EditorConfigFile($path);
    }
    public function testFileDoesNotExist() : void
    {
        $this->expectException(\RuntimeException::class);
        $file = new \RectorPrefix20210901\Idiosyncratic\EditorConfig\EditorConfigFile(__DIR__);
    }
