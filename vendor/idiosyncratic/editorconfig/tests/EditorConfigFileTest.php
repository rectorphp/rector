...
namespace RectorPrefix20220303\Idiosyncratic\EditorConfig;
...
class EditorConfigFileTest extends \RectorPrefix20220303\PHPUnit\Framework\TestCase
{
    public function testParseEditorConfigFile() : void
    {
        $path = __DIR__ . '/data/editorconfig';
        $file = new \RectorPrefix20220303\Idiosyncratic\EditorConfig\EditorConfigFile($path);
        $this->assertInstanceOf(\RectorPrefix20220303\Idiosyncratic\EditorConfig\EditorConfigFile::class, $file);
    ...
    public function testFileDoesNotExist() : void
    {
        ...
        $file = new \RectorPrefix20220303\Idiosyncratic\EditorConfig\EditorConfigFile(__DIR__);
    }
