...
namespace RectorPrefix20220217\Idiosyncratic\EditorConfig;
...
class EditorConfigFileTest extends \RectorPrefix20220217\PHPUnit\Framework\TestCase
{
    public function testParseEditorConfigFile() : void
    {
        ...
        $this->assertInstanceOf(\RectorPrefix20220217\Idiosyncratic\EditorConfig\EditorConfigFile::class, $file);
