...
namespace RectorPrefix20220101\Idiosyncratic\EditorConfig;
...
class EditorConfigFileTest extends \RectorPrefix20220101\PHPUnit\Framework\TestCase
{
    public function testParseEditorConfigFile() : void
    {
        ...
        $this->assertInstanceOf(\RectorPrefix20220101\Idiosyncratic\EditorConfig\EditorConfigFile::class, $file);
