...
class EditorConfigFileTest extends \RectorPrefix20220105\PHPUnit\Framework\TestCase
{
    public function testParseEditorConfigFile() : void
    {
        $path = __DIR__ . '/data/editorconfig';
        $file = new \RectorPrefix20220105\Idiosyncratic\EditorConfig\EditorConfigFile($path);
        $this->assertInstanceOf(\RectorPrefix20220105\Idiosyncratic\EditorConfig\EditorConfigFile::class, $file);
    ...
    public function testFileDoesNotExist() : void
    {
        ...
        $file = new \RectorPrefix20220105\Idiosyncratic\EditorConfig\EditorConfigFile(__DIR__);
    }
