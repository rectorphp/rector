...
final class Factory
{
     ...
     * @param mixed $value
     */
    public function getDeclaration(string $name, $value) : \RectorPrefix20220102\Idiosyncratic\EditorConfig\Declaration\Declaration
    {
        if ($value === 'unset') {
            return new \RectorPrefix20220102\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration($name);
        }
