...
final class EditorConfig
{
    ...
    private function getConfigFile(string $path) : \RectorPrefix20211124\Idiosyncratic\EditorConfig\EditorConfigFile
    {
        return $this->configFiles[$path] ?? ($this->configFiles[$path] = new \RectorPrefix20211124\Idiosyncratic\EditorConfig\EditorConfigFile($path));
    }
}
