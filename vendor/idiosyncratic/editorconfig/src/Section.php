...
final class Section
{
     ...
     */
    public function __construct(string $globPrefix, string $glob, array $declarations, \RectorPrefix20220501\Idiosyncratic\EditorConfig\Declaration\Factory $declarationFactory)
    {
