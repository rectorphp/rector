...
use ErrorException;
use RectorPrefix20210805\Idiosyncratic\EditorConfig\Declaration\Factory;
...
final class Section
{
     ...
     */
    public function __construct(string $globPrefix, string $glob, array $declarations, \RectorPrefix20210805\Idiosyncratic\EditorConfig\Declaration\Factory $declarationFactory)
    {
