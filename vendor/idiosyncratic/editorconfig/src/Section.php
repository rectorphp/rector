...
use ErrorException;
use RectorPrefix20211126\Idiosyncratic\EditorConfig\Declaration\Factory;
...
final class Section
{
     ...
     */
    public function __construct(string $globPrefix, string $glob, array $declarations, \RectorPrefix20211126\Idiosyncratic\EditorConfig\Declaration\Factory $declarationFactory)
    {
