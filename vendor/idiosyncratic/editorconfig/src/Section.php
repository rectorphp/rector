...
use ErrorException;
use RectorPrefix20211226\Idiosyncratic\EditorConfig\Declaration\Factory;
...
final class Section
{
     ...
     */
    public function __construct(string $globPrefix, string $glob, array $declarations, \RectorPrefix20211226\Idiosyncratic\EditorConfig\Declaration\Factory $declarationFactory)
    {
