...
use ErrorException;
use RectorPrefix20220508\Idiosyncratic\EditorConfig\Declaration\Factory;
...
final class Section
{
     ...
     */
    public function __construct(string $globPrefix, string $glob, array $declarations, \RectorPrefix20220508\Idiosyncratic\EditorConfig\Declaration\Factory $declarationFactory)
    {
