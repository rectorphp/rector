...
use ErrorException;
use RectorPrefix20220323\Idiosyncratic\EditorConfig\Declaration\Factory;
...
final class Section
{
     ...
     */
    public function __construct(string $globPrefix, string $glob, array $declarations, \RectorPrefix20220323\Idiosyncratic\EditorConfig\Declaration\Factory $declarationFactory)
    {
