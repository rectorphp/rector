...
use ErrorException;
use RectorPrefix20210722\Idiosyncratic\EditorConfig\Declaration\Factory;
...
final class Section
{
     ...
     */
    public function __construct(string $globPrefix, string $glob, array $declarations, \RectorPrefix20210722\Idiosyncratic\EditorConfig\Declaration\Factory $declarationFactory)
    {
