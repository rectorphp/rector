...
final class Section
{
     ...
     */
    public function __construct(string $globPrefix, string $glob, array $declarations, \RectorPrefix20211020\Idiosyncratic\EditorConfig\Declaration\Factory $declarationFactory)
    {
