...
use ErrorException;
use RectorPrefix20220421\Idiosyncratic\EditorConfig\Declaration\Factory;
...
final class Section
{
     ...
     */
    public function __construct(string $globPrefix, string $glob, array $declarations, \RectorPrefix20220421\Idiosyncratic\EditorConfig\Declaration\Factory $declarationFactory)
    {
