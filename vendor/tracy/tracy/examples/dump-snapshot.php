...
\class_alias('RectorPrefix20211221\\Test', 'Test', \false);
$arr = [10, 'hello', \fopen(__FILE__, 'r')];
$obj = new \RectorPrefix20211221\Test();
$snapshot = [];
echo \RectorPrefix20211221\Tracy\Dumper::toHtml($arr, [\RectorPrefix20211221\Tracy\Dumper::SNAPSHOT => &$snapshot]);
echo \RectorPrefix20211221\Tracy\Dumper::toHtml($obj, [\RectorPrefix20211221\Tracy\Dumper::SNAPSHOT => &$snapshot]);
...
echo \RectorPrefix20211221\Tracy\Dumper::toHtml($obj, [\RectorPrefix20211221\Tracy\Dumper::SNAPSHOT => &$snapshot]);
// prints snapshot
echo '<meta itemprop=tracy-snapshot content=', \RectorPrefix20211221\Tracy\Dumper::formatSnapshotAttribute($snapshot), '>';
echo '</div>';
