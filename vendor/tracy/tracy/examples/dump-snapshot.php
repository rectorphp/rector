...
$obj = new \RectorPrefix20210510\Test();
$snapshot = [];
echo \RectorPrefix20210510\Tracy\Dumper::toHtml($arr, [\RectorPrefix20210510\Tracy\Dumper::SNAPSHOT => &$snapshot]);
echo \RectorPrefix20210510\Tracy\Dumper::toHtml($obj, [\RectorPrefix20210510\Tracy\Dumper::SNAPSHOT => &$snapshot]);
...
echo \RectorPrefix20210510\Tracy\Dumper::toHtml($obj, [\RectorPrefix20210510\Tracy\Dumper::SNAPSHOT => &$snapshot]);
// prints snapshot
echo '<meta itemprop=tracy-snapshot content=', \RectorPrefix20210510\Tracy\Dumper::formatSnapshotAttribute($snapshot), '>';
echo '</div>';
