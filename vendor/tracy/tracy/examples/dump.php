...
\RectorPrefix20211221\dump('any string', 123, [\true, \false, null]);
echo "<h2>Dark Mode</h2>\n";
\RectorPrefix20211221\Tracy\Debugger::$dumpTheme = 'dark';
\RectorPrefix20211221\dump('any string');
echo "<h2>Objects</h2>\n";
...
\class_alias('RectorPrefix20211221\\ParentClass', 'ParentClass', \false);
class ChildClass extends \RectorPrefix20211221\ParentClass
{
    private $baz = 'child';
}
\class_alias('RectorPrefix20211221\\ChildClass', 'ChildClass', \false);
$obj = new \RectorPrefix20211221\ChildClass();
$obj->dynamic = 'hello';
$obj->selfReference = $obj;
\RectorPrefix20211221\dump($obj);
echo "<h2>Strings</h2>\n";
