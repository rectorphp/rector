...
\RectorPrefix20210511\dump('any string', 123, [\true, \false, null]);
echo "<h2>Dark Mode</h2>\n";
\RectorPrefix20210511\Tracy\Debugger::$dumpTheme = 'dark';
\RectorPrefix20210511\dump('any string');
echo "<h2>Objects</h2>\n";
...
\class_alias('RectorPrefix20210511\\ParentClass', 'ParentClass', \false);
class ChildClass extends \RectorPrefix20210511\ParentClass
{
    private $baz = 'child';
}
\class_alias('RectorPrefix20210511\\ChildClass', 'ChildClass', \false);
$obj = new \RectorPrefix20210511\ChildClass();
$obj->dynamic = 'hello';
$obj->selfReference = $obj;
\RectorPrefix20210511\dump($obj);
echo "<h2>Strings</h2>\n";
