...
\RectorPrefix20210726\dump('any string', 123, [\true, \false, null]);
echo "<h2>Dark Mode</h2>\n";
\RectorPrefix20210726\Tracy\Debugger::$dumpTheme = 'dark';
\RectorPrefix20210726\dump('any string');
echo "<h2>Objects</h2>\n";
...
\class_alias('RectorPrefix20210726\\ParentClass', 'ParentClass', \false);
class ChildClass extends \RectorPrefix20210726\ParentClass
{
    private $baz = 'child';
}
\class_alias('RectorPrefix20210726\\ChildClass', 'ChildClass', \false);
$obj = new \RectorPrefix20210726\ChildClass();
$obj->dynamic = 'hello';
$obj->selfReference = $obj;
\RectorPrefix20210726\dump($obj);
echo "<h2>Strings</h2>\n";
