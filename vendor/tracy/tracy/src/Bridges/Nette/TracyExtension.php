...
class TracyExtension extends Nette\DI\CompilerExtension
{
    ...
    public function afterCompile(Nette\PhpGenerator\ClassType $class)
    {
        ...
        if ($this->debugMode) {
            ...
            if (!$this->cliMode && Tracy\Debugger::getSessionStorage() instanceof Tracy\NativeSession && ($name = $builder->getByType(Nette\Http\Session::class))) {
