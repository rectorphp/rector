...
class TracyToPsrLoggerAdapter extends \RectorPrefix20210730\Psr\Log\AbstractLogger
{
    ...
    {
        $level = self::LEVEL_MAP[$level] ?? \RectorPrefix20210730\Tracy\ILogger::ERROR;
