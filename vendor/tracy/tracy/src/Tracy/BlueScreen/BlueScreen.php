...
class BlueScreen
{
    ...
    public static function highlightPhpCli(string $file, int $line, int $lines = 15, int $column = 0) : ?string
    {
        ...
        $colors = ['color: ' . \ini_get('highlight.comment') => '1;30', 'color: ' . \ini_get('highlight.default') => '1;36', 'color: ' . \ini_get('highlight.html') => '1;35', 'color: ' . \ini_get('highlight.keyword') => '1;37', 'color: ' . \ini_get('highlight.string') => '1;32', 'line' => '1;30', 'highlight' => "1;37m\x1b[41"];
        $stack = ['0'];
