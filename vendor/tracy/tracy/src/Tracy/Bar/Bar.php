...
class Bar
{
     ...
     * @param string $id
     */
    public function getPanel($id) : ?\RectorPrefix20210730\Tracy\IBarPanel
    {
    ...
    public function renderLoader() : void
    {
        ...
        $nonce = \RectorPrefix20210730\Tracy\Helpers::getNonce();
        $async = \true;
    ...
    public function render() : void
    {
        ...
        if (\RectorPrefix20210730\Tracy\Helpers::isAjax()) {
            if ($useSession) {
        ...
        } elseif (\RectorPrefix20210730\Tracy\Helpers::isHtmlMode()) {
    ...
    private function renderHtml(string $type, string $suffix = '') : array
    {
        ...
        return ['bar' => \RectorPrefix20210730\Tracy\Helpers::capture(function () use($type, $panels) {
            require __DIR__ . '/assets/bar.phtml';
        }), 'panels' => \RectorPrefix20210730\Tracy\Helpers::capture(function () use($type, $panels) {
    ...
    private function renderPanels(string $suffix = '') : array
    {
        ...
        foreach ($this->panels as $id => $panel) {
            ...
            try {
                ...
                $idHtml = "error-{$idHtml}";
                $tab = "Error in {$id}";
                $panelHtml = "<h1>Error: {$id}</h1><div class='tracy-inner'>" . \nl2br(\RectorPrefix20210730\Tracy\Helpers::escapeHtml($e)) . '</div>';
                unset($e);
            }
    ...
    public function dispatchAssets() : bool
    {
        ...
        if ($this->useSession && \RectorPrefix20210730\Tracy\Helpers::isAjax()) {
    ...
    {
        $css = \array_map('file_get_contents', \array_merge([__DIR__ . '/assets/bar.css', __DIR__ . '/../Toggle/toggle.css', __DIR__ . '/../TableSort/table-sort.css', __DIR__ . '/../Dumper/assets/dumper-light.css', __DIR__ . '/../Dumper/assets/dumper-dark.css', __DIR__ . '/../BlueScreen/assets/bluescreen.css'], \RectorPrefix20210730\Tracy\Debugger::$customCssFiles));
        ...
        \array_map('readfile', \RectorPrefix20210730\Tracy\Debugger::$customJsFiles);
    }
}
