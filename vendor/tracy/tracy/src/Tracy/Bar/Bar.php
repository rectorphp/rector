...
class Bar
{
     ...
     * @return static
     */
    public function addPanel(IBarPanel $panel, string $id = null)
    {
        if ($id === null) {
            $c = 0;
            do {
    ...
    {
        $css = \array_map('file_get_contents', \array_merge([__DIR__ . '/assets/bar.css', __DIR__ . '/../Toggle/toggle.css', __DIR__ . '/../TableSort/table-sort.css', __DIR__ . '/../Dumper/assets/dumper-light.css', __DIR__ . '/../Dumper/assets/dumper-dark.css', __DIR__ . '/../BlueScreen/assets/bluescreen.css'], Debugger::$customCssFiles));
