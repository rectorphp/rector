...
class Bar
{
     ...
     * @param string $id
     */
    public function getPanel($id) : ?\RectorPrefix20211031\Tracy\IBarPanel
    {
    ...
    public function renderLoader() : void
    {
        ...
        $nonce = \RectorPrefix20211031\Tracy\Helpers::getNonce();
        $async = \true;
    ...
    public function render() : void
    {
        ...
        if (\RectorPrefix20211031\Tracy\Helpers::isAjax()) {
            if ($useSession) {
        ...
        } elseif (\RectorPrefix20211031\Tracy\Helpers::isHtmlMode()) {
    ...
    private function renderHtml(string $type, string $suffix = '') : array
    {
        ...
        return ['bar' => \RectorPrefix20211031\Tracy\Helpers::capture(function () use($type, $panels) {
            require __DIR__ . '/assets/bar.phtml';
        }), 'panels' => \RectorPrefix20211031\Tracy\Helpers::capture(function () use($type, $panels) {
    ...
    private function renderPanels(string $suffix = '') : array
    {
        ...
        foreach ($this->panels as $id => $panel) {
            ...
            try {
                ...
                $idHtml = "error-{$idHtml}";
                $tab = "Error in {$id}";
                $panelHtml = "<h1>Error: {$id}</h1><div class='tracy-inner'>" . \nl2br(\RectorPrefix20211031\Tracy\Helpers::escapeHtml($e)) . '</div>';
                unset($e);
            }
    ...
    public function dispatchAssets() : bool
    {
        ...
        if ($this->useSession && \RectorPrefix20211031\Tracy\Helpers::isAjax()) {
    ...
    {
        $css = \array_map('file_get_contents', \array_merge([__DIR__ . '/assets/bar.css', __DIR__ . '/../Toggle/toggle.css', __DIR__ . '/../TableSort/table-sort.css', __DIR__ . '/../Dumper/assets/dumper-light.css', __DIR__ . '/../Dumper/assets/dumper-dark.css', __DIR__ . '/../BlueScreen/assets/bluescreen.css'], \RectorPrefix20211031\Tracy\Debugger::$customCssFiles));
        echo "'use strict';\n(function(){\n\tvar el = document.createElement('style');\n\tel.setAttribute('nonce', document.currentScript.getAttribute('nonce') || document.currentScript.nonce);\n\tel.className='tracy-debug';\n\tel.textContent=" . \json_encode(\RectorPrefix20211031\Tracy\Helpers::minifyCss(\implode($css))) . ";\n\tdocument.head.appendChild(el);})\n();\n";
        ...
        \array_map('readfile', \RectorPrefix20211031\Tracy\Debugger::$customJsFiles);
    }
}
