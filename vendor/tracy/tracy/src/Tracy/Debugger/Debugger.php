...
class Debugger
{
    ...
    public static function setLogger(\RectorPrefix20210520\Tracy\ILogger $logger) : void
    {
        self::$logger = $logger;
    }
