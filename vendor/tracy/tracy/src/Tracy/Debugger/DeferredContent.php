...
final class DeferredContent
{
    ...
    public function __construct(\RectorPrefix20220427\Tracy\SessionStorage $sessionStorage)
    {
        $this->sessionStorage = $sessionStorage;
        $this->requestId = $_SERVER['HTTP_X_TRACY_AJAX'] ?? \RectorPrefix20220427\Tracy\Helpers::createId();
    }
