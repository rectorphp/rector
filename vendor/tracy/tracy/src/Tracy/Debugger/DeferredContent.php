...
final class DeferredContent
{
    ...
    public function __construct(\RectorPrefix20220215\Tracy\SessionStorage $sessionStorage)
    {
        $this->sessionStorage = $sessionStorage;
        $this->requestId = $_SERVER['HTTP_X_TRACY_AJAX'] ?? \RectorPrefix20220215\Tracy\Helpers::createId();
    }
    ...
    public function sendAssets() : bool
    {
        ...
        if (\RectorPrefix20220215\Tracy\Helpers::isAjax()) {
    ...
    private function sendJsCss() : void
    {
        ...
        \array_map('readfile', \RectorPrefix20220215\Tracy\Debugger::$customJsFiles);
    }
