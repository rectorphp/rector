...
class PhpConfig
{
    ...
    {
        if ($data = \RectorPrefix20211019\Composer\XdebugHandler\XdebugHandler::getRestartSettings()) {
    ...
    {
        \RectorPrefix20211019\Composer\XdebugHandler\Process::setEnv($name, \false !== $value ? $value : null);
    }
}
