...
class CompilingMatcher
{
    ...
    public static function match($constraint, $operator, $version)
    {
        ...
        if (!self::$enabled) {
            return $constraint->matches(new \RectorPrefix20210731\Composer\Semver\Constraint\Constraint(self::$transOpInt[$operator], $version));
        }
