...
class CompilingMatcher
{
     ...
     * @return mixed
     */
    public static function match(\RectorPrefix20220607\Composer\Semver\Constraint\ConstraintInterface $constraint, $operator, $version)
    {
        ...
        if (!self::$enabled) {
            return self::$resultCache[$resultCacheKey] = $constraint->matches(new \RectorPrefix20220607\Composer\Semver\Constraint\Constraint(self::$transOpInt[$operator], $version));
        }
