 ...
 */
namespace RectorPrefix20220517\Composer\Pcre;
...
class PcreException extends \RuntimeException
{
    ...
    public static function fromFunction($function, $pattern)
    {
        ...
        return new \RectorPrefix20220517\Composer\Pcre\PcreException($function . '(): failed executing "' . $pattern . '": ' . self::pcreLastErrorMessage($code), $code);
    }
    /**
     * @param  int $code
     * @return string
