...
class Regex
{
    ...
    {
        return (bool) \RectorPrefix20220113\Composer\Pcre\Preg::match($pattern, $subject, $matches, 0, $offset);
    }
    /**
     * @param string $pattern
     * @param string $subject
    ...
    public static function match($pattern, $subject, $flags = 0, $offset = 0)
    {
        ...
        $count = \RectorPrefix20220113\Composer\Pcre\Preg::match($pattern, $subject, $matches, $flags, $offset);
        return new \RectorPrefix20220113\Composer\Pcre\MatchResult($count, $matches);
    }
    /**
    ...
    {
        $count = \RectorPrefix20220113\Composer\Pcre\Preg::matchWithOffsets($pattern, $subject, $matches, $flags, $offset);
        return new \RectorPrefix20220113\Composer\Pcre\MatchWithOffsetsResult($count, $matches);
    }
    /**
     * @param string $pattern
     * @param string $subject
    ...
    public static function matchAll($pattern, $subject, $flags = 0, $offset = 0)
    {
        ...
        $count = \RectorPrefix20220113\Composer\Pcre\Preg::matchAll($pattern, $subject, $matches, $flags, $offset);
        return new \RectorPrefix20220113\Composer\Pcre\MatchAllResult($count, $matches);
    }
    /**
    ...
    {
        $count = \RectorPrefix20220113\Composer\Pcre\Preg::matchAllWithOffsets($pattern, $subject, $matches, $flags, $offset);
        return new \RectorPrefix20220113\Composer\Pcre\MatchAllWithOffsetsResult($count, $matches);
    }
    /**
    ...
    {
        $result = \RectorPrefix20220113\Composer\Pcre\Preg::replace($pattern, $replacement, $subject, $limit, $count);
        return new \RectorPrefix20220113\Composer\Pcre\ReplaceResult($count, $result);
    }
    /**
     * @param string|string[] $pattern
    ...
    {
        $result = \RectorPrefix20220113\Composer\Pcre\Preg::replaceCallback($pattern, $replacement, $subject, $limit, $count, $flags);
        return new \RectorPrefix20220113\Composer\Pcre\ReplaceResult($count, $result);
    }
    /**
    ...
    {
        $result = \RectorPrefix20220113\Composer\Pcre\Preg::replaceCallbackArray($pattern, $subject, $limit, $count, $flags);
        return new \RectorPrefix20220113\Composer\Pcre\ReplaceResult($count, $result);
    }
}
