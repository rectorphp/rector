 ...
 */
namespace RectorPrefix20211020\Composer;
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('RectorPrefix20211020\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\RectorPrefix20211020\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
