 ...
 */
namespace RectorPrefix20211012\Composer;
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('RectorPrefix20211012\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\RectorPrefix20211012\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
