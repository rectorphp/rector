...
namespace RectorPrefix20220218\React\ChildProcess;
...
use RectorPrefix20220218\React\Stream\ReadableResourceStream;
 ...
 */
class Process extends \RectorPrefix20220218\Evenement\EventEmitter
{
    /**
     ...
     */
    public function start(\RectorPrefix20220218\React\EventLoop\LoopInterface $loop = null, $interval = 0.1)
    {
        if ($this->isRunning()) {
