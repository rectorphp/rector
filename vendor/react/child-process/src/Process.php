...
namespace RectorPrefix20220217\React\ChildProcess;
...
use RectorPrefix20220217\React\Stream\ReadableResourceStream;
 ...
 */
class Process extends \RectorPrefix20220217\Evenement\EventEmitter
{
    /**
     ...
     */
    public function start(\RectorPrefix20220217\React\EventLoop\LoopInterface $loop = null, $interval = 0.1)
    {
        if ($this->isRunning()) {
