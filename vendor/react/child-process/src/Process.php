...
namespace RectorPrefix20220101\React\ChildProcess;
...
use RectorPrefix20220101\React\Stream\ReadableResourceStream;
 ...
 */
class Process extends \RectorPrefix20220101\Evenement\EventEmitter
{
    /**
     ...
     */
    public function start(\RectorPrefix20220101\React\EventLoop\LoopInterface $loop = null, $interval = 0.1)
    {
        if ($this->isRunning()) {
