...
namespace RectorPrefix20220102\React\ChildProcess;
...
use RectorPrefix20220102\React\Stream\ReadableResourceStream;
 ...
 */
class Process extends \RectorPrefix20220102\Evenement\EventEmitter
{
    /**
     ...
     */
    public function start(\RectorPrefix20220102\React\EventLoop\LoopInterface $loop = null, $interval = 0.1)
    {
        if ($this->isRunning()) {
