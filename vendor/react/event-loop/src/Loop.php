...
final class Loop
{
    ...
    {
        if (self::$instance instanceof \RectorPrefix20220216\React\EventLoop\LoopInterface) {
            return self::$instance;
        }
        self::$instance = $loop = \RectorPrefix20220216\React\EventLoop\Factory::create();
     ...
     * @return void
     */
    public static function set(\RectorPrefix20220216\React\EventLoop\LoopInterface $loop)
    {
        self::$instance = $loop;
    }
    /**
     ...
     */
    public static function cancelTimer(\RectorPrefix20220216\React\EventLoop\TimerInterface $timer)
    {
