 ...
 */
final class ExtEventLoop implements \RectorPrefix20220206\React\EventLoop\LoopInterface
{
    private $eventBase;
     ...
     */
    private function scheduleTimer(\RectorPrefix20220206\React\EventLoop\TimerInterface $timer)
    {
        $flags = \Event::TIMEOUT;
        if ($timer->isPeriodic()) {
            $flags |= \Event::PERSIST;
