 ...
 */
final class ExtEventLoop implements \RectorPrefix20220421\React\EventLoop\LoopInterface
{
    private $eventBase;
     ...
     */
    private function scheduleTimer(\RectorPrefix20220421\React\EventLoop\TimerInterface $timer)
    {
        $flags = \Event::TIMEOUT;
        if ($timer->isPeriodic()) {
            $flags |= \Event::PERSIST;
