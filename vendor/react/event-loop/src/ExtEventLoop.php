 ...
 */
final class ExtEventLoop implements \RectorPrefix20220419\React\EventLoop\LoopInterface
{
    private $eventBase;
     ...
     */
    private function scheduleTimer(\RectorPrefix20220419\React\EventLoop\TimerInterface $timer)
    {
        $flags = \Event::TIMEOUT;
        if ($timer->isPeriodic()) {
            $flags |= \Event::PERSIST;
