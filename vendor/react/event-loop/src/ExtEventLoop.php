 ...
 */
final class ExtEventLoop implements \RectorPrefix20220504\React\EventLoop\LoopInterface
{
    private $eventBase;
     ...
     */
    private function scheduleTimer(\RectorPrefix20220504\React\EventLoop\TimerInterface $timer)
    {
        $flags = \Event::TIMEOUT;
        if ($timer->isPeriodic()) {
            $flags |= \Event::PERSIST;
