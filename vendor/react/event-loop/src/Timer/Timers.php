...
namespace RectorPrefix20220604\React\EventLoop\Timer;
...
final class Timers
{
    ...
    public function add(\RectorPrefix20220604\React\EventLoop\TimerInterface $timer)
    {
    ...
    public function contains(\RectorPrefix20220604\React\EventLoop\TimerInterface $timer)
    {
        return isset($this->timers[\spl_object_hash($timer)]);
    }
    public function cancel(\RectorPrefix20220604\React\EventLoop\TimerInterface $timer)
    {
        $id = \spl_object_hash($timer);
