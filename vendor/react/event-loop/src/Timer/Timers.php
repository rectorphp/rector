...
namespace RectorPrefix20211213\React\EventLoop\Timer;
...
final class Timers
{
    ...
    public function add(\RectorPrefix20211213\React\EventLoop\TimerInterface $timer)
    {
    ...
    public function contains(\RectorPrefix20211213\React\EventLoop\TimerInterface $timer)
    {
        return isset($this->timers[\spl_object_hash($timer)]);
    }
    public function cancel(\RectorPrefix20211213\React\EventLoop\TimerInterface $timer)
    {
        $id = \spl_object_hash($timer);
