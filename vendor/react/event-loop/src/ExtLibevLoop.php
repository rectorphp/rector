...
use RectorPrefix20211221\libev\EventLoop;
use RectorPrefix20211221\libev\IOEvent;
use RectorPrefix20211221\libev\SignalEvent;
use RectorPrefix20211221\libev\TimerEvent;
 ...
 */
final class ExtLibevLoop implements \RectorPrefix20211221\React\EventLoop\LoopInterface
{
    private $loop;
    ...
    public function __construct()
    {
        ...
        $this->loop = new \RectorPrefix20211221\libev\EventLoop();
    ...
    public function addReadStream($stream, $listener)
    {
        ...
        $event = new \RectorPrefix20211221\libev\IOEvent($callback, $stream, \RectorPrefix20211221\libev\IOEvent::READ);
        $this->loop->add($event);
    ...
    public function addWriteStream($stream, $listener)
    {
        ...
        $event = new \RectorPrefix20211221\libev\IOEvent($callback, $stream, \RectorPrefix20211221\libev\IOEvent::WRITE);
        $this->loop->add($event);
    ...
    public function addTimer($interval, $callback)
    {
        ...
        $event = new \RectorPrefix20211221\libev\TimerEvent($callback, $timer->getInterval());
    ...
    public function addPeriodicTimer($interval, $callback)
    {
        ...
        $event = new \RectorPrefix20211221\libev\TimerEvent($callback, $interval, $interval);
        $this->timerEvents->attach($timer, $event);
        $this->loop->add($event);
        return $timer;
    }
    ...
    public function addSignal($signal, $listener)
    {
        ...
        if (!isset($this->signalEvents[$signal])) {
            ...
            $this->signalEvents[$signal] = new \RectorPrefix20211221\libev\SignalEvent(function () use($signals, $signal) {
                $signals->call($signal);
            }, $signal);
    ...
    public function run()
    {
        ...
        while ($this->running) {
            ...
            $flags = \RectorPrefix20211221\libev\EventLoop::RUN_ONCE;
            if (!$this->running || !$this->futureTickQueue->isEmpty()) {
                $flags |= \RectorPrefix20211221\libev\EventLoop::RUN_NOWAIT;
