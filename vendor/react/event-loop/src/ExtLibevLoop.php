...
use RectorPrefix20220226\libev\EventLoop;
use RectorPrefix20220226\libev\IOEvent;
use RectorPrefix20220226\libev\SignalEvent;
use RectorPrefix20220226\libev\TimerEvent;
 ...
 */
final class ExtLibevLoop implements \RectorPrefix20220226\React\EventLoop\LoopInterface
{
    private $loop;
    ...
    public function __construct()
    {
        ...
        $this->loop = new \RectorPrefix20220226\libev\EventLoop();
    ...
    public function addReadStream($stream, $listener)
    {
        ...
        $event = new \RectorPrefix20220226\libev\IOEvent($callback, $stream, \RectorPrefix20220226\libev\IOEvent::READ);
        $this->loop->add($event);
    ...
    public function addWriteStream($stream, $listener)
    {
        ...
        $event = new \RectorPrefix20220226\libev\IOEvent($callback, $stream, \RectorPrefix20220226\libev\IOEvent::WRITE);
        $this->loop->add($event);
    ...
    public function addTimer($interval, $callback)
    {
        ...
        $event = new \RectorPrefix20220226\libev\TimerEvent($callback, $timer->getInterval());
    ...
    public function addPeriodicTimer($interval, $callback)
    {
        ...
        $event = new \RectorPrefix20220226\libev\TimerEvent($callback, $interval, $interval);
        $this->timerEvents->attach($timer, $event);
        $this->loop->add($event);
        return $timer;
    }
    ...
    public function addSignal($signal, $listener)
    {
        ...
        if (!isset($this->signalEvents[$signal])) {
            ...
            $this->signalEvents[$signal] = new \RectorPrefix20220226\libev\SignalEvent(function () use($signals, $signal) {
                $signals->call($signal);
            }, $signal);
    ...
    public function run()
    {
        ...
        while ($this->running) {
            ...
            $flags = \RectorPrefix20220226\libev\EventLoop::RUN_ONCE;
            if (!$this->running || !$this->futureTickQueue->isEmpty()) {
                $flags |= \RectorPrefix20220226\libev\EventLoop::RUN_NOWAIT;
