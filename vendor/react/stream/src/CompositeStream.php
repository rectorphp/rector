...
namespace RectorPrefix20220101\React\Stream;

use RectorPrefix20220101\Evenement\EventEmitter;
final class CompositeStream extends \RectorPrefix20220101\Evenement\EventEmitter implements \RectorPrefix20220101\React\Stream\DuplexStreamInterface
{
    private $readable;
    private $writable;
    private $closed = \false;
    public function __construct(\RectorPrefix20220101\React\Stream\ReadableStreamInterface $readable, \RectorPrefix20220101\React\Stream\WritableStreamInterface $writable)
    {
