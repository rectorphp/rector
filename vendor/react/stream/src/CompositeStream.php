...
namespace RectorPrefix20220102\React\Stream;

use RectorPrefix20220102\Evenement\EventEmitter;
final class CompositeStream extends \RectorPrefix20220102\Evenement\EventEmitter implements \RectorPrefix20220102\React\Stream\DuplexStreamInterface
{
    private $readable;
    private $writable;
    private $closed = \false;
    public function __construct(\RectorPrefix20220102\React\Stream\ReadableStreamInterface $readable, \RectorPrefix20220102\React\Stream\WritableStreamInterface $writable)
    {
