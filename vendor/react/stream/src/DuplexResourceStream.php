...
final class DuplexResourceStream extends \RectorPrefix20220508\Evenement\EventEmitter implements \RectorPrefix20220508\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \RectorPrefix20220508\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \RectorPrefix20220508\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \RectorPrefix20220508\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
