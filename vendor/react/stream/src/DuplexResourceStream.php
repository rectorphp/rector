...
final class DuplexResourceStream extends \RectorPrefix20220127\Evenement\EventEmitter implements \RectorPrefix20220127\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \RectorPrefix20220127\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \RectorPrefix20220127\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \RectorPrefix20220127\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
