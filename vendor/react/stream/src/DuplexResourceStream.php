...
final class DuplexResourceStream extends \RectorPrefix20220305\Evenement\EventEmitter implements \RectorPrefix20220305\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \RectorPrefix20220305\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \RectorPrefix20220305\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \RectorPrefix20220305\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
