...
final class DuplexResourceStream extends \RectorPrefix20220506\Evenement\EventEmitter implements \RectorPrefix20220506\React\Stream\DuplexStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    public function __construct($stream, \RectorPrefix20220506\React\EventLoop\LoopInterface $loop = null, $readChunkSize = null, \RectorPrefix20220506\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \RectorPrefix20220506\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
