...
final class WritableResourceStream extends \RectorPrefix20220417\Evenement\EventEmitter implements \RectorPrefix20220417\React\Stream\WritableStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    private $data = '';
    public function __construct($stream, \RectorPrefix20220417\React\EventLoop\LoopInterface $loop = null, $writeBufferSoftLimit = null, $writeChunkSize = null)
    {
