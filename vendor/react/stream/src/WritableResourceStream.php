...
final class WritableResourceStream extends \RectorPrefix20211213\Evenement\EventEmitter implements \RectorPrefix20211213\React\Stream\WritableStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    private $data = '';
    public function __construct($stream, \RectorPrefix20211213\React\EventLoop\LoopInterface $loop = null, $writeBufferSoftLimit = null, $writeChunkSize = null)
    {
