...
final class WritableResourceStream extends \RectorPrefix20220411\Evenement\EventEmitter implements \RectorPrefix20220411\React\Stream\WritableStreamInterface
{
    private $stream;
    /** @var LoopInterface */
    private $loop;
    ...
    private $data = '';
    public function __construct($stream, \RectorPrefix20220411\React\EventLoop\LoopInterface $loop = null, $writeBufferSoftLimit = null, $writeChunkSize = null)
    {
