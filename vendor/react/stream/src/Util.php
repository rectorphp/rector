...
final class Util
{
     ...
     */
    public static function pipe(\RectorPrefix20211225\React\Stream\ReadableStreamInterface $source, \RectorPrefix20211225\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
