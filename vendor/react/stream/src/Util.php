...
final class Util
{
     ...
     */
    public static function pipe(\RectorPrefix20220227\React\Stream\ReadableStreamInterface $source, \RectorPrefix20220227\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
