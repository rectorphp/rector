...
namespace RectorPrefix20220304\React\Dns\Model;
...
final class Message
{
     ...
     * @return self
     */
    public static function createRequestForQuery(\RectorPrefix20220304\React\Dns\Query\Query $query)
    {
        $request = new \RectorPrefix20220304\React\Dns\Model\Message();
     ...
     * @return self
     */
    public static function createResponseWithAnswersForQuery(\RectorPrefix20220304\React\Dns\Query\Query $query, array $answers)
    {
        $response = new \RectorPrefix20220304\React\Dns\Model\Message();
     ...
     * @see self::RCODE_OK
     */
    public $rcode = \RectorPrefix20220304\React\Dns\Model\Message::RCODE_OK;
    /**
