...
namespace RectorPrefix20220102\React\Dns\Model;
...
final class Message
{
     ...
     * @return self
     */
    public static function createRequestForQuery(\RectorPrefix20220102\React\Dns\Query\Query $query)
    {
        $request = new \RectorPrefix20220102\React\Dns\Model\Message();
