...
namespace RectorPrefix20211225\React\Dns\Model;
...
final class Message
{
     ...
     * @return self
     */
    public static function createRequestForQuery(\RectorPrefix20211225\React\Dns\Query\Query $query)
    {
        $request = new \RectorPrefix20211225\React\Dns\Model\Message();
     ...
     * @return self
     */
    public static function createResponseWithAnswersForQuery(\RectorPrefix20211225\React\Dns\Query\Query $query, array $answers)
    {
        $response = new \RectorPrefix20211225\React\Dns\Model\Message();
     ...
     * @see self::RCODE_OK
     */
    public $rcode = \RectorPrefix20211225\React\Dns\Model\Message::RCODE_OK;
    /**
