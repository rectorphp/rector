...
namespace RectorPrefix20220101\React\Dns\Model;
...
final class Message
{
     ...
     * @return self
     */
    public static function createRequestForQuery(\RectorPrefix20220101\React\Dns\Query\Query $query)
    {
        $request = new \RectorPrefix20220101\React\Dns\Model\Message();
