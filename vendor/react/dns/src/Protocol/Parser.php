...
namespace RectorPrefix20220217\React\Dns\Protocol;

use RectorPrefix20220217\React\Dns\Model\Message;
use RectorPrefix20220217\React\Dns\Model\Record;
...
final class Parser
{
    ...
    private function parse($data, $consumed)
    {
        ...
        $message = new \RectorPrefix20220217\React\Dns\Model\Message();
        $message->id = $id;
