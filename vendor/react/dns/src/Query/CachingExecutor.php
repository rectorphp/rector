...
final class CachingExecutor implements \RectorPrefix20220218\React\Dns\Query\ExecutorInterface
{
    /**
    ...
    private $executor;
    private $cache;
    public function __construct(\RectorPrefix20220218\React\Dns\Query\ExecutorInterface $executor, \RectorPrefix20220218\React\Cache\CacheInterface $cache)
    {
