...
final class CachingExecutor implements \RectorPrefix20220217\React\Dns\Query\ExecutorInterface
{
    /**
    ...
    private $executor;
    private $cache;
    public function __construct(\RectorPrefix20220217\React\Dns\Query\ExecutorInterface $executor, \RectorPrefix20220217\React\Cache\CacheInterface $cache)
    {
