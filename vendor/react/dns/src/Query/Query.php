...
final class Query
{
    ...
    {
        $class = $this->class !== \RectorPrefix20220408\React\Dns\Model\Message::CLASS_IN ? 'CLASS' . $this->class . ' ' : '';
        $type = 'TYPE' . $this->type;
        $ref = new \ReflectionClass('RectorPrefix20220408\\React\\Dns\\Model\\Message');
