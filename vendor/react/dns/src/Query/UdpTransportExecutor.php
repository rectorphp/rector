...
use RectorPrefix20220217\React\Dns\Protocol\BinaryDumper;
use RectorPrefix20220217\React\Dns\Protocol\Parser;
 ...
 */
final class UdpTransportExecutor implements \RectorPrefix20220217\React\Dns\Query\ExecutorInterface
{
    private $nameserver;
    private $loop;
    private $parser;
     ...
     */
    public function __construct($nameserver, \RectorPrefix20220217\React\EventLoop\LoopInterface $loop = null)
    {
