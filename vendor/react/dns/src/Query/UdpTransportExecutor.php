...
use RectorPrefix20220102\React\Dns\Protocol\BinaryDumper;
use RectorPrefix20220102\React\Dns\Protocol\Parser;
 ...
 */
final class UdpTransportExecutor implements \RectorPrefix20220102\React\Dns\Query\ExecutorInterface
{
    private $nameserver;
    private $loop;
    private $parser;
     ...
     */
    public function __construct($nameserver, \RectorPrefix20220102\React\EventLoop\LoopInterface $loop = null)
    {
