 ...
 */
final class HostsFileExecutor implements \RectorPrefix20220218\React\Dns\Query\ExecutorInterface
{
    private $hosts;
    private $fallback;
    public function __construct(\RectorPrefix20220218\React\Dns\Config\HostsFile $hosts, \RectorPrefix20220218\React\Dns\Query\ExecutorInterface $fallback)
    {
        $this->hosts = $hosts;
