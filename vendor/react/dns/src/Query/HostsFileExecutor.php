 ...
 */
final class HostsFileExecutor implements \RectorPrefix20220101\React\Dns\Query\ExecutorInterface
{
    private $hosts;
    private $fallback;
    public function __construct(\RectorPrefix20220101\React\Dns\Config\HostsFile $hosts, \RectorPrefix20220101\React\Dns\Query\ExecutorInterface $fallback)
    {
        $this->hosts = $hosts;
