...
namespace RectorPrefix20220102\React\Dns\Query;

use RectorPrefix20220102\React\Promise\CancellablePromiseInterface;
use RectorPrefix20220102\React\Promise\Deferred;
use RectorPrefix20220102\React\Promise\PromiseInterface;
final class RetryExecutor implements \RectorPrefix20220102\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $retries;
    public function __construct(\RectorPrefix20220102\React\Dns\Query\ExecutorInterface $executor, $retries = 2)
    {
