...
namespace RectorPrefix20220101\React\Dns\Query;

use RectorPrefix20220101\React\Promise\CancellablePromiseInterface;
use RectorPrefix20220101\React\Promise\Deferred;
use RectorPrefix20220101\React\Promise\PromiseInterface;
final class RetryExecutor implements \RectorPrefix20220101\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $retries;
    public function __construct(\RectorPrefix20220101\React\Dns\Query\ExecutorInterface $executor, $retries = 2)
    {
