...
use RectorPrefix202209\React\Dns\Protocol\BinaryDumper;
use RectorPrefix202209\React\Dns\Protocol\Parser;
...
class TcpTransportExecutor implements ExecutorInterface
{
    ...
    public function query(Query $query)
    {
        ...
        if ($length > 0xffff) {
            return \RectorPrefix202209\React\Promise\reject(new \RuntimeException('DNS query for ' . $query->describe() . ' failed: Query too large for TCP transport'));
        }
