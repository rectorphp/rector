...
final class TimeoutExecutor implements \RectorPrefix20220102\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $loop;
    private $timeout;
    public function __construct(\RectorPrefix20220102\React\Dns\Query\ExecutorInterface $executor, $timeout, \RectorPrefix20220102\React\EventLoop\LoopInterface $loop = null)
    {
