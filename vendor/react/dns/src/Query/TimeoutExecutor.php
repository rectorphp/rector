...
final class TimeoutExecutor implements \RectorPrefix20220101\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $loop;
    private $timeout;
    public function __construct(\RectorPrefix20220101\React\Dns\Query\ExecutorInterface $executor, $timeout, \RectorPrefix20220101\React\EventLoop\LoopInterface $loop = null)
    {
