 ...
 * ```
 */
final class CoopExecutor implements \RectorPrefix20220531\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\RectorPrefix20220531\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    public function query(\RectorPrefix20220531\React\Dns\Query\Query $query)
    {
        ...
        $pending =& $this->pending;
        $counts =& $this->counts;
        return new \RectorPrefix20220531\React\Promise\Promise(function ($resolve, $reject) use($promise) {
    ...
    private function serializeQueryToIdentity(\RectorPrefix20220531\React\Dns\Query\Query $query)
    {
