...
final class FallbackExecutor implements \RectorPrefix20220217\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $fallback;
    public function __construct(\RectorPrefix20220217\React\Dns\Query\ExecutorInterface $executor, \RectorPrefix20220217\React\Dns\Query\ExecutorInterface $fallback)
    {
