...
final class FallbackExecutor implements \RectorPrefix20220113\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $fallback;
    public function __construct(\RectorPrefix20220113\React\Dns\Query\ExecutorInterface $executor, \RectorPrefix20220113\React\Dns\Query\ExecutorInterface $fallback)
    {
    ...
    public function query(\RectorPrefix20220113\React\Dns\Query\Query $query)
    {
        ...
        return new \RectorPrefix20220113\React\Promise\Promise(function ($resolve, $reject) use(&$promise, $fallback, $query, &$cancelled) {
