...
use RectorPrefix20220218\React\Promise\Promise;
/**
 ...
 * ```
 */
class SelectiveTransportExecutor implements \RectorPrefix20220218\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\RectorPrefix20220218\React\Dns\Query\ExecutorInterface $datagramExecutor, \RectorPrefix20220218\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
