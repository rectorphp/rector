 ...
 * ```
 */
class SelectiveTransportExecutor implements \RectorPrefix20220503\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\RectorPrefix20220503\React\Dns\Query\ExecutorInterface $datagramExecutor, \RectorPrefix20220503\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\RectorPrefix20220503\React\Dns\Query\Query $query)
    {
        ...
        return new \RectorPrefix20220503\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
