 ...
 * ```
 */
class SelectiveTransportExecutor implements \RectorPrefix20220224\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\RectorPrefix20220224\React\Dns\Query\ExecutorInterface $datagramExecutor, \RectorPrefix20220224\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\RectorPrefix20220224\React\Dns\Query\Query $query)
    {
        ...
        return new \RectorPrefix20220224\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
