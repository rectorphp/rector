 ...
 * ```
 */
class SelectiveTransportExecutor implements \RectorPrefix20211216\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\RectorPrefix20211216\React\Dns\Query\ExecutorInterface $datagramExecutor, \RectorPrefix20211216\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\RectorPrefix20211216\React\Dns\Query\Query $query)
    {
        ...
        return new \RectorPrefix20211216\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
