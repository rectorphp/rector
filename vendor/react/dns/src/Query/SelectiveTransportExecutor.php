...
use RectorPrefix20220102\React\Promise\Promise;
/**
 ...
 * ```
 */
class SelectiveTransportExecutor implements \RectorPrefix20220102\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\RectorPrefix20220102\React\Dns\Query\ExecutorInterface $datagramExecutor, \RectorPrefix20220102\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
