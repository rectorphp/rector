 ...
 * ```
 */
class SelectiveTransportExecutor implements \RectorPrefix20211124\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\RectorPrefix20211124\React\Dns\Query\ExecutorInterface $datagramExecutor, \RectorPrefix20211124\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query($query)
    {
        ...
        return new \RectorPrefix20211124\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
