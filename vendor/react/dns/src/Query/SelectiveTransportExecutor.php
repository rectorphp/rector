...
use RectorPrefix20220101\React\Promise\Promise;
/**
 ...
 * ```
 */
class SelectiveTransportExecutor implements \RectorPrefix20220101\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\RectorPrefix20220101\React\Dns\Query\ExecutorInterface $datagramExecutor, \RectorPrefix20220101\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
