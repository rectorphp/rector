...
use RectorPrefix20220102\React\Cache\ArrayCache;
use RectorPrefix20220102\React\Cache\CacheInterface;
use RectorPrefix20220102\React\Dns\Config\Config;
use RectorPrefix20220102\React\Dns\Config\HostsFile;
use RectorPrefix20220102\React\Dns\Query\CachingExecutor;
use RectorPrefix20220102\React\Dns\Query\CoopExecutor;
use RectorPrefix20220102\React\Dns\Query\ExecutorInterface;
use RectorPrefix20220102\React\Dns\Query\FallbackExecutor;
use RectorPrefix20220102\React\Dns\Query\HostsFileExecutor;
use RectorPrefix20220102\React\Dns\Query\RetryExecutor;
use RectorPrefix20220102\React\Dns\Query\SelectiveTransportExecutor;
use RectorPrefix20220102\React\Dns\Query\TcpTransportExecutor;
use RectorPrefix20220102\React\Dns\Query\TimeoutExecutor;
use RectorPrefix20220102\React\Dns\Query\UdpTransportExecutor;
...
final class Factory
{
     ...
     */
    public function create($config, \RectorPrefix20220102\React\EventLoop\LoopInterface $loop = null)
    {
