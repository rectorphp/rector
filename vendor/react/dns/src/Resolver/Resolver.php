...
namespace RectorPrefix20220102\React\Dns\Resolver;

use RectorPrefix20220102\React\Dns\Model\Message;
use RectorPrefix20220102\React\Dns\Query\ExecutorInterface;
use RectorPrefix20220102\React\Dns\Query\Query;
use RectorPrefix20220102\React\Dns\RecordNotFoundException;
/**
 * @see ResolverInterface for the base interface
 */
final class Resolver implements \RectorPrefix20220102\React\Dns\Resolver\ResolverInterface
{
    private $executor;
    public function __construct(\RectorPrefix20220102\React\Dns\Query\ExecutorInterface $executor)
    {
