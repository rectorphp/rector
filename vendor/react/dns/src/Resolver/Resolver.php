...
namespace RectorPrefix20220101\React\Dns\Resolver;

use RectorPrefix20220101\React\Dns\Model\Message;
use RectorPrefix20220101\React\Dns\Query\ExecutorInterface;
use RectorPrefix20220101\React\Dns\Query\Query;
use RectorPrefix20220101\React\Dns\RecordNotFoundException;
/**
 * @see ResolverInterface for the base interface
 */
final class Resolver implements \RectorPrefix20220101\React\Dns\Resolver\ResolverInterface
{
    private $executor;
    public function __construct(\RectorPrefix20220101\React\Dns\Query\ExecutorInterface $executor)
    {
