 ...
 */
class RejectedPromise implements \RectorPrefix20211207\React\Promise\ExtendedPromiseInterface, \RectorPrefix20211207\React\Promise\CancellablePromiseInterface
{
    private $reason;
    public function __construct($reason = null)
    {
        if ($reason instanceof \RectorPrefix20211207\React\Promise\PromiseInterface) {
    ...
    {
        if (null === $onRejected) {
            throw \RectorPrefix20211207\React\Promise\UnhandledRejectionException::resolve($this->reason);
        }
        $result = $onRejected($this->reason);
        if ($result instanceof self) {
            throw \RectorPrefix20211207\React\Promise\UnhandledRejectionException::resolve($result->reason);
        }
