 ...
 */
class LazyPromise implements \RectorPrefix20220202\React\Promise\ExtendedPromiseInterface, \RectorPrefix20220202\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \RectorPrefix20220202\React\Promise\RejectedPromise($exception);
