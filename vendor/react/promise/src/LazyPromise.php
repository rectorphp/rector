 ...
 */
class LazyPromise implements \RectorPrefix20211124\React\Promise\ExtendedPromiseInterface, \RectorPrefix20211124\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \RectorPrefix20211124\React\Promise\RejectedPromise($exception);
