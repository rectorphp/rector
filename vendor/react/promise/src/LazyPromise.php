 ...
 */
class LazyPromise implements \RectorPrefix20211125\React\Promise\ExtendedPromiseInterface, \RectorPrefix20211125\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \RectorPrefix20211125\React\Promise\RejectedPromise($exception);
