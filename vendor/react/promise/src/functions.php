...
{
    if ($promiseOrValue instanceof \RectorPrefix20220101\React\Promise\ExtendedPromiseInterface) {
    ...
    if (\is_object($promiseOrValue) && \method_exists($promiseOrValue, 'then')) {
        ...
        return new \RectorPrefix20220101\React\Promise\Promise(function ($resolve, $reject, $notify) use($promiseOrValue) {
