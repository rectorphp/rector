...
{
    if ($promiseOrValue instanceof \RectorPrefix20220218\React\Promise\ExtendedPromiseInterface) {
    ...
    if (\is_object($promiseOrValue) && \method_exists($promiseOrValue, 'then')) {
        ...
        return new \RectorPrefix20220218\React\Promise\Promise(function ($resolve, $reject, $notify) use($promiseOrValue) {
