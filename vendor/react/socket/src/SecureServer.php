 ...
 */
final class SecureServer extends \RectorPrefix20220112\Evenement\EventEmitter implements \RectorPrefix20220112\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\RectorPrefix20220112\React\Socket\ServerInterface $tcp, \RectorPrefix20220112\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \RectorPrefix20220112\React\Socket\StreamEncryption($loop ?: \RectorPrefix20220112\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\RectorPrefix20220112\React\Socket\ConnectionInterface $connection)
    {
