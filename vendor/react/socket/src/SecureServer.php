 ...
 */
final class SecureServer extends \RectorPrefix20211205\Evenement\EventEmitter implements \RectorPrefix20211205\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\RectorPrefix20211205\React\Socket\ServerInterface $tcp, \RectorPrefix20211205\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \RectorPrefix20211205\React\Socket\StreamEncryption($loop ?: \RectorPrefix20211205\React\EventLoop\Loop::get());
