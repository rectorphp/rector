 ...
 */
final class SecureServer extends \RectorPrefix20211213\Evenement\EventEmitter implements \RectorPrefix20211213\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\RectorPrefix20211213\React\Socket\ServerInterface $tcp, \RectorPrefix20211213\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \RectorPrefix20211213\React\Socket\StreamEncryption($loop ?: \RectorPrefix20211213\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\RectorPrefix20211213\React\Socket\ConnectionInterface $connection)
    {
