 ...
 */
final class SecureServer extends \RectorPrefix20211130\Evenement\EventEmitter implements \RectorPrefix20211130\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\RectorPrefix20211130\React\Socket\ServerInterface $tcp, \RectorPrefix20211130\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \RectorPrefix20211130\React\Socket\StreamEncryption($loop ?: \RectorPrefix20211130\React\EventLoop\Loop::get());
