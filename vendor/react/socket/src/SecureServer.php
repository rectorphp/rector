 ...
 */
final class SecureServer extends \RectorPrefix20211210\Evenement\EventEmitter implements \RectorPrefix20211210\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\RectorPrefix20211210\React\Socket\ServerInterface $tcp, \RectorPrefix20211210\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \RectorPrefix20211210\React\Socket\StreamEncryption($loop ?: \RectorPrefix20211210\React\EventLoop\Loop::get());
