 ...
 */
final class SecureServer extends \RectorPrefix20220326\Evenement\EventEmitter implements \RectorPrefix20220326\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\RectorPrefix20220326\React\Socket\ServerInterface $tcp, \RectorPrefix20220326\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \RectorPrefix20220326\React\Socket\StreamEncryption($loop ?: \RectorPrefix20220326\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\RectorPrefix20220326\React\Socket\ConnectionInterface $connection)
    {
