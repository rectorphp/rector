 ...
 */
final class SecureServer extends \RectorPrefix20211220\Evenement\EventEmitter implements \RectorPrefix20211220\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\RectorPrefix20211220\React\Socket\ServerInterface $tcp, \RectorPrefix20211220\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \RectorPrefix20211220\React\Socket\StreamEncryption($loop ?: \RectorPrefix20211220\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\RectorPrefix20211220\React\Socket\ConnectionInterface $connection)
    {
