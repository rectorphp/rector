 ...
 */
final class SecureServer extends \RectorPrefix20211209\Evenement\EventEmitter implements \RectorPrefix20211209\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\RectorPrefix20211209\React\Socket\ServerInterface $tcp, \RectorPrefix20211209\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \RectorPrefix20211209\React\Socket\StreamEncryption($loop ?: \RectorPrefix20211209\React\EventLoop\Loop::get());
