 ...
 */
final class SecureServer extends \RectorPrefix20211230\Evenement\EventEmitter implements \RectorPrefix20211230\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\RectorPrefix20211230\React\Socket\ServerInterface $tcp, \RectorPrefix20211230\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \RectorPrefix20211230\React\Socket\StreamEncryption($loop ?: \RectorPrefix20211230\React\EventLoop\Loop::get());
    ...
    /** @internal */
    public function handleConnection(\RectorPrefix20211230\React\Socket\ConnectionInterface $connection)
    {
