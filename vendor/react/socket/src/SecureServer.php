 ...
 */
final class SecureServer extends \RectorPrefix20211201\Evenement\EventEmitter implements \RectorPrefix20211201\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\RectorPrefix20211201\React\Socket\ServerInterface $tcp, \RectorPrefix20211201\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \RectorPrefix20211201\React\Socket\StreamEncryption($loop ?: \RectorPrefix20211201\React\EventLoop\Loop::get());
