...
final class TcpConnector implements \RectorPrefix20211129\React\Socket\ConnectorInterface
{
    private $loop;
    private $context;
    public function __construct(\RectorPrefix20211129\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
    ...
    public function connect($uri)
    {
        ...
        // wait for connection
        $loop = $this->loop;
        return new \RectorPrefix20211129\React\Promise\Promise(function ($resolve, $reject) use($loop, $stream, $uri) {
