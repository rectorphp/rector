 ...
 * @internal
 */
final class FdServer extends \RectorPrefix20220224\Evenement\EventEmitter implements \RectorPrefix20220224\React\Socket\ServerInterface
{
    private $master;
    private $loop;
    private $unix = \false;
     ...
     */
    public function __construct($fd, \RectorPrefix20220224\React\EventLoop\LoopInterface $loop = null)
    {
        ...
        if (\false === $this->master) {
            ...
            throw new \RuntimeException('Failed to listen on FD ' . $fd . ': ' . $errstr . \RectorPrefix20220224\React\Socket\SocketServer::errconst($errno), $errno);
        }
    ...
    {
        $connection = new \RectorPrefix20220224\React\Socket\Connection($socket, $this->loop);
