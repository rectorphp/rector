 ...
 * @internal
 */
final class FdServer extends \RectorPrefix20211215\Evenement\EventEmitter implements \RectorPrefix20211215\React\Socket\ServerInterface
{
    private $master;
    private $loop;
    private $unix = \false;
     ...
     */
    public function __construct($fd, \RectorPrefix20211215\React\EventLoop\LoopInterface $loop = null)
    {
        ...
        if (\false === $this->master) {
            ...
            throw new \RuntimeException('Failed to listen on FD ' . $fd . ': ' . $errstr . \RectorPrefix20211215\React\Socket\SocketServer::errconst($errno), $errno);
        }
    ...
    {
        $connection = new \RectorPrefix20211215\React\Socket\Connection($socket, $this->loop);
