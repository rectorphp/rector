 ...
 * @internal
 */
final class FdServer extends \RectorPrefix20220109\Evenement\EventEmitter implements \RectorPrefix20220109\React\Socket\ServerInterface
{
    private $master;
    private $loop;
    private $unix = \false;
     ...
     */
    public function __construct($fd, \RectorPrefix20220109\React\EventLoop\LoopInterface $loop = null)
    {
        ...
        if (\false === $this->master) {
            ...
            throw new \RuntimeException('Failed to listen on FD ' . $fd . ': ' . $errstr . \RectorPrefix20220109\React\Socket\SocketServer::errconst($errno), $errno);
        }
    ...
    {
        $connection = new \RectorPrefix20220109\React\Socket\Connection($socket, $this->loop);
