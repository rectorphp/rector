...
use RectorPrefix20211202\React\Promise\Timer;
use RectorPrefix20211202\React\Promise\Timer\TimeoutException;
final class TimeoutConnector implements \RectorPrefix20211202\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
    public function __construct(\RectorPrefix20211202\React\Socket\ConnectorInterface $connector, $timeout, \RectorPrefix20211202\React\EventLoop\LoopInterface $loop = null)
    {
    ...
    {
        return \RectorPrefix20211202\React\Promise\Timer\timeout($this->connector->connect($uri), $this->timeout, $this->loop)->then(null, self::handler($uri));
    }
    /**
    ...
    private static function handler($uri)
    {
        return function (\Exception $e) use($uri) {
            if ($e instanceof \RectorPrefix20211202\React\Promise\Timer\TimeoutException) {
