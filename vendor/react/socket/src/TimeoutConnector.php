...
use RectorPrefix20220102\React\EventLoop\Loop;
use RectorPrefix20220102\React\EventLoop\LoopInterface;
use RectorPrefix20220102\React\Promise\Timer;
use RectorPrefix20220102\React\Promise\Timer\TimeoutException;
final class TimeoutConnector implements \RectorPrefix20220102\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
    public function __construct(\RectorPrefix20220102\React\Socket\ConnectorInterface $connector, $timeout, \RectorPrefix20220102\React\EventLoop\LoopInterface $loop = null)
    {
