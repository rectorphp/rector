...
use RectorPrefix20211124\React\Promise\Timer\TimeoutException;
final class TimeoutConnector implements \RectorPrefix20211124\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
    public function __construct(\RectorPrefix20211124\React\Socket\ConnectorInterface $connector, $timeout, \RectorPrefix20211124\React\EventLoop\LoopInterface $loop = null)
    {
    ...
    {
        return \RectorPrefix20211124\React\Promise\Timer\timeout($this->connector->connect($uri), $this->timeout, $this->loop)->then(null, self::handler($uri));
    }
    /**
