...
use RectorPrefix20220218\React\EventLoop\Loop;
use RectorPrefix20220218\React\EventLoop\LoopInterface;
use RectorPrefix20220218\React\Promise\Timer;
use RectorPrefix20220218\React\Promise\Timer\TimeoutException;
final class TimeoutConnector implements \RectorPrefix20220218\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
    public function __construct(\RectorPrefix20220218\React\Socket\ConnectorInterface $connector, $timeout, \RectorPrefix20220218\React\EventLoop\LoopInterface $loop = null)
    {
