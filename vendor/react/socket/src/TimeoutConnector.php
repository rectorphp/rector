...
use RectorPrefix20211129\React\Promise\Timer;
use RectorPrefix20211129\React\Promise\Timer\TimeoutException;
final class TimeoutConnector implements \RectorPrefix20211129\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
    public function __construct(\RectorPrefix20211129\React\Socket\ConnectorInterface $connector, $timeout, \RectorPrefix20211129\React\EventLoop\LoopInterface $loop = null)
    {
    ...
    {
        return \RectorPrefix20211129\React\Promise\Timer\timeout($this->connector->connect($uri), $this->timeout, $this->loop)->then(null, self::handler($uri));
    }
    /**
