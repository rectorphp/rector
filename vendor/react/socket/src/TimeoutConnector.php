...
use RectorPrefix20220217\React\EventLoop\Loop;
use RectorPrefix20220217\React\EventLoop\LoopInterface;
use RectorPrefix20220217\React\Promise\Timer;
use RectorPrefix20220217\React\Promise\Timer\TimeoutException;
final class TimeoutConnector implements \RectorPrefix20220217\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
    public function __construct(\RectorPrefix20220217\React\Socket\ConnectorInterface $connector, $timeout, \RectorPrefix20220217\React\EventLoop\LoopInterface $loop = null)
    {
