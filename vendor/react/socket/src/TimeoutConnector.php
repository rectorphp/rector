...
use RectorPrefix20211123\React\Promise\Timer\TimeoutException;
final class TimeoutConnector implements \RectorPrefix20211123\React\Socket\ConnectorInterface
{
    private $connector;
    private $timeout;
    private $loop;
    public function __construct(\RectorPrefix20211123\React\Socket\ConnectorInterface $connector, $timeout, \RectorPrefix20211123\React\EventLoop\LoopInterface $loop = null)
    {
    ...
    {
        return \RectorPrefix20211123\React\Promise\Timer\timeout($this->connector->connect($uri), $this->timeout, $this->loop)->then(null, self::handler($uri));
    }
    /**
