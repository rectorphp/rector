 ...
 * ```
 */
class FixedUriConnector implements \RectorPrefix20220531\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \RectorPrefix20220531\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
