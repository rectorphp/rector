 ...
 * ```
 */
class FixedUriConnector implements \RectorPrefix20220331\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \RectorPrefix20220331\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
