 ...
 * ```
 */
class FixedUriConnector implements \RectorPrefix20220221\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \RectorPrefix20220221\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
