 ...
 * ```
 */
class FixedUriConnector implements \RectorPrefix20211212\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \RectorPrefix20211212\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
