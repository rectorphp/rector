 ...
 * ```
 */
class FixedUriConnector implements \RectorPrefix20220206\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \RectorPrefix20220206\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
