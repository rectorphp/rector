 ...
 * ```
 */
class FixedUriConnector implements \RectorPrefix20220228\React\Socket\ConnectorInterface
{
    private $uri;
    private $connector;
    /**
     ...
     */
    public function __construct($uri, \RectorPrefix20220228\React\Socket\ConnectorInterface $connector)
    {
        $this->uri = $uri;
