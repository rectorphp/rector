...
use RectorPrefix20220208\React\Stream\DuplexResourceStream;
use RectorPrefix20220208\React\Stream\Util;
use RectorPrefix20220208\React\Stream\WritableResourceStream;
use RectorPrefix20220208\React\Stream\WritableStreamInterface;
/**
 ...
 * @internal
 */
class Connection extends \RectorPrefix20220208\Evenement\EventEmitter implements \RectorPrefix20220208\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \RectorPrefix20220208\React\EventLoop\LoopInterface $loop)
    {
        ...
        \RectorPrefix20220208\React\Stream\Util::forwardEvents($this->input, $this, array('data', 'end', 'error', 'close', 'pipe', 'drain'));
    ...
    public function pipe(\RectorPrefix20220208\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
