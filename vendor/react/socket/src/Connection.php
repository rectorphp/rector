...
namespace RectorPrefix20220217\React\Socket;

use RectorPrefix20220217\Evenement\EventEmitter;
use RectorPrefix20220217\React\EventLoop\LoopInterface;
use RectorPrefix20220217\React\Stream\DuplexResourceStream;
use RectorPrefix20220217\React\Stream\Util;
use RectorPrefix20220217\React\Stream\WritableResourceStream;
use RectorPrefix20220217\React\Stream\WritableStreamInterface;
/**
 ...
 * @internal
 */
class Connection extends \RectorPrefix20220217\Evenement\EventEmitter implements \RectorPrefix20220217\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \RectorPrefix20220217\React\EventLoop\LoopInterface $loop)
    {
