...
namespace RectorPrefix20220102\React\Socket;

use RectorPrefix20220102\Evenement\EventEmitter;
use RectorPrefix20220102\React\EventLoop\LoopInterface;
use RectorPrefix20220102\React\Stream\DuplexResourceStream;
use RectorPrefix20220102\React\Stream\Util;
use RectorPrefix20220102\React\Stream\WritableResourceStream;
use RectorPrefix20220102\React\Stream\WritableStreamInterface;
/**
 ...
 * @internal
 */
class Connection extends \RectorPrefix20220102\Evenement\EventEmitter implements \RectorPrefix20220102\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \RectorPrefix20220102\React\EventLoop\LoopInterface $loop)
    {
