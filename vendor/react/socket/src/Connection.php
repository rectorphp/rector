...
use RectorPrefix20220103\React\Stream\Util;
 ...
 * @internal
 */
class Connection extends \RectorPrefix20220103\Evenement\EventEmitter implements \RectorPrefix20220103\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \RectorPrefix20220103\React\EventLoop\LoopInterface $loop)
    {
        ...
        $this->input = new \RectorPrefix20220103\React\Stream\DuplexResourceStream($resource, $loop, $clearCompleteBuffer ? -1 : null, new \RectorPrefix20220103\React\Stream\WritableResourceStream($resource, $loop, null, $limitWriteChunks ? 8192 : null));
        $this->stream = $resource;
        \RectorPrefix20220103\React\Stream\Util::forwardEvents($this->input, $this, array('data', 'end', 'error', 'close', 'pipe', 'drain'));
    ...
    public function pipe(\RectorPrefix20220103\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
