...
namespace RectorPrefix20220417\React\Socket;

use RectorPrefix20220417\Evenement\EventEmitter;
use RectorPrefix20220417\React\EventLoop\LoopInterface;
use RectorPrefix20220417\React\Stream\DuplexResourceStream;
use RectorPrefix20220417\React\Stream\Util;
use RectorPrefix20220417\React\Stream\WritableResourceStream;
 ...
 * @internal
 */
class Connection extends \RectorPrefix20220417\Evenement\EventEmitter implements \RectorPrefix20220417\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \RectorPrefix20220417\React\EventLoop\LoopInterface $loop)
    {
        ...
        $this->input = new \RectorPrefix20220417\React\Stream\DuplexResourceStream($resource, $loop, $clearCompleteBuffer ? -1 : null, new \RectorPrefix20220417\React\Stream\WritableResourceStream($resource, $loop, null, $limitWriteChunks ? 8192 : null));
        $this->stream = $resource;
        \RectorPrefix20220417\React\Stream\Util::forwardEvents($this->input, $this, array('data', 'end', 'error', 'close', 'pipe', 'drain'));
    ...
    public function pipe(\RectorPrefix20220417\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
