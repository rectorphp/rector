...
namespace RectorPrefix20220118\React\Socket;

use RectorPrefix20220118\Evenement\EventEmitter;
use RectorPrefix20220118\React\EventLoop\LoopInterface;
use RectorPrefix20220118\React\Stream\DuplexResourceStream;
use RectorPrefix20220118\React\Stream\Util;
use RectorPrefix20220118\React\Stream\WritableResourceStream;
use RectorPrefix20220118\React\Stream\WritableStreamInterface;
/**
 ...
 * @internal
 */
class Connection extends \RectorPrefix20220118\Evenement\EventEmitter implements \RectorPrefix20220118\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \RectorPrefix20220118\React\EventLoop\LoopInterface $loop)
    {
        ...
        $this->input = new \RectorPrefix20220118\React\Stream\DuplexResourceStream($resource, $loop, $clearCompleteBuffer ? -1 : null, new \RectorPrefix20220118\React\Stream\WritableResourceStream($resource, $loop, null, $limitWriteChunks ? 8192 : null));
        $this->stream = $resource;
        \RectorPrefix20220118\React\Stream\Util::forwardEvents($this->input, $this, array('data', 'end', 'error', 'close', 'pipe', 'drain'));
    ...
    public function pipe(\RectorPrefix20220118\React\Stream\WritableStreamInterface $dest, array $options = array())
    {
