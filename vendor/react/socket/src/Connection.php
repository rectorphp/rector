...
use RectorPrefix20211203\React\Stream\DuplexResourceStream;
use RectorPrefix20211203\React\Stream\Util;
use RectorPrefix20211203\React\Stream\WritableResourceStream;
use RectorPrefix20211203\React\Stream\WritableStreamInterface;
/**
 ...
 * @internal
 */
class Connection extends \RectorPrefix20211203\Evenement\EventEmitter implements \RectorPrefix20211203\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \RectorPrefix20211203\React\EventLoop\LoopInterface $loop)
    {
        ...
        $this->input = new \RectorPrefix20211203\React\Stream\DuplexResourceStream($resource, $loop, $clearCompleteBuffer ? -1 : null, new \RectorPrefix20211203\React\Stream\WritableResourceStream($resource, $loop, null, $limitWriteChunks ? 8192 : null));
        $this->stream = $resource;
        \RectorPrefix20211203\React\Stream\Util::forwardEvents($this->input, $this, array('data', 'end', 'error', 'close', 'pipe', 'drain'));
