...
use RectorPrefix20211213\React\Stream\DuplexResourceStream;
use RectorPrefix20211213\React\Stream\Util;
use RectorPrefix20211213\React\Stream\WritableResourceStream;
 ...
 * @internal
 */
class Connection extends \RectorPrefix20211213\Evenement\EventEmitter implements \RectorPrefix20211213\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \RectorPrefix20211213\React\EventLoop\LoopInterface $loop)
    {
        ...
        $this->input = new \RectorPrefix20211213\React\Stream\DuplexResourceStream($resource, $loop, $clearCompleteBuffer ? -1 : null, new \RectorPrefix20211213\React\Stream\WritableResourceStream($resource, $loop, null, $limitWriteChunks ? 8192 : null));
        $this->stream = $resource;
        \RectorPrefix20211213\React\Stream\Util::forwardEvents($this->input, $this, array('data', 'end', 'error', 'close', 'pipe', 'drain'));
