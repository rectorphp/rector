...
final class HappyEyeBallsConnector implements \RectorPrefix20211215\React\Socket\ConnectorInterface
{
    private $loop;
    private $connector;
    private $resolver;
    public function __construct(\RectorPrefix20211215\React\EventLoop\LoopInterface $loop = null, \RectorPrefix20211215\React\Socket\ConnectorInterface $connector = null, \RectorPrefix20211215\React\Dns\Resolver\ResolverInterface $resolver = null)
    {
    ...
    public function connect($uri)
    {
        ...
        $builder = new \RectorPrefix20211215\React\Socket\HappyEyeBallsConnectionBuilder($this->loop, $this->connector, $this->resolver, $uri, $host, $parts);
