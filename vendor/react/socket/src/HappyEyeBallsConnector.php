...
final class HappyEyeBallsConnector implements \RectorPrefix20220531\React\Socket\ConnectorInterface
{
    private $loop;
    private $connector;
    private $resolver;
    public function __construct(\RectorPrefix20220531\React\EventLoop\LoopInterface $loop = null, \RectorPrefix20220531\React\Socket\ConnectorInterface $connector = null, \RectorPrefix20220531\React\Dns\Resolver\ResolverInterface $resolver = null)
    {
    ...
    public function connect($uri)
    {
        ...
        $builder = new \RectorPrefix20220531\React\Socket\HappyEyeBallsConnectionBuilder($this->loop, $this->connector, $this->resolver, $uri, $host, $parts);
