 ...
 */
final class TcpServer extends \RectorPrefix20211127\Evenement\EventEmitter implements \RectorPrefix20211127\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($uri, \RectorPrefix20211127\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
    ...
    {
        $this->emit('connection', array(new \RectorPrefix20211127\React\Socket\Connection($socket, $this->loop)));
    }
}
