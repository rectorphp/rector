 ...
 */
final class UnixServer extends \RectorPrefix20211124\Evenement\EventEmitter implements \RectorPrefix20211124\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \RectorPrefix20211124\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
    ...
    {
        $connection = new \RectorPrefix20211124\React\Socket\Connection($socket, $this->loop);
        $connection->unix = \true;
