 ...
 */
final class UnixServer extends \RectorPrefix20220404\Evenement\EventEmitter implements \RectorPrefix20220404\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \RectorPrefix20220404\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        if (\false === $this->master) {
            ...
            throw new \RuntimeException('Failed to listen on Unix domain socket "' . $path . '": ' . $errstr . \RectorPrefix20220404\React\Socket\SocketServer::errconst($errno), $errno);
        }
