...
final class DnsConnector implements \RectorPrefix20220102\React\Socket\ConnectorInterface
{
    private $connector;
    private $resolver;
    public function __construct(\RectorPrefix20220102\React\Socket\ConnectorInterface $connector, \RectorPrefix20220102\React\Dns\Resolver\ResolverInterface $resolver)
    {
