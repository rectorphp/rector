...
class StreamEncryption
{
    ...
    private $method;
    private $server;
    public function __construct(\RectorPrefix20211123\React\EventLoop\LoopInterface $loop, $server = \true)
    {
        $this->loop = $loop;
        $this->server = $server;
    ...
    public function toggle($stream, $toggle)
    {
        ...
        $deferred = new \RectorPrefix20211123\React\Promise\Deferred(function () {
