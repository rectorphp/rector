...
class StreamEncryption
{
    ...
    private $method;
    private $server;
    public function __construct(\RectorPrefix20211210\React\EventLoop\LoopInterface $loop, $server = \true)
    {
        $this->loop = $loop;
        $this->server = $server;
    ...
    public function toggle(\RectorPrefix20211210\React\Socket\Connection $stream, $toggle)
    {
        ...
        $deferred = new \RectorPrefix20211210\React\Promise\Deferred(function () {
