...
class StreamEncryption
{
    ...
    private $method;
    private $server;
    public function __construct(\RectorPrefix20211207\React\EventLoop\LoopInterface $loop, $server = \true)
    {
        $this->loop = $loop;
        $this->server = $server;
    ...
    public function toggle($stream, $toggle)
    {
        ...
        $deferred = new \RectorPrefix20211207\React\Promise\Deferred(function () {
