...
final class SecureConnector implements \RectorPrefix20211129\React\Socket\ConnectorInterface
{
    ...
    public function connect($uri)
    {
        ...
        $connected = \false;
        $promise = $this->connector->connect(\str_replace('tls://', '', $uri))->then(function (\RectorPrefix20211129\React\Socket\ConnectionInterface $connection) use($context, $encryption, $uri, &$promise, &$connected) {
