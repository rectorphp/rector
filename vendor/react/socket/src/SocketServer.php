...
final class SocketServer extends \RectorPrefix20220401\Evenement\EventEmitter implements \RectorPrefix20220401\React\Socket\ServerInterface
{
    private $server;
    /**
     ...
     */
    public function __construct($uri, array $context = array(), \RectorPrefix20220401\React\EventLoop\LoopInterface $loop = null)
    {
        ...
        if ($scheme === 'unix') {
            ...
            $server = new \RectorPrefix20220401\React\Socket\FdServer($uri, $loop);
        } else {
