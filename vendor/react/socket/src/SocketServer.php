...
final class SocketServer extends \RectorPrefix20220331\Evenement\EventEmitter implements \RectorPrefix20220331\React\Socket\ServerInterface
{
    private $server;
    /**
     ...
     */
    public function __construct($uri, array $context = array(), \RectorPrefix20220331\React\EventLoop\LoopInterface $loop = null)
    {
        ...
        if ($scheme === 'unix') {
            ...
            $server = new \RectorPrefix20220331\React\Socket\FdServer($uri, $loop);
        } else {
