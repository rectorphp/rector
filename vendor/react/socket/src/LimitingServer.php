 ...
 */
class LimitingServer extends \RectorPrefix20220515\Evenement\EventEmitter implements \RectorPrefix20220515\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20220515\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix20220515\React\Socket\ConnectionInterface $connection)
    {
