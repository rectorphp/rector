 ...
 */
class LimitingServer extends \RectorPrefix20220102\Evenement\EventEmitter implements \RectorPrefix20220102\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20220102\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
