 ...
 */
class LimitingServer extends \RectorPrefix20220118\Evenement\EventEmitter implements \RectorPrefix20220118\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20220118\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix20220118\React\Socket\ConnectionInterface $connection)
    {
