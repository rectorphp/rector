 ...
 */
class LimitingServer extends \RectorPrefix20211230\Evenement\EventEmitter implements \RectorPrefix20211230\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20211230\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix20211230\React\Socket\ConnectionInterface $connection)
    {
