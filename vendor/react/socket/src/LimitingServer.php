 ...
 */
class LimitingServer extends \RectorPrefix20220226\Evenement\EventEmitter implements \RectorPrefix20220226\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20220226\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix20220226\React\Socket\ConnectionInterface $connection)
    {
