 ...
 */
class LimitingServer extends \RectorPrefix20220428\Evenement\EventEmitter implements \RectorPrefix20220428\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20220428\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix20220428\React\Socket\ConnectionInterface $connection)
    {
