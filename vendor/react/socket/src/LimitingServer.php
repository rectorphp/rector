 ...
 */
class LimitingServer extends \RectorPrefix20220527\Evenement\EventEmitter implements \RectorPrefix20220527\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20220527\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix20220527\React\Socket\ConnectionInterface $connection)
    {
