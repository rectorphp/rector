 ...
 */
class LimitingServer extends \RectorPrefix20220406\Evenement\EventEmitter implements \RectorPrefix20220406\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20220406\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix20220406\React\Socket\ConnectionInterface $connection)
    {
