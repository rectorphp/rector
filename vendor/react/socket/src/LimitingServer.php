 ...
 */
class LimitingServer extends \RectorPrefix20211222\Evenement\EventEmitter implements \RectorPrefix20211222\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20211222\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix20211222\React\Socket\ConnectionInterface $connection)
    {
