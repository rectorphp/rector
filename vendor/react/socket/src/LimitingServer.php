 ...
 */
class LimitingServer extends \RectorPrefix20220303\Evenement\EventEmitter implements \RectorPrefix20220303\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20220303\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix20220303\React\Socket\ConnectionInterface $connection)
    {
