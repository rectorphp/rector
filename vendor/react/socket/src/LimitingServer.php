 ...
 */
class LimitingServer extends \RectorPrefix20220122\Evenement\EventEmitter implements \RectorPrefix20220122\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20220122\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix20220122\React\Socket\ConnectionInterface $connection)
    {
