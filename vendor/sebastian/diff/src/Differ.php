...
use function substr;
use RectorPrefix202208\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface;
use RectorPrefix202208\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder;
final class Differ
{
    public const OLD = 0;
