...
final class Differ
{
    ...
    public function __construct($outputBuilder = null)
    {
        if ($outputBuilder instanceof \RectorPrefix20220218\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface) {
            ...
            throw new \RectorPrefix20220218\SebastianBergmann\Diff\InvalidArgumentException(\sprintf('Expected builder to be an instance of DiffOutputBuilderInterface, <null> or a string, got %s.', \is_object($outputBuilder) ? 'instance of "' . \get_class($outputBuilder) . '"' : \gettype($outputBuilder) . ' "' . $outputBuilder . '"'));
        }
    }
    /**
