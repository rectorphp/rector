...
use function substr;
use RectorPrefix202207\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface;
use RectorPrefix202207\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder;
final class Differ
{
    public const OLD = 0;
