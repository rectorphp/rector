...
use function substr;
use RectorPrefix20210510\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface;
use RectorPrefix20210510\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder;
final class Differ
{
    public const OLD = 0;
