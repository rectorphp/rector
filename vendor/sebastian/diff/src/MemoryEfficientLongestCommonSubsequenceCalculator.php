...
use function max;
final class MemoryEfficientLongestCommonSubsequenceCalculator implements \RectorPrefix20211020\SebastianBergmann\Diff\LongestCommonSubsequenceCalculator
{
    /**
     * {@inheritdoc}
     * @param mixed[] $from
