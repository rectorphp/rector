...
use function max;
final class MemoryEfficientLongestCommonSubsequenceCalculator implements \RectorPrefix20211118\SebastianBergmann\Diff\LongestCommonSubsequenceCalculator
{
    /**
     * {@inheritdoc}
     * @param mixed[] $from
