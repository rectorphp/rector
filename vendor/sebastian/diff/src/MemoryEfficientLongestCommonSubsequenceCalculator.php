...
use function max;
final class MemoryEfficientLongestCommonSubsequenceCalculator implements \RectorPrefix20211001\SebastianBergmann\Diff\LongestCommonSubsequenceCalculator
{
    /**
     * {@inheritdoc}
     * @param mixed[] $from
