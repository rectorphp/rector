...
namespace RectorPrefix20210514\Symplify\SymplifyKernel\HttpKernel;
...
use RectorPrefix20210514\Symplify\SymplifyKernel\Strings\KernelUniqueHasher;
abstract class AbstractSymplifyKernel extends \RectorPrefix20210514\Symfony\Component\HttpKernel\Kernel implements \RectorPrefix20210514\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    {
        return [new \RectorPrefix20210514\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle()];
    }
    /**
    ...
    {
        $kernelUniqueHasher = new \RectorPrefix20210514\Symplify\SymplifyKernel\Strings\KernelUniqueHasher();
