...
namespace RectorPrefix20220418\Symplify\SymplifyKernel\HttpKernel;
...
use RectorPrefix20220418\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig;
/**
 * @api
 */
abstract class AbstractSymplifyKernel implements \RectorPrefix20220418\Symplify\SymplifyKernel\Contract\LightKernelInterface
{
    /**
     ...
     */
    public function create(array $configFiles, array $compilerPasses = [], array $extensions = []) : \RectorPrefix20220418\Symfony\Component\DependencyInjection\ContainerInterface
    {
        ...
        $configFiles[] = \RectorPrefix20220418\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig::FILE_PATH;
    ...
    {
        if (!$this->container instanceof \RectorPrefix20220418\Symfony\Component\DependencyInjection\Container) {
