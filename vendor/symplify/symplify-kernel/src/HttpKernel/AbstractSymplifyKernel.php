...
use RectorPrefix20220125\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig;
/**
 * @api
 */
abstract class AbstractSymplifyKernel implements \RectorPrefix20220125\Symplify\SymplifyKernel\Contract\LightKernelInterface
{
    /**
    ...
    {
        if (!$this->container instanceof \RectorPrefix20220125\Symfony\Component\DependencyInjection\Container) {
