...
namespace RectorPrefix20220501\Symplify\SymplifyKernel\ValueObject;
...
use RectorPrefix20220501\Symplify\PackageBuilder\Console\Input\StaticInputDetector;
...
use RectorPrefix20220501\Symplify\SymplifyKernel\Exception\BootException;
use Throwable;
/**
 * @api
 */
final class KernelBootAndApplicationRun
{
    ...
    public function run() : void
    {
        try {
            ...
            $symfonyStyleFactory = new \RectorPrefix20220501\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory();
            $symfonyStyle = $symfonyStyleFactory->create();
            $symfonyStyle->error($throwable->getMessage());
            exit(\RectorPrefix20220501\Symfony\Component\Console\Command\Command::FAILURE);
        }
    }
    /**
    ...
    private function createKernel()
    {
        ...
        return new $kernelClass($environment, \RectorPrefix20220501\Symplify\PackageBuilder\Console\Input\StaticInputDetector::isDebug());
    }
    private function booKernelAndRunApplication() : void
    {
        ...
        $application = $container->get(\RectorPrefix20220501\Symfony\Component\Console\Application::class);
    ...
    {
        if (\is_a($kernelClass, \RectorPrefix20220501\Symfony\Component\HttpKernel\KernelInterface::class, \true)) {
            return;
        }
        if (\is_a($kernelClass, \RectorPrefix20220501\Symplify\SymplifyKernel\Contract\LightKernelInterface::class, \true)) {
            return;
        ...
        $errorMessage = \sprintf('Class "%s" must by type of "%s" or "%s". "%s" given', $kernelClass, \RectorPrefix20220501\Symfony\Component\HttpKernel\KernelInterface::class, \RectorPrefix20220501\Symplify\SymplifyKernel\Contract\LightKernelInterface::class, $currentValueType);
        throw new \RectorPrefix20220501\Symplify\SymplifyKernel\Exception\BootException($errorMessage);
    }
}
