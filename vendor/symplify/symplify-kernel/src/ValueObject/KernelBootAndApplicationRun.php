...
use RectorPrefix20220606\Symplify\PackageBuilder\Console\Input\StaticInputDetector;
...
use RectorPrefix20220606\Symplify\SymplifyKernel\Exception\BootException;
use Throwable;
/**
 * @api
 */
final class KernelBootAndApplicationRun
{
    ...
    private function createKernel()
    {
        ...
        return new $kernelClass($environment, \RectorPrefix20220606\Symplify\PackageBuilder\Console\Input\StaticInputDetector::isDebug());
    }
    private function booKernelAndRunApplication() : void
    {
        ...
        $application = $container->get(\RectorPrefix20220606\Symfony\Component\Console\Application::class);
    ...
    {
        if (\is_a($kernelClass, \RectorPrefix20220606\Symfony\Component\HttpKernel\KernelInterface::class, \true)) {
            return;
        }
        if (\is_a($kernelClass, \RectorPrefix20220606\Symplify\SymplifyKernel\Contract\LightKernelInterface::class, \true)) {
            return;
        ...
        $errorMessage = \sprintf('Class "%s" must by type of "%s" or "%s". "%s" given', $kernelClass, \RectorPrefix20220606\Symfony\Component\HttpKernel\KernelInterface::class, \RectorPrefix20220606\Symplify\SymplifyKernel\Contract\LightKernelInterface::class, $currentValueType);
        throw new \RectorPrefix20220606\Symplify\SymplifyKernel\Exception\BootException($errorMessage);
    }
}
