...
use RectorPrefix20211206\Symplify\PackageBuilder\Console\Input\StaticInputDetector;
...
use RectorPrefix20211206\Symplify\SymplifyKernel\Exception\BootException;
use Throwable;
/**
 * @api
 */
final class KernelBootAndApplicationRun
{
    ...
    public function run() : void
    {
        try {
            ...
            $symfonyStyleFactory = new \RectorPrefix20211206\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory();
            $symfonyStyle = $symfonyStyleFactory->create();
            $symfonyStyle->error($throwable->getMessage());
            exit(\RectorPrefix20211206\Symfony\Component\Console\Command\Command::FAILURE);
        }
    }
    /**
    ...
    private function createKernel()
    {
        ...
        return new $kernelClass($environment, \RectorPrefix20211206\Symplify\PackageBuilder\Console\Input\StaticInputDetector::isDebug());
    }
    private function booKernelAndRunApplication() : void
    {
        ...
        $application = $container->get(\RectorPrefix20211206\Symfony\Component\Console\Application::class);
    ...
    {
        if (\is_a($kernelClass, \RectorPrefix20211206\Symfony\Component\HttpKernel\KernelInterface::class, \true)) {
            return;
        }
        if (\is_a($kernelClass, \RectorPrefix20211206\Symplify\SymplifyKernel\Contract\LightKernelInterface::class, \true)) {
            return;
