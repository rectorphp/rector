...
namespace RectorPrefix20220611\Symplify\SymplifyKernel\Config\Loader;
...
use RectorPrefix20220611\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader;
use RectorPrefix20220611\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface;
final class ParameterMergingLoaderFactory implements LoaderFactoryInterface
{
    public function create(ContainerBuilder $containerBuilder, string $currentWorkingDirectory) : \RectorPrefix20220611\Symfony\Component\Config\Loader\LoaderInterface
    {
