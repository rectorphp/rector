...
namespace RectorPrefix20211213\Symplify\SymplifyKernel\Config\Loader;
...
use RectorPrefix20211213\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader;
use RectorPrefix20211213\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface;
final class ParameterMergingLoaderFactory implements \RectorPrefix20211213\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface
{
    public function create(\RectorPrefix20211213\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $currentWorkingDirectory) : \RectorPrefix20211213\Symfony\Component\Config\Loader\LoaderInterface
    {
        ...
        $loaders = [new \RectorPrefix20211213\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \RectorPrefix20211213\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader($containerBuilder, $fileLocator)];
        $loaderResolver = new \RectorPrefix20211213\Symfony\Component\Config\Loader\LoaderResolver($loaders);
