...
namespace RectorPrefix20211110\Symplify\SymplifyKernel\Config\Loader;
...
use RectorPrefix20211110\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader;
use RectorPrefix20211110\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface;
final class ParameterMergingLoaderFactory implements \RectorPrefix20211110\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface
{
    /**
    ...
    public function create($containerBuilder, $currentWorkingDirectory) : \RectorPrefix20211110\Symfony\Component\Config\Loader\LoaderInterface
    {
        ...
        $loaders = [new \RectorPrefix20211110\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \RectorPrefix20211110\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader($containerBuilder, $fileLocator)];
        $loaderResolver = new \RectorPrefix20211110\Symfony\Component\Config\Loader\LoaderResolver($loaders);
