...
namespace RectorPrefix20220610\Symplify\SymplifyKernel\Config\Loader;
...
use RectorPrefix20220610\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader;
use RectorPrefix20220610\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface;
final class ParameterMergingLoaderFactory implements LoaderFactoryInterface
{
    public function create(ContainerBuilder $containerBuilder, string $currentWorkingDirectory) : \RectorPrefix20220610\Symfony\Component\Config\Loader\LoaderInterface
    {
