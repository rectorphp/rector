...
namespace RectorPrefix20220607\Symplify\SymplifyKernel\Config\Loader;
...
use RectorPrefix20220607\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader;
use RectorPrefix20220607\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface;
final class ParameterMergingLoaderFactory implements \RectorPrefix20220607\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface
{
    public function create(\RectorPrefix20220607\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $currentWorkingDirectory) : \RectorPrefix20220607\Symfony\Component\Config\Loader\LoaderInterface
    {
        ...
        $loaders = [new \RectorPrefix20220607\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \RectorPrefix20220607\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader($containerBuilder, $fileLocator)];
        $loaderResolver = new \RectorPrefix20220607\Symfony\Component\Config\Loader\LoaderResolver($loaders);
