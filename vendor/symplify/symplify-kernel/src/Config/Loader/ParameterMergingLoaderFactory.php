...
final class ParameterMergingLoaderFactory implements \RectorPrefix20220527\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface
{
    public function create(\RectorPrefix20220527\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $currentWorkingDirectory) : \RectorPrefix20220527\Symfony\Component\Config\Loader\LoaderInterface
    {
        ...
        $loaders = [new \RectorPrefix20220527\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \RectorPrefix20220527\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader($containerBuilder, $fileLocator)];
        $loaderResolver = new \RectorPrefix20220527\Symfony\Component\Config\Loader\LoaderResolver($loaders);
