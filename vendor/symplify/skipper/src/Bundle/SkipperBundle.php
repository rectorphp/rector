...
final class SkipperBundle extends \RectorPrefix20210510\Symfony\Component\HttpKernel\Bundle\Bundle
{
    ...
    {
        return new \RectorPrefix20210510\Symplify\Skipper\DependencyInjection\Extension\SkipperExtension();
    }
}
