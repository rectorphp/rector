...
namespace RectorPrefix20210519\Symplify\Skipper\SkipCriteriaResolver;
...
final class SkippedPathsResolver
{
    ...
    public function resolve() : array
    {
        ...
        $skip = $this->parameterProvider->provideArrayParameter(\RectorPrefix20210519\Symplify\Skipper\ValueObject\Option::SKIP);
        foreach ($skip as $key => $value) {
            ...
            if (\RectorPrefix20210519\Nette\Utils\Strings::contains($value, '*')) {
                $this->skippedPaths[] = $this->pathNormalizer->normalizePath($value);
                continue;
            }
        }
