...
namespace RectorPrefix20220418\Symplify\Skipper\SkipCriteriaResolver;
...
final class SkippedPathsResolver
{
    ...
    public function __construct(\RectorPrefix20220418\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20220418\Symplify\SmartFileSystem\Normalizer\PathNormalizer $pathNormalizer)
    {
    ...
    public function resolve() : array
    {
        ...
        $skip = $this->parameterProvider->provideArrayParameter(\RectorPrefix20220418\Symplify\Skipper\ValueObject\Option::SKIP);
