...
namespace RectorPrefix20210523\Symplify\Skipper\SkipCriteriaResolver;
...
final class SkippedPathsResolver
{
    ...
    public function __construct(\RectorPrefix20210523\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210523\Symplify\SmartFileSystem\Normalizer\PathNormalizer $pathNormalizer)
    {
    ...
    public function resolve() : array
    {
        ...
        $skip = $this->parameterProvider->provideArrayParameter(\RectorPrefix20210523\Symplify\Skipper\ValueObject\Option::SKIP);
