...
namespace RectorPrefix20220201\Symplify\Skipper\Skipper;
...
final class SkipSkipper
{
    ...
    public function __construct(\RectorPrefix20220201\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
