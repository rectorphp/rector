...
namespace RectorPrefix20220525\Symplify\Skipper\Skipper;
...
final class SkipSkipper
{
    ...
    public function __construct(\RectorPrefix20220525\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
