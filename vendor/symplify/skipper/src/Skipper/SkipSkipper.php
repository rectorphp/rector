...
namespace RectorPrefix20220320\Symplify\Skipper\Skipper;
...
final class SkipSkipper
{
    ...
    public function __construct(\RectorPrefix20220320\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
