...
namespace RectorPrefix20220505\Symplify\Skipper\Skipper;
...
final class SkipSkipper
{
    ...
    public function __construct(\RectorPrefix20220505\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
