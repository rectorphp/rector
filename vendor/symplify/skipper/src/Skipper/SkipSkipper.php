...
namespace RectorPrefix20211103\Symplify\Skipper\Skipper;
...
final class SkipSkipper
{
    ...
    public function __construct(\RectorPrefix20211103\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
