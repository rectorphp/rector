...
use RectorPrefix20220531\Symplify\Skipper\SkipCriteriaResolver\SkippedClassResolver;
use RectorPrefix20220531\Symplify\Skipper\Skipper\OnlySkipper;
use RectorPrefix20220531\Symplify\Skipper\Skipper\SkipSkipper;
use RectorPrefix20220531\Symplify\Skipper\ValueObject\Option;
use Symplify\SmartFileSystem\SmartFileInfo;
final class ClassSkipVoter implements \RectorPrefix20220531\Symplify\Skipper\Contract\SkipVoterInterface
{
    /**
    ...
    public function __construct(\RectorPrefix20220531\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker $classLikeExistenceChecker, \RectorPrefix20220531\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20220531\Symplify\Skipper\Skipper\SkipSkipper $skipSkipper, \RectorPrefix20220531\Symplify\Skipper\Skipper\OnlySkipper $onlySkipper, \RectorPrefix20220531\Symplify\Skipper\SkipCriteriaResolver\SkippedClassResolver $skippedClassResolver)
    {
    ...
    {
        $only = $this->parameterProvider->provideArrayParameter(\RectorPrefix20220531\Symplify\Skipper\ValueObject\Option::ONLY);
