...
use RectorPrefix20211110\Symplify\Skipper\SkipCriteriaResolver\SkippedClassResolver;
use RectorPrefix20211110\Symplify\Skipper\Skipper\OnlySkipper;
use RectorPrefix20211110\Symplify\Skipper\Skipper\SkipSkipper;
use RectorPrefix20211110\Symplify\Skipper\ValueObject\Option;
use Symplify\SmartFileSystem\SmartFileInfo;
final class ClassSkipVoter implements \RectorPrefix20211110\Symplify\Skipper\Contract\SkipVoterInterface
{
    /**
    ...
    public function __construct(\RectorPrefix20211110\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker $classLikeExistenceChecker, \RectorPrefix20211110\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20211110\Symplify\Skipper\Skipper\SkipSkipper $skipSkipper, \RectorPrefix20211110\Symplify\Skipper\Skipper\OnlySkipper $onlySkipper, \RectorPrefix20211110\Symplify\Skipper\SkipCriteriaResolver\SkippedClassResolver $skippedClassResolver)
    {
    ...
    {
        $only = $this->parameterProvider->provideArrayParameter(\RectorPrefix20211110\Symplify\Skipper\ValueObject\Option::ONLY);
