...
use RectorPrefix20211101\Symfony\Component\Config\Loader\GlobFileLoader;
...
final class ParameterMergingLoaderFactory implements \RectorPrefix20211101\Symplify\SymfonyContainerBuilder\Contract\Config\LoaderFactoryInterface
{
    ...
    {
        $fileLocator = new \RectorPrefix20211101\Symfony\Component\Config\FileLocator([$currentWorkingDirectory]);
        $loaders = [new \RectorPrefix20211101\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \RectorPrefix20211101\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader($containerBuilder, $fileLocator)];
        $loaderResolver = new \RectorPrefix20211101\Symfony\Component\Config\Loader\LoaderResolver($loaders);
        return new \RectorPrefix20211101\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
