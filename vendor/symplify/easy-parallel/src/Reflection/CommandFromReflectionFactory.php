...
namespace RectorPrefix20220208\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \RectorPrefix20220208\Symfony\Component\Console\Command\Command
    {
