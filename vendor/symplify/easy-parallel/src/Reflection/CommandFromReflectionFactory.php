...
namespace RectorPrefix20220328\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \RectorPrefix20220328\Symfony\Component\Console\Command\Command
    {
        ...
        if (!$parentClassReflection instanceof \ReflectionClass) {
            throw new \RectorPrefix20220328\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException();
        }
