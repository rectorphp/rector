...
namespace RectorPrefix20220329\Symplify\EasyParallel\Reflection;
...
final class CommandFromReflectionFactory
{
     ...
     */
    public function create(string $className) : \RectorPrefix20220329\Symfony\Component\Console\Command\Command
    {
        ...
        if (!$parentClassReflection instanceof \ReflectionClass) {
            throw new \RectorPrefix20220329\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException();
        }
