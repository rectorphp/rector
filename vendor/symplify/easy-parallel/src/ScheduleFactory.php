...
final class ScheduleFactory
{
     ...
     */
    public function create(int $cpuCores, int $jobSize, int $maxNumberOfProcesses, array $files) : \RectorPrefix20220104\Symplify\EasyParallel\ValueObject\Schedule
    {
        ...
        return new \RectorPrefix20220104\Symplify\EasyParallel\ValueObject\Schedule($numberOfProcesses, $jobs);
    }
}
