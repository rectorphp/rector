...
final class ScheduleFactory
{
     ...
     */
    public function create(int $cpuCores, int $jobSize, int $maxNumberOfProcesses, array $files) : \RectorPrefix20220410\Symplify\EasyParallel\ValueObject\Schedule
    {
        ...
        return new \RectorPrefix20220410\Symplify\EasyParallel\ValueObject\Schedule($numberOfProcesses, $jobs);
    }
}
