...
namespace RectorPrefix20210822\Symplify\ComposerJsonManipulator\FileSystem;

use RectorPrefix20210822\Nette\Utils\Json;
use RectorPrefix20210822\Symplify\ComposerJsonManipulator\Json\JsonCleaner;
use RectorPrefix20210822\Symplify\ComposerJsonManipulator\Json\JsonInliner;
use RectorPrefix20210822\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson;
use RectorPrefix20210822\Symplify\PackageBuilder\Configuration\StaticEolConfiguration;
...
final class JsonFileManager
{
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \RectorPrefix20210822\Nette\Utils\Json::decode($smartFileInfo->getContents(), \RectorPrefix20210822\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function printComposerJsonToFilePath(\RectorPrefix20210822\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, string $filePath) : string
    {
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \RectorPrefix20210822\Nette\Utils\Json::encode($json, \RectorPrefix20210822\Nette\Utils\Json::PRETTY) . \RectorPrefix20210822\Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
