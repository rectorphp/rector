...
namespace RectorPrefix20210511\Symplify\ComposerJsonManipulator\FileSystem;
...
use RectorPrefix20210511\Symplify\PackageBuilder\Configuration\StaticEolConfiguration;
...
final class JsonFileManager
{
    ...
    public function __construct(\RectorPrefix20210511\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20210511\Symplify\ComposerJsonManipulator\Json\JsonCleaner $jsonCleaner, \RectorPrefix20210511\Symplify\ComposerJsonManipulator\Json\JsonInliner $jsonInliner)
    {
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \RectorPrefix20210511\Nette\Utils\Json::decode($smartFileInfo->getContents(), \RectorPrefix20210511\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function printComposerJsonToFilePath(\RectorPrefix20210511\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, string $filePath) : string
    {
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \RectorPrefix20210511\Nette\Utils\Json::encode($json, \RectorPrefix20210511\Nette\Utils\Json::PRETTY) . \RectorPrefix20210511\Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
