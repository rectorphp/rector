...
namespace RectorPrefix20220601\Symplify\ComposerJsonManipulator\FileSystem;

use RectorPrefix20220601\Nette\Utils\Json;
use RectorPrefix20220601\Symplify\ComposerJsonManipulator\Json\JsonCleaner;
use RectorPrefix20220601\Symplify\ComposerJsonManipulator\Json\JsonInliner;
use RectorPrefix20220601\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson;
use RectorPrefix20220601\Symplify\PackageBuilder\Configuration\StaticEolConfiguration;
...
final class JsonFileManager
{
     ...
     */
    private $jsonInliner;
    public function __construct(\RectorPrefix20220601\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20220601\Symplify\ComposerJsonManipulator\Json\JsonCleaner $jsonCleaner, \RectorPrefix20220601\Symplify\ComposerJsonManipulator\Json\JsonInliner $jsonInliner)
    {
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \RectorPrefix20220601\Nette\Utils\Json::decode($smartFileInfo->getContents(), \RectorPrefix20220601\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function printComposerJsonToFilePath(\RectorPrefix20220601\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, string $filePath) : string
    {
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \RectorPrefix20220601\Nette\Utils\Json::encode($json, \RectorPrefix20220601\Nette\Utils\Json::PRETTY) . \RectorPrefix20220601\Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
