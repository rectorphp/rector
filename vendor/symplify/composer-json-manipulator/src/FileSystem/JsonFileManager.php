...
namespace RectorPrefix20210519\Symplify\ComposerJsonManipulator\FileSystem;

use RectorPrefix20210519\Nette\Utils\Json;
use RectorPrefix20210519\Symplify\ComposerJsonManipulator\Json\JsonCleaner;
use RectorPrefix20210519\Symplify\ComposerJsonManipulator\Json\JsonInliner;
...
final class JsonFileManager
{
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \RectorPrefix20210519\Nette\Utils\Json::decode($smartFileInfo->getContents(), \RectorPrefix20210519\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function printComposerJsonToFilePath(\RectorPrefix20210519\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, string $filePath) : string
    {
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \RectorPrefix20210519\Nette\Utils\Json::encode($json, \RectorPrefix20210519\Nette\Utils\Json::PRETTY) . \RectorPrefix20210519\Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
