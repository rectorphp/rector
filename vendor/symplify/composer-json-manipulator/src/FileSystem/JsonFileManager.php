...
namespace RectorPrefix20211012\Symplify\ComposerJsonManipulator\FileSystem;

use RectorPrefix20211012\Nette\Utils\Json;
use RectorPrefix20211012\Symplify\ComposerJsonManipulator\Json\JsonCleaner;
use RectorPrefix20211012\Symplify\ComposerJsonManipulator\Json\JsonInliner;
use RectorPrefix20211012\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson;
use RectorPrefix20211012\Symplify\PackageBuilder\Configuration\StaticEolConfiguration;
...
final class JsonFileManager
{
     ...
     */
    private $jsonInliner;
    public function __construct(\RectorPrefix20211012\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20211012\Symplify\ComposerJsonManipulator\Json\JsonCleaner $jsonCleaner, \RectorPrefix20211012\Symplify\ComposerJsonManipulator\Json\JsonInliner $jsonInliner)
    {
    ...
    public function loadFromFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        ...
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \RectorPrefix20211012\Nette\Utils\Json::decode($smartFileInfo->getContents(), \RectorPrefix20211012\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function printComposerJsonToFilePath(\RectorPrefix20211012\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, string $filePath) : string
    {
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \RectorPrefix20211012\Nette\Utils\Json::encode($json, \RectorPrefix20211012\Nette\Utils\Json::PRETTY) . \RectorPrefix20211012\Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
