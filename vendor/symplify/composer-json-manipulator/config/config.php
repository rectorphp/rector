...
use RectorPrefix20210515\Symplify\ComposerJsonManipulator\ValueObject\Option;
use RectorPrefix20210515\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory;
use RectorPrefix20210515\Symplify\PackageBuilder\Parameter\ParameterProvider;
use RectorPrefix20210515\Symplify\PackageBuilder\Reflection\PrivatesCaller;
use RectorPrefix20210515\Symplify\SmartFileSystem\SmartFileSystem;
...
return static function (\RectorPrefix20210515\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $parameters->set(\RectorPrefix20210515\Symplify\ComposerJsonManipulator\ValueObject\Option::INLINE_SECTIONS, ['keywords']);
    $services = $containerConfigurator->services();
    $services->defaults()->public()->autowire()->autoconfigure();
    $services->load('RectorPrefix20210515\Symplify\\ComposerJsonManipulator\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/Bundle']);
    $services->set(\RectorPrefix20210515\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\RectorPrefix20210515\Symplify\PackageBuilder\Reflection\PrivatesCaller::class);
    $services->set(\RectorPrefix20210515\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\RectorPrefix20210515\Symfony\Component\DependencyInjection\Loader\Configurator\service(\RectorPrefix20210515\Symfony\Component\DependencyInjection\ContainerInterface::class)]);
