...
use RectorPrefix20211112\Symplify\ComposerJsonManipulator\ValueObject\Option;
...
use RectorPrefix20211112\Symplify\PackageBuilder\Reflection\PrivatesCaller;
...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $parameters->set(\RectorPrefix20211112\Symplify\ComposerJsonManipulator\ValueObject\Option::INLINE_SECTIONS, ['keywords']);
    $services = $containerConfigurator->services();
    $services->defaults()->public()->autowire()->autoconfigure();
    $services->load('RectorPrefix20211112\Symplify\\ComposerJsonManipulator\\', __DIR__ . '/../src');
    $services->set(\RectorPrefix20211112\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\RectorPrefix20211112\Symplify\PackageBuilder\Reflection\PrivatesCaller::class);
