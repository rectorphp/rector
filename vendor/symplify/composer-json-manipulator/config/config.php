...
use RectorPrefix20210522\Symplify\ComposerJsonManipulator\ValueObject\Option;
...
return static function (\RectorPrefix20210522\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $parameters->set(\RectorPrefix20210522\Symplify\ComposerJsonManipulator\ValueObject\Option::INLINE_SECTIONS, ['keywords']);
    $services = $containerConfigurator->services();
    $services->defaults()->public()->autowire()->autoconfigure();
    $services->load('RectorPrefix20210522\Symplify\\ComposerJsonManipulator\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/Bundle']);
    ...
    $services->set(\RectorPrefix20210522\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\RectorPrefix20210522\Symfony\Component\DependencyInjection\Loader\Configurator\service(\RectorPrefix20210522\Symfony\Component\DependencyInjection\ContainerInterface::class)]);
