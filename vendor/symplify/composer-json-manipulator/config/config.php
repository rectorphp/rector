...
use RectorPrefix20211218\Symplify\ComposerJsonManipulator\ValueObject\Option;
...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $parameters->set(\RectorPrefix20211218\Symplify\ComposerJsonManipulator\ValueObject\Option::INLINE_SECTIONS, ['keywords']);
    $services = $containerConfigurator->services();
    $services->defaults()->public()->autowire()->autoconfigure();
    $services->load('RectorPrefix20211218\Symplify\\ComposerJsonManipulator\\', __DIR__ . '/../src');
    ...
    $services->set(\RectorPrefix20211218\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\RectorPrefix20211218\Symfony\Component\DependencyInjection\Loader\Configurator\service('service_container')]);
