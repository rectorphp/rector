...
use RectorPrefix20220102\Symplify\ComposerJsonManipulator\ValueObject\Option;
use RectorPrefix20220102\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory;
...
use function RectorPrefix20220102\Symfony\Component\DependencyInjection\Loader\Configurator\service;
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    $parameters = $containerConfigurator->parameters();
    $parameters->set(\RectorPrefix20220102\Symplify\ComposerJsonManipulator\ValueObject\Option::INLINE_SECTIONS, ['keywords']);
    $services = $containerConfigurator->services();
    $services->defaults()->public()->autowire()->autoconfigure();
    $services->load('RectorPrefix20220102\Symplify\\ComposerJsonManipulator\\', __DIR__ . '/../src');
    ...
    $services->set(\RectorPrefix20220102\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\RectorPrefix20220102\Symfony\Component\DependencyInjection\Loader\Configurator\service('service_container')]);
