...
{
    public function create() : \RectorPrefix20211230\Symplify\Astral\PhpParser\SmartPhpParser
    {
        $nativePhpParser = $this->createNativePhpParser();
        $cachedParser = $this->createPHPStanParser($nativePhpParser);
        return new \RectorPrefix20211230\Symplify\Astral\PhpParser\SmartPhpParser($cachedParser);
    }
