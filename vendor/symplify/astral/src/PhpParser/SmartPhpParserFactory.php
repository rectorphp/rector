...
namespace RectorPrefix20211103\Symplify\Astral\PhpParser;
...
{
    public function create() : \RectorPrefix20211103\Symplify\Astral\PhpParser\SmartPhpParser
    {
        $nativePhpParser = $this->createNativePhpParser();
        $cachedParser = $this->createPHPStanParser($nativePhpParser);
        return new \RectorPrefix20211103\Symplify\Astral\PhpParser\SmartPhpParser($cachedParser);
    }
