...
namespace RectorPrefix20220414\Symplify\Astral\PhpParser;
...
{
    public function create() : \RectorPrefix20220414\Symplify\Astral\PhpParser\SmartPhpParser
    {
        $nativePhpParser = $this->createNativePhpParser();
        $cachedParser = $this->createPHPStanParser($nativePhpParser);
        return new \RectorPrefix20220414\Symplify\Astral\PhpParser\SmartPhpParser($cachedParser);
    }
