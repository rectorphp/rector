...
namespace RectorPrefix20211117\Symplify\Astral\Reflection;
...
final class ReflectionParser
{
     ...
     */
    private $nodeFinder;
    public function __construct(\RectorPrefix20211117\Symplify\Astral\PhpParser\SmartPhpParser $smartPhpParser, \PhpParser\NodeFinder $nodeFinder)
    {
