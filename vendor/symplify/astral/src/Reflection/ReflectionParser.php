...
namespace RectorPrefix20211102\Symplify\Astral\Reflection;
...
final class ReflectionParser
{
     ...
     */
    private $nodeFinder;
    public function __construct(\RectorPrefix20211102\Symplify\Astral\PhpParser\SmartPhpParser $smartPhpParser, \PhpParser\NodeFinder $nodeFinder)
    {
