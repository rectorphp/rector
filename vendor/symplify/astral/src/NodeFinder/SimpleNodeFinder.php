...
namespace RectorPrefix20211223\Symplify\Astral\NodeFinder;

use PhpParser\Node;
use PhpParser\NodeFinder;
use RectorPrefix20211223\Symplify\Astral\ValueObject\AttributeKey;
...
final class SimpleNodeFinder
{
     ...
     */
    private $nodeFinder;
    public function __construct(\RectorPrefix20211223\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \PhpParser\NodeFinder $nodeFinder)
    {
    ...
    {
        $node = $node->getAttribute(\RectorPrefix20211223\Symplify\Astral\ValueObject\AttributeKey::PARENT);
        while ($node) {
