...
namespace RectorPrefix20220430\Symplify\Astral\NodeFinder;

use PhpParser\Node;
use PhpParser\NodeFinder;
use RectorPrefix20220430\Symplify\Astral\ValueObject\AttributeKey;
final class SimpleNodeFinder
{
    ...
    {
        $node = $node->getAttribute(\RectorPrefix20220430\Symplify\Astral\ValueObject\AttributeKey::PARENT);
