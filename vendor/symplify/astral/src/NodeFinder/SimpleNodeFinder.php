...
namespace RectorPrefix20210622\Symplify\Astral\NodeFinder;

use PhpParser\Node;
use PhpParser\NodeFinder;
use RectorPrefix20210622\Symplify\Astral\ValueObject\AttributeKey;
...
final class SimpleNodeFinder
{
     ...
     */
    private $nodeFinder;
    public function __construct(\RectorPrefix20210622\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \PhpParser\NodeFinder $nodeFinder)
    {
    ...
    {
        $node = $node->getAttribute(\RectorPrefix20210622\Symplify\Astral\ValueObject\AttributeKey::PARENT);
        while ($node) {
