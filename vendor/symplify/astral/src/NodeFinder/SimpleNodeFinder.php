...
namespace RectorPrefix20210626\Symplify\Astral\NodeFinder;

use PhpParser\Node;
use PhpParser\NodeFinder;
use RectorPrefix20210626\Symplify\Astral\ValueObject\AttributeKey;
...
final class SimpleNodeFinder
{
    ...
    {
        $node = $node->getAttribute(\RectorPrefix20210626\Symplify\Astral\ValueObject\AttributeKey::PARENT);
        while ($node) {
