...
namespace RectorPrefix20210923\Symplify\Astral\NodeValue;
...
use RectorPrefix20210923\Symplify\Astral\Exception\ShouldNotHappenException;
use RectorPrefix20210923\Symplify\Astral\Naming\SimpleNameResolver;
use RectorPrefix20210923\Symplify\Astral\NodeFinder\SimpleNodeFinder;
...
final class NodeValueResolver
{
    ...
    public function __construct(\RectorPrefix20210923\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \RectorPrefix20210923\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \RectorPrefix20210923\Symplify\Astral\NodeFinder\SimpleNodeFinder $simpleNodeFinder)
    {
    ...
    private function resolveMagicConst(\PhpParser\Node\Scalar\MagicConst $magicConst) : ?string
    {
        if ($this->currentFilePath === null) {
            throw new \RectorPrefix20210923\Symplify\Astral\Exception\ShouldNotHappenException();
        }
