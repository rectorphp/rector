...
final class NodeValueResolver
{
     ...
     */
    private $typeChecker;
    public function __construct(\RectorPrefix20220606\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \RectorPrefix20220606\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \RectorPrefix20220606\Symplify\Astral\NodeFinder\SimpleNodeFinder $simpleNodeFinder)
    {
        ...
        $this->unionTypeValueResolver = new \RectorPrefix20220606\Symplify\Astral\NodeValue\UnionTypeValueResolver();
        $this->nodeValueResolvers[] = new \RectorPrefix20220606\Symplify\Astral\NodeValue\NodeValueResolver\ClassConstFetchValueResolver($this->simpleNameResolver, $simpleNodeFinder);
        $this->nodeValueResolvers[] = new \RectorPrefix20220606\Symplify\Astral\NodeValue\NodeValueResolver\ConstFetchValueResolver($this->simpleNameResolver);
        $this->nodeValueResolvers[] = new \RectorPrefix20220606\Symplify\Astral\NodeValue\NodeValueResolver\MagicConstValueResolver();
        $this->nodeValueResolvers[] = new \RectorPrefix20220606\Symplify\Astral\NodeValue\NodeValueResolver\FuncCallValueResolver($this->simpleNameResolver, $this->constExprEvaluator);
    }
    /**
     * @return mixed
     */
