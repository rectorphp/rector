...
namespace RectorPrefix20210822\Symplify\Astral\NodeValue;
...
use RectorPrefix20210822\Symplify\Astral\Exception\ShouldNotHappenException;
use RectorPrefix20210822\Symplify\Astral\Naming\SimpleNameResolver;
use RectorPrefix20210822\Symplify\Astral\NodeFinder\SimpleNodeFinder;
...
final class NodeValueResolver
{
    ...
    private function resolveMagicConst(\PhpParser\Node\Scalar\MagicConst $magicConst) : ?string
    {
        if ($this->currentFilePath === null) {
            throw new \RectorPrefix20210822\Symplify\Astral\Exception\ShouldNotHappenException();
        }
