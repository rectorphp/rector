...
namespace RectorPrefix20210907\Symplify\Astral\NodeValue;
...
use RectorPrefix20210907\Symplify\Astral\Exception\ShouldNotHappenException;
use RectorPrefix20210907\Symplify\Astral\Naming\SimpleNameResolver;
use RectorPrefix20210907\Symplify\Astral\NodeFinder\SimpleNodeFinder;
...
final class NodeValueResolver
{
    ...
    public function __construct(\RectorPrefix20210907\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \RectorPrefix20210907\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \RectorPrefix20210907\Symplify\Astral\NodeFinder\SimpleNodeFinder $simpleNodeFinder)
    {
    ...
    private function resolveMagicConst(\PhpParser\Node\Scalar\MagicConst $magicConst) : ?string
    {
        if ($this->currentFilePath === null) {
            throw new \RectorPrefix20210907\Symplify\Astral\Exception\ShouldNotHappenException();
        }
