...
namespace RectorPrefix20210803\Symplify\Astral\NodeValue;
...
use RectorPrefix20210803\Symplify\Astral\Exception\ShouldNotHappenException;
use RectorPrefix20210803\Symplify\Astral\Naming\SimpleNameResolver;
use RectorPrefix20210803\Symplify\Astral\NodeFinder\SimpleNodeFinder;
...
final class NodeValueResolver
{
    ...
    public function __construct(\RectorPrefix20210803\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \RectorPrefix20210803\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \RectorPrefix20210803\Symplify\Astral\NodeFinder\SimpleNodeFinder $simpleNodeFinder)
    {
    ...
    private function resolveMagicConst(\PhpParser\Node\Scalar\MagicConst $magicConst) : ?string
    {
        if ($this->currentFilePath === null) {
            throw new \RectorPrefix20210803\Symplify\Astral\Exception\ShouldNotHappenException();
        }
