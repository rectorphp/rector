...
namespace RectorPrefix20220501\Symplify\VendorPatches\FileSystem;
...
final class PathResolver
{
    ...
    {
        $match = \RectorPrefix20220501\Nette\Utils\Strings::match($fileInfo->getRealPath(), self::VENDOR_PACKAGE_DIRECTORY_REGEX);
        if (!isset($match['vendor_package_directory'])) {
            throw new \RectorPrefix20220501\Symplify\SymplifyKernel\Exception\ShouldNotHappenException('Could not resolve vendor package directory');
        }
