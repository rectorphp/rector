...
namespace RectorPrefix20211219\Symplify\VendorPatches\Command;
...
use RectorPrefix20211219\Symplify\PackageBuilder\Composer\VendorDirProvider;
...
use RectorPrefix20211219\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater;
use RectorPrefix20211219\Symplify\VendorPatches\Console\GenerateCommandReporter;
use RectorPrefix20211219\Symplify\VendorPatches\Differ\PatchDiffer;
use RectorPrefix20211219\Symplify\VendorPatches\Finder\OldToNewFilesFinder;
use RectorPrefix20211219\Symplify\VendorPatches\PatchFileFactory;
final class GenerateCommand extends \RectorPrefix20211219\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20211219\Symplify\VendorPatches\Finder\OldToNewFilesFinder $oldToNewFilesFinder, \RectorPrefix20211219\Symplify\VendorPatches\Differ\PatchDiffer $patchDiffer, \RectorPrefix20211219\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater $composerPatchesConfigurationUpdater, \RectorPrefix20211219\Symplify\PackageBuilder\Composer\VendorDirProvider $vendorDirProvider, \RectorPrefix20211219\Symplify\VendorPatches\PatchFileFactory $patchFileFactory, \RectorPrefix20211219\Symplify\VendorPatches\Console\GenerateCommandReporter $generateCommandReporter)
    {
    ...
    {
        $this->setName(\RectorPrefix20211219\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
