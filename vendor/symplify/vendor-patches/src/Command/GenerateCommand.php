...
namespace RectorPrefix20220529\Symplify\VendorPatches\Command;
...
use RectorPrefix20220529\Symplify\PackageBuilder\Composer\VendorDirProvider;
...
use RectorPrefix20220529\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater;
use RectorPrefix20220529\Symplify\VendorPatches\Console\GenerateCommandReporter;
use RectorPrefix20220529\Symplify\VendorPatches\Differ\PatchDiffer;
use RectorPrefix20220529\Symplify\VendorPatches\Finder\OldToNewFilesFinder;
use RectorPrefix20220529\Symplify\VendorPatches\PatchFileFactory;
final class GenerateCommand extends \RectorPrefix20220529\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20220529\Symplify\VendorPatches\Finder\OldToNewFilesFinder $oldToNewFilesFinder, \RectorPrefix20220529\Symplify\VendorPatches\Differ\PatchDiffer $patchDiffer, \RectorPrefix20220529\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater $composerPatchesConfigurationUpdater, \RectorPrefix20220529\Symplify\PackageBuilder\Composer\VendorDirProvider $vendorDirProvider, \RectorPrefix20220529\Symplify\VendorPatches\PatchFileFactory $patchFileFactory, \RectorPrefix20220529\Symplify\VendorPatches\Console\GenerateCommandReporter $generateCommandReporter)
    {
    ...
    {
        $this->setName(\RectorPrefix20220529\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
