...
use RectorPrefix20211231\Symplify\Astral\Exception\ShouldNotHappenException;
...
final class ComposerPatchesConfigurationUpdater
{
     ...
     */
    public function updateComposerJson(string $composerJsonFilePath, array $composerExtraPatches) : \RectorPrefix20211231\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
    ...
    public function updateComposerJsonAndPrint(string $composerJsonFilePath, array $composerExtraPatches) : void
    {
        ...
        if (!$fileInfo instanceof \Symplify\SmartFileSystem\SmartFileInfo) {
            throw new \RectorPrefix20211231\Symplify\Astral\Exception\ShouldNotHappenException();
        }
