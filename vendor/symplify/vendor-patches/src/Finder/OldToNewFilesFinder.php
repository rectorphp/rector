...
namespace RectorPrefix20220202\Symplify\VendorPatches\Finder;
...
use RectorPrefix20220202\Symplify\VendorPatches\Composer\PackageNameResolver;
...
final class OldToNewFilesFinder
{
    ...
    public function __construct(\RectorPrefix20220202\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \RectorPrefix20220202\Symplify\VendorPatches\Composer\PackageNameResolver $packageNameResolver)
    {
    ...
    public function find(string $directory) : array
    {
        ...
        foreach ($oldFileInfos as $oldFileInfo) {
            ...
            $oldAndNewFileInfos[] = new \RectorPrefix20220202\Symplify\VendorPatches\ValueObject\OldAndNewFileInfo($oldFileInfo, $newFileInfo, $packageName);
        }
    ...
    {
        $finder = \RectorPrefix20220202\Symfony\Component\Finder\Finder::create()->in($directory)->files()->exclude('composer/')->exclude('ocramius/')->name('*.old');
