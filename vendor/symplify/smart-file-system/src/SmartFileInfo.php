 ...
 */
final class SmartFileInfo extends \RectorPrefix20210519\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    {
        return \RectorPrefix20210519\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    public function getRelativeFilePathFromCwdInTests() : string
    {
        ...
        if (\RectorPrefix20210519\Symplify\EasyTesting\PHPUnit\StaticPHPUnitEnvironment::isPHPUnitRun()) {
            return $this->getRelativeFilePathFromDirectory(\RectorPrefix20210519\Symplify\EasyTesting\StaticFixtureSplitter::getTemporaryPath());
        }
    ...
    {
        return \RectorPrefix20210519\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \RectorPrefix20210519\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }
