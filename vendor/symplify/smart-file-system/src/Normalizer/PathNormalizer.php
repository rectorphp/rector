...
namespace RectorPrefix20220131\Symplify\SmartFileSystem\Normalizer;
...
final class PathNormalizer
{
    ...
    public function normalizePath(string $originalPath) : string
    {
        ...
        $matches = \RectorPrefix20220131\Nette\Utils\Strings::match($originalPath, self::SCHEME_PATH_REGEX);
        if ($matches !== null) {
            [, $scheme, $path] = $matches;
        } else {
        ...
        $path = \RectorPrefix20220131\Nette\Utils\Strings::replace($normalizedPath, self::TWO_AND_MORE_SLASHES_REGEX, '/');
