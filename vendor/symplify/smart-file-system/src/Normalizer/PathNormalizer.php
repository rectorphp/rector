...
namespace RectorPrefix20220218\Symplify\SmartFileSystem\Normalizer;
...
final class PathNormalizer
{
    ...
    public function normalizePath(string $originalPath) : string
    {
        ...
        $matches = \RectorPrefix20220218\Nette\Utils\Strings::match($originalPath, self::SCHEME_PATH_REGEX);
        if ($matches !== null) {
            [, $scheme, $path] = $matches;
        } else {
        ...
        $path = \RectorPrefix20220218\Nette\Utils\Strings::replace($normalizedPath, self::TWO_AND_MORE_SLASHES_REGEX, '/');
