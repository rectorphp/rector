...
use RectorPrefix20220410\Symfony\Component\Filesystem\Exception\IOException;
use RectorPrefix20220410\Symfony\Component\Filesystem\Filesystem;
/**
 * @see \Symplify\SmartFileSystem\Tests\SmartFileSystem\SmartFileSystemTest
 */
final class SmartFileSystem extends \RectorPrefix20220410\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \RectorPrefix20220410\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \RectorPrefix20220410\Nette\Utils\Strings::replace($htmlMessage, self::BEFORE_COLLON_REGEX, '');
    }
}
