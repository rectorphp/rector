...
use RectorPrefix20210710\Symfony\Component\Filesystem\Exception\IOException;
use RectorPrefix20210710\Symfony\Component\Filesystem\Filesystem;
/**
 * @see \Symplify\SmartFileSystem\Tests\SmartFileSystem\SmartFileSystemTest
 */
final class SmartFileSystem extends \RectorPrefix20210710\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile($filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \RectorPrefix20210710\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    /**
    ...
    private function getLastError() : string
    {
        ...
        return \RectorPrefix20210710\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
