...
namespace RectorPrefix20210605\Symplify\SmartFileSystem\Finder;

use RectorPrefix20210605\Symfony\Component\Finder\Finder;
...
final class SmartFinder
{
    ...
    public function __construct(\RectorPrefix20210605\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \RectorPrefix20210605\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter)
    {
    ...
    public function findPaths(array $directoriesOrFiles, string $path) : array
    {
        ...
        $fileInfos = [];
        if ($directories !== []) {
            $finder = new \RectorPrefix20210605\Symfony\Component\Finder\Finder();
