...
namespace RectorPrefix20220527\Symplify\SmartFileSystem\Finder;
...
final class SmartFinder
{
    ...
    public function __construct(\RectorPrefix20220527\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \RectorPrefix20220527\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter)
    {
    ...
    public function findPaths(array $directoriesOrFiles, string $path) : array
    {
        ...
        $fileInfos = [];
        if ($directories !== []) {
            $finder = new \RectorPrefix20220527\Symfony\Component\Finder\Finder();
