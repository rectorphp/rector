...
namespace RectorPrefix20210822\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass;
...
use RectorPrefix20210822\Symplify\AutowireArrayParameter\Skipper\ParameterSkipper;
use RectorPrefix20210822\Symplify\AutowireArrayParameter\TypeResolver\ParameterTypeResolver;
use RectorPrefix20210822\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder;
/**
 * @inspiration https://github.com/nette/di/pull/178
 * @see \Symplify\AutowireArrayParameter\Tests\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPassTest
 */
final class AutowireArrayParameterCompilerPass implements \RectorPrefix20210822\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
    ...
    {
        $this->definitionFinder = new \RectorPrefix20210822\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder();
        $paramTypeDocBlockResolver = new \RectorPrefix20210822\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver();
        $this->parameterTypeResolver = new \RectorPrefix20210822\Symplify\AutowireArrayParameter\TypeResolver\ParameterTypeResolver($paramTypeDocBlockResolver);
    ...
    private function shouldSkipDefinition(\RectorPrefix20210822\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \RectorPrefix20210822\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if (\RectorPrefix20210822\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function processParameters(\RectorPrefix20210822\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \RectorPrefix20210822\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \RectorPrefix20210822\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
}
