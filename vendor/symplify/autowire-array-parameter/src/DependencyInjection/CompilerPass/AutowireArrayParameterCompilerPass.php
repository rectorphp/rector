...
namespace RectorPrefix20210731\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass;
...
use RectorPrefix20210731\Symplify\AutowireArrayParameter\Skipper\ParameterSkipper;
use RectorPrefix20210731\Symplify\AutowireArrayParameter\TypeResolver\ParameterTypeResolver;
use RectorPrefix20210731\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder;
/**
...
final class AutowireArrayParameterCompilerPass implements \RectorPrefix20210731\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    {
        $this->definitionFinder = new \RectorPrefix20210731\Symplify\PackageBuilder\DependencyInjection\DefinitionFinder();
        $paramTypeDocBlockResolver = new \RectorPrefix20210731\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver();
        $this->parameterTypeResolver = new \RectorPrefix20210731\Symplify\AutowireArrayParameter\TypeResolver\ParameterTypeResolver($paramTypeDocBlockResolver);
        $this->parameterSkipper = new \RectorPrefix20210731\Symplify\AutowireArrayParameter\Skipper\ParameterSkipper($this->parameterTypeResolver, $excludedFatalClasses);
    }
    /**
    ...
    private function shouldSkipDefinition(\RectorPrefix20210731\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \RectorPrefix20210731\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if (\RectorPrefix20210731\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function processParameters(\RectorPrefix20210731\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \RectorPrefix20210731\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \RectorPrefix20210731\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
}
