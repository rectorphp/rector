...
namespace RectorPrefix20211020\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass;
...
use RectorPrefix20211020\Symplify\AutowireArrayParameter\DependencyInjection\DefinitionFinder;
use RectorPrefix20211020\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver;
use RectorPrefix20211020\Symplify\AutowireArrayParameter\Skipper\ParameterSkipper;
 ...
 */
final class AutowireArrayParameterCompilerPass implements \RectorPrefix20211020\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
    ...
    {
        $this->definitionFinder = new \RectorPrefix20211020\Symplify\AutowireArrayParameter\DependencyInjection\DefinitionFinder();
        $paramTypeDocBlockResolver = new \RectorPrefix20211020\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver();
        $this->parameterTypeResolver = new \RectorPrefix20211020\Symplify\AutowireArrayParameter\TypeResolver\ParameterTypeResolver($paramTypeDocBlockResolver);
        $this->parameterSkipper = new \RectorPrefix20211020\Symplify\AutowireArrayParameter\Skipper\ParameterSkipper($this->parameterTypeResolver, $excludedFatalClasses);
    }
    /**
    ...
    private function shouldSkipDefinition(\RectorPrefix20211020\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \RectorPrefix20211020\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if (\RectorPrefix20211020\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function processParameters(\RectorPrefix20211020\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \RectorPrefix20211020\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \RectorPrefix20211020\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
}
