...
namespace RectorPrefix20220203\Symplify\AutowireArrayParameter\TypeResolver;

use RectorPrefix20220203\Nette\Utils\Reflection;
use ReflectionMethod;
use RectorPrefix20220203\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver;
final class ParameterTypeResolver
{
    ...
    public function __construct(\RectorPrefix20220203\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver $paramTypeDocBlockResolver)
    {
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $resolvedClass = \RectorPrefix20220203\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
