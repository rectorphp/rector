...
namespace RectorPrefix20210626\Symplify\AutowireArrayParameter\TypeResolver;

use RectorPrefix20210626\Nette\Utils\Reflection;
use ReflectionMethod;
use RectorPrefix20210626\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver;
final class ParameterTypeResolver
{
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $resolvedClass = \RectorPrefix20210626\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
