...
namespace RectorPrefix20211206\Symplify\AutowireArrayParameter\TypeResolver;

use RectorPrefix20211206\Nette\Utils\Reflection;
use ReflectionMethod;
use RectorPrefix20211206\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver;
final class ParameterTypeResolver
{
    ...
    public function __construct(\RectorPrefix20211206\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver $paramTypeDocBlockResolver)
    {
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $resolvedClass = \RectorPrefix20211206\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
