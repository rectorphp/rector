...
use RectorPrefix20210802\Symplify\EasyTesting\ValueObject\InputAndExpected;
use RectorPrefix20210802\Symplify\EasyTesting\ValueObject\InputFileInfoAndExpected;
use RectorPrefix20210802\Symplify\EasyTesting\ValueObject\InputFileInfoAndExpectedFileInfo;
...
final class StaticFixtureSplitter
{
    ...
    public static function splitFileInfoToInputAndExpected(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : \RectorPrefix20210802\Symplify\EasyTesting\ValueObject\InputAndExpected
    {
        $splitLineCount = \count(\RectorPrefix20210802\Nette\Utils\Strings::matchAll($smartFileInfo->getContents(), \RectorPrefix20210802\Symplify\EasyTesting\ValueObject\SplitLine::SPLIT_LINE_REGEX));
        // if more or less, it could be a test cases for monorepo line in it
        if ($splitLineCount === 1) {
            // input → expected
            [$input, $expected] = \RectorPrefix20210802\Nette\Utils\Strings::split($smartFileInfo->getContents(), \RectorPrefix20210802\Symplify\EasyTesting\ValueObject\SplitLine::SPLIT_LINE_REGEX);
            $expected = self::retypeExpected($expected);
            return new \RectorPrefix20210802\Symplify\EasyTesting\ValueObject\InputAndExpected($input, $expected);
        }
        // no changes
        return new \RectorPrefix20210802\Symplify\EasyTesting\ValueObject\InputAndExpected($smartFileInfo->getContents(), $smartFileInfo->getContents());
    }
    public static function splitFileInfoToLocalInputAndExpectedFileInfos(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, bool $autoloadTestFixture = \false) : \RectorPrefix20210802\Symplify\EasyTesting\ValueObject\InputFileInfoAndExpectedFileInfo
    {
        ...
        return new \RectorPrefix20210802\Symplify\EasyTesting\ValueObject\InputFileInfoAndExpectedFileInfo($inputFileInfo, $expectedFileInfo);
    }
    ...
    public static function splitFileInfoToLocalInputAndExpected(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo, bool $autoloadTestFixture = \false) : \RectorPrefix20210802\Symplify\EasyTesting\ValueObject\InputFileInfoAndExpected
    {
        ...
        return new \RectorPrefix20210802\Symplify\EasyTesting\ValueObject\InputFileInfoAndExpected($inputFileInfo, $inputAndExpected->getExpected());
    }
    ...
    {
        $hash = \RectorPrefix20210802\Nette\Utils\Strings::substring(\md5($smartFileInfo->getRealPath()), -20);
