...
namespace RectorPrefix20211012\Symplify\EasyTesting\FixtureSplitter;

use RectorPrefix20211012\Nette\Utils\Strings;
use RectorPrefix20211012\Symplify\EasyTesting\ValueObject\FixtureSplit\TrioContent;
...
final class TrioFixtureSplitter
{
    ...
    {
        $parts = \RectorPrefix20211012\Nette\Utils\Strings::split($smartFileInfo->getContents(), \RectorPrefix20211012\Symplify\EasyTesting\ValueObject\SplitLine::SPLIT_LINE_REGEX);
        $this->ensureHasThreeParts($parts, $smartFileInfo);
        return new \RectorPrefix20211012\Symplify\EasyTesting\ValueObject\FixtureSplit\TrioContent($parts[0], $parts[1], $parts[2]);
    }
    /**
     * @param mixed[] $parts
     */
    private function ensureHasThreeParts(array $parts, \Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        ...
        throw new \RectorPrefix20211012\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($message);
    }
}
