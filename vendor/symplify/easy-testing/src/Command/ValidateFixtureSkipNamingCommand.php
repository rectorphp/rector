...
namespace RectorPrefix20211228\Symplify\EasyTesting\Command;
...
use RectorPrefix20211228\Symplify\EasyTesting\Finder\FixtureFinder;
use RectorPrefix20211228\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use RectorPrefix20211228\Symplify\EasyTesting\ValueObject\Option;
use RectorPrefix20211228\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \RectorPrefix20211228\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20211228\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \RectorPrefix20211228\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\RectorPrefix20211228\Symplify\EasyTesting\ValueObject\Option::SOURCE, \RectorPrefix20211228\Symfony\Component\Console\Input\InputArgument::REQUIRED | \RectorPrefix20211228\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\RectorPrefix20211228\Symplify\EasyTesting\ValueObject\Option::SOURCE);
