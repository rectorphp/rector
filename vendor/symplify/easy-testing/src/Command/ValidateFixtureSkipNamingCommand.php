...
namespace RectorPrefix20211205\Symplify\EasyTesting\Command;
...
use RectorPrefix20211205\Symplify\EasyTesting\Finder\FixtureFinder;
use RectorPrefix20211205\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use RectorPrefix20211205\Symplify\EasyTesting\ValueObject\Option;
use RectorPrefix20211205\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \RectorPrefix20211205\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20211205\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \RectorPrefix20211205\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\RectorPrefix20211205\Symplify\EasyTesting\ValueObject\Option::SOURCE, \RectorPrefix20211205\Symfony\Component\Console\Input\InputArgument::REQUIRED | \RectorPrefix20211205\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\RectorPrefix20211205\Symplify\EasyTesting\ValueObject\Option::SOURCE);
