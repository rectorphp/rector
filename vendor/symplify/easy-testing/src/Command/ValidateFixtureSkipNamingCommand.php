...
namespace RectorPrefix20210930\Symplify\EasyTesting\Command;
...
use RectorPrefix20210930\Symplify\EasyTesting\Finder\FixtureFinder;
use RectorPrefix20210930\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use RectorPrefix20210930\Symplify\EasyTesting\ValueObject\Option;
use RectorPrefix20210930\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \RectorPrefix20210930\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20210930\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \RectorPrefix20210930\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\RectorPrefix20210930\Symplify\EasyTesting\ValueObject\Option::SOURCE, \RectorPrefix20210930\Symfony\Component\Console\Input\InputArgument::REQUIRED | \RectorPrefix20210930\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\RectorPrefix20210930\Symplify\EasyTesting\ValueObject\Option::SOURCE);
