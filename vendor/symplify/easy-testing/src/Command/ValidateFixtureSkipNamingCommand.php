...
namespace RectorPrefix20220124\Symplify\EasyTesting\Command;
...
use RectorPrefix20220124\Symplify\EasyTesting\Finder\FixtureFinder;
use RectorPrefix20220124\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use RectorPrefix20220124\Symplify\EasyTesting\ValueObject\Option;
use RectorPrefix20220124\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \RectorPrefix20220124\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20220124\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \RectorPrefix20220124\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\RectorPrefix20220124\Symplify\EasyTesting\ValueObject\Option::SOURCE, \RectorPrefix20220124\Symfony\Component\Console\Input\InputArgument::REQUIRED | \RectorPrefix20220124\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\RectorPrefix20220124\Symplify\EasyTesting\ValueObject\Option::SOURCE);
