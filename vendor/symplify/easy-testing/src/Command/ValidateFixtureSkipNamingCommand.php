...
namespace RectorPrefix20211206\Symplify\EasyTesting\Command;
...
use RectorPrefix20211206\Symplify\EasyTesting\Finder\FixtureFinder;
use RectorPrefix20211206\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use RectorPrefix20211206\Symplify\EasyTesting\ValueObject\Option;
use RectorPrefix20211206\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \RectorPrefix20211206\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20211206\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \RectorPrefix20211206\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $source = (array) $input->getArgument(\RectorPrefix20211206\Symplify\EasyTesting\ValueObject\Option::SOURCE);
