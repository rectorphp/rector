...
namespace RectorPrefix20210707\Symplify\EasyTesting\Command;
...
use RectorPrefix20210707\Symplify\EasyTesting\Finder\FixtureFinder;
use RectorPrefix20210707\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use RectorPrefix20210707\Symplify\EasyTesting\ValueObject\Option;
...
final class ValidateFixtureSkipNamingCommand extends \RectorPrefix20210707\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\RectorPrefix20210707\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \RectorPrefix20210707\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\RectorPrefix20210707\Symplify\EasyTesting\ValueObject\Option::SOURCE, \RectorPrefix20210707\Symfony\Component\Console\Input\InputArgument::REQUIRED | \RectorPrefix20210707\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\RectorPrefix20210707\Symplify\EasyTesting\ValueObject\Option::SOURCE);
