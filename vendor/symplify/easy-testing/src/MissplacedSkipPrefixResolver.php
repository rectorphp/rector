...
namespace RectorPrefix20210922\Symplify\EasyTesting;

use RectorPrefix20210922\Nette\Utils\Strings;
use RectorPrefix20210922\Symplify\EasyTesting\ValueObject\Prefix;
use RectorPrefix20210922\Symplify\EasyTesting\ValueObject\SplitLine;
...
final class MissplacedSkipPrefixResolver
{
    ...
    public function resolve(array $fixtureFileInfos) : array
    {
        ...
        foreach ($fixtureFileInfos as $fixtureFileInfo) {
            ...
            $hasSplitLine = (bool) \RectorPrefix20210922\Nette\Utils\Strings::match($fileContents, \RectorPrefix20210922\Symplify\EasyTesting\ValueObject\SplitLine::SPLIT_LINE_REGEX);
    ...
    {
        return (bool) \RectorPrefix20210922\Nette\Utils\Strings::match($fixtureFileInfo->getBasenameWithoutSuffix(), \RectorPrefix20210922\Symplify\EasyTesting\ValueObject\Prefix::SKIP_PREFIX_REGEX);
    }
}
