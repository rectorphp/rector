...
namespace RectorPrefix20210928\Symplify\EasyTesting\ValueObject;
...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function getOutputFileContent() : string
    {
        if (!$this->outputFileInfo instanceof \Symplify\SmartFileSystem\SmartFileInfo) {
            throw new \RectorPrefix20210928\Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
