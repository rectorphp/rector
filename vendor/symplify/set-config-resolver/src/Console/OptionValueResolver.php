...
namespace RectorPrefix20210513\Symplify\SetConfigResolver\Console;
...
final class OptionValueResolver
{
     ...
     */
    public function getOptionValue(\RectorPrefix20210513\Symfony\Component\Console\Input\InputInterface $input, array $optionNames) : ?string
    {
