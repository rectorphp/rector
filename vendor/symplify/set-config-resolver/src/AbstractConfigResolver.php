...
use RectorPrefix20210511\Symplify\SetConfigResolver\Console\Option\OptionName;
use RectorPrefix20210511\Symplify\SetConfigResolver\Console\OptionValueResolver;
...
abstract class AbstractConfigResolver
{
    ...
    {
        $this->optionValueResolver = new \RectorPrefix20210511\Symplify\SetConfigResolver\Console\OptionValueResolver();
    }
    public function resolveFromInput(\RectorPrefix20210511\Symfony\Component\Console\Input\InputInterface $input) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
        $configValue = $this->optionValueResolver->getOptionValue($input, \RectorPrefix20210511\Symplify\SetConfigResolver\Console\Option\OptionName::CONFIG);
        if ($configValue !== null) {
            if (!\file_exists($configValue)) {
                $message = \sprintf('File "%s" was not found', $configValue);
                throw new \RectorPrefix20210511\Symplify\SmartFileSystem\Exception\FileNotFoundException($message);
            }
     ...
     */
    public function resolveFromInputWithFallback(\RectorPrefix20210511\Symfony\Component\Console\Input\InputInterface $input, array $fallbackFiles) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
