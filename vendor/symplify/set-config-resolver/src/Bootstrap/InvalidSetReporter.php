...
namespace RectorPrefix20210512\Symplify\SetConfigResolver\Bootstrap;
...
final class InvalidSetReporter
{
    ...
    public function report(\RectorPrefix20210512\Symplify\SetConfigResolver\Exception\SetNotFoundException $setNotFoundException) : void
    {
        $message = $setNotFoundException->getMessage();
        $suggestedSet = \RectorPrefix20210512\Nette\Utils\ObjectHelpers::getSuggestion($setNotFoundException->getAvailableSetNames(), $setNotFoundException->getSetName());
