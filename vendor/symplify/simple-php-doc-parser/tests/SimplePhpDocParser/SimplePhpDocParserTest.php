...
namespace RectorPrefix20210511\Symplify\SimplePhpDocParser\Tests\SimplePhpDocParser;
...
final class SimplePhpDocParserTest extends \RectorPrefix20210511\Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
    ...
    protected function setUp() : void
    {
        ...
        $this->simplePhpDocParser = $this->getService(\RectorPrefix20210511\Symplify\SimplePhpDocParser\SimplePhpDocParser::class);
    }
    public function testVar() : void
    {
        ...
        $this->assertInstanceOf(\RectorPrefix20210511\Symplify\SimplePhpDocParser\ValueObject\Ast\PhpDoc\SimplePhpDocNode::class, $phpDocNode);
