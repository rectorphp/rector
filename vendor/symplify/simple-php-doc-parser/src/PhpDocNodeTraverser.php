...
use RectorPrefix20210702\Symplify\SimplePhpDocParser\Exception\InvalidTraverseException;
use RectorPrefix20210702\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\CallablePhpDocNodeVisitor;
/**
 * Mimics
...
final class PhpDocNodeTraverser
{
    ...
    public function addPhpDocNodeVisitor(\RectorPrefix20210702\Symplify\SimplePhpDocParser\Contract\PhpDocNodeVisitorInterface $phpDocNodeVisitor) : void
    {
    ...
    public function traverse(\PHPStan\PhpDocParser\Ast\Node $node) : void
    {
        ...
        if (\is_int($node)) {
            throw new \RectorPrefix20210702\Symplify\SimplePhpDocParser\Exception\InvalidTraverseException();
        }
        foreach ($this->phpDocNodeVisitors as $phpDocNodeVisitor) {
    ...
    {
        $callablePhpDocNodeVisitor = new \RectorPrefix20210702\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\CallablePhpDocNodeVisitor($callable, $docContent);
