 ...
 */
final class CloningPhpDocNodeVisitor extends \RectorPrefix20210708\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\AbstractPhpDocNodeVisitor
{
    /**
    ...
    {
        $node = clone $origNode;
        $node->setAttribute(\RectorPrefix20210708\Symplify\SimplePhpDocParser\ValueObject\PhpDocAttributeKey::ORIG_NODE, $origNode);
        return $node;
    }
}
