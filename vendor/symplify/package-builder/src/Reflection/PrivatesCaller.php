...
namespace RectorPrefix20210928\Symplify\PackageBuilder\Reflection;

use ReflectionClass;
use ReflectionMethod;
use RectorPrefix20210928\Symplify\SymplifyKernel\Exception\ShouldNotHappenException;
/**
...
final class PrivatesCaller
{
    ...
    private function ensureIsNotNull($object, string $location) : void
    {
        ...
        throw new \RectorPrefix20210928\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
    }
}
