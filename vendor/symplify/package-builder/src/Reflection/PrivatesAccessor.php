...
use RectorPrefix20220316\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use RectorPrefix20220316\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
...
final class PrivatesAccessor
{
    ...
    public function getPrivatePropertyOfClass($object, string $propertyName, string $valueClassName)
    {
        ...
        throw new \RectorPrefix20220316\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException($errorMessage);
    }
    /**
     * @return mixed
     * @param object $object
    ...
    private function resolvePropertyReflection($object, string $propertyName) : \ReflectionProperty
    {
        ...
        throw new \RectorPrefix20220316\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException($errorMessage);
    }
}
