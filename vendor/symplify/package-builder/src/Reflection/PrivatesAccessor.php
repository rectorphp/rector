...
use RectorPrefix202207\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use RectorPrefix202207\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
