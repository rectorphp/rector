...
use RectorPrefix20220610\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use RectorPrefix20220610\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
