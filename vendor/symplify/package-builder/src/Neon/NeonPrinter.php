...
namespace RectorPrefix20220125\Symplify\PackageBuilder\Neon;

use RectorPrefix20220125\Nette\Neon\Encoder;
use RectorPrefix20220125\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \RectorPrefix20220125\Nette\Neon\Neon::encode($phpStanNeon, \RectorPrefix20220125\Nette\Neon\Encoder::BLOCK, '    ');
    ...
    {
        return \RectorPrefix20220125\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \RectorPrefix20220125\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
