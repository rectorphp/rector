...
namespace RectorPrefix20220101\Symplify\PackageBuilder\Neon;

use RectorPrefix20220101\Nette\Neon\Encoder;
use RectorPrefix20220101\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \RectorPrefix20220101\Nette\Neon\Neon::encode($phpStanNeon, \RectorPrefix20220101\Nette\Neon\Encoder::BLOCK, '    ');
    ...
    {
        return \RectorPrefix20220101\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \RectorPrefix20220101\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
