...
namespace RectorPrefix20210912\Symplify\PackageBuilder\Neon;

use RectorPrefix20210912\Nette\Neon\Encoder;
use RectorPrefix20210912\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \RectorPrefix20210912\Nette\Neon\Neon::encode($phpStanNeon, \RectorPrefix20210912\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \RectorPrefix20210912\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \RectorPrefix20210912\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \RectorPrefix20210912\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
