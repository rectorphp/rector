...
namespace RectorPrefix20211130\Symplify\PackageBuilder\Neon;

use RectorPrefix20211130\Nette\Neon\Encoder;
use RectorPrefix20211130\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \RectorPrefix20211130\Nette\Neon\Neon::encode($phpStanNeon, \RectorPrefix20211130\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \RectorPrefix20211130\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \RectorPrefix20211130\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \RectorPrefix20211130\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
