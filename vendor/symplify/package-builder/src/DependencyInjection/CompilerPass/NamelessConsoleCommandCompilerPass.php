...
final class NamelessConsoleCommandCompilerPass implements \RectorPrefix20211029\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process($containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \RectorPrefix20211029\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
            $commandName = \RectorPrefix20211029\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName($definitionClass);
