...
namespace RectorPrefix20210731\Symplify\PackageBuilder\DependencyInjection;
...
use RectorPrefix20210731\Symplify\PackageBuilder\Exception\DependencyInjection\DefinitionForTypeNotFoundException;
use Throwable;
/**
...
final class DefinitionFinder
{
     ...
     * @return Definition[]
     */
    public function findAllByType(\RectorPrefix20210731\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : array
    {
        $definitions = [];
    ...
    public function getByType(\RectorPrefix20210731\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : \RectorPrefix20210731\Symfony\Component\DependencyInjection\Definition
    {
        ...
        throw new \RectorPrefix20210731\Symplify\PackageBuilder\Exception\DependencyInjection\DefinitionForTypeNotFoundException(\sprintf('Definition for type "%s" was not found.', $type));
    }
