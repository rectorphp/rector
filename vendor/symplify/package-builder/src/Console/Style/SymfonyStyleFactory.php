...
namespace RectorPrefix20220301\Symplify\PackageBuilder\Console\Style;
...
final class SymfonyStyleFactory
{
    ...
    {
        $this->privatesCaller = new \RectorPrefix20220301\Symplify\PackageBuilder\Reflection\PrivatesCaller();
    }
    public function create() : \RectorPrefix20220301\Symfony\Component\Console\Style\SymfonyStyle
    {
        ...
        if (\RectorPrefix20220301\Symplify\EasyTesting\PHPUnit\StaticPHPUnitEnvironment::isPHPUnitRun()) {
            $consoleOutput->setVerbosity(\RectorPrefix20220301\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
        return new \RectorPrefix20220301\Symfony\Component\Console\Style\SymfonyStyle($argvInput, $consoleOutput);
    }
}
