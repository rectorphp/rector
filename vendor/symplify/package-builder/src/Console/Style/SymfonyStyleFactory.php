...
namespace RectorPrefix20210607\Symplify\PackageBuilder\Console\Style;
...
final class SymfonyStyleFactory
{
    ...
    {
        $this->privatesCaller = new \RectorPrefix20210607\Symplify\PackageBuilder\Reflection\PrivatesCaller();
    }
    public function create() : \RectorPrefix20210607\Symfony\Component\Console\Style\SymfonyStyle
    {
        ...
        if (\RectorPrefix20210607\Symplify\EasyTesting\PHPUnit\StaticPHPUnitEnvironment::isPHPUnitRun()) {
            $consoleOutput->setVerbosity(\RectorPrefix20210607\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
