...
namespace RectorPrefix20220209\Symplify\PackageBuilder\Console\Style;
...
final class SymfonyStyleFactory
{
    ...
    {
        $this->privatesCaller = new \RectorPrefix20220209\Symplify\PackageBuilder\Reflection\PrivatesCaller();
    }
    public function create() : \RectorPrefix20220209\Symfony\Component\Console\Style\SymfonyStyle
    {
        ...
        $this->privatesCaller->callPrivateMethod(new \RectorPrefix20220209\Symfony\Component\Console\Application(), 'configureIO', [$argvInput, $consoleOutput]);
        // --debug is called
        ...
        if (\RectorPrefix20220209\Symplify\EasyTesting\PHPUnit\StaticPHPUnitEnvironment::isPHPUnitRun()) {
            $consoleOutput->setVerbosity(\RectorPrefix20220209\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
