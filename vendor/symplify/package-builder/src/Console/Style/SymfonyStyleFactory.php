...
namespace RectorPrefix20220202\Symplify\PackageBuilder\Console\Style;
...
final class SymfonyStyleFactory
{
    ...
    {
        $this->privatesCaller = new \RectorPrefix20220202\Symplify\PackageBuilder\Reflection\PrivatesCaller();
    }
    public function create() : \RectorPrefix20220202\Symfony\Component\Console\Style\SymfonyStyle
    {
        ...
        if (\RectorPrefix20220202\Symplify\EasyTesting\PHPUnit\StaticPHPUnitEnvironment::isPHPUnitRun()) {
            $consoleOutput->setVerbosity(\RectorPrefix20220202\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
