...
namespace RectorPrefix20210822\Symplify\ConsolePackageBuilder\DependencyInjection\CompilerPass;
...
final class NamelessConsoleCommandCompilerPass implements \RectorPrefix20210822\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process($containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \RectorPrefix20210822\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
            $commandName = \RectorPrefix20210822\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName($definitionClass);
