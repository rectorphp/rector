...
namespace RectorPrefix20210731\Symplify\ConsolePackageBuilder\DependencyInjection\CompilerPass;
...
final class NamelessConsoleCommandCompilerPass implements \RectorPrefix20210731\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process($containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $definition) {
            ...
            if (!\is_a($definitionClass, \RectorPrefix20210731\Symfony\Component\Console\Command\Command::class, \true)) {
                continue;
            }
