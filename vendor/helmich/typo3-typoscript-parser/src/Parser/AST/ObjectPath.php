...
class ObjectPath
{
     ...
     */
    public function parent() : \RectorPrefix20220321\Helmich\TypoScriptParser\Parser\AST\ObjectPath
    {
        $components = \explode('.', $this->absoluteName);
        if (\count($components) === 1) {
            return new \RectorPrefix20220321\Helmich\TypoScriptParser\Parser\AST\RootObjectPath();
        }
