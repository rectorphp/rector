...
class ObjectPath
{
     ...
     */
    public function parent() : \RectorPrefix20210607\Helmich\TypoScriptParser\Parser\AST\ObjectPath
    {
        $components = \explode('.', $this->absoluteName);
        if (\count($components) === 1) {
            return new \RectorPrefix20210607\Helmich\TypoScriptParser\Parser\AST\RootObjectPath();
        }
