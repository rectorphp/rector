...
class ObjectPath
{
     ...
     */
    public function parent() : \RectorPrefix20211205\Helmich\TypoScriptParser\Parser\AST\ObjectPath
    {
        $components = \explode('.', $this->absoluteName);
        if (\count($components) === 1) {
            return new \RectorPrefix20211205\Helmich\TypoScriptParser\Parser\AST\RootObjectPath();
        }
