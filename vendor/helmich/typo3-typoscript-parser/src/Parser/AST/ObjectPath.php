...
class ObjectPath
{
     ...
     */
    public function parent() : \RectorPrefix20210716\Helmich\TypoScriptParser\Parser\AST\ObjectPath
    {
        $components = \explode('.', $this->absoluteName);
        if (\count($components) === 1) {
            return new \RectorPrefix20210716\Helmich\TypoScriptParser\Parser\AST\RootObjectPath();
        }
