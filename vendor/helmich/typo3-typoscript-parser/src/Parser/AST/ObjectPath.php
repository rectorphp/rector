...
class ObjectPath
{
     ...
     */
    public function parent() : \RectorPrefix20210611\Helmich\TypoScriptParser\Parser\AST\ObjectPath
    {
        $components = \explode('.', $this->absoluteName);
        if (\count($components) === 1) {
            return new \RectorPrefix20210611\Helmich\TypoScriptParser\Parser\AST\RootObjectPath();
        }
