...
class ObjectPath
{
     ...
     */
    public function parent() : \RectorPrefix20210907\Helmich\TypoScriptParser\Parser\AST\ObjectPath
    {
        $components = \explode('.', $this->absoluteName);
        if (\count($components) === 1) {
            return new \RectorPrefix20210907\Helmich\TypoScriptParser\Parser\AST\RootObjectPath();
        }
