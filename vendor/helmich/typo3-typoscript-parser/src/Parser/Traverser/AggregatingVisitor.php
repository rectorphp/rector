...
class AggregatingVisitor implements \RectorPrefix20210620\Helmich\TypoScriptParser\Parser\Traverser\Visitor
{
     ...
     * @return void
     */
    public function addVisitor(\RectorPrefix20210620\Helmich\TypoScriptParser\Parser\Traverser\Visitor $visitor) : void
    {
     ...
     * @return void
     */
    public function exitNode(\RectorPrefix20210620\Helmich\TypoScriptParser\Parser\AST\Statement $statement) : void
    {
        foreach ($this->visitors as $visitor) {
