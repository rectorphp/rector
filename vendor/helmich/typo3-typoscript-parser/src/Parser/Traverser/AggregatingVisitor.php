 ...
 */
class AggregatingVisitor implements \RectorPrefix20210616\Helmich\TypoScriptParser\Parser\Traverser\Visitor
{
    /** @var Visitor[] */
    private $visitors = [];
    /**
     ...
     * @return void
     */
    public function addVisitor(\RectorPrefix20210616\Helmich\TypoScriptParser\Parser\Traverser\Visitor $visitor) : void
    {
     ...
     * @return void
     */
    public function enterNode(\RectorPrefix20210616\Helmich\TypoScriptParser\Parser\AST\Statement $statement) : void
    {
        foreach ($this->visitors as $visitor) {
     ...
     * @return void
     */
    public function exitNode(\RectorPrefix20210616\Helmich\TypoScriptParser\Parser\AST\Statement $statement) : void
    {
        foreach ($this->visitors as $visitor) {
