 ...
 */
class AggregatingVisitor implements \RectorPrefix20210625\Helmich\TypoScriptParser\Parser\Traverser\Visitor
{
    /** @var Visitor[] */
    private $visitors = [];
    /**
     ...
     * @return void
     */
    public function exitNode(\RectorPrefix20210625\Helmich\TypoScriptParser\Parser\AST\Statement $statement) : void
    {
        foreach ($this->visitors as $visitor) {
