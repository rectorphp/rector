...
class PrettyPrinter implements \RectorPrefix20210616\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface
{
    ...
    public function setPrettyPrinterConfiguration(\RectorPrefix20210616\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration $prettyPrinterConfiguration) : void
    {
     ...
     * @return void
     */
    public function printStatements(array $statements, \RectorPrefix20210616\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
     ...
     * @return void
     */
    private function printStatementList(array $statements, \RectorPrefix20210616\Symfony\Component\Console\Output\OutputInterface $output, int $nesting = 0) : void
    {
    ...
    private function printBinaryObjectOperator(\RectorPrefix20210616\Symfony\Component\Console\Output\OutputInterface $output, \RectorPrefix20210616\Helmich\TypoScriptParser\Parser\AST\Operator\BinaryObjectOperator $operator, int $nesting) : void
    {
    ...
    private function printIncludeStatement(\RectorPrefix20210616\Symfony\Component\Console\Output\OutputInterface $output, \RectorPrefix20210616\Helmich\TypoScriptParser\Parser\AST\IncludeStatement $statement) : void
    {
    ...
    private function printFileIncludeStatement(\RectorPrefix20210616\Symfony\Component\Console\Output\OutputInterface $output, \RectorPrefix20210616\Helmich\TypoScriptParser\Parser\AST\FileIncludeStatement $statement) : void
    {
    ...
    private function printDirectoryIncludeStatement(\RectorPrefix20210616\Symfony\Component\Console\Output\OutputInterface $output, \RectorPrefix20210616\Helmich\TypoScriptParser\Parser\AST\DirectoryIncludeStatement $statement) : void
    {
        $attributes = "";
     ...
     */
    private function printNestedAssignment(\RectorPrefix20210616\Symfony\Component\Console\Output\OutputInterface $output, $nesting, \RectorPrefix20210616\Helmich\TypoScriptParser\Parser\AST\NestedAssignment $statement) : void
    {
     ...
     */
    private function printConditionalStatement(\RectorPrefix20210616\Symfony\Component\Console\Output\OutputInterface $output, int $nesting, \RectorPrefix20210616\Helmich\TypoScriptParser\Parser\AST\ConditionalStatement $statement, bool $hasNext = \false, bool $hasPrevious = \false) : void
    {
        if (!$hasPrevious) {
            $output->writeln('');
        }
     ...
     * @param string          $indent
     */
    private function printAssignment(\RectorPrefix20210616\Symfony\Component\Console\Output\OutputInterface $output, \RectorPrefix20210616\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement, string $indent) : void
    {
    ...
    private function printNopStatement(\RectorPrefix20210616\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
