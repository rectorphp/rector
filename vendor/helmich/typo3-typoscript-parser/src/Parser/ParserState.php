...
use RectorPrefix20210811\Helmich\TypoScriptParser\Parser\AST\RootObjectPath;
...
class ParserState
{
    ...
    /** @var TokenStream */
    private $tokens;
    public function __construct(\RectorPrefix20210811\Helmich\TypoScriptParser\Parser\TokenStream $tokens, \ArrayObject $statements = null)
    {
        if ($statements === null) {
        ...
        $this->tokens = $tokens;
        $this->context = new \RectorPrefix20210811\Helmich\TypoScriptParser\Parser\AST\RootObjectPath();
    }
    /**
     * @return $this
     ...
     */
    public function token($lookAhead = 0) : \RectorPrefix20210811\Helmich\TypoScriptParser\Tokenizer\TokenInterface
    {
     ...
     * @return ObjectPath
     */
    public function context() : \RectorPrefix20210811\Helmich\TypoScriptParser\Parser\AST\ObjectPath
    {
        return $this->context;
    }
    /**
