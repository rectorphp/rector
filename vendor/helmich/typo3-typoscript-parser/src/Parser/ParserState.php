...
use RectorPrefix20220217\Helmich\TypoScriptParser\Parser\AST\RootObjectPath;
...
class ParserState
{
    ...
    /** @var TokenStream */
    private $tokens;
    public function __construct(\RectorPrefix20220217\Helmich\TypoScriptParser\Parser\TokenStream $tokens, \ArrayObject $statements = null)
    {
        if ($statements === null) {
