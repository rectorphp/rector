...
use RectorPrefix20210731\Helmich\TypoScriptParser\Parser\AST\RootObjectPath;
...
class ParserState
{
    ...
    public function __construct(\RectorPrefix20210731\Helmich\TypoScriptParser\Parser\TokenStream $tokens, \ArrayObject $statements = null)
    {
        ...
        $this->tokens = $tokens;
        $this->context = new \RectorPrefix20210731\Helmich\TypoScriptParser\Parser\AST\RootObjectPath();
    }
    /**
     * @return $this
     ...
     * @return ObjectPath
     */
    public function context() : \RectorPrefix20210731\Helmich\TypoScriptParser\Parser\AST\ObjectPath
    {
        return $this->context;
    }
    /**
