...
namespace RectorPrefix20210920\Helmich\TypoScriptParser\Tokenizer;
...
class MultilineTokenBuilder
{
     ...
     */
    public function endMultilineToken($append = '') : \RectorPrefix20210920\Helmich\TypoScriptParser\Tokenizer\TokenInterface
    {
        ...
        if ($type === null || $startLine === null || $startColumn === null) {
            throw new \RectorPrefix20210920\Helmich\TypoScriptParser\Tokenizer\TokenizerException('cannot call "endMultilineToken" before calling "startMultilineToken"');
        }
        $token = new \RectorPrefix20210920\Helmich\TypoScriptParser\Tokenizer\Token($type, \rtrim($value), $startLine, $startColumn);
        $this->reset();
        return $token;
    }
    /**
