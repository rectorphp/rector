...
class StructuredTokenPrinter implements \RectorPrefix20220126\Helmich\TypoScriptParser\Tokenizer\Printer\TokenPrinterInterface
{
    /** @var Yaml */
    private $yaml;
    public function __construct(\RectorPrefix20220126\Symfony\Component\Yaml\Yaml $yaml = null)
    {
        $this->yaml = $yaml ?: new \RectorPrefix20220126\Symfony\Component\Yaml\Yaml();
    }
    /**
