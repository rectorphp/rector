...
class StructuredTokenPrinter implements \RectorPrefix20210519\Helmich\TypoScriptParser\Tokenizer\Printer\TokenPrinterInterface
{
    /** @var Yaml */
    private $yaml;
    public function __construct(\RectorPrefix20210519\Symfony\Component\Yaml\Yaml $yaml = null)
    {
        $this->yaml = $yaml ?: new \RectorPrefix20210519\Symfony\Component\Yaml\Yaml();
    }
    /**
