...
namespace RectorPrefix20220304\Helmich\TypoScriptParser\Tokenizer\Preprocessing;
 ...
 */
class ProcessorChain implements \RectorPrefix20220304\Helmich\TypoScriptParser\Tokenizer\Preprocessing\Preprocessor
{
    /** @var Preprocessor[] */
     ...
     * @return self
     */
    public function with(\RectorPrefix20220304\Helmich\TypoScriptParser\Tokenizer\Preprocessing\Preprocessor $next) : self
    {
        $new = new self();
