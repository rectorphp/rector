...
namespace RectorPrefix20210620\Helmich\TypoScriptParser\Tokenizer\Preprocessing;
 ...
 */
class ProcessorChain implements \RectorPrefix20210620\Helmich\TypoScriptParser\Tokenizer\Preprocessing\Preprocessor
{
    /** @var Preprocessor[] */
     ...
     * @return self
     */
    public function with(\RectorPrefix20210620\Helmich\TypoScriptParser\Tokenizer\Preprocessing\Preprocessor $next)
    {
        $new = new self();
