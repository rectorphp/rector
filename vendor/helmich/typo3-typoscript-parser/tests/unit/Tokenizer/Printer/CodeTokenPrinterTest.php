...
use RectorPrefix20210518\Helmich\TypoScriptParser\Tokenizer\Printer\CodeTokenPrinter;
use RectorPrefix20210518\Helmich\TypoScriptParser\Tokenizer\Token;
use RectorPrefix20210518\PHPUnit\Framework\TestCase;
class CodeTokenPrinterTest extends \RectorPrefix20210518\PHPUnit\Framework\TestCase
{
    /** @var CodeTokenPrinter */
    private $printer;
    public function setUp() : void
    {
        $this->printer = new \RectorPrefix20210518\Helmich\TypoScriptParser\Tokenizer\Printer\CodeTokenPrinter();
    }
