...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('(s)tatuses$'), 'RectorPrefix202402\\1\\2tatus'));
        (yield new Transformation(new Pattern('(s)tatus$'), 'RectorPrefix202402\\1\\2tatus'));
        (yield new Transformation(new Pattern('(c)ampus$'), 'RectorPrefix202402\\1\\2ampus'));
        (yield new Transformation(new Pattern('^(.*)(menu)s$'), 'RectorPrefix202402\\1\\2'));
        ...
        (yield new Transformation(new Pattern('(m)ovies$'), 'RectorPrefix202402\\1\\2ovie'));
        (yield new Transformation(new Pattern('(s)eries$'), 'RectorPrefix202402\\1\\2eries'));
        ...
        (yield new Transformation(new Pattern('(n)ews$'), 'RectorPrefix202402\\1\\2ews'));
    ...
    {
        (yield new Transformation(new Pattern('(s)tatus$'), 'RectorPrefix202402\\1\\2tatuses'));
        (yield new Transformation(new Pattern('(quiz)$'), '\\1zes'));
        (yield new Transformation(new Pattern('^(ox)$'), 'RectorPrefix202402\\1\\2en'));
        ...
        (yield new Transformation(new Pattern('(?:([^f])fe|([lr])f)$'), 'RectorPrefix202402\\1\\2ves'));
        ...
        (yield new Transformation(new Pattern('(buffal|her|potat|tomat|volcan)o$'), 'RectorPrefix202402\\1\\2oes'));
