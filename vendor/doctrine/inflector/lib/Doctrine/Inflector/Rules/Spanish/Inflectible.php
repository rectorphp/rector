...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('/ú([sn])$/i'), 'RectorPrefix202404\\u\\1es'));
        (yield new Transformation(new Pattern('/ó([sn])$/i'), 'RectorPrefix202404\\o\\1es'));
        (yield new Transformation(new Pattern('/í([sn])$/i'), 'RectorPrefix202404\\i\\1es'));
        (yield new Transformation(new Pattern('/é([sn])$/i'), 'RectorPrefix202404\\e\\1es'));
        (yield new Transformation(new Pattern('/á([sn])$/i'), 'RectorPrefix202404\\a\\1es'));
