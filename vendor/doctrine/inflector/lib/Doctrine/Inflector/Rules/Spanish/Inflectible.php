...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('/ú([sn])$/i'), 'RectorPrefix202211\\u\\1es'));
        (yield new Transformation(new Pattern('/ó([sn])$/i'), 'RectorPrefix202211\\o\\1es'));
        (yield new Transformation(new Pattern('/í([sn])$/i'), 'RectorPrefix202211\\i\\1es'));
        (yield new Transformation(new Pattern('/é([sn])$/i'), 'RectorPrefix202211\\e\\1es'));
        (yield new Transformation(new Pattern('/á([sn])$/i'), 'RectorPrefix202211\\a\\1es'));
