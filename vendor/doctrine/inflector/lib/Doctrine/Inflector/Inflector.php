...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\RectorPrefix20210801\Doctrine\Inflector\WordInflector $singularizer, \RectorPrefix20210801\Doctrine\Inflector\WordInflector $pluralizer)
    {
    ...
    public function urlize($string) : string
    {
        ...
        $replacements = ['/\\W/' => ' ', '/([A-Z]+)([A-Z][a-z])/' => 'RectorPrefix20210801\\1_\\2', '/([a-z\\d])([A-Z])/' => 'RectorPrefix20210801\\1_\\2', '/[^A-Z^a-z^0-9^\\/]+/' => '-'];
        $urlized = $lowered;
...
\class_alias('RectorPrefix20210801\\Doctrine\\Inflector\\Inflector', 'Doctrine\\Inflector\\Inflector', \false);
