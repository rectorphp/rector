...
abstract class GenericLanguageInflectorFactory implements \RectorPrefix20210708\Doctrine\Inflector\LanguageInflectorFactory
{
    /** @var Ruleset[] */
    ...
    public final function build() : \RectorPrefix20210708\Doctrine\Inflector\Inflector
    {
    ...
    public final function withSingularRules($singularRules, $reset = \false) : self
    {
        ...
        if ($singularRules instanceof \RectorPrefix20210708\Doctrine\Inflector\Rules\Ruleset) {
    ...
    public final function withPluralRules($pluralRules, $reset = \false) : self
    {
        ...
        if ($pluralRules instanceof \RectorPrefix20210708\Doctrine\Inflector\Rules\Ruleset) {
            \array_unshift($this->pluralRulesets, $pluralRules);
        }
        return $this;
    }
    protected abstract function getSingularRuleset() : \RectorPrefix20210708\Doctrine\Inflector\Rules\Ruleset;
    protected abstract function getPluralRuleset() : \RectorPrefix20210708\Doctrine\Inflector\Rules\Ruleset;
}
