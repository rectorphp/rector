...
abstract class GenericLanguageInflectorFactory implements \RectorPrefix20211210\Doctrine\Inflector\LanguageInflectorFactory
{
    /** @var Ruleset[] */
    ...
    public final function build() : \RectorPrefix20211210\Doctrine\Inflector\Inflector
    {
    ...
    public final function withSingularRules(?\RectorPrefix20211210\Doctrine\Inflector\Rules\Ruleset $singularRules, bool $reset = \false) : \RectorPrefix20211210\Doctrine\Inflector\LanguageInflectorFactory
    {
        ...
        if ($singularRules instanceof \RectorPrefix20211210\Doctrine\Inflector\Rules\Ruleset) {
    ...
    public final function withPluralRules(?\RectorPrefix20211210\Doctrine\Inflector\Rules\Ruleset $pluralRules, bool $reset = \false) : \RectorPrefix20211210\Doctrine\Inflector\LanguageInflectorFactory
    {
        ...
        if ($pluralRules instanceof \RectorPrefix20211210\Doctrine\Inflector\Rules\Ruleset) {
            \array_unshift($this->pluralRulesets, $pluralRules);
        }
        return $this;
    }
    protected abstract function getSingularRuleset() : \RectorPrefix20211210\Doctrine\Inflector\Rules\Ruleset;
    protected abstract function getPluralRuleset() : \RectorPrefix20211210\Doctrine\Inflector\Rules\Ruleset;
}
