...
use RectorPrefix20210907\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker;
final class InitializeArgumentsClassMethodFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20210907\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder(self::METHOD_NAME);
