...
use RectorPrefix20210825\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker;
final class InitializeArgumentsClassMethodFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20210825\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder(self::METHOD_NAME);
