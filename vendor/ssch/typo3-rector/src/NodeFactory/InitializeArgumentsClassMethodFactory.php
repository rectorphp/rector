...
use RectorPrefix20210830\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker;
final class InitializeArgumentsClassMethodFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20210830\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder(self::METHOD_NAME);
