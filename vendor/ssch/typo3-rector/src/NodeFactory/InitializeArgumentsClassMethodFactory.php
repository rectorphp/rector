...
final class InitializeArgumentsClassMethodFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20211211\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder(self::METHOD_NAME);
