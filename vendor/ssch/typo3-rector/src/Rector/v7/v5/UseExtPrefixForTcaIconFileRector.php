...
CODE_SAMPLE
    ...
    private function refactorIconFile(\PhpParser\Node\Expr\ArrayItem $fieldValue) : void
    {
        ...
        if ($fieldValue->value instanceof \PhpParser\Node\Expr\BinaryOp\Concat) {
            ...
            if (!$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($staticCall, new \PHPStan\Type\ObjectType('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Utility\\ExtensionManagementUtility'))) {
                return;
            }
