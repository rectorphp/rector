...
final class TypeHandlingServiceToTypeHandlingUtilityRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($node, new \PHPStan\Type\ObjectType('RectorPrefix20210518\\TYPO3\\CMS\\Extbase\\Service\\TypeHandlingService'))) {
            return null;
        }
        ...
        return $this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Extbase\\Utility\\TypeHandlingUtility', $methodCall, $node->args);
    }
    /**
     * @codeCoverageIgnore
     */
