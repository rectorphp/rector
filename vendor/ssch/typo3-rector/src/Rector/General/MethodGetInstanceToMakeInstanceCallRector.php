...
use RectorPrefix20220214\TYPO3\CMS\Core\Utility\GeneralUtility;
...
final class MethodGetInstanceToMakeInstanceCallRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        return $this->nodeFactory->createStaticCall(\RectorPrefix20220214\TYPO3\CMS\Core\Utility\GeneralUtility::class, 'makeInstance', [$class]);
    }
    /**
     * @codeCoverageIgnore
     */
...
, self::EXAMPLE_CONFIGURATION)]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220214\Webmozart\Assert\Assert::isArray($classes);
        \RectorPrefix20220214\Webmozart\Assert\Assert::allString($classes);
