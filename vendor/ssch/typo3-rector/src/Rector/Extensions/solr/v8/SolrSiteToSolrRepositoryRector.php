...
CODE_SAMPLE
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        if ($firstArgumentObjectType->isInstanceOf('RectorPrefix20210518\\ApacheSolrForTypo3\\Solr\\Site')->no()) {
            return null;
        }
        ...
        $node->args[0]->value = $this->nodeFactory->createClassConstReference('RectorPrefix20210518\\ApacheSolrForTypo3\\Solr\\Domain\\Site\\SiteRepository');
        unset($node->args[1]);
