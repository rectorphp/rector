...
final class UseSignalAfterExtensionInstallInsteadOfHasInstalledExtensionsRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        if (!$this->classConstAnalyzer->isClassConstReference($node->args[0]->value, 'RectorPrefix20210518\\TYPO3\\CMS\\Extensionmanager\\Service\\ExtensionManagementService')) {
            return null;
        }
        if (!$this->valueResolver->isValue($node->args[1]->value, 'hasInstalledExtensions')) {
            return null;
        }
        $node->args[0]->value = $this->nodeFactory->createClassConstReference('RectorPrefix20210518\\TYPO3\\CMS\\Extensionmanager\\Utility\\InstallUtility');
