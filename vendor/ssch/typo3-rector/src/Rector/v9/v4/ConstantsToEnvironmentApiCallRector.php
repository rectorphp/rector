...
final class ConstantsToEnvironmentApiCallRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        return $this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Core\\Environment', 'isCli');
    }
    private function refactorConstants(\PhpParser\Node\Expr\ConstFetch $node) : ?\PhpParser\Node
    {
        ...
        if ('PATH_thisScript' === $constantName) {
            return $this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Core\\Environment', 'getCurrentScript');
        }
        if ('PATH_site' === $constantName) {
            return new \PhpParser\Node\Expr\BinaryOp\Concat($this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Core\\Environment', 'getPublicPath'), new \PhpParser\Node\Scalar\String_('/'));
        }
        if ('PATH_typo3' === $constantName) {
            return $this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Core\\Environment', 'getBackendPath');
        }
        if ('PATH_typo3conf' === $constantName) {
            return $this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Core\\Environment', 'getLegacyConfigPath');
        }
        return new \PhpParser\Node\Expr\BinaryOp\BooleanOr($this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Core\\Environment', 'isUnix'), $this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Core\\Environment', 'isWindows'));
    }
}
