...
use RectorPrefix20210518\TYPO3\CMS\Frontend\Page\PageRepository;
/**
...
final class UseContextApiForVersioningWorkspaceIdRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        return $this->nodeFactory->createMethodCall($this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Utility\\GeneralUtility', 'makeInstance', [$this->nodeFactory->createClassConstReference('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Context\\Context')]), 'getPropertyFromAspect', ['workspace', 'id', 0]);
    }
    /**
     * @codeCoverageIgnore
     */
...
CODE_SAMPLE
    ...
    private function shouldSkip(\PhpParser\Node\Expr\PropertyFetch $node) : bool
    {
        ...
        if ($this->isObjectType($node->var, new \PHPStan\Type\ObjectType('RectorPrefix20210518\\TYPO3\\CMS\\Frontend\\Page\\PageRepository'))) {
            return \false;
        }
