...
final class MoveRenderArgumentsToInitializeArgumentsMethodRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        $desiredObjectTypes = [new \PHPStan\Type\ObjectType('RectorPrefix20210518\\TYPO3Fluid\\Fluid\\Core\\ViewHelper\\AbstractViewHelper'), new \PHPStan\Type\ObjectType('RectorPrefix20210518\\TYPO3\\CMS\\Fluid\\Core\\ViewHelper\\AbstractViewHelper')];
