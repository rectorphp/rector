...
CODE_SAMPLE
    ...
    private function resolveExtensionKeyByComposerJson(\Symplify\SmartFileSystem\SmartFileInfo $extEmConf) : ?string
    {
        try {
            ...
            $json = \RectorPrefix20220602\Nette\Utils\Json::decode($composerJson->getContents(), \RectorPrefix20220602\Nette\Utils\Json::FORCE_ARRAY);
        ...
        } catch (\RectorPrefix20220602\Symplify\SmartFileSystem\Exception\FileNotFoundException $exception) {
            return null;
        }
        return null;
    }
