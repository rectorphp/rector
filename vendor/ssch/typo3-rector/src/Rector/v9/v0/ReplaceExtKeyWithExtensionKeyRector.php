...
CODE_SAMPLE
    ...
    private function resolveExtensionKeyByComposerJson(\Symplify\SmartFileSystem\SmartFileInfo $extEmConf) : ?string
    {
        try {
            ...
            $json = \RectorPrefix20220504\Nette\Utils\Json::decode($composerJson->getContents(), \RectorPrefix20220504\Nette\Utils\Json::FORCE_ARRAY);
        ...
        } catch (\RectorPrefix20220504\Symplify\SmartFileSystem\Exception\FileNotFoundException $exception) {
            return null;
        }
        return null;
    }
