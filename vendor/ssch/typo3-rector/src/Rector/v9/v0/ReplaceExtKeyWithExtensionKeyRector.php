...
CODE_SAMPLE
    ...
    private function resolveExtensionKeyByComposerJson(\Symplify\SmartFileSystem\SmartFileInfo $extEmConf) : ?string
    {
        try {
            ...
            $json = \RectorPrefix20220521\Nette\Utils\Json::decode($composerJson->getContents(), \RectorPrefix20220521\Nette\Utils\Json::FORCE_ARRAY);
        ...
        } catch (\RectorPrefix20220521\Symplify\SmartFileSystem\Exception\FileNotFoundException $exception) {
            return null;
        }
        return null;
    }
