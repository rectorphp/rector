...
CODE_SAMPLE
    ...
    private function resolveExtensionKeyByComposerJson(\Symplify\SmartFileSystem\SmartFileInfo $extEmConf) : ?string
    {
        try {
            ...
            $json = \RectorPrefix20220522\Nette\Utils\Json::decode($composerJson->getContents(), \RectorPrefix20220522\Nette\Utils\Json::FORCE_ARRAY);
        ...
        } catch (\RectorPrefix20220522\Symplify\SmartFileSystem\Exception\FileNotFoundException $exception) {
            return null;
        }
        return null;
    }
