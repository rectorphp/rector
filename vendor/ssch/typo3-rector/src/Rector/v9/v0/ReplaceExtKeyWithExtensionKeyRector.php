...
CODE_SAMPLE
    ...
    private function resolveExtensionKeyByComposerJson(\Symplify\SmartFileSystem\SmartFileInfo $extEmConf) : ?string
    {
        try {
            ...
            $json = \RectorPrefix20220507\Nette\Utils\Json::decode($composerJson->getContents(), \RectorPrefix20220507\Nette\Utils\Json::FORCE_ARRAY);
        ...
        } catch (\RectorPrefix20220507\Symplify\SmartFileSystem\Exception\FileNotFoundException $exception) {
            return null;
        }
        return null;
    }
