...
final class InjectAnnotationRector extends \Rector\Core\Rector\AbstractRector
{
     ...
     * @var string
     */
    private const NEW_ANNOTATION = 'RectorPrefix20210518\\TYPO3\\CMS\\Extbase\\Annotation\\Inject';
    /**
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        foreach ($properties as $property) {
            ...
            $paramBuilder = new \RectorPrefix20210518\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder($variableName);
...
CODE_SAMPLE
    ...
    private function createInjectClassMethod(string $variableName, \PhpParser\Node\Param $param, \PhpParser\Node\Expr\Assign $assign) : \PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $injectMethodBuilder = new \RectorPrefix20210518\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder($injectMethodName);
