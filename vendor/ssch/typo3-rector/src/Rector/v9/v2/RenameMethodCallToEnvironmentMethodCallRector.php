...
CODE_SAMPLE
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        if ('TYPO3\\CMS\\Core\\Core\\Bootstrap' === $className && 'usesComposerClassLoading' === $methodName) {
            return $this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Core\\Environment', 'isComposerMode');
        }
        if ('TYPO3\\CMS\\Core\\Utility\\GeneralUtility' === $className && 'getApplicationContext' === $methodName) {
            return $this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Core\\Environment', 'getContext');
        }
