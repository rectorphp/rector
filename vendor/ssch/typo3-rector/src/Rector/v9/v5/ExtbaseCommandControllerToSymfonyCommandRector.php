...
final class ExtbaseCommandControllerToSymfonyCommandRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        foreach ($commandMethods as $commandMethod) {
            ...
            $commandName = \RectorPrefix20211001\Nette\Utils\Strings::firstUpper($commandMethodName);
            ...
            $newCommandName = \sprintf('%s:%s', \RectorPrefix20211001\Nette\Utils\Strings::lower($vendorName), \RectorPrefix20211001\Nette\Utils\Strings::lower($commandName));
