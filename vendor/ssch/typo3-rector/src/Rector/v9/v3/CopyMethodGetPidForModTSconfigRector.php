...
final class CopyMethodGetPidForModTSconfigRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        return new \PhpParser\Node\Expr\Ternary(new \PhpParser\Node\Expr\BinaryOp\BooleanAnd(new \PhpParser\Node\Expr\BinaryOp\Identical($tableVariableNode, new \PhpParser\Node\Scalar\String_('pages')), $this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Utility\\MathUtility', 'canBeInterpretedAsInteger', [$node->args[1]])), $node->args[1]->value, $node->args[2]->value);
    }
    /**
     * @codeCoverageIgnore
     */
