...
CODE_SAMPLE
    ...
    {
        return new \PhpParser\Node\Expr\BinaryOp\Concat(new \PhpParser\Node\Expr\BinaryOp\Concat($this->nodeFactory->createMethodCall($this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Utility\\GeneralUtility', 'makeInstance', [$this->nodeFactory->createClassConstReference('RectorPrefix20210518\\TYPO3\\CMS\\Backend\\Routing\\UriBuilder')]), 'buildUriFromRoute', [$this->nodeFactory->createArg('record_edit')]), $firstArgument->value), new \PhpParser\Node\Scalar\String_('&returnUrl='));
    }
    private function createRequestUriCall() : \PhpParser\Node\Expr\FuncCall
    {
        return new \PhpParser\Node\Expr\FuncCall(new \PhpParser\Node\Name('rawurlencode'), [$this->nodeFactory->createArg($this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Utility\\GeneralUtility', 'getIndpEnv', [$this->nodeFactory->createArg('REQUEST_URI')]))]);
    }
}
