...
final class RemoveFormatConstantsEmailFinisherRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!$this->isObjectType($node->class, new \PHPStan\Type\ObjectType('RectorPrefix20210518\\TYPO3\\CMS\\Form\\Domain\\Finishers\\EmailFinisher'))) {
            return null;
        }
    ...
    {
        return new \Symplify\RuleDocGenerator\ValueObject\RuleDefinition('RectorPrefix20210518\\Remove constants FORMAT_PLAINTEXT and FORMAT_HTML of class TYPO3\\CMS\\Form\\Domain\\Finishers\\EmailFinisher', [new \Symplify\RuleDocGenerator\ValueObject\CodeSample\CodeSample(<<<'CODE_SAMPLE'
