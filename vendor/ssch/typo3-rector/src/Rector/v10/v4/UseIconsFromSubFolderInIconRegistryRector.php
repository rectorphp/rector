...
final class UseIconsFromSubFolderInIconRegistryRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        $options[self::SOURCE] = \RectorPrefix20220313\Nette\Utils\Strings::replace($options[self::SOURCE], '#typo3/sysext/core/Resources/Public/Icons/T3Icons/content/#i', 'typo3/sysext/core/Resources/Public/Icons/T3Icons/svgs/content/');
