...
use RectorPrefix20210518\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder;
use RectorPrefix20210518\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder;
use RectorPrefix20210518\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder;
...
final class InjectEnvironmentServiceIfNeededInResponseRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!$this->isObjectType($node, new \PHPStan\Type\ObjectType('RectorPrefix20210518\\TYPO3\\CMS\\Extbase\\Mvc\\Web\\Response'))) {
            return null;
        }
...
CODE_SAMPLE
    ...
    {
        $propertyBuilder = new \RectorPrefix20210518\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder(self::ENVIRONMENT_SERVICE);
        $propertyBuilder->makeProtected();
        $type = new \Rector\StaticTypeMapper\ValueObject\Type\FullyQualifiedObjectType('RectorPrefix20210518\\TYPO3\\CMS\\Extbase\\Service\\EnvironmentService');
    ...
    {
        $paramBuilder = new \RectorPrefix20210518\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder(self::ENVIRONMENT_SERVICE);
        $paramBuilder->setType(new \PhpParser\Node\Name\FullyQualified('RectorPrefix20210518\\TYPO3\\CMS\\Extbase\\Service\\EnvironmentService'));
        ...
        $classMethodBuilder = new \RectorPrefix20210518\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('injectEnvironmentService');
