...
CODE_SAMPLE
    ...
    {
        $propertyBuilder = new \RectorPrefix20220408\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder(self::ENVIRONMENT_SERVICE);
    ...
    {
        $paramBuilder = new \RectorPrefix20220408\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder(self::ENVIRONMENT_SERVICE);
        ...
        $classMethodBuilder = new \RectorPrefix20220408\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('injectEnvironmentService');
