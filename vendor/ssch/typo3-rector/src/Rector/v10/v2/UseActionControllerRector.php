...
final class UseActionControllerRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        if (!$this->isName($node->extends, 'RectorPrefix20210518\\TYPO3\\CMS\\Extbase\\Mvc\\Controller\\AbstractController')) {
            return null;
        }
        $node->extends = new \PhpParser\Node\Name\FullyQualified('RectorPrefix20210518\\TYPO3\\CMS\\Extbase\\Mvc\\Controller\\ActionController');
        return $node;
    }
    /**
     * @codeCoverageIgnore
