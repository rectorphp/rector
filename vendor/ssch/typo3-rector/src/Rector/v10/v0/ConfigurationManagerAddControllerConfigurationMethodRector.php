...
CODE_SAMPLE
    ...
    private function addMethodGetControllerConfiguration(\PhpParser\Node\Stmt\Class_ $class) : void
    {
        $methodBuilder = new \RectorPrefix20220531\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('getControllerConfiguration');
        $methodBuilder->makeProtected();
        $methodBuilder->addParams([(new \RectorPrefix20220531\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('extensionName'))->getNode(), (new \RectorPrefix20220531\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('pluginName'))->getNode()]);
