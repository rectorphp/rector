...
final class UseClassTypo3InformationRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        if ('TYPO3_URL_GENERAL' === $nodeName) {
            return $this->nodeFactory->createClassConstFetch('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Information\\Typo3Information', 'URL_COMMUNITY');
        }
        if ('TYPO3_URL_LICENSE' === $nodeName) {
            return $this->nodeFactory->createClassConstFetch('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Information\\Typo3Information', 'URL_LICENSE');
        }
        if ('TYPO3_URL_EXCEPTION' === $nodeName) {
            return $this->nodeFactory->createClassConstFetch('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Information\\Typo3Information', 'URL_EXCEPTION');
        }
        if ('TYPO3_URL_DONATE' === $nodeName) {
            return $this->nodeFactory->createClassConstFetch('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Information\\Typo3Information', 'URL_DONATE');
        }
        if ('TYPO3_URL_WIKI_OPCODECACHE' === $nodeName) {
            return $this->nodeFactory->createClassConstFetch('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Information\\Typo3Information', 'URL_OPCACHE');
        }
        return null;
    }
    /**
