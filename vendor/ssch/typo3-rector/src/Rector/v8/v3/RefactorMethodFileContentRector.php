...
use RectorPrefix20210518\TYPO3\CMS\Core\TypoScript\TemplateService;
/**
...
CODE_SAMPLE
    ...
    {
        if ($this->isObjectType($node->var, new \PHPStan\Type\ObjectType('RectorPrefix20210518\\TYPO3\\CMS\\Core\\TypoScript\\TemplateService'))) {
            return \false;
        }
