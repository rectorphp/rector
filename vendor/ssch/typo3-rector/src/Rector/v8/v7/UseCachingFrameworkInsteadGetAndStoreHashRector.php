...
CODE_SAMPLE
    ...
    private function shouldSkip(\PhpParser\Node $node) : bool
    {
        ...
        return !$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($node, new \PHPStan\Type\ObjectType('RectorPrefix20210518\\TYPO3\\CMS\\Frontend\\Page\\PageRepository'));
    }
    private function createCacheManager() : \PhpParser\Node\Expr\MethodCall
    {
        return $this->nodeFactory->createMethodCall($this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Utility\\GeneralUtility', 'makeInstance', [$this->nodeFactory->createClassConstReference('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Cache\\CacheManager')]), 'getCache', [new \PhpParser\Node\Scalar\String_('cache_hash')]);
    }
}
