...
final class RefactorRemovedMarkerMethodsFromContentObjectRendererRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($node, new \PHPStan\Type\ObjectType('RectorPrefix20210518\\TYPO3\\CMS\\Frontend\\ContentObject\\ContentObjectRenderer'))) {
            return null;
        }
        ...
        if ($this->isName($node->name, self::FILL_IN_MARKER_ARRAY)) {
            ...
            return $this->nodeFactory->createMethodCall($this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Utility\\GeneralUtility', 'makeInstance', [$this->nodeFactory->createClassConstReference('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Service\\MarkerBasedTemplateService')]), self::FILL_IN_MARKER_ARRAY, $node->args);
        }
        return null;
    }
    /**
