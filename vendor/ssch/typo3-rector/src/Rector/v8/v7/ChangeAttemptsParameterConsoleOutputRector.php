...
final class ChangeAttemptsParameterConsoleOutputRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    {
        if (!$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($node, new \PHPStan\Type\ObjectType('RectorPrefix20210518\\TYPO3\\CMS\\Extbase\\Mvc\\Cli\\ConsoleOutput'))) {
            return null;
        }
