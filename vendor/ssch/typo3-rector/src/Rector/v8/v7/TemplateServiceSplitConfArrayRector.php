...
final class TemplateServiceSplitConfArrayRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Substitute TemplateService->splitConfArray() with TypoScriptService->explodeConfigurationForOptionSplit()', [new CodeSample(<<<'CODE_SAMPLE'
