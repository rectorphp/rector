...
CODE_SAMPLE
    ...
    {
        $paramBuilder = new \RectorPrefix20220524\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder(self::COBJ);
        ...
        $classMethodBuilder = new \RectorPrefix20220524\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('setContentObjectRenderer');
