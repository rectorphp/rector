...
CODE_SAMPLE
    ...
    {
        $paramBuilder = new \RectorPrefix20211120\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder(self::COBJ);
        ...
        $classMethodBuilder = new \RectorPrefix20211120\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('setContentObjectRenderer');
