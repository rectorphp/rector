...
CODE_SAMPLE
    ...
    {
        $paramBuilder = new \RectorPrefix20211114\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder(self::COBJ);
        ...
        $classMethodBuilder = new \RectorPrefix20211114\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('setContentObjectRenderer');
