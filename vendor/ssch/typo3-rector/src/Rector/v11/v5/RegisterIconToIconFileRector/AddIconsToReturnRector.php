...
, [self::ICON_IDENTIFIER => 'my-icon', self::ICON_CONFIGURATION => ['provider' => \stdClass::class, 'source' => 'mysvg.svg']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220422\Webmozart\Assert\Assert::stringNotEmpty($iconIdentifier);
        \RectorPrefix20220422\Webmozart\Assert\Assert::isArray($iconConfiguration);
        \RectorPrefix20220422\Webmozart\Assert\Assert::keyExists($iconConfiguration, 'provider');
