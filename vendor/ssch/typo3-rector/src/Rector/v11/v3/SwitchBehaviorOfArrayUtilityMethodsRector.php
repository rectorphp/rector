...
final class SwitchBehaviorOfArrayUtilityMethodsRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Handles the methods arrayDiffAssocRecursive() and arrayDiffKeyRecursive() of ArrayUtility', [new CodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    {
        if (!$this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType($staticCall, new ObjectType('TYPO3\\CMS\\Core\\Utility\\ArrayUtility'))) {
            return \true;
        }
