...
final class GetClickMenuOnIconTagParametersRector extends \Rector\Core\Rector\AbstractRector
{
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        return $this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Backend\\Utility\\BackendUtility', 'getClickMenuOnIconTagParameters', [$node->args[0], $node->args[1], $node->args[2]]);
    }
    /**
     * @codeCoverageIgnore
     */
