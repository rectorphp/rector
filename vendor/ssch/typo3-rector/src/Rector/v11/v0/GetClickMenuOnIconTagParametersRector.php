...
final class GetClickMenuOnIconTagParametersRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Use BackendUtility::getClickMenuOnIconTagParameters() instead BackendUtility::wrapClickMenuOnIcon() if needed', [new CodeSample(<<<'CODE_SAMPLE'
