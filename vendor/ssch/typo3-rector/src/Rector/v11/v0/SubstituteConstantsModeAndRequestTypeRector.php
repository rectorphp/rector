...
CODE_SAMPLE
    ...
    {
        return $this->nodeFactory->createMethodCall($this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Http\\ApplicationType', 'fromRequest', $arguments), 'isBackend');
    }
    /**
     * @param Expr[] $arguments
     */
    ...
    {
        return $this->nodeFactory->createMethodCall($this->nodeFactory->createStaticCall('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Http\\ApplicationType', 'fromRequest', $arguments), 'isFrontend');
    }
}
