...
trait FileHelperTrait
{
    ...
    {
        return \RectorPrefix20210518\Nette\Utils\Strings::endsWith($fileInfo->getFilename(), 'ext_localconf.php');
    }
    private function isExtTables(\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : bool
    {
        return \RectorPrefix20210518\Nette\Utils\Strings::endsWith($fileInfo->getFilename(), 'ext_tables.php');
    }
    private function isExtEmconf(\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : bool
    {
        return \RectorPrefix20210518\Nette\Utils\Strings::endsWith($fileInfo->getFilename(), 'ext_emconf.php');
    }
}
