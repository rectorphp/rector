...
final class CommandMethodDecorator
{
     ...
     */
    private const MODE_MAPPING = [\RectorPrefix20220603\Symfony\Component\Console\Input\InputArgument::OPTIONAL => 'OPTIONAL', \RectorPrefix20220603\Symfony\Component\Console\Input\InputArgument::REQUIRED => 'REQUIRED'];
    /**
     * @readonly
