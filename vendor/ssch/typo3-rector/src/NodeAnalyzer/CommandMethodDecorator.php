...
final class CommandMethodDecorator
{
     ...
     */
    private const MODE_MAPPING = [\RectorPrefix20220605\Symfony\Component\Console\Input\InputArgument::OPTIONAL => 'OPTIONAL', \RectorPrefix20220605\Symfony\Component\Console\Input\InputArgument::REQUIRED => 'REQUIRED'];
    /**
     * @readonly
