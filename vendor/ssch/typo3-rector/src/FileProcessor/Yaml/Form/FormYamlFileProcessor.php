...
use RectorPrefix20220208\Symfony\Component\Yaml\Yaml;
/**
...
final class FormYamlFileProcessor implements \Rector\Core\Contract\Processor\FileProcessorInterface
{
    ...
    public function process(\Rector\Core\ValueObject\Application\File $file, \Rector\Core\ValueObject\Configuration $configuration) : array
    {
        ...
        $yaml = \RectorPrefix20220208\Symfony\Component\Yaml\Yaml::parse($oldYamlContent);
        if (!\is_array($yaml)) {
        ...
        $newFileContent = \RectorPrefix20220208\Symfony\Component\Yaml\Yaml::dump($newYaml, 99, $spaceCount);
