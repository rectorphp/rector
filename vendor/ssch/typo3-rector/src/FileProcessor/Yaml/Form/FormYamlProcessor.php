...
final class FormYamlProcessor implements \Rector\Core\Contract\Processor\FileProcessorInterface
{
    ...
    public function supports(\Rector\Core\ValueObject\Application\File $file) : bool
    {
        ...
        return \RectorPrefix20210530\Nette\Utils\Strings::endsWith($smartFileInfo->getFilename(), 'form.yaml');
    }
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file) : void
    {
        ...
        $smartFileInfo = $file->getSmartFileInfo();
        $yaml = \RectorPrefix20210530\Symfony\Component\Yaml\Yaml::parseFile($smartFileInfo->getRealPath());
        if (!\is_array($yaml)) {
            return;
        }
        $newYaml = $yaml;
        ...
        $newFileContent = \RectorPrefix20210530\Symfony\Component\Yaml\Yaml::dump($newYaml, 99);
