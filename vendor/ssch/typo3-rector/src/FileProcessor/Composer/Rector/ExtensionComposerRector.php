...
final class ExtensionComposerRector implements \Rector\Composer\Contract\Rector\ComposerRectorInterface
{
    ...
    public function refactor(\RectorPrefix20220604\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
...
, [self::TYPO3_VERSION_CONSTRAINT => '^10.4'])]);
    ...
    private function addExtensionKey(\RectorPrefix20220604\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
    ...
    private function addDescription(\RectorPrefix20220604\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
    ...
    private function addLicense(\RectorPrefix20220604\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
    ...
    private function fixPackageName(\RectorPrefix20220604\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
