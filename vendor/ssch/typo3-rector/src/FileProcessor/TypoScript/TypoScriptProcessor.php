...
use RectorPrefix20210628\Helmich\TypoScriptParser\Parser\ParseError;
use RectorPrefix20210628\Helmich\TypoScriptParser\Parser\ParserInterface;
use RectorPrefix20210628\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface;
use RectorPrefix20210628\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration;
use RectorPrefix20210628\Helmich\TypoScriptParser\Parser\Traverser\Traverser;
use RectorPrefix20210628\Helmich\TypoScriptParser\Parser\Traverser\Visitor;
use RectorPrefix20210628\Helmich\TypoScriptParser\Tokenizer\TokenizerException;
...
final class TypoScriptProcessor implements \Ssch\TYPO3Rector\Contract\Processor\ConfigurableProcessorInterface
{
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file) : void
    {
        try {
            ...
            $prettyPrinterConfiguration = \RectorPrefix20210628\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration::create();
