...
final class AdditionalHeadersToArrayVisitor extends \Ssch\TYPO3Rector\FileProcessor\TypoScript\Visitors\AbstractVisitor
{
     ...
     */
    private $builder;
    public function __construct(\RectorPrefix20210626\Helmich\TypoScriptParser\Parser\AST\Builder $builder)
    {
    ...
    public function enterNode(\RectorPrefix20210626\Helmich\TypoScriptParser\Parser\AST\Statement $statement) : void
    {
        ...
        if (!\RectorPrefix20210626\Nette\Utils\Strings::startsWith($statement->object->relativeName, 'additionalHeaders')) {
            return;
        }
        $this->hasChanged = \true;
