...
use RectorPrefix20210618\Helmich\TypoScriptParser\Parser\AST\Scalar as ScalarValue;
...
use RectorPrefix20210618\Symfony\Component\VarExporter\VarExporter;
...
final class ExtbasePersistenceVisitor extends \Ssch\TYPO3Rector\FileProcessor\TypoScript\Visitors\AbstractVisitor implements \Ssch\TYPO3Rector\Contract\FileProcessor\TypoScript\ConvertToPhpFileInterface, \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    {
        if (!$statement instanceof \RectorPrefix20210618\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment) {
            return;
        }
        if (!\RectorPrefix20210618\Nette\Utils\Strings::contains($statement->object->absoluteName, 'persistence.classes')) {
            return;
        }
...
, [self::FILENAME => 'path/to/Configuration/Extbase/Persistence/Classes.php'])]);
    ...
    public function convert() : ?\Rector\FileSystemRector\ValueObject\AddedFileWithContent
    {
        ...
        $content = \str_replace('__PERSISTENCE_ARRAY__', \RectorPrefix20210618\Symfony\Component\VarExporter\VarExporter::export(self::$persistenceArray), $this->fileTemplate->getContents());
     ...
     * @param string[] $paths
     */
    private function extractSubClasses(array $paths, \RectorPrefix20210618\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement) : void
    {
     ...
     * @param string[] $paths
     */
    private function extractMapping(string $name, array $paths, \RectorPrefix20210618\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement) : void
    {
     ...
     * @param string[] $paths
     */
    private function extractColumns(array $paths, \RectorPrefix20210618\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement) : void
    {
