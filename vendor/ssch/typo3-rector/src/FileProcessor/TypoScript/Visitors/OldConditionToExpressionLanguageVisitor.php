...
final class OldConditionToExpressionLanguageVisitor extends \Ssch\TYPO3Rector\FileProcessor\TypoScript\Visitors\AbstractVisitor
{
    ...
    public function enterNode(\RectorPrefix20210620\Helmich\TypoScriptParser\Parser\AST\Statement $statement) : void
    {
        if (!$statement instanceof \RectorPrefix20210620\Helmich\TypoScriptParser\Parser\AST\ConditionalStatement) {
            return;
        }
