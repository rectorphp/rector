...
use RectorPrefix20220327\Helmich\TypoScriptParser\Parser\ParseError;
...
use RectorPrefix20220327\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration;
use Helmich\TypoScriptParser\Parser\Traverser\Traverser;
use RectorPrefix20220327\Helmich\TypoScriptParser\Parser\Traverser\Visitor;
use RectorPrefix20220327\Helmich\TypoScriptParser\Tokenizer\TokenizerException;
...
final class TypoScriptFileProcessor implements \Ssch\TYPO3Rector\Contract\Processor\ConfigurableProcessorInterface
{
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220327\Webmozart\Assert\Assert::isArray($allowedFileExtensions);
        \RectorPrefix20220327\Webmozart\Assert\Assert::allString($allowedFileExtensions);
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file) : void
    {
        try {
            ...
            $prettyPrinterConfiguration = \RectorPrefix20220327\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration::create();
        ...
        } catch (\RectorPrefix20220327\Helmich\TypoScriptParser\Tokenizer\TokenizerException $exception) {
            return;
        } catch (\RectorPrefix20220327\Helmich\TypoScriptParser\Parser\ParseError $exception) {
            $smartFileInfo = $file->getSmartFileInfo();
    ...
    {
        return \array_filter($this->typoScriptRectors, function (\RectorPrefix20220327\Helmich\TypoScriptParser\Parser\Traverser\Visitor $visitor) : bool {
