...
use RectorPrefix20220126\Helmich\TypoScriptParser\Parser\ParseError;
...
use RectorPrefix20220126\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration;
...
final class TypoScriptFileProcessor implements \Ssch\TYPO3Rector\Contract\Processor\ConfigurableProcessorInterface
{
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220126\Webmozart\Assert\Assert::isArray($allowedFileExtensions);
        \RectorPrefix20220126\Webmozart\Assert\Assert::allString($allowedFileExtensions);
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file) : void
    {
        try {
            ...
            $prettyPrinterConfiguration = \RectorPrefix20220126\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration::create();
    ...
    {
        return \array_filter($this->typoScriptRectors, function (\RectorPrefix20220126\Helmich\TypoScriptParser\Parser\Traverser\Visitor $visitor) : bool {
