...
use RectorPrefix20211220\Helmich\TypoScriptParser\Parser\ParseError;
...
use RectorPrefix20211220\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration;
use Helmich\TypoScriptParser\Parser\Traverser\Traverser;
use RectorPrefix20211220\Helmich\TypoScriptParser\Parser\Traverser\Visitor;
use RectorPrefix20211220\Helmich\TypoScriptParser\Tokenizer\TokenizerException;
...
final class TypoScriptFileProcessor implements \Ssch\TYPO3Rector\Contract\Processor\ConfigurableProcessorInterface
{
     ...
     */
    public function __construct(\RectorPrefix20211220\Helmich\TypoScriptParser\Parser\ParserInterface $typoscriptParser, \RectorPrefix20211220\Symfony\Component\Console\Output\BufferedOutput $output, \RectorPrefix20211220\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface $typoscriptPrinter, \Rector\Core\Provider\CurrentFileProvider $currentFileProvider, \Rector\FileFormatter\EditorConfig\EditorConfigParser $editorConfigParser, \Rector\Core\Application\FileSystem\RemovedAndAddedFilesCollector $removedAndAddedFilesCollector, \Rector\Core\Console\Output\RectorOutputStyle $rectorOutputStyle, array $typoScriptRectors = [])
    {
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211220\Webmozart\Assert\Assert::isArray($allowedFileExtensions);
        \RectorPrefix20211220\Webmozart\Assert\Assert::allString($allowedFileExtensions);
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file) : void
    {
        try {
            ...
            $prettyPrinterConfiguration = \RectorPrefix20211220\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration::create();
        ...
        } catch (\RectorPrefix20211220\Helmich\TypoScriptParser\Tokenizer\TokenizerException $exception) {
            return;
        } catch (\RectorPrefix20211220\Helmich\TypoScriptParser\Parser\ParseError $exception) {
            $smartFileInfo = $file->getSmartFileInfo();
    ...
    {
        return \array_filter($this->typoScriptRectors, function (\RectorPrefix20211220\Helmich\TypoScriptParser\Parser\Traverser\Visitor $visitor) : bool {
