...
use RectorPrefix20210813\Helmich\TypoScriptParser\Parser\ParseError;
...
use RectorPrefix20210813\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration;
use RectorPrefix20210813\Helmich\TypoScriptParser\Parser\Traverser\Traverser;
use RectorPrefix20210813\Helmich\TypoScriptParser\Parser\Traverser\Visitor;
use RectorPrefix20210813\Helmich\TypoScriptParser\Tokenizer\TokenizerException;
...
final class TypoScriptFileProcessor implements \Ssch\TYPO3Rector\Contract\Processor\ConfigurableProcessorInterface
{
     ...
     */
    public function __construct(\RectorPrefix20210813\Helmich\TypoScriptParser\Parser\ParserInterface $typoscriptParser, \RectorPrefix20210813\Symfony\Component\Console\Output\BufferedOutput $output, \RectorPrefix20210813\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface $typoscriptPrinter, \Rector\Core\Provider\CurrentFileProvider $currentFileProvider, \Rector\FileFormatter\EditorConfig\EditorConfigParser $editorConfigParser, \Rector\Core\Application\FileSystem\RemovedAndAddedFilesCollector $removedAndAddedFilesCollector, \Rector\Core\Console\Output\RectorOutputStyle $rectorOutputStyle, array $typoScriptRectors = [])
    {
    ...
    private function processFile(\Rector\Core\ValueObject\Application\File $file) : void
    {
        try {
            ...
            $traverser = new \RectorPrefix20210813\Helmich\TypoScriptParser\Parser\Traverser\Traverser($originalStatements);
            ...
            $prettyPrinterConfiguration = \RectorPrefix20210813\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinterConfiguration::create();
        ...
        } catch (\RectorPrefix20210813\Helmich\TypoScriptParser\Tokenizer\TokenizerException $exception) {
            return;
        } catch (\RectorPrefix20210813\Helmich\TypoScriptParser\Parser\ParseError $exception) {
            $smartFileInfo = $file->getSmartFileInfo();
    ...
    {
        return \array_filter($this->typoScriptRectors, function (\RectorPrefix20210813\Helmich\TypoScriptParser\Parser\Traverser\Visitor $visitor) : bool {
