...
final class LibFluidContentToLibContentElementRector extends \Ssch\TYPO3Rector\FileProcessor\TypoScript\Rector\AbstractTypoScriptRector
{
    ...
    {
        if (!\is_a($statement, \RectorPrefix20220503\Helmich\TypoScriptParser\Parser\AST\NestedAssignment::class) && !\is_a($statement, \RectorPrefix20220503\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment::class)) {
            return;
        }
