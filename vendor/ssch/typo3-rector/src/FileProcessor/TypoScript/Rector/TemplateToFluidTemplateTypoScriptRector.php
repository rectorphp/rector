...
use RectorPrefix20220519\Helmich\TypoScriptParser\Parser\AST\Operator\ObjectCreation;
use RectorPrefix20220519\Helmich\TypoScriptParser\Parser\AST\Scalar;
...
final class TemplateToFluidTemplateTypoScriptRector extends \Ssch\TYPO3Rector\FileProcessor\TypoScript\Rector\AbstractTypoScriptRector
{
    ...
    {
        if (!$statement instanceof \RectorPrefix20220519\Helmich\TypoScriptParser\Parser\AST\Operator\ObjectCreation) {
            return;
        }
        if (!$statement->value instanceof \RectorPrefix20220519\Helmich\TypoScriptParser\Parser\AST\Scalar) {
            return;
        }
