...
use RectorPrefix20220604\Helmich\TypoScriptParser\Parser\AST\Operator\ObjectCreation;
...
final class TemplateToFluidTemplateTypoScriptRector extends \Ssch\TYPO3Rector\FileProcessor\TypoScript\Rector\AbstractTypoScriptRector
{
    ...
    {
        if (!$statement instanceof \RectorPrefix20220604\Helmich\TypoScriptParser\Parser\AST\Operator\ObjectCreation) {
            return;
        }
        if (!$statement->value instanceof \RectorPrefix20220604\Helmich\TypoScriptParser\Parser\AST\Scalar) {
            return;
        }
