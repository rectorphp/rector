...
use RectorPrefix20220209\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment;
...
final class AdditionalHeadersToArrayTypoScriptRector extends \Ssch\TYPO3Rector\FileProcessor\TypoScript\Rector\AbstractTypoScriptRector
{
    ...
    {
        if (!$statement instanceof \RectorPrefix20220209\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment) {
            return;
        }
