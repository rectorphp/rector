...
final class AdditionalHeadersToArrayTypoScriptRector extends \Ssch\TYPO3Rector\FileProcessor\TypoScript\Rector\AbstractTypoScriptRector
{
    ...
    {
        if (!$statement instanceof \RectorPrefix20210706\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment) {
            return;
        }
        if (!\RectorPrefix20210706\Nette\Utils\Strings::startsWith($statement->object->relativeName, 'additionalHeaders')) {
            return;
        }
        $this->hasChanged = \true;
