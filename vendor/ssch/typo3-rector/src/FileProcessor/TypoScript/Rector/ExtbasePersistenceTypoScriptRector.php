...
use RectorPrefix20220130\Helmich\TypoScriptParser\Parser\AST\Scalar as ScalarValue;
...
, [self::FILENAME => 'path/to/Configuration/Extbase/Persistence/Classes.php'])]);
    ...
    public function convert() : ?\Rector\FileSystemRector\ValueObject\AddedFileWithContent
    {
        ...
        $content = \RectorPrefix20220130\Nette\Utils\Strings::replace($content, self::REMOVE_EMPTY_LINES, '');
     ...
     * @param string[] $paths
     */
    private function extractSubClasses(array $paths, \RectorPrefix20220130\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement) : void
    {
     ...
     * @param string[] $paths
     */
    private function extractMapping(string $name, array $paths, \RectorPrefix20220130\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement) : void
    {
     ...
     * @param string[] $paths
     */
    private function extractColumns(array $paths, \RectorPrefix20220130\Helmich\TypoScriptParser\Parser\AST\Operator\Assignment $statement) : void
    {
