...
final class IconsFileProcessor implements \Rector\Core\Contract\Processor\FileProcessorInterface
{
     ...
     */
    public function __construct(\Ssch\TYPO3Rector\Helper\FilesFinder $filesFinder, \RectorPrefix20210717\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, array $iconsRector)
    {
    ...
    public function supports($file, $configuration) : bool
    {
        ...
        if (!\RectorPrefix20210717\Nette\Utils\Strings::contains($smartFileInfo->getFilename(), 'ext_icon')) {
            return \false;
        }
