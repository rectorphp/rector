...
use RectorPrefix20211003\TYPO3\CMS\Core\Cache\CacheManager;
...
class PageRepository
{
    ...
    {
        \RectorPrefix20211003\TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Core\\Cache\\CacheManager')->getCache('cache_hash')->get($hash) !== null ? \RectorPrefix20211003\TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Core\\Cache\\CacheManager')->getCache('cache_hash')->get($hash) : null;
    }
}
