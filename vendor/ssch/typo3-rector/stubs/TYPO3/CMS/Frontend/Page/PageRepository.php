...
use RectorPrefix20210729\TYPO3\CMS\Core\Cache\CacheManager;
...
class PageRepository
{
    ...
    {
        \RectorPrefix20210729\TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Core\\Cache\\CacheManager')->getCache('cache_hash')->get($hash) !== null ? \RectorPrefix20210729\TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('TYPO3\\CMS\\Core\\Cache\\CacheManager')->getCache('cache_hash')->get($hash) : null;
    }
}
