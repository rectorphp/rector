...
use RectorPrefix20210821\TYPO3\CMS\Core\Charset\CharsetConverter;
use RectorPrefix20210821\TYPO3\CMS\Core\Context\Context;
...
use RectorPrefix20210821\TYPO3\CMS\Frontend\Authentication\FrontendUserAuthentication;
...
class TypoScriptFrontendController
{
    ...
    public function __construct()
    {
        ...
        $this->tmpl = new \RectorPrefix20210821\TYPO3\CMS\Core\TypoScript\TemplateService();
        $this->sys_page = new \RectorPrefix20210821\TYPO3\CMS\Frontend\Page\PageRepository();
        $this->language = new \RectorPrefix20210821\TYPO3\CMS\Core\Site\Entity\SiteLanguage();
        $this->sys_language_isocode = 'ch';
        $this->csConvObj = new \RectorPrefix20210821\TYPO3\CMS\Core\Charset\CharsetConverter();
        $this->cObj = new \RectorPrefix20210821\TYPO3\CMS\Frontend\ContentObject\ContentObjectRenderer();
        $this->fe_user = new \RectorPrefix20210821\TYPO3\CMS\Frontend\Authentication\FrontendUserAuthentication();
    }
    /**
     * @return void
