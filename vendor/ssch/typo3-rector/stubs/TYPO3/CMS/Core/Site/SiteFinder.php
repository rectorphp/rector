...
namespace RectorPrefix20211011\TYPO3\CMS\Core\Site;

use RectorPrefix20211011\TYPO3\CMS\Core\Site\Entity\Site;
...
class SiteFinder
{
    ...
    public function getSiteByPageId($pageId, $rootLine = null, $mountPointParameter = null)
    {
        ...
        return new \RectorPrefix20211011\TYPO3\CMS\Core\Site\Entity\Site();
    }
}
