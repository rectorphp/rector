...
namespace RectorPrefix20210709\TYPO3\CMS\Core\Site;

use RectorPrefix20210709\TYPO3\CMS\Core\Site\Entity\Site;
...
class SiteFinder
{
    ...
    public function getSiteByPageId($pageId, $rootLine = null, $mountPointParameter = null)
    {
        ...
        return new \RectorPrefix20210709\TYPO3\CMS\Core\Site\Entity\Site();
    }
}
