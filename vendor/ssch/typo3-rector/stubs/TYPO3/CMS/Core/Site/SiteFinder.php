...
namespace RectorPrefix20210702\TYPO3\CMS\Core\Site;

use RectorPrefix20210702\TYPO3\CMS\Core\Site\Entity\Site;
...
class SiteFinder
{
    ...
    public function getSiteByPageId($pageId, array $rootLine = null, $mountPointParameter = null)
    {
        ...
        return new \RectorPrefix20210702\TYPO3\CMS\Core\Site\Entity\Site();
    }
}
