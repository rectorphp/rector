...
namespace RectorPrefix20210922\TYPO3\CMS\Core\Site;

use RectorPrefix20210922\TYPO3\CMS\Core\Site\Entity\Site;
...
class SiteFinder
{
    ...
    public function getSiteByPageId($pageId, $rootLine = null, $mountPointParameter = null)
    {
        ...
        return new \RectorPrefix20210922\TYPO3\CMS\Core\Site\Entity\Site();
    }
}
