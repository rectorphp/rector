...
namespace RectorPrefix20211002\TYPO3\CMS\Core\Site;

use RectorPrefix20211002\TYPO3\CMS\Core\Site\Entity\Site;
...
class SiteFinder
{
    ...
    public function getSiteByPageId($pageId, $rootLine = null, $mountPointParameter = null)
    {
        ...
        return new \RectorPrefix20211002\TYPO3\CMS\Core\Site\Entity\Site();
    }
}
