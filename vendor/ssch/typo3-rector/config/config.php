...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\RectorPrefix20220606\Helmich\TypoScriptParser\Tokenizer\Tokenizer::class);
    $services->alias(\RectorPrefix20220606\Helmich\TypoScriptParser\Tokenizer\TokenizerInterface::class, \RectorPrefix20220606\Helmich\TypoScriptParser\Tokenizer\Tokenizer::class);
    $services->set(\RectorPrefix20220606\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinter::class);
    $services->alias(\RectorPrefix20220606\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface::class, \RectorPrefix20220606\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinter::class);
    $services->set(\RectorPrefix20220606\Helmich\TypoScriptParser\Parser\Parser::class);
    $services->alias(\RectorPrefix20220606\Helmich\TypoScriptParser\Parser\ParserInterface::class, \RectorPrefix20220606\Helmich\TypoScriptParser\Parser\Parser::class);
    $services->set(\RectorPrefix20220606\Symfony\Component\Console\Output\BufferedOutput::class);
    $services->alias(\RectorPrefix20220606\Symfony\Component\Console\Output\OutputInterface::class, \RectorPrefix20220606\Symfony\Component\Console\Output\BufferedOutput::class);
    $services->set(\RectorPrefix20220606\Helmich\TypoScriptParser\Parser\AST\Builder::class);
