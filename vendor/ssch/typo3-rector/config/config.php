...
use RectorPrefix20220418\Helmich\TypoScriptParser\Parser\Parser;
...
use RectorPrefix20220418\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinter;
use Helmich\TypoScriptParser\Parser\Traverser\Traverser;
use RectorPrefix20220418\Helmich\TypoScriptParser\Tokenizer\Tokenizer;
...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\RectorPrefix20220418\Helmich\TypoScriptParser\Tokenizer\Tokenizer::class);
    $services->alias(\RectorPrefix20220418\Helmich\TypoScriptParser\Tokenizer\TokenizerInterface::class, \RectorPrefix20220418\Helmich\TypoScriptParser\Tokenizer\Tokenizer::class);
    $services->set(\RectorPrefix20220418\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinter::class);
    $services->alias(\RectorPrefix20220418\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface::class, \RectorPrefix20220418\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinter::class);
    $services->set(\RectorPrefix20220418\Helmich\TypoScriptParser\Parser\Parser::class);
    $services->alias(\RectorPrefix20220418\Helmich\TypoScriptParser\Parser\ParserInterface::class, \RectorPrefix20220418\Helmich\TypoScriptParser\Parser\Parser::class);
    $services->set(\RectorPrefix20220418\Symfony\Component\Console\Output\BufferedOutput::class);
    $services->alias(\RectorPrefix20220418\Symfony\Component\Console\Output\OutputInterface::class, \RectorPrefix20220418\Symfony\Component\Console\Output\BufferedOutput::class);
    $services->set(\RectorPrefix20220418\Helmich\TypoScriptParser\Parser\AST\Builder::class);
