...
use RectorPrefix20210722\Helmich\TypoScriptParser\Parser\Parser;
use RectorPrefix20210722\Helmich\TypoScriptParser\Parser\ParserInterface;
use RectorPrefix20210722\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface;
use RectorPrefix20210722\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinter;
...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\RectorPrefix20210722\Helmich\TypoScriptParser\Parser\Traverser\Traverser::class);
    $services->set(\RectorPrefix20210722\Helmich\TypoScriptParser\Tokenizer\Tokenizer::class);
    $services->alias(\RectorPrefix20210722\Helmich\TypoScriptParser\Tokenizer\TokenizerInterface::class, \RectorPrefix20210722\Helmich\TypoScriptParser\Tokenizer\Tokenizer::class);
    $services->set(\RectorPrefix20210722\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinter::class);
    $services->alias(\RectorPrefix20210722\Helmich\TypoScriptParser\Parser\Printer\ASTPrinterInterface::class, \RectorPrefix20210722\Helmich\TypoScriptParser\Parser\Printer\PrettyPrinter::class);
    $services->set(\RectorPrefix20210722\Helmich\TypoScriptParser\Parser\Parser::class);
    $services->alias(\RectorPrefix20210722\Helmich\TypoScriptParser\Parser\ParserInterface::class, \RectorPrefix20210722\Helmich\TypoScriptParser\Parser\Parser::class);
    $services->set(\RectorPrefix20210722\Symfony\Component\Console\Output\BufferedOutput::class);
