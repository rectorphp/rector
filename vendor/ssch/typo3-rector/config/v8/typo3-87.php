...
return static function (\RectorPrefix20210518\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set('extbase_typoscriptservice_to_core_typoscriptservice')->class(\Rector\Renaming\Rector\Name\RenameClassRector::class)->call('configure', [[\Rector\Renaming\Rector\Name\RenameClassRector::OLD_TO_NEW_CLASSES => ['RectorPrefix20210518\\TYPO3\\CMS\\Extbase\\Service\\TypoScriptService' => 'RectorPrefix20210518\\TYPO3\\CMS\\Core\\TypoScript\\TypoScriptService']]]);
    ...
    $services->set('general_utility_csv_values_to_csv_utility')->class(\Rector\Renaming\Rector\StaticCall\RenameStaticMethodRector::class)->call('configure', [[\Rector\Renaming\Rector\StaticCall\RenameStaticMethodRector::OLD_TO_NEW_METHODS_BY_CLASSES => \Symplify\SymfonyPhpConfig\ValueObjectInliner::inline([new \Rector\Renaming\ValueObject\RenameStaticMethod('RectorPrefix20210518\\TYPO3\\CMS\\Core\\Utility\\GeneralUtility', 'csvValues', 'RectorPrefix20210518\\TYPO3\\CMS\\Core\\Utility\\CsvUtility', 'csvValues')])]]);
