...
namespace RectorPrefix20210904\Stringy;
...
class StaticStringy
{
    ...
    public static function __callStatic($name, $arguments)
    {
        if (!static::$methodArgs) {
            $stringyClass = new \ReflectionClass('RectorPrefix20210904\\Stringy\\Stringy');
        ...
        $stringy = \RectorPrefix20210904\Stringy\Stringy::create($str, $encoding);
