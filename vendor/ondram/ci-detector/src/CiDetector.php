 ...
 */
class CiDetector implements \RectorPrefix20220607\OndraM\CiDetector\CiDetectorInterface
{
    ...
    {
        $this->environment = new \RectorPrefix20220607\OndraM\CiDetector\Env();
    }
    public static function fromEnvironment(\RectorPrefix20220607\OndraM\CiDetector\Env $environment) : self
    {
        $detector = new static();
    ...
    public function detect() : \RectorPrefix20220607\OndraM\CiDetector\Ci\CiInterface
    {
        $ciServer = $this->detectCurrentCiServer();
        if ($ciServer === null) {
            throw new \RectorPrefix20220607\OndraM\CiDetector\Exception\CiNotDetectedException('No CI server detected in current environment');
        }
        return $ciServer;
    }
    /**
    ...
    {
        return [\RectorPrefix20220607\OndraM\CiDetector\Ci\AppVeyor::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\AwsCodeBuild::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\AzurePipelines::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\Bamboo::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\BitbucketPipelines::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\Buddy::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\Circle::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\Codeship::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\Continuousphp::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\Drone::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\GitHubActions::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\GitLab::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\Jenkins::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\SourceHut::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\TeamCity::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\Travis::class, \RectorPrefix20220607\OndraM\CiDetector\Ci\Wercker::class];
    }
    protected function detectCurrentCiServer() : ?\RectorPrefix20220607\OndraM\CiDetector\Ci\CiInterface
    {
