...
class GitHubActions extends \RectorPrefix20220528\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \RectorPrefix20220528\OndraM\CiDetector\CiDetector::CI_GITHUB_ACTIONS;
    }
    public function isPullRequest() : \RectorPrefix20220528\OndraM\CiDetector\TrinaryLogic
    {
        return \RectorPrefix20220528\OndraM\CiDetector\TrinaryLogic::createFromBoolean($this->env->getString('GITHUB_EVENT_NAME') === 'pull_request');
    }
