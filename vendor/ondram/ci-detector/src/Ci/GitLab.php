...
class GitLab extends \RectorPrefix20220501\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \RectorPrefix20220501\OndraM\CiDetector\CiDetector::CI_GITLAB;
    }
    public function isPullRequest() : \RectorPrefix20220501\OndraM\CiDetector\TrinaryLogic
    {
        return \RectorPrefix20220501\OndraM\CiDetector\TrinaryLogic::createFromBoolean($this->env->get('CI_MERGE_REQUEST_ID') !== \false || $this->env->get('CI_EXTERNAL_PULL_REQUEST_IID') !== \false);
    }
