...
class AwsCodeBuild extends \RectorPrefix20220306\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \RectorPrefix20220306\OndraM\CiDetector\CiDetector::CI_AWS_CODEBUILD;
    }
    public function isPullRequest() : \RectorPrefix20220306\OndraM\CiDetector\TrinaryLogic
    {
        return \RectorPrefix20220306\OndraM\CiDetector\TrinaryLogic::createFromBoolean(\mb_strpos($this->env->getString('CODEBUILD_WEBHOOK_EVENT'), 'PULL_REQUEST') === 0);
    }
