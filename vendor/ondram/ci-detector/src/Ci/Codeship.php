...
use RectorPrefix20220321\OndraM\CiDetector\CiDetector;
use RectorPrefix20220321\OndraM\CiDetector\Env;
use RectorPrefix20220321\OndraM\CiDetector\TrinaryLogic;
class Codeship extends \RectorPrefix20220321\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \RectorPrefix20220321\OndraM\CiDetector\CiDetector::CI_CODESHIP;
    }
    public function isPullRequest() : \RectorPrefix20220321\OndraM\CiDetector\TrinaryLogic
    {
        return \RectorPrefix20220321\OndraM\CiDetector\TrinaryLogic::createFromBoolean($this->env->getString('CI_PULL_REQUEST') !== 'false');
    }
