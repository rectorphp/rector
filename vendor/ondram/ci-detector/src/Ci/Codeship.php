...
class Codeship extends \RectorPrefix20220228\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \RectorPrefix20220228\OndraM\CiDetector\CiDetector::CI_CODESHIP;
    }
    public function isPullRequest() : \RectorPrefix20220228\OndraM\CiDetector\TrinaryLogic
    {
        return \RectorPrefix20220228\OndraM\CiDetector\TrinaryLogic::createFromBoolean($this->env->getString('CI_PULL_REQUEST') !== 'false');
    }
