 ...
 */
abstract class AbstractCi implements \RectorPrefix20220222\OndraM\CiDetector\Ci\CiInterface
{
    /** @var Env */
    protected $env;
    public function __construct(\RectorPrefix20220222\OndraM\CiDetector\Env $env)
    {
        $this->env = $env;
    }
