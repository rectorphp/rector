 ...
 */
abstract class AbstractCi implements \RectorPrefix20220606\OndraM\CiDetector\Ci\CiInterface
{
    /** @var Env */
    protected $env;
    public function __construct(\RectorPrefix20220606\OndraM\CiDetector\Env $env)
    {
        $this->env = $env;
    }
