...
class BitbucketPipelines extends \RectorPrefix20220306\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \RectorPrefix20220306\OndraM\CiDetector\CiDetector::CI_BITBUCKET_PIPELINES;
    }
    public function isPullRequest() : \RectorPrefix20220306\OndraM\CiDetector\TrinaryLogic
    {
        return \RectorPrefix20220306\OndraM\CiDetector\TrinaryLogic::createFromBoolean($this->env->getString('BITBUCKET_PR_ID') !== '');
    }
