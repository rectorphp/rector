...
class SourceHut extends \RectorPrefix20220508\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \RectorPrefix20220508\OndraM\CiDetector\CiDetector::CI_SOURCEHUT;
    }
    public function isPullRequest() : \RectorPrefix20220508\OndraM\CiDetector\TrinaryLogic
    {
        return \RectorPrefix20220508\OndraM\CiDetector\TrinaryLogic::createFromBoolean($this->env->getString('BUILD_REASON') === 'patchset');
    }
