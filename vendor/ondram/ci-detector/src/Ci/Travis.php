...
class Travis extends \RectorPrefix20220228\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \RectorPrefix20220228\OndraM\CiDetector\CiDetector::CI_TRAVIS;
    }
    public function isPullRequest() : \RectorPrefix20220228\OndraM\CiDetector\TrinaryLogic
    {
        return \RectorPrefix20220228\OndraM\CiDetector\TrinaryLogic::createFromBoolean($this->env->getString('TRAVIS_PULL_REQUEST') !== 'false');
    }
