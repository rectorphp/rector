...
class AppVeyor extends \RectorPrefix20220427\OndraM\CiDetector\Ci\AbstractCi
{
    ...
    {
        return \RectorPrefix20220427\OndraM\CiDetector\CiDetector::CI_APPVEYOR;
    }
    public function isPullRequest() : \RectorPrefix20220427\OndraM\CiDetector\TrinaryLogic
    {
        return \RectorPrefix20220427\OndraM\CiDetector\TrinaryLogic::createFromBoolean($this->env->getString('APPVEYOR_PULL_REQUEST_NUMBER') !== '');
    }
