...
namespace RectorPrefix20220608\OndraM\CiDetector;

use RectorPrefix20220608\OndraM\CiDetector\Ci\CiInterface;
use RectorPrefix20220608\OndraM\CiDetector\Exception\CiNotDetectedException;
/**
