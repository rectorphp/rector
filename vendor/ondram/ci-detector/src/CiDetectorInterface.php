...
namespace RectorPrefix20220609\OndraM\CiDetector;

use RectorPrefix20220609\OndraM\CiDetector\Ci\CiInterface;
use RectorPrefix20220609\OndraM\CiDetector\Exception\CiNotDetectedException;
/**
