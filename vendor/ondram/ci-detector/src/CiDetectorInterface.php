...
namespace RectorPrefix20220218\OndraM\CiDetector;

use RectorPrefix20220218\OndraM\CiDetector\Ci\CiInterface;
use RectorPrefix20220218\OndraM\CiDetector\Exception\CiNotDetectedException;
/**
