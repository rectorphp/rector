...
namespace RectorPrefix20220611\OndraM\CiDetector;

use RectorPrefix20220611\OndraM\CiDetector\Ci\CiInterface;
use RectorPrefix20220611\OndraM\CiDetector\Exception\CiNotDetectedException;
/**
