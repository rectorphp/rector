...
namespace RectorPrefix20220527\OndraM\CiDetector;

use RectorPrefix20220527\OndraM\CiDetector\Ci\CiInterface;
use RectorPrefix20220527\OndraM\CiDetector\Exception\CiNotDetectedException;
/**
