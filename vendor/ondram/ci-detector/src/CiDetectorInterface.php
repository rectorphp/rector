...
namespace RectorPrefix20220610\OndraM\CiDetector;

use RectorPrefix20220610\OndraM\CiDetector\Ci\CiInterface;
use RectorPrefix20220610\OndraM\CiDetector\Exception\CiNotDetectedException;
/**
