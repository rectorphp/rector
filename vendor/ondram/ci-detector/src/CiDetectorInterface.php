...
namespace RectorPrefix20220606\OndraM\CiDetector;

use RectorPrefix20220606\OndraM\CiDetector\Ci\CiInterface;
use RectorPrefix20220606\OndraM\CiDetector\Exception\CiNotDetectedException;
/**
