...
namespace RectorPrefix20220217\OndraM\CiDetector;

use RectorPrefix20220217\OndraM\CiDetector\Ci\CiInterface;
use RectorPrefix20220217\OndraM\CiDetector\Exception\CiNotDetectedException;
/**
