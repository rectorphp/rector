...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->rules([DowngradeNewMethodCallWithoutParenthesesRector::class, DowngradeExitNamedArgumentRector::class, DowngradeRoundingModeEnumRector::class, DowngradeArrayAllRector::class, DowngradeArrayAnyRector::class, DowngradeArrayFindRector::class, DowngradeArrayFindKeyRector::class]);
};
