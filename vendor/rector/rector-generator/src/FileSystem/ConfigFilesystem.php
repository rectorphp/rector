...
final class ConfigFilesystem
{
    ...
    public function __construct(\RectorPrefix20220515\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\RectorGenerator\TemplateFactory $templateFactory)
    {
    ...
    public function appendRectorServiceToSet(string $setFilePath, array $templateVariables, string $rectorFqnNamePattern) : void
    {
        ...
        $setFileContents = \RectorPrefix20220515\Nette\Utils\Strings::replace($setFileContents, self::LAST_ITEM_REGEX, $registerServiceLine);
