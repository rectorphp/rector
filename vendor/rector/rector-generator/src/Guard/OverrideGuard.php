...
final class OverrideGuard
{
    ...
    public function __construct(\RectorPrefix20220314\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Rector\RectorGenerator\FileSystem\TemplateFileSystem $templateFileSystem)
    {
