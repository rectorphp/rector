...
final class OverrideGuard
{
    ...
    public function __construct(\RectorPrefix20220306\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Rector\RectorGenerator\FileSystem\TemplateFileSystem $templateFileSystem)
    {
