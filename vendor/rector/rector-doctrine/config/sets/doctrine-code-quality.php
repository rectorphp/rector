...
return static function (RectorConfig $rectorConfig) : void {
    ...
    $rectorConfig->ruleWithConfiguration(AttributeKeyToClassConstFetchRector::class, [new AttributeKeyToClassConstFetch('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\Column', 'type', 'RectorPrefix20220607\\Doctrine\\DBAL\\Types\\Types', ['array' => 'ARRAY', 'ascii_string' => 'ASCII_STRING', 'bigint' => 'BIGINT', 'binary' => 'BINARY', 'blob' => 'BLOB', 'boolean' => 'BOOLEAN', 'date' => 'DATE_MUTABLE', 'date_immutable' => 'DATE_IMMUTABLE', 'dateinterval' => 'DATEINTERVAL', 'datetime' => 'DATETIME_MUTABLE', 'datetime_immutable' => 'DATETIME_IMMUTABLE', 'datetimetz' => 'DATETIMETZ_MUTABLE', 'datetimetz_immutable' => 'DATETIMETZ_IMMUTABLE', 'decimal' => 'DECIMAL', 'float' => 'FLOAT', 'guid' => 'GUID', 'integer' => 'INTEGER', 'json' => 'JSON', 'object' => 'OBJECT', 'simple_array' => 'SIMPLE_ARRAY', 'smallint' => 'SMALLINT', 'string' => 'STRING', 'text' => 'TEXT', 'time' => 'TIME_MUTABLE', 'time_immutable' => 'TIME_IMMUTABLE'])]);
    $rectorConfig->ruleWithConfiguration(ReplaceStringWithClassConstantRector::class, [new ReplaceStringWithClassConstant('RectorPrefix20220607\\Doctrine\\ORM\\QueryBuilder', 'orderBy', 1, 'RectorPrefix20220607\\Doctrine\\Common\\Collections\\Criteria', \true), new ReplaceStringWithClassConstant('RectorPrefix20220607\\Doctrine\\ORM\\QueryBuilder', 'addOrderBy', 1, 'RectorPrefix20220607\\Doctrine\\Common\\Collections\\Criteria', \true)]);
    $rectorConfig->ruleWithConfiguration(ServiceGetterToConstructorInjectionRector::class, [new ServiceGetterToConstructorInjection('RectorPrefix20220607\\Doctrine\\Common\\Persistence\\ManagerRegistry', 'getConnection', 'RectorPrefix20220607\\Doctrine\\DBAL\\Connection'), new ServiceGetterToConstructorInjection('RectorPrefix20220607\\Doctrine\\ORM\\EntityManagerInterface', 'getConfiguration', 'RectorPrefix20220607\\Doctrine\\ORM\\Configuration')]);
};
