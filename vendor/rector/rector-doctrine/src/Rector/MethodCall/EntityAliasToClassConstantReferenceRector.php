...
, [self::ALIASES_TO_NAMESPACES => ['App' => 'App\\Entity']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211117\Webmozart\Assert\Assert::allString($aliasesToNamespaces);
        \RectorPrefix20211117\Webmozart\Assert\Assert::allString(\array_keys($aliasesToNamespaces));
