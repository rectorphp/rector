...
final class RemoveRedundantDefaultPropertyAnnotationValuesRector extends AbstractRector
{
    ...
    public function __construct(DoctrineItemDefaultValueManipulator $doctrineItemDefaultValueManipulator, AttributeFinder $attributeFinder, AttributeCleaner $attributeCleaner)
    {
        ...
        $this->defaultAnnotationArgValues = [new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\Column', 'nullable', \false), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\Column', 'unique', \false), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\Column', 'precision', 0), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\Column', 'scale', 0), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\GeneratedValue', 'strategy', 'AUTO'), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\JoinColumn', 'unique', \false), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\JoinColumn', 'nullable', \true), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\JoinColumn', 'referencedColumnName', 'id'), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\ManyToMany', ArgName::ORPHAN_REMOVAL, \false), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\ManyToMany', ArgName::FETCH, ArgName::LAZY), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\ManyToOne', ArgName::FETCH, ArgName::LAZY), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\OneToMany', ArgName::ORPHAN_REMOVAL, \false), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\OneToMany', ArgName::FETCH, ArgName::LAZY), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\OneToOne', ArgName::ORPHAN_REMOVAL, \false), new DefaultAnnotationArgValue('RectorPrefix20220607\\Doctrine\\ORM\\Mapping\\OneToOne', ArgName::FETCH, ArgName::LAZY)];
    }
