...
use RectorPrefix20210609\Prophecy\Argument;
use RectorPrefix20210609\Prophecy\PhpUnit\ProphecyTrait;
use RectorPrefix20210609\Prophecy\Prophecy\ObjectProphecy;
use Rector\RectorInstaller\Filesystem;
use Rector\RectorInstaller\PluginInstaller;
/**
 * @covers PluginInstaller
 */
final class PluginInstallerTest extends \RectorPrefix20210609\PHPUnit\Framework\TestCase
{
    use ProphecyTrait;
    /**
     * @var string
    ...
    protected function setUp() : void
    {
        ...
        $this->composerFilesystem = $this->prophesize(\RectorPrefix20210609\Composer\Util\Filesystem::class);
        ...
        $this->localRepository = $this->prophesize(\RectorPrefix20210609\Composer\Repository\InstalledRepositoryInterface::class);
        $this->io = $this->prophesize(\RectorPrefix20210609\Composer\IO\IOInterface::class);
        $this->installationManager = $this->prophesize(\RectorPrefix20210609\Composer\Installer\InstallationManager::class);
    ...
    public function testNoRectorPackagesInstalled() : void
    {
        ...
        $this->filesystem->writeFile($this->configurationFile, \RectorPrefix20210609\Prophecy\Argument::any())->shouldNotBeCalled();
        $this->filesystem->hashEquals(self::FILE_HASH, \RectorPrefix20210609\Prophecy\Argument::any())->willReturn(\true);
        $this->pluginInstaller->install();
    }
    public function testPackagesInstalled() : void
    {
        $rectorExtensionPackage = $this->prophesize(\RectorPrefix20210609\Composer\Package\PackageInterface::class);
        ...
        $nonRectorExtensionPackage = $this->prophesize(\RectorPrefix20210609\Composer\Package\PackageInterface::class);
        $nonRectorExtensionPackageWithExtra = $this->prophesize(\RectorPrefix20210609\Composer\Package\PackageInterface::class);
        ...
        $this->filesystem->hashEquals(self::FILE_HASH, \RectorPrefix20210609\Prophecy\Argument::any())->willReturn(\false);
        $this->filesystem->writeFile($this->configurationFile, \RectorPrefix20210609\Prophecy\Argument::any())->shouldBeCalledOnce();
