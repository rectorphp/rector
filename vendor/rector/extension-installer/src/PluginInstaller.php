...
use RectorPrefix20220203\Composer\Installer\InstallationManager;
use RectorPrefix20220203\Composer\IO\IOInterface;
use RectorPrefix20220203\Composer\Package\PackageInterface;
use RectorPrefix20220203\Composer\Repository\InstalledRepositoryInterface;
use RectorPrefix20220203\Composer\Util\Filesystem as ComposerFilesystem;
/**
...
CODE_SAMPLE;
    ...
    public function __construct(\Rector\RectorInstaller\Filesystem $filesystem, \RectorPrefix20220203\Composer\Repository\InstalledRepositoryInterface $localRepository, \RectorPrefix20220203\Composer\IO\IOInterface $io, \RectorPrefix20220203\Composer\Installer\InstallationManager $installationManager, \RectorPrefix20220203\Composer\Util\Filesystem $composerFilesystem, string $configurationFile)
    {
    ...
    private function shouldSkip(\RectorPrefix20220203\Composer\Package\PackageInterface $package) : bool
    {
