...
use RectorPrefix20220415\Composer\Installer\InstallationManager;
use RectorPrefix20220415\Composer\IO\IOInterface;
use RectorPrefix20220415\Composer\Package\PackageInterface;
use RectorPrefix20220415\Composer\Repository\InstalledRepositoryInterface;
use RectorPrefix20220415\Composer\Util\Filesystem as ComposerFilesystem;
/**
...
CODE_SAMPLE;
    ...
    public function __construct(\Rector\RectorInstaller\Filesystem $filesystem, \RectorPrefix20220415\Composer\Repository\InstalledRepositoryInterface $localRepository, \RectorPrefix20220415\Composer\IO\IOInterface $io, \RectorPrefix20220415\Composer\Installer\InstallationManager $installationManager, \RectorPrefix20220415\Composer\Util\Filesystem $composerFilesystem, string $configurationFile)
    {
    ...
    private function shouldSkip(\RectorPrefix20220415\Composer\Package\PackageInterface $package) : bool
    {
