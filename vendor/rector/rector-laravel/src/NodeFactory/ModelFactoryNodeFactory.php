...
use RectorPrefix20211021\Symplify\Astral\NodeTraverser\SimpleCallableNodeTraverser;
...
final class ModelFactoryNodeFactory
{
    ...
    public function createEmptyFactory(string $name, \PhpParser\Node\Expr $expr) : \PhpParser\Node\Stmt\Class_
    {
        ...
        $propertyBuilder = new \RectorPrefix20211021\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder('model');
