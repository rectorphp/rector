...
, [self::ADDED_ARGUMENTS => [new \Rector\Laravel\ValueObject\AddArgumentDefaultValue('SomeClass', 'someMethod', 0, \false)]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220119\Webmozart\Assert\Assert::isArray($addedArguments);
        \RectorPrefix20220119\Webmozart\Assert\Assert::allIsInstanceOf($addedArguments, \Rector\Laravel\ValueObject\AddArgumentDefaultValue::class);
