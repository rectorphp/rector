...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        \RectorPrefix20220124\Webmozart\Assert\Assert::allString($missingDates);
    ...
    {
        $propertyBuilder = new \RectorPrefix20220124\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder('casts');
