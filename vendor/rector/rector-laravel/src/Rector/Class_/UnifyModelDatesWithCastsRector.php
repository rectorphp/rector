...
CODE_SAMPLE
    ...
    public function refactor($node) : ?\PhpParser\Node
    {
        ...
        \RectorPrefix20211210\Webmozart\Assert\Assert::allString($missingDates);
    ...
    {
        $propertyBuilder = new \RectorPrefix20211210\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder('casts');
