...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        \RectorPrefix20220316\Webmozart\Assert\Assert::allString($missingDates);
    ...
    {
        $propertyBuilder = new \RectorPrefix20220316\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder('casts');
