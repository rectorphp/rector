...
, [self::NAMESPACE => 'App\\Http\\Controllers'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220303\Webmozart\Assert\Assert::isArray($routes);
        \RectorPrefix20220303\Webmozart\Assert\Assert::allString(\array_keys($routes));
        \RectorPrefix20220303\Webmozart\Assert\Assert::allString($routes);
        $this->routes = $routes;
        $namespace = $configuration[self::NAMESPACE] ?? self::DEFAULT_NAMESPACE;
        \RectorPrefix20220303\Webmozart\Assert\Assert::string($namespace);
