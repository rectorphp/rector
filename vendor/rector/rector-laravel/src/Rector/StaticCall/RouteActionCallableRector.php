...
, [self::NAMESPACE => 'App\\Http\\Controllers'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211114\Webmozart\Assert\Assert::allString($routes);
        \RectorPrefix20211114\Webmozart\Assert\Assert::allString(\array_keys($routes));
        $this->routes = $routes;
        $namespace = $configuration[self::NAMESPACE] ?? self::DEFAULT_NAMESPACE;
        \RectorPrefix20211114\Webmozart\Assert\Assert::string($namespace);
