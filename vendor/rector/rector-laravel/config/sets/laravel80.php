...
return static function (RectorConfig $rectorConfig) : void {
    ...
    $rectorConfig->ruleWithConfiguration(ArgumentAdderRector::class, [new ArgumentAdder(
        'RectorPrefix20220607\\Illuminate\\Contracts\\Database\\Eloquent\\Castable',
        'castUsing',
        0,
        'arguments',
        [],
    ...
    $rectorConfig->ruleWithConfiguration(AddArgumentDefaultValueRector::class, [new AddArgumentDefaultValue('RectorPrefix20220607\\Illuminate\\Contracts\\Events\\Dispatcher', 'listen', 1, null)]);
    ...
    $rectorConfig->ruleWithConfiguration(RenamePropertyRector::class, [
        ...
        new RenameProperty('RectorPrefix20220607\\Illuminate\\Support\\Manager', 'app', 'container'),
        # https://github.com/laravel/framework/commit/4656c2cf012ac62739ab5ea2bce006e1e9fe8f09
        new RenameProperty('RectorPrefix20220607\\Illuminate\\Contracts\\Queue\\ShouldQueue', 'retryAfter', 'backoff'),
        # https://github.com/laravel/framework/commit/12c35e57c0a6da96f36ad77f88f083e96f927205
        new RenameProperty('RectorPrefix20220607\\Illuminate\\Contracts\\Queue\\ShouldQueue', 'timeoutAt', 'retryUntil'),
    ]);
    $rectorConfig->ruleWithConfiguration(RenameMethodRector::class, [
        # https://github.com/laravel/framework/pull/32092/files
        new MethodCallRename('RectorPrefix20220607\\Illuminate\\Mail\\PendingMail', 'sendNow', 'send'),
        # https://github.com/laravel/framework/commit/4656c2cf012ac62739ab5ea2bce006e1e9fe8f09
        new MethodCallRename('RectorPrefix20220607\\Illuminate\\Contracts\\Queue\\ShouldQueue', 'retryAfter', 'backoff'),
        # https://github.com/laravel/framework/commit/12c35e57c0a6da96f36ad77f88f083e96f927205
        new MethodCallRename('RectorPrefix20220607\\Illuminate\\Contracts\\Queue\\ShouldQueue', 'timeoutAt', 'retryUntil'),
        # https://github.com/laravel/framework/commit/f9374fa5fb0450721fb2f90e96adef9d409b112c
        new MethodCallRename('RectorPrefix20220607\\Illuminate\\Testing\\TestResponse', 'decodeResponseJson', 'json'),
        # https://github.com/laravel/framework/commit/fd662d4699776a94e7ead2a42e82c340363fc5a6
        new MethodCallRename('RectorPrefix20220607\\Illuminate\\Testing\\TestResponse', 'assertExactJson', 'assertSimilarJson'),
    ]);
