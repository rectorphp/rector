...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20210512\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20210512\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
}
