...
CODE_SAMPLE
    ...
    {
        if (!\RectorPrefix20211015\Nette\Utils\Strings::startsWith($possibleClassName, '\\')) {
            return \false;
        }
        return \RectorPrefix20211015\Nette\Utils\Strings::endsWith($possibleClassName, 'Test');
    }
    /**
