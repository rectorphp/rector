...
, $configuration)]);
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (!$renameMethodCallBasedOnParameter instanceof \Rector\CakePHP\ValueObject\RenameMethodCallBasedOnParameter) {
            return null;
        }
        $node->name = new \PhpParser\Node\Identifier($renameMethodCallBasedOnParameter->getNewMethod());
        return $node;
    }
    /**
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220531\Webmozart\Assert\Assert::isArray($callsWithParamRenames);
        \RectorPrefix20220531\Webmozart\Assert\Assert::allIsInstanceOf($callsWithParamRenames, \Rector\CakePHP\ValueObject\RenameMethodCallBasedOnParameter::class);
