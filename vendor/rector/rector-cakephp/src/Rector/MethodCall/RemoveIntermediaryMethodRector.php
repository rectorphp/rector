...
, [self::REMOVE_INTERMEDIARY_METHOD => [new \Rector\CakePHP\ValueObject\RemoveIntermediaryMethod('getTableLocator', 'get', 'fetchTable')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220213\Webmozart\Assert\Assert::isArray($removeIntermediaryMethods);
        \RectorPrefix20220213\Webmozart\Assert\Assert::allIsAOf($removeIntermediaryMethods, \Rector\CakePHP\ValueObject\RemoveIntermediaryMethod::class);
