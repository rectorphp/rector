...
, [self::UNPREFIXED_METHODS_TO_GET_SET => [new \Rector\CakePHP\ValueObject\ModalToGetSet('InstanceConfigTrait', 'config', 'getConfig', 'setConfig')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::isArray($unprefixedMethodsToGetSet);
        \RectorPrefix20211231\Webmozart\Assert\Assert::allIsAOf($unprefixedMethodsToGetSet, \Rector\CakePHP\ValueObject\ModalToGetSet::class);
