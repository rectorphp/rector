...
final class ServiceMapFactory
{
    ...
    {
        $data = \RectorPrefix20220501\Nette\Utils\Json::decode(\RectorPrefix20220501\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20220501\Nette\Utils\Json::FORCE_ARRAY);
