...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210807\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210807\Nette\Utils\Json::decode(\RectorPrefix20210807\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210807\Nette\Utils\Json::FORCE_ARRAY);
