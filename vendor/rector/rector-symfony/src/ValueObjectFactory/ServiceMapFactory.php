...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210729\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210729\Nette\Utils\Json::decode(\RectorPrefix20210729\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210729\Nette\Utils\Json::FORCE_ARRAY);
