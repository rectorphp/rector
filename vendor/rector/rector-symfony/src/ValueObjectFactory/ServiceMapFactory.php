...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210901\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210901\Nette\Utils\Json::decode(\RectorPrefix20210901\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210901\Nette\Utils\Json::FORCE_ARRAY);
