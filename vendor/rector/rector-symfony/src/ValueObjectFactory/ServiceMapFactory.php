...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210818\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210818\Nette\Utils\Json::decode(\RectorPrefix20210818\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210818\Nette\Utils\Json::FORCE_ARRAY);
