...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210823\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210823\Nette\Utils\Json::decode(\RectorPrefix20210823\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210823\Nette\Utils\Json::FORCE_ARRAY);
