...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20220203\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20220203\Nette\Utils\Json::decode(\RectorPrefix20220203\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20220203\Nette\Utils\Json::FORCE_ARRAY);
