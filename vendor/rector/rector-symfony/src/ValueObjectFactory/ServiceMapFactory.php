...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210718\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210718\Nette\Utils\Json::decode(\RectorPrefix20210718\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210718\Nette\Utils\Json::FORCE_ARRAY);
