...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20211111\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20211111\Nette\Utils\Json::decode(\RectorPrefix20211111\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20211111\Nette\Utils\Json::FORCE_ARRAY);
