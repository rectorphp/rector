...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210511\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210511\Nette\Utils\Json::decode(\RectorPrefix20210511\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210511\Nette\Utils\Json::FORCE_ARRAY);
