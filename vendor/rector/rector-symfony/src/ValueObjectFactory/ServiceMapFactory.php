...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210521\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210521\Nette\Utils\Json::decode(\RectorPrefix20210521\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210521\Nette\Utils\Json::FORCE_ARRAY);
