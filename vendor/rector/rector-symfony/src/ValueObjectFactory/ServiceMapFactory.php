...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20211130\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20211130\Nette\Utils\Json::decode(\RectorPrefix20211130\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20211130\Nette\Utils\Json::FORCE_ARRAY);
