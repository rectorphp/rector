...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210629\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210629\Nette\Utils\Json::decode(\RectorPrefix20210629\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210629\Nette\Utils\Json::FORCE_ARRAY);
