...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210809\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210809\Nette\Utils\Json::decode(\RectorPrefix20210809\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210809\Nette\Utils\Json::FORCE_ARRAY);
