...
final class ServiceMapFactory
{
    ...
    public function __construct(\RectorPrefix20210731\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $data = \RectorPrefix20210731\Nette\Utils\Json::decode(\RectorPrefix20210731\Nette\Utils\Json::encode((array) $simpleXMLElement), \RectorPrefix20210731\Nette\Utils\Json::FORCE_ARRAY);
