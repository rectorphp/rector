...
use RectorPrefix20220122\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20220122\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20220122\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
