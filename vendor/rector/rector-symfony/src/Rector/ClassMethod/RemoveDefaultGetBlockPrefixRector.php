...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (\substr_compare($shortClassName, 'Type', -\strlen('Type')) === 0) {
            $shortClassName = (string) \RectorPrefix20211027\Nette\Utils\Strings::before($shortClassName, 'Type');
        }
        $stringy = new \RectorPrefix20211027\Stringy\Stringy($shortClassName);
