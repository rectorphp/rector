...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (\substr_compare($shortClassName, 'Type', -\strlen('Type')) === 0) {
            $shortClassName = (string) \RectorPrefix20220414\Nette\Utils\Strings::before($shortClassName, 'Type');
        }
        $shortClassNameUnicodeString = new \RectorPrefix20220414\Symfony\Component\String\UnicodeString($shortClassName);
