...
use RectorPrefix20220606\Rector\Symfony\NodeAnalyzer\InvokableAnalyzer\ActiveClassElementsClassMethodResolver;
use RectorPrefix20220606\Rector\Symfony\NodeFactory\InvokableController\ActiveClassElementsFilter;
...
final class InvokableControllerClassFactory
{
    ...
    public function __construct(InvokableControllerNameFactory $invokableControllerNameFactory, NodeNameResolver $nodeNameResolver, ActiveClassElementsClassMethodResolver $activeClassElementsClassMethodResolver, ActiveClassElementsFilter $activeClassElementsFilter)
    {
