...
use RectorPrefix20220606\Rector\Symfony\ValueObject\EventReferenceToMethodNameWithPriority;
use RectorPrefix20220606\Rector\Symfony\ValueObject\ServiceDefinition;
use RectorPrefix20220606\Rector\Symfony\ValueObject\Tag;
...
final class GetSubscribedEventsClassMethodFactory
{
    ...
    public function __construct(NodeFactory $nodeFactory, VisibilityManipulator $visibilityManipulator, PhpVersionProvider $phpVersionProvider, PhpDocInfoFactory $phpDocInfoFactory, PhpDocTypeChanger $phpDocTypeChanger, EventReferenceFactory $eventReferenceFactory)
    {
