...
final class BuilderFormNodeFactory
{
    ...
    public function create(\PHPStan\Reflection\MethodReflection $methodReflection) : ?\PhpParser\Node\Stmt\ClassMethod
    {
        ...
        $classMethodBuilder = new \RectorPrefix20210713\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('buildForm');
    ...
    {
        $builderParamBuilder = new \RectorPrefix20210713\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('builder');
    ...
    {
        $optionsParamBuilder = new \RectorPrefix20210713\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('options');
