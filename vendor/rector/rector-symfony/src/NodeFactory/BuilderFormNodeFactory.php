...
final class BuilderFormNodeFactory
{
    ...
    {
        $builderParamBuilder = new \RectorPrefix20210702\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('builder');
    ...
    {
        $optionsParamBuilder = new \RectorPrefix20210702\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('options');
