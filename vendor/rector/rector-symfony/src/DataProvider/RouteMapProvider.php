...
final class RouteMapProvider
{
    ...
    public function __construct(\RectorPrefix20220521\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Rector\Symfony\ValueObjectFactory\RouteMapFactory $routeMapFactory)
    {
