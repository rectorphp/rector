...
use RectorPrefix20220521\Symfony\Component\Routing\Route;
use RectorPrefix20220521\Symfony\Component\Routing\RouterInterface;
/**
 * This command must be added to the application to export the routes to work with the "AddRouteAnnotationRector" rule
 */
final class RectorRoutesExportCommand extends \RectorPrefix20220521\Symfony\Component\Console\Command\Command
{
     ...
     */
    private $router;
    public function __construct(\RectorPrefix20220521\Symfony\Component\Routing\RouterInterface $router)
    {
        $this->router = $router;
        parent::__construct();
    }
    ...
    protected function execute(\RectorPrefix20220521\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20220521\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $routes = \array_map(static function (\RectorPrefix20220521\Symfony\Component\Routing\Route $route) : array {
