...
return static function (RectorConfig $rectorConfig): void {
    $rectorConfig->rules([FormTypeInstanceToClassConstRector::class, StringFormTypeToClassRector::class, FormTypeGetParentRector::class, OptionNameRector::class, ReadOnlyOptionToAttributeRector::class, ChangeStringCollectionOptionToConstantRector::class]);
