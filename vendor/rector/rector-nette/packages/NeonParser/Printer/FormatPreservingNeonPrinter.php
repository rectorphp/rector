...
final class FormatPreservingNeonPrinter
{
    ...
    public function printNode(\RectorPrefix20220307\Nette\Neon\Node $node, string $originalContenet) : string
    {
        ...
        return \RectorPrefix20220307\Nette\Utils\Strings::replace($neonContent, '#\\"#', '\'');
    }
    /**
    ...
    {
        $indentMatch = \RectorPrefix20220307\Nette\Utils\Strings::match($neonContent, '#(\\t|  )#ms');
        if ($indentMatch[0] === "\t") {
