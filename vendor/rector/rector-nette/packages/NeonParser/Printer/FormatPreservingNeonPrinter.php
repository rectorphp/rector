...
final class FormatPreservingNeonPrinter
{
    ...
    public function printNode(\RectorPrefix20211104\Nette\Neon\Node $node, string $originalContenet) : string
    {
    ...
    {
        $indentMatch = \RectorPrefix20211104\Nette\Utils\Strings::match($neonContent, '#(\\t|  )#ms');
        if ($indentMatch[0] === "\t") {
