...
final class FormatPreservingNeonPrinter
{
    ...
    public function printNode(\RectorPrefix20211127\Nette\Neon\Node $node, string $originalContenet) : string
    {
    ...
    {
        $indentMatch = \RectorPrefix20211127\Nette\Utils\Strings::match($neonContent, '#(\\t|  )#ms');
        if ($indentMatch[0] === "\t") {
