...
final class FormatPreservingNeonPrinter
{
    ...
    public function printNode(\RectorPrefix20220509\Nette\Neon\Node $node, string $originalContenet) : string
    {
        ...
        return \RectorPrefix20220509\Nette\Utils\Strings::replace($neonContent, '#\\"#', '\'');
    }
    /**
    ...
    {
        $indentMatch = \RectorPrefix20220509\Nette\Utils\Strings::match($neonContent, '#(\\t|  )#ms');
        if ($indentMatch[0] === "\t") {
