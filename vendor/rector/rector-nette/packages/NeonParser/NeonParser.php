...
final class NeonParser
{
     ...
     */
    private $decoder;
    public function __construct(\RectorPrefix20220427\Nette\Neon\Decoder $decoder)
    {
        $this->decoder = $decoder;
    }
    public function parseString(string $neonContent) : \RectorPrefix20220427\Nette\Neon\Node
    {
