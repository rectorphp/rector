...
final class Service_ extends \Rector\Nette\NeonParser\Node\AbstractVirtualNode
{
    ...
    {
        if ($this->classLiteralNode instanceof \RectorPrefix20220502\Nette\Neon\Node\LiteralNode) {
            (yield $this->classLiteralNode);
        }
        if ($this->factoryLiteralNode instanceof \RectorPrefix20220502\Nette\Neon\Node\LiteralNode) {
