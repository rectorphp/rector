...
final class Service_ extends \Rector\Nette\NeonParser\Node\AbstractVirtualNode
{
    ...
    {
        $subNodes = [];
        if ($this->classLiteralNode instanceof \RectorPrefix20211125\Nette\Neon\Node\LiteralNode) {
            $subNodes[] = $this->classLiteralNode;
        }
        if ($this->factoryLiteralNode instanceof \RectorPrefix20211125\Nette\Neon\Node\LiteralNode) {
