...
use RectorPrefix20211128\Nette\Neon\Node\EntityNode;
use RectorPrefix20211128\Nette\Neon\Node\LiteralNode;
...
final class SetupMethodCall extends \Rector\Nette\NeonParser\Node\AbstractVirtualNode
{
     ...
     */
    public $entityNode;
    public function __construct(string $className, \RectorPrefix20211128\Nette\Neon\Node\LiteralNode $methodNameLiteralNode, \RectorPrefix20211128\Nette\Neon\Node\EntityNode $entityNode)
    {
