...
final class CheckRequirementsClassMethodFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20220506\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder(self::CHECK_REQUIREMENTS_METHOD_NAME);
        $methodBuilder->makePublic();
        $paramBuilder = new \RectorPrefix20220506\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder('element');
