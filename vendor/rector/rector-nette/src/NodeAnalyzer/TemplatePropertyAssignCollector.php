...
use RectorPrefix20220606\Rector\Nette\ValueObject\AlwaysTemplateParameterAssign;
use RectorPrefix20220606\Rector\Nette\ValueObject\ParameterAssign;
...
final class TemplatePropertyAssignCollector
{
    ...
    public function __construct(ScopeNestingComparator $scopeNestingComparator, BetterNodeFinder $betterNodeFinder, ThisTemplatePropertyFetchAnalyzer $thisTemplatePropertyFetchAnalyzer, ReturnAnalyzer $returnAnalyzer)
    {
