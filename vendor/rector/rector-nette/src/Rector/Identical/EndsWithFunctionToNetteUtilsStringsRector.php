...
CODE_SAMPLE
    ...
    public function refactor(Node $node) : ?Node
    {
        ...
        $staticCall = $this->nodeFactory->createStaticCall('RectorPrefix20220607\\Nette\\Utils\\Strings', 'endsWith', [$contentExprAndNeedleExpr->getContentExpr(), $contentExprAndNeedleExpr->getNeedleExpr()]);
