...
, [self::FORM_DATA_CLASS_PARENT => '', self::FORM_DATA_CLASS_TRAITS => []])]);
    ...
    public function configure(array $configuration) : void
    {
        if (isset($configuration[self::FORM_DATA_CLASS_PARENT])) {
            ...
            \RectorPrefix20220414\Webmozart\Assert\Assert::string($formDataClassParent);
        ...
        if (isset($configuration[self::FORM_DATA_CLASS_TRAITS])) {
            ...
            \RectorPrefix20220414\Webmozart\Assert\Assert::isArray($formDataClassTraits);
            \RectorPrefix20220414\Webmozart\Assert\Assert::allString($formDataClassTraits);
