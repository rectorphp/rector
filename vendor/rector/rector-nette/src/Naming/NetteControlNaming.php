...
final class NetteControlNaming
{
    ...
    {
        $variableNameUnicodeString = new \RectorPrefix20220105\Symfony\Component\String\UnicodeString($shortName);
    ...
    {
        $shortNameUnicodeString = new \RectorPrefix20220105\Symfony\Component\String\UnicodeString($shortName);
