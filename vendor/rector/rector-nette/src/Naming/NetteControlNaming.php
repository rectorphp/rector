...
final class NetteControlNaming
{
    ...
    {
        $variableNameUnicodeString = new \RectorPrefix20220126\Symfony\Component\String\UnicodeString($shortName);
    ...
    {
        $shortNameUnicodeString = new \RectorPrefix20220126\Symfony\Component\String\UnicodeString($shortName);
