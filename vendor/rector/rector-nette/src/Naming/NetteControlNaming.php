...
final class NetteControlNaming
{
    ...
    {
        $variableNameUnicodeString = new \RectorPrefix20220331\Symfony\Component\String\UnicodeString($shortName);
    ...
    {
        $shortNameUnicodeString = new \RectorPrefix20220331\Symfony\Component\String\UnicodeString($shortName);
