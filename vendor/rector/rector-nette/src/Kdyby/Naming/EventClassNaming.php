...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \RectorPrefix20220521\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \RectorPrefix20220521\Nette\Utils\Strings::substring($property, \strlen('on'));
