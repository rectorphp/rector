...
\class_exists(\RectorPrefix20211006\Symfony\Component\HttpFoundation\ResponseHeaderBag::class);
/**
...
class Response
{
    ...
    {
        $this->headers = new \RectorPrefix20211006\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
