...
\class_exists(\RectorPrefix20210827\Symfony\Component\HttpFoundation\ResponseHeaderBag::class);
/**
...
class Response
{
    ...
    {
        $this->headers = new \RectorPrefix20210827\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @param bool $safe
     */
    public function setContentSafe($safe = \true) : void
    {
        if ($safe) {
