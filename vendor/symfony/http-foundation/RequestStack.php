...
class RequestStack
{
     ...
     */
    public function push(\RectorPrefix20210629\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * like ESI support.
     */
    public function getMainRequest() : ?\RectorPrefix20210629\Symfony\Component\HttpFoundation\Request
    {
        if (!$this->requests) {
            return null;
        }
     ...
     */
    public function getSession() : \RectorPrefix20210629\Symfony\Component\HttpFoundation\Session\SessionInterface
    {
        if (null !== ($request = \end($this->requests) ?: null) && $request->hasSession()) {
            return $request->getSession();
        }
        throw new \RectorPrefix20210629\Symfony\Component\HttpFoundation\Exception\SessionNotFoundException();
    }
}
