 ...
 */
namespace RectorPrefix20211001\Symfony\Component\HttpFoundation\Session\Storage\Handler;
...
abstract class AbstractSessionHandler implements \SessionHandlerInterface, \SessionUpdateTimestampHandlerInterface
{
    ...
    public function destroy($sessionId)
    {
        if (!\headers_sent() && \filter_var(\ini_get('session.use_cookies'), \FILTER_VALIDATE_BOOLEAN)) {
            ...
            $cookie = \RectorPrefix20211001\Symfony\Component\HttpFoundation\Session\SessionUtils::popSessionCookie($this->sessionName, $sessionId);
            /*
