 ...
 */
class RequestMatcher implements \RectorPrefix20210926\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches($request)
    {
        ...
        if (\RectorPrefix20210926\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
