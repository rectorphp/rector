 ...
 */
class RequestMatcher implements \RectorPrefix20210802\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches($request)
    {
        ...
        if (\RectorPrefix20210802\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
