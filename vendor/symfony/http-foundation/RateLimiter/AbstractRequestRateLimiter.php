 ...
 */
namespace RectorPrefix20210822\Symfony\Component\HttpFoundation\RateLimiter;

use RectorPrefix20210822\Symfony\Component\HttpFoundation\Request;
use RectorPrefix20210822\Symfony\Component\RateLimiter\LimiterInterface;
use RectorPrefix20210822\Symfony\Component\RateLimiter\Policy\NoLimiter;
use RectorPrefix20210822\Symfony\Component\RateLimiter\RateLimit;
/**
...
abstract class AbstractRequestRateLimiter implements \RectorPrefix20210822\Symfony\Component\HttpFoundation\RateLimiter\RequestRateLimiterInterface
{
    ...
    public function consume($request) : \RectorPrefix20210822\Symfony\Component\RateLimiter\RateLimit
    {
        ...
        if (0 === \count($limiters)) {
            $limiters = [new \RectorPrefix20210822\Symfony\Component\RateLimiter\Policy\NoLimiter()];
        }
