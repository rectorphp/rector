...
use RectorPrefix20210828\Symfony\Component\RateLimiter\LimiterInterface;
use RectorPrefix20210828\Symfony\Component\RateLimiter\Policy\NoLimiter;
 ...
 * @experimental in 5.3
 */
abstract class AbstractRequestRateLimiter implements \RectorPrefix20210828\Symfony\Component\HttpFoundation\RateLimiter\RequestRateLimiterInterface
{
    /**
    ...
    public function consume($request) : \RectorPrefix20210828\Symfony\Component\RateLimiter\RateLimit
    {
        ...
        if (0 === \count($limiters)) {
            $limiters = [new \RectorPrefix20210828\Symfony\Component\RateLimiter\Policy\NoLimiter()];
        }
