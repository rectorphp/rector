 ...
 */
final class ResponseFormatSame extends \RectorPrefix20210809\PHPUnit\Framework\Constraint\Constraint
{
    private $request;
    private $format;
    public function __construct(\RectorPrefix20210809\Symfony\Component\HttpFoundation\Request $request, ?string $format)
    {
