 ...
 */
final class ResponseFormatSame extends \RectorPrefix20211005\PHPUnit\Framework\Constraint\Constraint
{
    private $request;
    private $format;
    public function __construct(\RectorPrefix20211005\Symfony\Component\HttpFoundation\Request $request, ?string $format)
    {
