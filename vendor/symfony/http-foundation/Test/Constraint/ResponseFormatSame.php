 ...
 */
final class ResponseFormatSame extends \RectorPrefix20210828\PHPUnit\Framework\Constraint\Constraint
{
    private $request;
    private $format;
    public function __construct(\RectorPrefix20210828\Symfony\Component\HttpFoundation\Request $request, ?string $format)
    {
