...
final class ResponseHasCookie extends \RectorPrefix20211020\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $path;
    private $domain;
    ...
    private function getCookie(\RectorPrefix20211020\Symfony\Component\HttpFoundation\Response $response) : ?\RectorPrefix20211020\Symfony\Component\HttpFoundation\Cookie
    {
