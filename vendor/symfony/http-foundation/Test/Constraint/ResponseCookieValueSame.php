...
use RectorPrefix20210801\Symfony\Component\HttpFoundation\Cookie;
use RectorPrefix20210801\Symfony\Component\HttpFoundation\Response;
final class ResponseCookieValueSame extends \RectorPrefix20210801\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
    ...
    protected function getCookie(\RectorPrefix20210801\Symfony\Component\HttpFoundation\Response $response) : ?\RectorPrefix20210801\Symfony\Component\HttpFoundation\Cookie
    {
        $cookies = $response->headers->getCookies();
        $filteredCookies = \array_filter($cookies, function (\RectorPrefix20210801\Symfony\Component\HttpFoundation\Cookie $cookie) {
