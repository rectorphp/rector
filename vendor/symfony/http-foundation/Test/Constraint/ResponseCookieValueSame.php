...
final class ResponseCookieValueSame extends \RectorPrefix20210607\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
    ...
    protected function getCookie(\RectorPrefix20210607\Symfony\Component\HttpFoundation\Response $response) : ?\RectorPrefix20210607\Symfony\Component\HttpFoundation\Cookie
    {
        $cookies = $response->headers->getCookies();
        $filteredCookies = \array_filter($cookies, function (\RectorPrefix20210607\Symfony\Component\HttpFoundation\Cookie $cookie) {
