...
use RectorPrefix20211005\Symfony\Component\HttpFoundation\Cookie;
use RectorPrefix20211005\Symfony\Component\HttpFoundation\Response;
final class ResponseCookieValueSame extends \RectorPrefix20211005\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
    ...
    protected function getCookie(\RectorPrefix20211005\Symfony\Component\HttpFoundation\Response $response) : ?\RectorPrefix20211005\Symfony\Component\HttpFoundation\Cookie
    {
        $cookies = $response->headers->getCookies();
        $filteredCookies = \array_filter($cookies, function (\RectorPrefix20211005\Symfony\Component\HttpFoundation\Cookie $cookie) {
