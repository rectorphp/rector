 ...
 */
final class CompletionInput extends \RectorPrefix20211209\Symfony\Component\Console\Input\ArgvInput
{
    ...
    protected function parseToken($token, $parseOptions) : bool
    {
        ...
        } catch (\RectorPrefix20211209\Symfony\Component\Console\Exception\RuntimeException $e) {
            // suppress errors, completed input is almost never valid
        }
        return $parseOptions;
    }
    private function getOptionFromToken(string $optionToken) : ?\RectorPrefix20211209\Symfony\Component\Console\Input\InputOption
    {
