 ...
 */
final class CompletionInput extends \RectorPrefix20220607\Symfony\Component\Console\Input\ArgvInput
{
     ...
     * {@inheritdoc}
     */
    public function bind(\RectorPrefix20220607\Symfony\Component\Console\Input\InputDefinition $definition) : void
    {
    ...
    protected function parseToken(string $token, bool $parseOptions) : bool
    {
        ...
        } catch (\RectorPrefix20220607\Symfony\Component\Console\Exception\RuntimeException $exception) {
            // suppress errors, completed input is almost never valid
        }
        return $parseOptions;
    }
    private function getOptionFromToken(string $optionToken) : ?\RectorPrefix20220607\Symfony\Component\Console\Input\InputOption
    {
