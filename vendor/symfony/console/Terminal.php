 ...
 */
namespace RectorPrefix202601\Symfony\Component\Console;

use RectorPrefix202601\Symfony\Component\Console\Output\AnsiColorMode;
class Terminal
{
    ...
    public static function hasSttyAvailable(): bool
    {
        ...
        if (!\function_exists('shell_exec') && !\function_exists('RectorPrefix202601\shell_exec')) {
            return \false;
        }
    ...
    {
        if (!\function_exists('proc_open') && !\function_exists('RectorPrefix202601\proc_open')) {
            return null;
        }
