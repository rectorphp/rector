 ...
 */
namespace RectorPrefix202604\Symfony\Component\Console;

use RectorPrefix202604\Symfony\Component\Console\Output\AnsiColorMode;
class Terminal
{
    ...
    public static function hasSttyAvailable(): bool
    {
        ...
        if (!\function_exists('shell_exec') && !\function_exists('RectorPrefix202604\shell_exec')) {
            return \false;
        }
