...
use RectorPrefix20220202\Symfony\Component\Console\Descriptor\ApplicationDescription;
use RectorPrefix20220202\Symfony\Component\Console\Helper\DescriptorHelper;
 ...
 */
class ListCommand extends \RectorPrefix20220202\Symfony\Component\Console\Command\Command
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->setName('list')->setDefinition([new \RectorPrefix20220202\Symfony\Component\Console\Input\InputArgument('namespace', \RectorPrefix20220202\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The namespace name'), new \RectorPrefix20220202\Symfony\Component\Console\Input\InputOption('raw', null, \RectorPrefix20220202\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command list'), new \RectorPrefix20220202\Symfony\Component\Console\Input\InputOption('format', null, \RectorPrefix20220202\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt'), new \RectorPrefix20220202\Symfony\Component\Console\Input\InputOption('short', null, \RectorPrefix20220202\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To skip describing commands\' arguments')])->setDescription('List commands')->setHelp(<<<'EOF'
...
EOF
    ...
    {
        $helper = new \RectorPrefix20220202\Symfony\Component\Console\Helper\DescriptorHelper();
    ...
    public function complete(\RectorPrefix20220202\Symfony\Component\Console\Completion\CompletionInput $input, \RectorPrefix20220202\Symfony\Component\Console\Completion\CompletionSuggestions $suggestions) : void
    {
        if ($input->mustSuggestArgumentValuesFor('namespace')) {
            $descriptor = new \RectorPrefix20220202\Symfony\Component\Console\Descriptor\ApplicationDescription($this->getApplication());
