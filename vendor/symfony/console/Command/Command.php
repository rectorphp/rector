...
class Command
{
    ...
    {
        $class = static::class;
        if ($attribute = \method_exists(new \ReflectionClass($class), 'getAttributes') ? (new \ReflectionClass($class))->getAttributes(\RectorPrefix20220604\Symfony\Component\Console\Attribute\AsCommand::class) : []) {
    ...
    {
        $this->definition = new \RectorPrefix20220604\Symfony\Component\Console\Input\InputDefinition();
    ...
    public function setApplication(\RectorPrefix20220604\Symfony\Component\Console\Application $application = null)
    {
     ...
     */
    public function getApplication() : ?\RectorPrefix20220604\Symfony\Component\Console\Application
    {
     ...
     * @see setCode()
     */
    protected function execute(\RectorPrefix20220604\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20220604\Symfony\Component\Console\Output\OutputInterface $output)
    {
        throw new \RectorPrefix20220604\Symfony\Component\Console\Exception\LogicException('You must override the execute() method in the concrete command class.');
    }
    /**
     ...
     */
    protected function interact(\RectorPrefix20220604\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20220604\Symfony\Component\Console\Output\OutputInterface $output)
    {
    }
    /**
     ...
     */
    protected function initialize(\RectorPrefix20220604\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20220604\Symfony\Component\Console\Output\OutputInterface $output)
    {
    }
    /**
     * Runs the command.
     ...
     * @see execute()
     */
    public function run(\RectorPrefix20220604\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20220604\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        if (null !== $this->processTitle) {
            if (\function_exists('cli_set_process_title')) {
                if (!@\cli_set_process_title($this->processTitle)) {
                    if ('Darwin' === \PHP_OS) {
                        $output->writeln('<comment>Running "cli_set_process_title" as an unprivileged user is not supported on MacOS.</comment>', \RectorPrefix20220604\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERY_VERBOSE);
                    } else {
                        \cli_set_process_title($this->processTitle);
                    }
                }
            } elseif (\function_exists('RectorPrefix20220604\\setproctitle')) {
                setproctitle($this->processTitle);
            } elseif (\RectorPrefix20220604\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERY_VERBOSE === $output->getVerbosity()) {
    ...
    public function mergeApplicationDefinition(bool $mergeArgs = \true)
    {
        ...
        $this->fullDefinition = new \RectorPrefix20220604\Symfony\Component\Console\Input\InputDefinition();
    ...
    {
        if ($definition instanceof \RectorPrefix20220604\Symfony\Component\Console\Input\InputDefinition) {
     ...
     * This method is not part of public API and should not be used directly.
     */
    public function getNativeDefinition() : \RectorPrefix20220604\Symfony\Component\Console\Input\InputDefinition
    {
        if (!isset($this->definition)) {
            throw new \RectorPrefix20220604\Symfony\Component\Console\Exception\LogicException(\sprintf('Command class "%s" is not correctly initialized. You probably forgot to call the parent constructor.', static::class));
        }
    ...
    {
        if (!\preg_match('/^[^\\:]++(\\:[^\\:]++)*$/', $name)) {
            throw new \RectorPrefix20220604\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Command name "%s" is invalid.', $name));
        }
    }
}
