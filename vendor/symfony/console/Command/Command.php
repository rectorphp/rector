...
use RectorPrefix20211210\Symfony\Component\Console\Attribute\AsCommand;
...
class Command
{
    ...
    {
        $this->definition = new \RectorPrefix20211210\Symfony\Component\Console\Input\InputDefinition();
     ...
     */
    public function getApplication() : ?\RectorPrefix20211210\Symfony\Component\Console\Application
    {
        ...
        if (null !== $this->processTitle) {
            if (\function_exists('cli_set_process_title')) {
                if (!@\cli_set_process_title($this->processTitle)) {
                    if ('Darwin' === \PHP_OS) {
                        $output->writeln('<comment>Running "cli_set_process_title" as an unprivileged user is not supported on MacOS.</comment>', \RectorPrefix20211210\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERY_VERBOSE);
                    } else {
                        \cli_set_process_title($this->processTitle);
                    }
                }
            } elseif (\function_exists('RectorPrefix20211210\\setproctitle')) {
                setproctitle($this->processTitle);
            } elseif (\RectorPrefix20211210\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERY_VERBOSE === $output->getVerbosity()) {
    ...
    public function mergeApplicationDefinition(bool $mergeArgs = \true)
    {
        ...
        $this->fullDefinition = new \RectorPrefix20211210\Symfony\Component\Console\Input\InputDefinition();
    ...
    {
        if ($definition instanceof \RectorPrefix20211210\Symfony\Component\Console\Input\InputDefinition) {
     ...
     * This method is not part of public API and should not be used directly.
     */
    public function getNativeDefinition() : \RectorPrefix20211210\Symfony\Component\Console\Input\InputDefinition
    {
        if (!isset($this->definition)) {
            throw new \RectorPrefix20211210\Symfony\Component\Console\Exception\LogicException(\sprintf('Command class "%s" is not correctly initialized. You probably forgot to call the parent constructor.', static::class));
        }
    ...
    public function addArgument(string $name, int $mode = null, string $description = '', $default = null)
    {
        ...
        if (null !== $this->fullDefinition) {
            $this->fullDefinition->addArgument(new \RectorPrefix20211210\Symfony\Component\Console\Input\InputArgument($name, $mode, $description, $default));
        }
        return $this;
    }
    /**
    ...
    public function addOption(string $name, $shortcut = null, int $mode = null, string $description = '', $default = null)
    {
        ...
        if (null !== $this->fullDefinition) {
            $this->fullDefinition->addOption(new \RectorPrefix20211210\Symfony\Component\Console\Input\InputOption($name, $shortcut, $mode, $description, $default));
        }
        return $this;
    }
    /**
    ...
    {
        if (!\preg_match('/^[^\\:]++(\\:[^\\:]++)*$/', $name)) {
            throw new \RectorPrefix20211210\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Command name "%s" is invalid.', $name));
        }
    }
}
