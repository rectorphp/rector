 ...
 */
namespace RectorPrefix20211209\Symfony\Component\Console\Descriptor;
 ...
 * @internal
 */
abstract class Descriptor implements \RectorPrefix20211209\Symfony\Component\Console\Descriptor\DescriptorInterface
{
    /**
     * @var OutputInterface
     */
    ...
    public function describe($output, $object, $options = [])
    {
        $this->output = $output;
        switch (\true) {
            case $object instanceof \RectorPrefix20211209\Symfony\Component\Console\Input\InputArgument:
                $this->describeInputArgument($object, $options);
                break;
            case $object instanceof \RectorPrefix20211209\Symfony\Component\Console\Input\InputOption:
                $this->describeInputOption($object, $options);
                break;
            case $object instanceof \RectorPrefix20211209\Symfony\Component\Console\Input\InputDefinition:
                $this->describeInputDefinition($object, $options);
                break;
            case $object instanceof \RectorPrefix20211209\Symfony\Component\Console\Command\Command:
                $this->describeCommand($object, $options);
                break;
            case $object instanceof \RectorPrefix20211209\Symfony\Component\Console\Application:
                $this->describeApplication($object, $options);
                break;
            default:
                throw new \RectorPrefix20211209\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Object of type "%s" is not describable.', \get_debug_type($object)));
        }
    }
    /**
    ...
    {
        $this->output->write($content, \false, $decorated ? \RectorPrefix20211209\Symfony\Component\Console\Output\OutputInterface::OUTPUT_NORMAL : \RectorPrefix20211209\Symfony\Component\Console\Output\OutputInterface::OUTPUT_RAW);
    }
    /**
