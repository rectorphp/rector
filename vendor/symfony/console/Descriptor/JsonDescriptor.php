 ...
 * @internal
 */
class JsonDescriptor extends \RectorPrefix20210804\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
    ...
    protected function describeApplication($application, $options = [])
    {
        ...
        $description = new \RectorPrefix20210804\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
    ...
    private function getInputArgumentData(\RectorPrefix20210804\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\RectorPrefix20210804\Symfony\Component\Console\Input\InputOption $option, bool $negated = \false) : array
    {
    ...
    private function getInputDefinitionData(\RectorPrefix20210804\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
    ...
    private function getCommandData(\RectorPrefix20210804\Symfony\Component\Console\Command\Command $command, bool $short = \false) : array
    {
