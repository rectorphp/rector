 ...
 * @internal
 */
class XmlDescriptor extends \RectorPrefix20220112\Symfony\Component\Console\Descriptor\Descriptor
{
    public function getInputDefinitionDocument(\RectorPrefix20220112\Symfony\Component\Console\Input\InputDefinition $definition) : \DOMDocument
    {
    ...
    public function getCommandDocument(\RectorPrefix20220112\Symfony\Component\Console\Command\Command $command, bool $short = \false) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    public function getApplicationDocument(\RectorPrefix20220112\Symfony\Component\Console\Application $application, string $namespace = null, bool $short = \false) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
        ...
        $description = new \RectorPrefix20220112\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\RectorPrefix20220112\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\RectorPrefix20220112\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
