 ...
 * @internal
 */
class XmlDescriptor extends \RectorPrefix20211018\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
    ...
    public function getApplicationDocument($application, $namespace = null, $short = \false) : \DOMDocument
    {
        ...
        $description = new \RectorPrefix20211018\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\RectorPrefix20211018\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\RectorPrefix20211018\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
