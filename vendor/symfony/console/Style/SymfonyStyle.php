...
class SymfonyStyle extends \RectorPrefix20220101\Symfony\Component\Console\Style\OutputStyle
{
    ...
    {
        $this->autoPrependBlock();
        $this->writeln([\sprintf('<comment>%s</>', \RectorPrefix20220101\Symfony\Component\Console\Formatter\OutputFormatter::escapeTrailingBackslash($message)), \sprintf('<comment>%s</>', \str_repeat('=', \RectorPrefix20220101\Symfony\Component\Console\Helper\Helper::width(\RectorPrefix20220101\Symfony\Component\Console\Helper\Helper::removeDecoration($this->getFormatter(), $message))))]);
        $this->newLine();
    }
    /**
     * {@inheritdoc}
