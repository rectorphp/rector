 ...
 */
abstract class OutputStyle implements \RectorPrefix20211210\Symfony\Component\Console\Output\OutputInterface, \RectorPrefix20211210\Symfony\Component\Console\Style\StyleInterface
{
    private $output;
    ...
    {
        if (!$this->output instanceof \RectorPrefix20211210\Symfony\Component\Console\Output\ConsoleOutputInterface) {
            return $this->output;
        }
