 ...
 */
namespace RectorPrefix20211210\Symfony\Component\Console\Input;
...
class InputDefinition
{
    ...
    public function setDefinition($definition)
    {
        ...
        foreach ($definition as $item) {
            if ($item instanceof \RectorPrefix20211210\Symfony\Component\Console\Input\InputOption) {
                $options[] = $item;
            } else {
                $arguments[] = $item;
            }
    ...
    public function addArgument($argument)
    {
        ...
        if (null !== $this->lastArrayArgument) {
            throw new \RectorPrefix20211210\Symfony\Component\Console\Exception\LogicException(\sprintf('Cannot add a required argument "%s" after an array argument "%s".', $argument->getName(), $this->lastArrayArgument->getName()));
        }
        if ($argument->isRequired() && null !== $this->lastOptionalArgument) {
            throw new \RectorPrefix20211210\Symfony\Component\Console\Exception\LogicException(\sprintf('Cannot add a required argument "%s" after an optional one "%s".', $argument->getName(), $this->lastOptionalArgument->getName()));
        }
        if ($argument->isArray()) {
     ...
     */
    public function getArgument($name) : \RectorPrefix20211210\Symfony\Component\Console\Input\InputArgument
    {
    ...
    public function addOption($option)
    {
        ...
        if ($option->getShortcut()) {
            foreach (\explode('|', $option->getShortcut()) as $shortcut) {
                if (isset($this->shortcuts[$shortcut]) && !$option->equals($this->options[$this->shortcuts[$shortcut]])) {
                    throw new \RectorPrefix20211210\Symfony\Component\Console\Exception\LogicException(\sprintf('An option with shortcut "%s" already exists.', $shortcut));
                }
            }
        }
        ...
        if ($option->isNegatable()) {
            ...
            if (isset($this->options[$negatedName])) {
                throw new \RectorPrefix20211210\Symfony\Component\Console\Exception\LogicException(\sprintf('An option named "%s" already exists.', $negatedName));
            }
