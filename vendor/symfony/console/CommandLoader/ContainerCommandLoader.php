 ...
 */
class ContainerCommandLoader implements \RectorPrefix20220221\Symfony\Component\Console\CommandLoader\CommandLoaderInterface
{
    private $container;
    /**
     * @var mixed[]
     ...
     */
    public function __construct(\RectorPrefix20220221\Psr\Container\ContainerInterface $container, array $commandMap)
    {
    ...
    {
        if (!$this->has($name)) {
            throw new \RectorPrefix20220221\Symfony\Component\Console\Exception\CommandNotFoundException(\sprintf('Command "%s" does not exist.', $name));
        }
