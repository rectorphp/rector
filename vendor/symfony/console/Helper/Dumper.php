...
use RectorPrefix20220604\Symfony\Component\VarDumper\Cloner\ClonerInterface;
use RectorPrefix20220604\Symfony\Component\VarDumper\Cloner\VarCloner;
use RectorPrefix20220604\Symfony\Component\VarDumper\Dumper\CliDumper;
/**
...
final class Dumper
{
     ...
     */
    private $handler;
    public function __construct(\RectorPrefix20220604\Symfony\Component\Console\Output\OutputInterface $output, \RectorPrefix20220604\Symfony\Component\VarDumper\Dumper\CliDumper $dumper = null, \RectorPrefix20220604\Symfony\Component\VarDumper\Cloner\ClonerInterface $cloner = null)
    {
        $this->output = $output;
        $this->dumper = $dumper;
        $this->cloner = $cloner;
