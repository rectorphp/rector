...
use RectorPrefix202606\Symfony\Component\Console\Exception\MissingInputException;
...
use RectorPrefix202606\Symfony\Component\Console\Formatter\OutputFormatterStyle;
use RectorPrefix202606\Symfony\Component\Console\Input\InputInterface;
use RectorPrefix202606\Symfony\Component\Console\Input\StreamableInputInterface;
...
use function RectorPrefix202606\Symfony\Component\String\s;
/**
            ...
            if (\false === $c || '' === $ret && '' === $c && null === $question->getDefault()) {
                ...
                if ("\t" === $c || "\n" === $c) {
                    if ($numMatches > 0 && -1 !== $ofs) {
                        ...
                        $matches = array_filter($autocomplete($ret), static fn($match) => '' === $ret || strncmp($match, $ret, strlen($ret)) === 0);
                        $numMatches = \count($matches);
                        $ofs = -1;
                    }
                    if ("\n" === $c) {
