 ...
 */
abstract class Helper implements \RectorPrefix20220202\Symfony\Component\Console\Helper\HelperInterface
{
    ...
    public static function width(?string $string) : int
    {
        ...
        if (\preg_match('//u', $string)) {
            return (new \RectorPrefix20220202\Symfony\Component\String\UnicodeString($string))->width(\false);
        }
    ...
    public static function length(?string $string) : int
    {
        $string ?? ($string = '');
        if (\preg_match('//u', $string)) {
            return (new \RectorPrefix20220202\Symfony\Component\String\UnicodeString($string))->length();
        }
        if (\false === ($encoding = \mb_detect_encoding($string, null, \true))) {
            return \strlen($string);
        }
    ...
    public static function removeDecoration(\RectorPrefix20220202\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter, ?string $string)
    {
