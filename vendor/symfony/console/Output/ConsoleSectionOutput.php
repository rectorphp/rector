 ...
 */
class ConsoleSectionOutput extends \RectorPrefix20210705\Symfony\Component\Console\Output\StreamOutput
{
    private $content = [];
    private $lines = 0;
    private $sections;
     ...
     */
    public function __construct($stream, array &$sections, int $verbosity, bool $decorated, \RectorPrefix20210705\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter)
    {
