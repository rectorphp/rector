 ...
 */
namespace RectorPrefix20210730\Symfony\Component\Console\Logger;

use RectorPrefix20210730\Psr\Log\AbstractLogger;
use RectorPrefix20210730\Psr\Log\InvalidArgumentException;
...
class ConsoleLogger extends \RectorPrefix20210730\Psr\Log\AbstractLogger
{
    ...
    public function __construct(\RectorPrefix20210730\Symfony\Component\Console\Output\OutputInterface $output, array $verbosityLevelMap = [], array $formatLevelMap = [])
    {
        $this->output = $output;
    ...
    public function log($level, $message, $context = [])
    {
        if (!isset($this->verbosityLevelMap[$level])) {
            throw new \RectorPrefix20210730\Psr\Log\InvalidArgumentException(\sprintf('The log level "%s" does not exist.', $level));
        }
        $output = $this->output;
