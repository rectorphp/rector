 ...
 */
namespace RectorPrefix20220607\Symfony\Component\Console\Logger;

use RectorPrefix20220607\Psr\Log\AbstractLogger;
use RectorPrefix20220607\Psr\Log\InvalidArgumentException;
 ...
 */
class ConsoleLogger extends \RectorPrefix20220607\Psr\Log\AbstractLogger
{
    ...
    public function log($level, $message, array $context = []) : void
    {
        if (!isset($this->verbosityLevelMap[$level])) {
            throw new \RectorPrefix20220607\Psr\Log\InvalidArgumentException(\sprintf('The log level "%s" does not exist.', $level));
        }
        $output = $this->output;
