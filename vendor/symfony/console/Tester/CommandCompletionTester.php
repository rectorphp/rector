 ...
 */
namespace RectorPrefix20211209\Symfony\Component\Console\Tester;
...
class CommandCompletionTester
{
    ...
    public function complete(array $input) : array
    {
        ...
        $completionInput = \RectorPrefix20211209\Symfony\Component\Console\Completion\CompletionInput::fromTokens($input, $currentIndex);
        $completionInput->bind($this->command->getDefinition());
        $suggestions = new \RectorPrefix20211209\Symfony\Component\Console\Completion\CompletionSuggestions();
