 ...
 */
namespace RectorPrefix20220209\Symfony\Component\Console\Tester;
...
{
    private $command;
    public function __construct(\RectorPrefix20220209\Symfony\Component\Console\Command\Command $command)
    {
    ...
    public function complete(array $input) : array
    {
        ...
        $completionInput = \RectorPrefix20220209\Symfony\Component\Console\Completion\CompletionInput::fromTokens($input, $currentIndex);
