 ...
 */
class OutputFormatterStyleStack implements \RectorPrefix20210904\Symfony\Contracts\Service\ResetInterface
{
    /**
    ...
    private $styles;
    private $emptyStyle;
    public function __construct(\RectorPrefix20210904\Symfony\Component\Console\Formatter\OutputFormatterStyleInterface $emptyStyle = null)
    {
    ...
    public function pop($style = null)
    {
        ...
        throw new \RectorPrefix20210904\Symfony\Component\Console\Exception\InvalidArgumentException('Incorrectly nested style tag found.');
    }
    /**
