 ...
 */
class OutputFormatterStyleStack implements \RectorPrefix20211118\Symfony\Contracts\Service\ResetInterface
{
    /**
    ...
    private $styles;
    private $emptyStyle;
    public function __construct(\RectorPrefix20211118\Symfony\Component\Console\Formatter\OutputFormatterStyleInterface $emptyStyle = null)
    {
        $this->emptyStyle = $emptyStyle ?? new \RectorPrefix20211118\Symfony\Component\Console\Formatter\OutputFormatterStyle();
        $this->reset();
    }
    /**
    ...
    public function pop($style = null)
    {
        ...
        throw new \RectorPrefix20211118\Symfony\Component\Console\Exception\InvalidArgumentException('Incorrectly nested style tag found.');
    }
    /**
