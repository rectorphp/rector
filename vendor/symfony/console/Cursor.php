 ...
 */
namespace RectorPrefix20210806\Symfony\Component\Console;
...
final class Cursor
{
    private $output;
    private $input;
    public function __construct(\RectorPrefix20210806\Symfony\Component\Console\Output\OutputInterface $output, $input = null)
    {
        $this->output = $output;
