 ...
 */
namespace RectorPrefix20220120\Symfony\Component\VarExporter\Internal;

use RectorPrefix20220120\Symfony\Component\VarExporter\Exception\ClassNotFoundException;
/**
...
class Hydrator
{
    ...
    public $value;
    public $wakeups;
    public function __construct(?\RectorPrefix20220120\Symfony\Component\VarExporter\Internal\Registry $registry, ?\RectorPrefix20220120\Symfony\Component\VarExporter\Internal\Values $values, array $properties, $value, array $wakeups)
    {
    ...
    public static function getHydrator($class)
    {
        ...
        if (!\class_exists($class) && !\interface_exists($class, \false) && !\trait_exists($class, \false)) {
            throw new \RectorPrefix20220120\Symfony\Component\VarExporter\Exception\ClassNotFoundException($class);
        }
