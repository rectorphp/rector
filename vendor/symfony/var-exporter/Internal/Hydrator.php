 ...
 */
namespace RectorPrefix20210717\Symfony\Component\VarExporter\Internal;

use RectorPrefix20210717\Symfony\Component\VarExporter\Exception\ClassNotFoundException;
/**
...
class Hydrator
{
    ...
    public $value;
    public $wakeups;
    public function __construct(?\RectorPrefix20210717\Symfony\Component\VarExporter\Internal\Registry $registry, ?\RectorPrefix20210717\Symfony\Component\VarExporter\Internal\Values $values, array $properties, $value, array $wakeups)
    {
    ...
    public static function getHydrator($class)
    {
        ...
        if (!\class_exists($class) && !\interface_exists($class, \false) && !\trait_exists($class, \false)) {
            throw new \RectorPrefix20210717\Symfony\Component\VarExporter\Exception\ClassNotFoundException($class);
        }
