...
class Registry
{
    ...
    public static function getClassReflector($class, $instantiableWithoutConstructor = \false, $cloneable = null)
    {
        ...
        if ($instantiableWithoutConstructor) {
            ...
            throw new \RectorPrefix20210605\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException($class);
            ...
            try {
                ...
                if ('C:' === $proto && !$reflector->getMethod('unserialize')->isInternal()) {
                    ...
                    try {
                        ...
                        throw new \RectorPrefix20210605\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException($class, $e);
                    }
                    if (\false === $proto) {
                        throw new \RectorPrefix20210605\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException($class);
                    }
