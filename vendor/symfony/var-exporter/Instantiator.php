...
use RectorPrefix20210919\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException;
...
final class Instantiator
{
    ...
    {
        $reflector = \RectorPrefix20210919\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$class] ?? \RectorPrefix20210919\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class);
        if (\RectorPrefix20210919\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
            $wrappedInstance = [clone \RectorPrefix20210919\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]];
        } elseif (\RectorPrefix20210919\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            $wrappedInstance = [$reflector->newInstanceWithoutConstructor()];
        } elseif (null === \RectorPrefix20210919\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]) {
            throw new \RectorPrefix20210919\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException($class);
        ...
        foreach ($privateProperties as $class => $properties) {
            ...
            (\RectorPrefix20210919\Symfony\Component\VarExporter\Internal\Hydrator::$hydrators[$class] ?? \RectorPrefix20210919\Symfony\Component\VarExporter\Internal\Hydrator::getHydrator($class))($properties, $wrappedInstance);
        }
