 ...
 */
namespace RectorPrefix20210908\Symfony\Component\VarExporter;

use RectorPrefix20210908\Symfony\Component\VarExporter\Exception\ExceptionInterface;
use RectorPrefix20210908\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException;
use RectorPrefix20210908\Symfony\Component\VarExporter\Internal\Hydrator;
use RectorPrefix20210908\Symfony\Component\VarExporter\Internal\Registry;
/**
...
final class Instantiator
{
    ...
    {
        $reflector = \RectorPrefix20210908\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$class] ?? \RectorPrefix20210908\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class);
        if (\RectorPrefix20210908\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
            $wrappedInstance = [clone \RectorPrefix20210908\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]];
        } elseif (\RectorPrefix20210908\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            $wrappedInstance = [$reflector->newInstanceWithoutConstructor()];
        } elseif (null === \RectorPrefix20210908\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]) {
        ...
        foreach ($privateProperties as $class => $properties) {
            ...
            (\RectorPrefix20210908\Symfony\Component\VarExporter\Internal\Hydrator::$hydrators[$class] ?? \RectorPrefix20210908\Symfony\Component\VarExporter\Internal\Hydrator::getHydrator($class))($properties, $wrappedInstance);
        }
