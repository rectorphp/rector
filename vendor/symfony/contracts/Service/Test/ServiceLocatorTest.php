 ...
 */
namespace RectorPrefix202212\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\RectorPrefix202212\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\RectorPrefix202212\Psr\Container\ContainerExceptionInterface::class);
