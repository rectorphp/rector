 ...
 */
namespace RectorPrefix202302\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\RectorPrefix202302\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\RectorPrefix202302\Psr\Container\ContainerExceptionInterface::class);
