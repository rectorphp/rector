 ...
 */
namespace RectorPrefix202308\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\RectorPrefix202308\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\RectorPrefix202308\Psr\Container\ContainerExceptionInterface::class);
