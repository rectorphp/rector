...
use RectorPrefix20211207\Symfony\Component\Translation\Exception\InvalidArgumentException;
/**
...
EOF;
        ...
        if (!isset($standardRules[$position])) {
            ...
            if (\class_exists(\RectorPrefix20211207\Symfony\Component\Translation\Exception\InvalidArgumentException::class)) {
                throw new \RectorPrefix20211207\Symfony\Component\Translation\Exception\InvalidArgumentException($message);
            }
