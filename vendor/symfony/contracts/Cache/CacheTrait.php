 ...
 */
namespace RectorPrefix20220604\Symfony\Contracts\Cache;

use RectorPrefix20220604\Psr\Cache\CacheItemPoolInterface;
use RectorPrefix20220604\Psr\Cache\InvalidArgumentException;
use RectorPrefix20220604\Psr\Log\LoggerInterface;
// Help opcache.preload discover always-needed symbols
\class_exists(\RectorPrefix20220604\Psr\Cache\InvalidArgumentException::class);
/**
...
trait CacheTrait
{
    ...
    private function doGet(\RectorPrefix20220604\Psr\Cache\CacheItemPoolInterface $pool, string $key, callable $callback, ?float $beta, array &$metadata = null, \RectorPrefix20220604\Psr\Log\LoggerInterface $logger = null) : mixed
    {
        ...
        $metadata = $item instanceof \RectorPrefix20220604\Symfony\Contracts\Cache\ItemInterface ? $item->getMetadata() : [];
        if (!$recompute && $metadata) {
            $expiry = $metadata[\RectorPrefix20220604\Symfony\Contracts\Cache\ItemInterface::METADATA_EXPIRY] ?? \false;
            $ctime = $metadata[\RectorPrefix20220604\Symfony\Contracts\Cache\ItemInterface::METADATA_CTIME] ?? \false;
