...
use RectorPrefix20220608\Composer\InstalledVersions;
use RectorPrefix20220608\Symfony\Component\Config\Resource\ClassExistenceResource;
use RectorPrefix20220608\Symfony\Component\Config\Resource\ComposerResource;
use RectorPrefix20220608\Symfony\Component\Config\Resource\DirectoryResource;
use RectorPrefix20220608\Symfony\Component\Config\Resource\FileExistenceResource;
use RectorPrefix20220608\Symfony\Component\Config\Resource\FileResource;
use RectorPrefix20220608\Symfony\Component\Config\Resource\GlobResource;
use RectorPrefix20220608\Symfony\Component\Config\Resource\ReflectionClassResource;
use RectorPrefix20220608\Symfony\Component\Config\Resource\ResourceInterface;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Argument\RewindableGenerator;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Attribute\Target;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Compiler\Compiler;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Exception\BadMethodCallException;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Exception\LogicException;
...
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use RectorPrefix20220608\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
...
use RectorPrefix20220608\Symfony\Component\DependencyInjection\ParameterBag\ParameterBagInterface;
use RectorPrefix20220608\Symfony\Component\ExpressionLanguage\Expression;
use RectorPrefix20220608\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
    ...
    private function doGet(string $id, int $invalidBehavior = ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, array &$inlineServices = null, bool $isConstructorArgument = \false)
    {
        ...
        if (!isset($this->definitions[$id]) && isset($this->aliasDefinitions[$id])) {
            ...
            if ($alias->isDeprecated()) {
                ...
                \RectorPrefix20220608\trigger_deprecation($deprecation['package'], $deprecation['version'], $deprecation['message']);
            }
        ...
        if (null !== $factory) {
            ...
            if (!$definition->isDeprecated() && \is_array($factory) && \is_string($factory[0])) {
                ...
                if (0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                    \RectorPrefix20220608\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" factory class. It should either be deprecated or its factory upgraded.', $id, $r->name);
                }
            }
        } else {
            ...
            if (!$definition->isDeprecated() && 0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                \RectorPrefix20220608\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" class. It should either be deprecated or its implementation upgraded.', $id, $r->name);
            }
        }
