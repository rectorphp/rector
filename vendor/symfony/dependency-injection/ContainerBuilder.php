...
use RectorPrefix202306\Composer\InstalledVersions;
use RectorPrefix202306\Symfony\Component\Config\Resource\ClassExistenceResource;
use RectorPrefix202306\Symfony\Component\Config\Resource\ComposerResource;
use RectorPrefix202306\Symfony\Component\Config\Resource\DirectoryResource;
use RectorPrefix202306\Symfony\Component\Config\Resource\FileExistenceResource;
use RectorPrefix202306\Symfony\Component\Config\Resource\FileResource;
use RectorPrefix202306\Symfony\Component\Config\Resource\GlobResource;
use RectorPrefix202306\Symfony\Component\Config\Resource\ReflectionClassResource;
...
use RectorPrefix202306\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use RectorPrefix202306\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use RectorPrefix202306\Symfony\Component\DependencyInjection\Attribute\Target;
use RectorPrefix202306\Symfony\Component\DependencyInjection\Compiler\Compiler;
use RectorPrefix202306\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use RectorPrefix202306\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use RectorPrefix202306\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use RectorPrefix202306\Symfony\Component\DependencyInjection\Exception\BadMethodCallException;
...
use RectorPrefix202306\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException;
use RectorPrefix202306\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use RectorPrefix202306\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use RectorPrefix202306\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
...
use RectorPrefix202306\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
    ...
    private function doGet(string $id, int $invalidBehavior = ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, array &$inlineServices = null, bool $isConstructorArgument = \false)
    {
        ...
        if (!isset($this->definitions[$id]) && isset($this->aliasDefinitions[$id])) {
            ...
            if ($alias->isDeprecated()) {
                ...
                \RectorPrefix202306\trigger_deprecation($deprecation['package'], $deprecation['version'], $deprecation['message']);
            }
        ...
        if (null !== $factory) {
            ...
            if (!$definition->isDeprecated() && \is_array($factory) && \is_string($factory[0])) {
                ...
                if (0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                    \RectorPrefix202306\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" factory class. It should either be deprecated or its factory upgraded.', $id, $r->name);
                }
            }
        } else {
            ...
            if (!$definition->isDeprecated() && 0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                \RectorPrefix202306\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" class. It should either be deprecated or its implementation upgraded.', $id, $r->name);
            }
        }
