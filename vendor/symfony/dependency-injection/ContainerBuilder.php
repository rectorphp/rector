...
use RectorPrefix202304\Composer\InstalledVersions;
use RectorPrefix202304\Symfony\Component\Config\Resource\ClassExistenceResource;
use RectorPrefix202304\Symfony\Component\Config\Resource\ComposerResource;
use RectorPrefix202304\Symfony\Component\Config\Resource\DirectoryResource;
use RectorPrefix202304\Symfony\Component\Config\Resource\FileExistenceResource;
use RectorPrefix202304\Symfony\Component\Config\Resource\FileResource;
use RectorPrefix202304\Symfony\Component\Config\Resource\GlobResource;
use RectorPrefix202304\Symfony\Component\Config\Resource\ReflectionClassResource;
...
use RectorPrefix202304\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
...
use RectorPrefix202304\Symfony\Component\DependencyInjection\Compiler\Compiler;
use RectorPrefix202304\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use RectorPrefix202304\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use RectorPrefix202304\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
...
use RectorPrefix202304\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use RectorPrefix202304\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
...
use RectorPrefix202304\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
        ...
        if (null !== $factory) {
            ...
            if (!$definition->isDeprecated() && \is_array($factory) && \is_string($factory[0])) {
                ...
                if (0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                    \RectorPrefix202304\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" factory class. It should either be deprecated or its factory upgraded.', $id, $r->name);
                }
            }
        } else {
            ...
            if (!$definition->isDeprecated() && 0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                \RectorPrefix202304\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" class. It should either be deprecated or its implementation upgraded.', $id, $r->name);
            }
        }
