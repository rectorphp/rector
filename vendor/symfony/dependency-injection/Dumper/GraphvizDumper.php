 ...
 */
namespace RectorPrefix20220604\Symfony\Component\DependencyInjection\Dumper;

use RectorPrefix20220604\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
...
use RectorPrefix20220604\Symfony\Component\DependencyInjection\Parameter;
use RectorPrefix20220604\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
 ...
 */
class GraphvizDumper extends \RectorPrefix20220604\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
     * @var mixed[]
     */
    ...
    private function findEdges(string $id, array $arguments, bool $required, string $name, bool $lazy = \false) : array
    {
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \RectorPrefix20220604\Symfony\Component\DependencyInjection\Parameter) {
            ...
            } elseif ($argument instanceof \RectorPrefix20220604\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
                $edges[] = $this->findEdges($id, $argument->getValues(), $required, $name, \true);
            } elseif ($argument instanceof \RectorPrefix20220604\Symfony\Component\DependencyInjection\Definition) {
    ...
    private function cloneContainer() : \RectorPrefix20220604\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        $parameterBag = new \RectorPrefix20220604\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \RectorPrefix20220604\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);
