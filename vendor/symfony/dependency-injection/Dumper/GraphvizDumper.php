 ...
 */
namespace RectorPrefix20210904\Symfony\Component\DependencyInjection\Dumper;

use RectorPrefix20210904\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
...
use RectorPrefix20210904\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException;
use RectorPrefix20210904\Symfony\Component\DependencyInjection\Parameter;
use RectorPrefix20210904\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
...
class GraphvizDumper extends \RectorPrefix20210904\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    ...
    private function findEdges(string $id, array $arguments, bool $required, string $name, bool $lazy = \false) : array
    {
        ...
        foreach ($arguments as $argument) {
            ...
            } elseif ($argument instanceof \RectorPrefix20210904\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
    ...
    private function findNodes() : array
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            } catch (\RectorPrefix20210904\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException $e) {
            }
            ...
            $container->setDefinition($id, new \RectorPrefix20210904\Symfony\Component\DependencyInjection\Definition('stdClass'));
        }
    ...
    private function cloneContainer() : \RectorPrefix20210904\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        $parameterBag = new \RectorPrefix20210904\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \RectorPrefix20210904\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);
