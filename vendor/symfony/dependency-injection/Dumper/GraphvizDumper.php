 ...
 */
namespace RectorPrefix20220530\Symfony\Component\DependencyInjection\Dumper;

use RectorPrefix20220530\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
...
use RectorPrefix20220530\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException;
use RectorPrefix20220530\Symfony\Component\DependencyInjection\Parameter;
use RectorPrefix20220530\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
 ...
 */
class GraphvizDumper extends \RectorPrefix20220530\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
     * @var mixed[]
     */
    ...
    private function findEdges(string $id, array $arguments, bool $required, string $name, bool $lazy = \false) : array
    {
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \RectorPrefix20220530\Symfony\Component\DependencyInjection\Parameter) {
                $argument = $this->container->hasParameter($argument) ? $this->container->getParameter($argument) : null;
            } elseif (\is_string($argument) && \preg_match('/^%([^%]+)%$/', $argument, $match)) {
                $argument = $this->container->hasParameter($match[1]) ? $this->container->getParameter($match[1]) : null;
            }
            if ($argument instanceof \RectorPrefix20220530\Symfony\Component\DependencyInjection\Reference) {
                $lazyEdge = $lazy;
            ...
            } elseif ($argument instanceof \RectorPrefix20220530\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
                $edges[] = $this->findEdges($id, $argument->getValues(), $required, $name, \true);
            } elseif ($argument instanceof \RectorPrefix20220530\Symfony\Component\DependencyInjection\Definition) {
    ...
    private function findNodes() : array
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            } catch (\RectorPrefix20220530\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException $e) {
            }
            ...
            $container->setDefinition($id, new \RectorPrefix20220530\Symfony\Component\DependencyInjection\Definition('stdClass'));
        }
    ...
    private function cloneContainer() : \RectorPrefix20220530\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        $parameterBag = new \RectorPrefix20220530\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \RectorPrefix20220530\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);
