...
use RectorPrefix20220217\Symfony\Contracts\Service\ServiceProviderInterface;
use RectorPrefix20220217\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
 * @author Robin Chalas <robin.chalas@gmail.com>
 * @author Nicolas Grekas <p@tchwork.com>
 */
class ServiceLocator implements \RectorPrefix20220217\Symfony\Contracts\Service\ServiceProviderInterface
{
     ...
     * @return $this
     */
    public function withContext(string $externalId, \RectorPrefix20220217\Symfony\Component\DependencyInjection\Container $container)
    {
        $locator = clone $this;
    ...
    private function createNotFoundException(string $id) : \RectorPrefix20220217\Psr\Container\NotFoundExceptionInterface
    {
        if ($this->loading) {
            ...
            return new \RectorPrefix20220217\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], $msg);
        }
        ...
        if (!$class) {
            // no-op
        } elseif (\is_subclass_of($class, \RectorPrefix20220217\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            $msg[] = \sprintf('Unless you need extra laziness, try using dependency injection instead. Otherwise, you need to declare it using "%s::getSubscribedServices()".', \preg_replace('/([^\\\\]++\\\\)++/', '', $class));
        } else {
            $msg[] = 'Try using dependency injection instead.';
        }
        return new \RectorPrefix20220217\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], \implode(' ', $msg));
    }
    ...
    {
        return new \RectorPrefix20220217\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, $path);
    }
