...
use RectorPrefix20211020\Psr\Container\ContainerExceptionInterface;
...
use RectorPrefix20211020\Symfony\Contracts\Service\ServiceLocatorTrait;
use RectorPrefix20211020\Symfony\Contracts\Service\ServiceProviderInterface;
use RectorPrefix20211020\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
 * @author Robin Chalas <robin.chalas@gmail.com>
 * @author Nicolas Grekas <p@tchwork.com>
 */
class ServiceLocator implements \RectorPrefix20211020\Symfony\Contracts\Service\ServiceProviderInterface
{
    ...
    private function createNotFoundException(string $id) : \RectorPrefix20211020\Psr\Container\NotFoundExceptionInterface
    {
        if ($this->loading) {
            ...
            return new \RectorPrefix20211020\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], $msg);
        }
        ...
        if (!$class) {
            // no-op
        } elseif (\is_subclass_of($class, \RectorPrefix20211020\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            $msg[] = \sprintf('Unless you need extra laziness, try using dependency injection instead. Otherwise, you need to declare it using "%s::getSubscribedServices()".', \preg_replace('/([^\\\\]++\\\\)++/', '', $class));
        } else {
            $msg[] = 'Try using dependency injection instead.';
        }
        return new \RectorPrefix20211020\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], \implode(' ', $msg));
    }
    private function createCircularReferenceException(string $id, array $path) : \RectorPrefix20211020\Psr\Container\ContainerExceptionInterface
    {
        return new \RectorPrefix20211020\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, $path);
    }
