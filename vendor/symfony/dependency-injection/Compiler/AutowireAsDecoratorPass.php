...
use RectorPrefix20220607\Symfony\Component\DependencyInjection\Attribute\AsDecorator;
 ...
 */
final class AutowireAsDecoratorPass implements \RectorPrefix20220607\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    private function accept(\RectorPrefix20220607\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        return !$definition->hasTag('container.ignore_attributes') && $definition->isAutowired();
    }
    private function processClass(\RectorPrefix20220607\Symfony\Component\DependencyInjection\Definition $definition, \ReflectionClass $reflectionClass)
    {
        foreach (\method_exists($reflectionClass, 'getAttributes') ? $reflectionClass->getAttributes(\RectorPrefix20220607\Symfony\Component\DependencyInjection\Attribute\AsDecorator::class, \ReflectionAttribute::IS_INSTANCEOF) : [] as $attribute) {
