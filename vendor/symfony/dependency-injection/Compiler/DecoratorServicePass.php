 ...
 */
class DecoratorServicePass extends \RectorPrefix20220604\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    public function process(\RectorPrefix20220604\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($definitions as [$id, $definition]) {
            ...
            $invalidBehavior = $decoratedService[3] ?? \RectorPrefix20220604\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
            ...
            if ($container->hasAlias($inner)) {
                ...
                $container->setAlias($renamedId, new \RectorPrefix20220604\Symfony\Component\DependencyInjection\Alias((string) $alias, \false));
                ...
                continue;
            } elseif (\RectorPrefix20220604\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
    ...
    {
        if ($value instanceof \RectorPrefix20220604\Symfony\Component\DependencyInjection\Reference && '.inner' === (string) $value) {
            return new \RectorPrefix20220604\Symfony\Component\DependencyInjection\Reference($this->currentId, $value->getInvalidBehavior());
        }
