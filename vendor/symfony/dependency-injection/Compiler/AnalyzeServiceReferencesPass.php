 ...
 */
class AnalyzeServiceReferencesPass extends \RectorPrefix20220605\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        if ($value instanceof \RectorPrefix20220605\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            $this->lazy = !$this->byFactory || !$value instanceof \RectorPrefix20220605\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
        ...
        if (\is_string($factory = $value->getFactory()) && \strncmp($factory, '@=', \strlen('@=')) === 0) {
            if (!\class_exists(\RectorPrefix20220605\Symfony\Component\ExpressionLanguage\Expression::class)) {
                throw new \RectorPrefix20220605\Symfony\Component\DependencyInjection\Exception\LogicException('Expressions cannot be used in service factories without the ExpressionLanguage component. Try running "composer require symfony/expression-language".');
            }
            $factory = new \RectorPrefix20220605\Symfony\Component\ExpressionLanguage\Expression(\substr($factory, 2));
        }
