 ...
 */
class AutowireRequiredPropertiesPass extends \RectorPrefix20211214\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getProperties() as $reflectionProperty) {
            ...
            $type = $type->getName();
            $value->setProperty($name, new \RectorPrefix20211214\Symfony\Component\DependencyInjection\TypedReference($type, $type, \RectorPrefix20211214\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, $name));
        }
        return $value;
    }
}
