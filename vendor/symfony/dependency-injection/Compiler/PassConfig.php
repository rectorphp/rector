...
class PassConfig
{
    ...
    public function addPass($pass, $type = self::TYPE_BEFORE_OPTIMIZATION, $priority = 0)
    {
        ...
        if (!isset($this->{$property})) {
            throw new \RectorPrefix20210904\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('Invalid type "%s".', $type));
        }
