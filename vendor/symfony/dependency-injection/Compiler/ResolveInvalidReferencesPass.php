 ...
 */
class ResolveInvalidReferencesPass implements \RectorPrefix20220101\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $container;
    ...
    public function process(\RectorPrefix20220101\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        $this->signalingException = new \RectorPrefix20220101\Symfony\Component\DependencyInjection\Exception\RuntimeException('Invalid reference.');
        try {
    ...
    private function processValue($value, int $rootLevel = 0, int $level = 0)
    {
        if ($value instanceof \RectorPrefix20220101\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument) {
            ...
            if ($currentDefinition->innerServiceId === $id && \RectorPrefix20220101\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $currentDefinition->decorationOnInvalid) {
                return null;
            }
            $invalidBehavior = $value->getInvalidBehavior();
            if (\RectorPrefix20220101\Symfony\Component\DependencyInjection\ContainerInterface::RUNTIME_EXCEPTION_ON_INVALID_REFERENCE === $invalidBehavior && $value instanceof \RectorPrefix20220101\Symfony\Component\DependencyInjection\TypedReference && !$this->container->has($id)) {
                $e = new \RectorPrefix20220101\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, $this->currentId);
                ...
                return new \RectorPrefix20220101\Symfony\Component\DependencyInjection\TypedReference($id, $value->getType(), $value->getInvalidBehavior());
            }
            // resolve invalid behavior
            if (\RectorPrefix20220101\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $value = null;
