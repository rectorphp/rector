 ...
 */
final class AttributeAutoconfigurationPass extends \RectorPrefix20211206\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    {
        if (!$value instanceof \RectorPrefix20211206\Symfony\Component\DependencyInjection\Definition || !$value->isAutoconfigured() || $value->isAbstract() || $value->hasTag('container.ignore_attributes') || !($classReflector = $this->container->getReflectionClass($value->getClass(), \false))) {
        ...
        if (!isset($instanceof[$classReflector->getName()]) && new \RectorPrefix20211206\Symfony\Component\DependencyInjection\ChildDefinition('') != $conditionals) {
