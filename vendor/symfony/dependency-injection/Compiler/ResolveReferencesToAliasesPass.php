 ...
 */
class ResolveReferencesToAliasesPass extends \RectorPrefix20210705\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
    ...
    {
        if (!$value instanceof \RectorPrefix20210705\Symfony\Component\DependencyInjection\Reference) {
    ...
    private function getDefinitionId($id, $container) : string
    {
        ...
        do {
            if (isset($seen[$id])) {
                throw new \RectorPrefix20210705\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_merge(\array_keys($seen), [$id]));
            }
            $seen[$id] = \true;
