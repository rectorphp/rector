 ...
 */
class CheckArgumentsValidityPass extends \RectorPrefix20211118\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
            ...
            if ($k !== $i++) {
                if (!\is_int($k)) {
                    ...
                    if ($this->throwExceptions) {
                        throw new \RectorPrefix20211118\Symfony\Component\DependencyInjection\Exception\RuntimeException($msg);
                    }
                    break;
                }
