 ...
 */
class CheckArgumentsValidityPass extends \RectorPrefix20220530\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * @var bool
     */
            ...
            if ($k !== $i++) {
                if (!\is_int($k)) {
                    ...
                    if ($this->throwExceptions) {
                        throw new \RectorPrefix20220530\Symfony\Component\DependencyInjection\Exception\RuntimeException($msg);
                    }
                    break;
                }
