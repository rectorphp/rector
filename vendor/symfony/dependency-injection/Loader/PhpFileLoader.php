 ...
 */
class PhpFileLoader extends \RectorPrefix20210513\Symfony\Component\DependencyInjection\Loader\FileLoader
{
    ...
    public function load($resource, $type = null)
    {
        ...
        $load = \Closure::bind(function ($path) use($container, $loader, $resource, $type) {
            return include $path;
        }, $this, \RectorPrefix20210513\Symfony\Component\DependencyInjection\Loader\ProtectedPhpFileLoader::class);
        try {
            $callback = $load($path);
 ...
 * @internal
 */
final class ProtectedPhpFileLoader extends \RectorPrefix20210513\Symfony\Component\DependencyInjection\Loader\PhpFileLoader
{
}
