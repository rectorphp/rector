...
abstract class AbstractServiceConfigurator extends \RectorPrefix20220531\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractConfigurator
{
    protected $parent;
    protected $id;
    /**
     ...
     */
    private $defaultTags = [];
    public function __construct(\RectorPrefix20220531\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, \RectorPrefix20220531\Symfony\Component\DependencyInjection\Definition $definition, string $id = null, array $defaultTags = [])
    {
        $this->parent = $parent;
     ...
     * Registers a service.
     */
    public final function set(?string $id, string $class = null) : \RectorPrefix20220531\Symfony\Component\DependencyInjection\Loader\Configurator\ServiceConfigurator
    {
        $this->__destruct();
     ...
     */
    public final function remove(string $id) : \RectorPrefix20220531\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator
    {
        $this->__destruct();
