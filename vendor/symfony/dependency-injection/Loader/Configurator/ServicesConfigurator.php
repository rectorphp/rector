...
class ServicesConfigurator extends AbstractConfigurator
{
     ...
     */
    public function set(?string $id, string $class = null) : \RectorPrefix20220606\Rector\Core\DependencyInjection\Loader\Configurator\RectorServiceConfigurator
    {
        ...
        $configurator = new \RectorPrefix20220606\Rector\Core\DependencyInjection\Loader\Configurator\RectorServiceConfigurator($this->container, $this->instanceof, \true, $this, $definition, $id, $defaults->getTags(), $this->path);
