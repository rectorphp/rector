 ...
 */
class TraceableEventDispatcher implements \RectorPrefix20211020\Symfony\Component\EventDispatcher\EventDispatcherInterface, \RectorPrefix20211020\Symfony\Contracts\Service\ResetInterface
{
    protected $logger;
    protected $stopwatch;
    private $callStack;
    ...
    public function __construct(\RectorPrefix20211020\Symfony\Component\EventDispatcher\EventDispatcherInterface $dispatcher, \RectorPrefix20211020\Symfony\Component\Stopwatch\Stopwatch $stopwatch, \RectorPrefix20211020\Psr\Log\LoggerInterface $logger = null, \RectorPrefix20211020\Symfony\Component\HttpFoundation\RequestStack $requestStack = null)
    {
    ...
    public function dispatch($event, $eventName = null)
    {
        ...
        if (null !== $this->logger && $event instanceof \RectorPrefix20211020\Psr\EventDispatcher\StoppableEventInterface && $event->isPropagationStopped()) {
        ...
        foreach ($allListeners as $eventName => $listeners) {
            foreach ($listeners as $listener) {
                if (!\in_array($listener, $calledListeners, \true)) {
                    if (!$listener instanceof \RectorPrefix20211020\Symfony\Component\EventDispatcher\Debug\WrappedListener) {
                        $listener = new \RectorPrefix20211020\Symfony\Component\EventDispatcher\Debug\WrappedListener($listener, null, $this->stopwatch, $this);
                    }
    ...
    private function preProcess(string $eventName) : void
    {
        ...
        foreach ($this->dispatcher->getListeners($eventName) as $listener) {
            ...
            $wrappedListener = new \RectorPrefix20211020\Symfony\Component\EventDispatcher\Debug\WrappedListener($listener instanceof \RectorPrefix20211020\Symfony\Component\EventDispatcher\Debug\WrappedListener ? $listener->getWrappedListener() : $listener, null, $this->stopwatch, $this);
