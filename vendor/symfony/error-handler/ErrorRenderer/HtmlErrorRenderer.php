 ...
 */
namespace RectorPrefix20210903\Symfony\Component\ErrorHandler\ErrorRenderer;

use RectorPrefix20210903\Psr\Log\LoggerInterface;
use RectorPrefix20210903\Symfony\Component\ErrorHandler\Exception\FlattenException;
...
use RectorPrefix20210903\Symfony\Component\HttpKernel\Log\DebugLoggerInterface;
/**
 * @author Yonel Ceruto <yonelceruto@gmail.com>
 */
class HtmlErrorRenderer implements \RectorPrefix20210903\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
     ...
     */
    public function __construct($debug = \false, string $charset = null, $fileLinkFormat = null, string $projectDir = null, $outputBuffer = '', \RectorPrefix20210903\Psr\Log\LoggerInterface $logger = null)
    {
     ...
     */
    public function render($exception) : \RectorPrefix20210903\Symfony\Component\ErrorHandler\Exception\FlattenException
    {
        ...
        $exception = \RectorPrefix20210903\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception, null, $headers);
    ...
    public static function getAndCleanOutputBuffer($requestStack) : \Closure
    {
        return static function () use($requestStack) : string {
            ...
            \RectorPrefix20210903\Symfony\Component\HttpFoundation\Response::closeOutputBuffers($startObLevel + 1, \true);
            return \ob_get_clean();
        };
    }
    private function renderException(\RectorPrefix20210903\Symfony\Component\ErrorHandler\Exception\FlattenException $exception, string $debugTemplate = 'views/exception_full.html.php') : string
    {
        ...
        return $this->include($debugTemplate, ['exception' => $exception, 'exceptionMessage' => $exceptionMessage, 'statusText' => $statusText, 'statusCode' => $statusCode, 'logger' => $this->logger instanceof \RectorPrefix20210903\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null, 'currentContent' => \is_string($this->outputBuffer) ? $this->outputBuffer : ($this->outputBuffer)()]);
    }
    /**
