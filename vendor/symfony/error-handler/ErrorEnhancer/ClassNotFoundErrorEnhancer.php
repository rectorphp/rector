...
use RectorPrefix20211020\Symfony\Component\ErrorHandler\Error\ClassNotFoundError;
use RectorPrefix20211020\Symfony\Component\ErrorHandler\Error\FatalError;
/**
 * @author Fabien Potencier <fabien@symfony.com>
 */
class ClassNotFoundErrorEnhancer implements \RectorPrefix20211020\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface
{
    /**
     * {@inheritdoc}
    ...
    public function enhance($error) : ?\Throwable
    {
        ...
        $message = !$error instanceof \RectorPrefix20211020\Symfony\Component\ErrorHandler\Error\FatalError ? $error->getMessage() : $error->getError()['message'];
        ...
        return new \RectorPrefix20211020\Symfony\Component\ErrorHandler\Error\ClassNotFoundError($message, $error);
    }
    /**
    ...
    private function getClassCandidates(string $class) : array
    {
        ...
        foreach ($functions as $function) {
            ...
            if ($function[0] instanceof \RectorPrefix20211020\Symfony\Component\ErrorHandler\DebugClassLoader) {
                $function = $function[0]->getClassLoader();
                if (!\is_array($function)) {
                    continue;
                }
            }
            if ($function[0] instanceof \RectorPrefix20211020\Composer\Autoload\ClassLoader) {
