 ...
 */
namespace RectorPrefix20210617\Symfony\Component\VarDumper\Command\Descriptor;

use RectorPrefix20210617\Symfony\Component\Console\Output\OutputInterface;
use RectorPrefix20210617\Symfony\Component\VarDumper\Cloner\Data;
 ...
 * @final
 */
class HtmlDescriptor implements \RectorPrefix20210617\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $initialized = \false;
    public function __construct(\RectorPrefix20210617\Symfony\Component\VarDumper\Dumper\HtmlDumper $dumper)
    {
        $this->dumper = $dumper;
    }
    public function describe(\RectorPrefix20210617\Symfony\Component\Console\Output\OutputInterface $output, \RectorPrefix20210617\Symfony\Component\VarDumper\Cloner\Data $data, array $context, int $clientId) : void
    {
        if (!$this->initialized) {
