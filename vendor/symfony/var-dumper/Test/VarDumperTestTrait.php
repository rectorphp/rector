 ...
 */
namespace RectorPrefix20210510\Symfony\Component\VarDumper\Test;
...
trait VarDumperTestTrait
{
    ...
    protected function getDump($data, $key = null, int $filter = 0) : ?string
    {
        if (null === ($flags = $this->varDumperConfig['flags'])) {
            $flags = \getenv('DUMP_LIGHT_ARRAY') ? \RectorPrefix20210510\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_LIGHT_ARRAY : 0;
            $flags |= \getenv('DUMP_STRING_LENGTH') ? \RectorPrefix20210510\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_STRING_LENGTH : 0;
            $flags |= \getenv('DUMP_COMMA_SEPARATOR') ? \RectorPrefix20210510\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_COMMA_SEPARATOR : 0;
        }
        ...
        $dumper = new \RectorPrefix20210510\Symfony\Component\VarDumper\Dumper\CliDumper(null, null, $flags);
