...
abstract class AbstractCloner implements \RectorPrefix20210730\Symfony\Component\VarDumper\Cloner\ClonerInterface
{
    ...
    public function cloneVar($var, $filter = 0)
    {
        ...
        try {
            return new \RectorPrefix20210730\Symfony\Component\VarDumper\Cloner\Data($this->doClone($var));
        } finally {
            if ($gc) {
                \gc_enable();
            }
    ...
    protected function castObject($stub, $isNested)
    {
        ...
        if (isset($this->classInfo[$class])) {
            ...
            $fileInfo = $r->isInternal() || $r->isSubclassOf(\RectorPrefix20210730\Symfony\Component\VarDumper\Cloner\Stub::class) ? [] : ['file' => $r->getFileName(), 'line' => $r->getStartLine()];
            $this->classInfo[$class] = [$i, $parents, $hasDebugInfo, $fileInfo];
        }
        $stub->attr += $fileInfo;
        $a = \RectorPrefix20210730\Symfony\Component\VarDumper\Caster\Caster::castObject($obj, $class, $hasDebugInfo, $stub->class);
        try {
            while ($i--) {
            ...
            $a = [(\RectorPrefix20210730\Symfony\Component\VarDumper\Cloner\Stub::TYPE_OBJECT === $stub->type ? \RectorPrefix20210730\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL : '') . '⚠' => new \RectorPrefix20210730\Symfony\Component\VarDumper\Exception\ThrowingCasterException($e)] + $a;
        }
        return $a;
    }
    /**
