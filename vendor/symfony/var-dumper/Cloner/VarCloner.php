 ...
 */
class VarCloner extends \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\AbstractCloner
{
    private static $gid;
    ...
    protected function doClone($var)
    {
        ...
        $arrayStub = new \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub();
        $arrayStub->type = \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub::TYPE_ARRAY;
        $fromObjCast = \false;
        for ($i = 0; $i < $len; ++$i) {
                ...
                switch (\true) {
                    ...
                    case \is_string($v):
                        ...
                        if (!\preg_match('//u', $v)) {
                            ...
                            $stub->type = \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub::TYPE_STRING;
                            $stub->class = \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub::STRING_BINARY;
                            ...
                            $stub = new \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub();
                            $stub->type = \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub::TYPE_STRING;
                            $stub->class = \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub::STRING_UTF8;
                            $stub->cut = $cut;
                    ...
                    case \is_array($v):
                        ...
                        $stub = $arrayStub;
                        $stub->class = \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub::ARRAY_INDEXED;
                        $j = -1;
                        foreach ($v as $gk => $gv) {
                            if ($gk !== ++$j) {
                                $stub->class = \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub::ARRAY_ASSOC;
                                break;
                            }
                        }
                        $a = $v;
                        if (\RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub::ARRAY_ASSOC === $stub->class) {
                    ...
                    case \is_object($v):
                        if (empty($objRefs[$h = \spl_object_id($v)])) {
                            $stub = new \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub();
                            $stub->type = \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub::TYPE_OBJECT;
                            $stub->class = \get_class($v);
                            $stub->value = $v;
                            $stub->handle = $h;
                            $a = $this->castObject($stub, 0 < $i);
                            if ($v !== $stub->value) {
                                if (\RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub::TYPE_OBJECT !== $stub->type || null === $stub->value) {
                                    break;
                                }
                    ...
                    default:
                        ...
                        if (empty($resRefs[$h = (int) $v])) {
                            $stub = new \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub();
                            $stub->type = \RectorPrefix20210928\Symfony\Component\VarDumper\Cloner\Stub::TYPE_RESOURCE;
