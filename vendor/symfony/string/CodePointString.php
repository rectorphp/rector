 ...
 */
namespace RectorPrefix20211027\Symfony\Component\String;

use RectorPrefix20211027\Symfony\Component\String\Exception\ExceptionInterface;
use RectorPrefix20211027\Symfony\Component\String\Exception\InvalidArgumentException;
/**
 ...
 */
class CodePointString extends \RectorPrefix20211027\Symfony\Component\String\AbstractUnicodeString
{
    public function __construct(string $string = '')
    {
        if ('' !== $string && !\preg_match('//u', $string)) {
            throw new \RectorPrefix20211027\Symfony\Component\String\Exception\InvalidArgumentException('Invalid UTF-8 string.');
        }
        $this->string = $string;
    }
    /**
     * @param string ...$suffix
     */
    public function append(...$suffix) : \RectorPrefix20211027\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    {
        if ($suffix instanceof \RectorPrefix20211027\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($string instanceof \RectorPrefix20211027\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($needle instanceof \RectorPrefix20211027\Symfony\Component\String\AbstractString) {
     ...
     * @param string ...$prefix
     */
    public function prepend(...$prefix) : \RectorPrefix20211027\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     * @param string $to
     */
    public function replace($from, $to) : \RectorPrefix20211027\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     */
    public function slice($start = 0, $length = null) : \RectorPrefix20211027\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     * @param int|null $length
     */
    public function splice($replacement, $start = 0, $length = null) : \RectorPrefix20211027\Symfony\Component\String\AbstractString
    {
    ...
    public function split($delimiter, $limit = null, $flags = null) : array
    {
        ...
        if ('' === $delimiter) {
            throw new \RectorPrefix20211027\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is empty.');
        }
        if (null !== $flags) {
            return parent::split($delimiter . 'u', $limit, $flags);
        }
        if (!\preg_match('//u', $delimiter)) {
            throw new \RectorPrefix20211027\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
    ...
    {
        if ($prefix instanceof \RectorPrefix20211027\Symfony\Component\String\AbstractString) {
