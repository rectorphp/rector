 ...
 */
class CodePointString extends \RectorPrefix20220222\Symfony\Component\String\AbstractUnicodeString
{
    public function __construct(string $string = '')
    {
        if ('' !== $string && !\preg_match('//u', $string)) {
            throw new \RectorPrefix20220222\Symfony\Component\String\Exception\InvalidArgumentException('Invalid UTF-8 string.');
        }
        $this->string = $string;
    }
    /**
    ...
    public function split(string $delimiter, int $limit = null, int $flags = null) : array
    {
        ...
        if (!\preg_match('//u', $delimiter)) {
            throw new \RectorPrefix20220222\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
