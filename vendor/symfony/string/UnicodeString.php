 ...
 */
class UnicodeString extends \RectorPrefix20220315\Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function normalize(int $form = self::NFC)
    {
        ...
        if (\in_array($form, [self::NFC, self::NFKC], \true)) {
            ...
            throw new \RectorPrefix20220315\Symfony\Component\String\Exception\InvalidArgumentException('Unsupported normalization form.');
