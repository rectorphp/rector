 ...
 */
class UnicodeString extends \RectorPrefix20210610\Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function join(array $strings, string $lastGlue = null) : \RectorPrefix20210610\Symfony\Component\String\AbstractString
    {
    ...
    public function normalize(int $form = self::NFC)
    {
        ...
        if (\in_array($form, [self::NFC, self::NFKC], \true)) {
            ...
            throw new \RectorPrefix20210610\Symfony\Component\String\Exception\InvalidArgumentException('Unsupported normalization form.');
    ...
    public function replaceMatches(string $fromRegexp, $to) : \RectorPrefix20210610\Symfony\Component\String\AbstractString
    {
