 ...
 */
class UnicodeString extends \RectorPrefix20211205\Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function normalize($form = self::NFC) : self
    {
        ...
        if (\in_array($form, [self::NFC, self::NFKC], \true)) {
            ...
            throw new \RectorPrefix20211205\Symfony\Component\String\Exception\InvalidArgumentException('Unsupported normalization form.');
