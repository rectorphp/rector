 ...
 */
class UnicodeString extends \RectorPrefix20210717\Symfony\Component\String\AbstractUnicodeString
{
     ...
     */
    public function join($strings, $lastGlue = null) : \RectorPrefix20210717\Symfony\Component\String\AbstractString
    {
    ...
    public function normalize($form = self::NFC)
    {
        ...
        if (\in_array($form, [self::NFC, self::NFKC], \true)) {
            ...
            throw new \RectorPrefix20210717\Symfony\Component\String\Exception\InvalidArgumentException('Unsupported normalization form.');
     ...
     */
    public function replaceMatches($fromRegexp, $to) : \RectorPrefix20210717\Symfony\Component\String\AbstractString
    {
