...
use RectorPrefix20220604\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractString implements \JsonSerializable
{
    ...
    {
        if (0 > $multiplier) {
            throw new \RectorPrefix20220604\Symfony\Component\String\Exception\InvalidArgumentException(\sprintf('Multiplier must be positive, %d given.', $multiplier));
        }
        $str = clone $this;
    ...
    public function split(string $delimiter, int $limit = null, int $flags = null) : array
    {
        ...
        \set_error_handler(static function ($t, $m) {
            throw new \RectorPrefix20220604\Symfony\Component\String\Exception\InvalidArgumentException($m);
        });
        try {
            if (\false === ($chunks = \preg_split($delimiter, $this->string, $limit, $flags))) {
                ...
                throw new \RectorPrefix20220604\Symfony\Component\String\Exception\RuntimeException('Splitting failed with unknown error code.');
            }
        } finally {
    ...
    public function toByteString(string $toEncoding = null) : \RectorPrefix20220604\Symfony\Component\String\ByteString
    {
        $b = new \RectorPrefix20220604\Symfony\Component\String\ByteString();
        $toEncoding = \in_array($toEncoding, ['utf8', 'utf-8', 'UTF8'], \true) ? 'UTF-8' : $toEncoding;
        if (null === $toEncoding || $toEncoding === ($fromEncoding = $this instanceof \RectorPrefix20220604\Symfony\Component\String\AbstractUnicodeString || \preg_match('//u', $b->string) ? 'UTF-8' : 'Windows-1252')) {
        ...
        try {
            ...
            } catch (\RectorPrefix20220604\Symfony\Component\String\Exception\InvalidArgumentException $e) {
    ...
    public function toCodePointString() : \RectorPrefix20220604\Symfony\Component\String\CodePointString
    {
        return new \RectorPrefix20220604\Symfony\Component\String\CodePointString($this->string);
    }
    public function toString() : string
    {
        return $this->string;
    }
    public function toUnicodeString() : \RectorPrefix20220604\Symfony\Component\String\UnicodeString
    {
        return new \RectorPrefix20220604\Symfony\Component\String\UnicodeString($this->string);
    }
    /**
     * @return $this
     */
