...
if (!\function_exists(\RectorPrefix20210620\Symfony\Component\String\u::class)) {
    function u(?string $string = '') : \RectorPrefix20210620\Symfony\Component\String\UnicodeString
    {
...
if (!\function_exists(\RectorPrefix20210620\Symfony\Component\String\b::class)) {
    function b(?string $string = '') : \RectorPrefix20210620\Symfony\Component\String\ByteString
    {
...
if (!\function_exists(\RectorPrefix20210620\Symfony\Component\String\s::class)) {
     ...
     */
    function s(?string $string = '') : \RectorPrefix20210620\Symfony\Component\String\AbstractString
    {
        $string = $string ?? '';
