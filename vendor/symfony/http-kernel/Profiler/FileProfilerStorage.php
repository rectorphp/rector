 ...
 */
class FileProfilerStorage implements \RectorPrefix20210916\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * @param string $token
     */
    public function read($token) : ?\RectorPrefix20210916\Symfony\Component\HttpKernel\Profiler\Profile
    {
    ...
    public function write($profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\RectorPrefix20210916\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \RectorPrefix20210916\Symfony\Component\HttpKernel\Profiler\Profile($token);
