 ...
 */
class FileProfilerStorage implements \RectorPrefix20210823\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
    ...
    public function write($profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\RectorPrefix20210823\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \RectorPrefix20210823\Symfony\Component\HttpKernel\Profiler\Profile($token);
