...
use RectorPrefix20211020\Symfony\Component\DependencyInjection\ContainerAwareTrait;
 ...
 */
abstract class Bundle implements \RectorPrefix20211020\Symfony\Component\HttpKernel\Bundle\BundleInterface
{
    ...
    public function getContainerExtension()
    {
        if (null === $this->extension) {
            ...
            if (null !== $extension) {
                if (!$extension instanceof \RectorPrefix20211020\Symfony\Component\DependencyInjection\Extension\ExtensionInterface) {
                ...
                $expectedAlias = \RectorPrefix20211020\Symfony\Component\DependencyInjection\Container::underscore($basename);
