...
use RectorPrefix20210921\Symfony\Component\HttpKernel\Attribute\ArgumentInterface;
/**
...
class ArgumentMetadata
{
    ...
    public function __construct(string $name, ?string $type, bool $isVariadic, bool $hasDefaultValue, $defaultValue, bool $isNullable = \false, $attributes = [])
    {
        ...
        if (null === $attributes || $attributes instanceof \RectorPrefix20210921\Symfony\Component\HttpKernel\Attribute\ArgumentInterface) {
     ...
     */
    public function getAttribute() : ?\RectorPrefix20210921\Symfony\Component\HttpKernel\Attribute\ArgumentInterface
    {
        trigger_deprecation('symfony/http-kernel', '5.3', 'Method "%s()" is deprecated, use "getAttributes()" instead.', __METHOD__);
        if (!$this->attributes) {
            return null;
        }
        return $this->attributes[0] instanceof \RectorPrefix20210921\Symfony\Component\HttpKernel\Attribute\ArgumentInterface ? $this->attributes[0] : null;
    }
    /**
     * @return object[]
