 ...
 */
class ControllerResolver implements \RectorPrefix20210808\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\RectorPrefix20210808\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
