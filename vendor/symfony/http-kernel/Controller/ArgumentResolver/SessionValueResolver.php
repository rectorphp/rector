 ...
 */
final class SessionValueResolver implements \RectorPrefix20210608\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\RectorPrefix20210608\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210608\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\RectorPrefix20210608\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \RectorPrefix20210608\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
