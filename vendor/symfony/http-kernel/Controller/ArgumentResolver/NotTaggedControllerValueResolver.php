 ...
 */
final class NotTaggedControllerValueResolver implements \RectorPrefix20211015\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $container;
    public function __construct(\RectorPrefix20211015\Psr\Container\ContainerInterface $container)
    {
    ...
    public function resolve($request, $argument) : iterable
    {
        ...
        throw new \RectorPrefix20211015\Symfony\Component\DependencyInjection\Exception\RuntimeException($message);
    }
}
