 ...
 */
final class NotTaggedControllerValueResolver implements \RectorPrefix20210731\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $container;
    public function __construct(\RectorPrefix20210731\Psr\Container\ContainerInterface $container)
    {
    ...
    public function resolve($request, $argument) : iterable
    {
        ...
        throw new \RectorPrefix20210731\Symfony\Component\DependencyInjection\Exception\RuntimeException($message);
    }
}
