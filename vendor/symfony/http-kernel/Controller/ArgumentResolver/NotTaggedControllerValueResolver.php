 ...
 */
final class NotTaggedControllerValueResolver implements \RectorPrefix20210808\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $container;
    public function __construct(\RectorPrefix20210808\Psr\Container\ContainerInterface $container)
    {
    ...
    public function resolve($request, $argument) : iterable
    {
        ...
        throw new \RectorPrefix20210808\Symfony\Component\DependencyInjection\Exception\RuntimeException($message);
    }
}
