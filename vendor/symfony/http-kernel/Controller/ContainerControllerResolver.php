 ...
 */
class ContainerControllerResolver extends \RectorPrefix20211009\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20211009\Psr\Container\ContainerInterface $container, \RectorPrefix20211009\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20211009\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
