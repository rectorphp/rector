 ...
 */
class ContainerControllerResolver extends \RectorPrefix20211030\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20211030\Psr\Container\ContainerInterface $container, \RectorPrefix20211030\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20211030\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
