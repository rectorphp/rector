 ...
 */
class ContainerControllerResolver extends \RectorPrefix20210827\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20210827\Psr\Container\ContainerInterface $container, \RectorPrefix20210827\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20210827\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
