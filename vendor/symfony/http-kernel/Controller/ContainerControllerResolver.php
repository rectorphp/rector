 ...
 */
class ContainerControllerResolver extends \RectorPrefix20210808\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20210808\Psr\Container\ContainerInterface $container, \RectorPrefix20210808\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20210808\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
