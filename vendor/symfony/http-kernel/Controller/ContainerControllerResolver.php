 ...
 */
class ContainerControllerResolver extends \RectorPrefix20211027\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20211027\Psr\Container\ContainerInterface $container, \RectorPrefix20211027\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20211027\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
