 ...
 */
class ContainerControllerResolver extends \RectorPrefix20210923\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20210923\Psr\Container\ContainerInterface $container, \RectorPrefix20210923\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20210923\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
