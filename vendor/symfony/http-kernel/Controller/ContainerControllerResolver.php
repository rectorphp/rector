 ...
 */
class ContainerControllerResolver extends \RectorPrefix20211026\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20211026\Psr\Container\ContainerInterface $container, \RectorPrefix20211026\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20211026\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
