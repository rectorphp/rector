 ...
 */
class ContainerControllerResolver extends \RectorPrefix20211007\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20211007\Psr\Container\ContainerInterface $container, \RectorPrefix20211007\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20211007\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
