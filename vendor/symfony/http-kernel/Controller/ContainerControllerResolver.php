 ...
 */
class ContainerControllerResolver extends \RectorPrefix20211010\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\RectorPrefix20211010\Psr\Container\ContainerInterface $container, \RectorPrefix20211010\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \RectorPrefix20211010\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
