...
use RectorPrefix20210731\Symfony\Component\HttpKernel\Log\Logger;
/**
...
class LoggerPass implements \RectorPrefix20210731\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    {
        $container->setAlias(\RectorPrefix20210731\Psr\Log\LoggerInterface::class, 'logger')->setPublic(\false);
        if ($container->has('logger')) {
            return;
        }
        $container->register('logger', \RectorPrefix20210731\Symfony\Component\HttpKernel\Log\Logger::class)->setPublic(\false);
    }
}
