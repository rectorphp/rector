...
use RectorPrefix20210607\Symfony\Component\HttpFoundation\RedirectResponse;
 ...
 */
class RouterDataCollector extends \RectorPrefix20210607\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
    ...
    {
        if ($response instanceof \RectorPrefix20210607\Symfony\Component\HttpFoundation\RedirectResponse) {
    ...
    protected function guessRoute(\RectorPrefix20210607\Symfony\Component\HttpFoundation\Request $request, $controller)
    {
        return 'n/a';
    }
    /**
