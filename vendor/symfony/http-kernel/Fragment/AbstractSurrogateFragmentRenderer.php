 ...
 */
abstract class AbstractSurrogateFragmentRenderer extends \RectorPrefix20210705\Symfony\Component\HttpKernel\Fragment\RoutableFragmentRenderer
{
    private $surrogate;
     ...
     */
    public function __construct(\RectorPrefix20210705\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, \RectorPrefix20210705\Symfony\Component\HttpKernel\Fragment\FragmentRendererInterface $inlineStrategy, \RectorPrefix20210705\Symfony\Component\HttpKernel\UriSigner $signer = null)
    {
    ...
    public function render($uri, $request, $options = [])
    {
        ...
        if ($alt instanceof \RectorPrefix20210705\Symfony\Component\HttpKernel\Controller\ControllerReference) {
