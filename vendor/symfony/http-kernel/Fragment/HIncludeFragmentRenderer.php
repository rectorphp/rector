...
use RectorPrefix20210822\Twig\Environment;
/**
 * Implements the Hinclude rendering strategy.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HIncludeFragmentRenderer extends \RectorPrefix20210822\Symfony\Component\HttpKernel\Fragment\RoutableFragmentRenderer
{
     ...
     */
    public function __construct(\RectorPrefix20210822\Twig\Environment $twig = null, \RectorPrefix20210822\Symfony\Component\HttpKernel\UriSigner $signer = null, string $globalDefaultTemplate = null, string $charset = 'utf-8')
    {
        $this->twig = $twig;
    ...
    public function render($uri, $request, $options = [])
    {
        if ($uri instanceof \RectorPrefix20210822\Symfony\Component\HttpKernel\Controller\ControllerReference) {
            $uri = (new \RectorPrefix20210822\Symfony\Component\HttpKernel\Fragment\FragmentUriGenerator($this->fragmentPath, $this->signer))->generate($uri, $request);
        }
        ...
        return new \RectorPrefix20210822\Symfony\Component\HttpFoundation\Response(\sprintf('<hx:include src="%s"%s>%s</hx:include>', $uri, $renderedAttributes, $content));
    }
    /**
     * {@inheritdoc}
     */
