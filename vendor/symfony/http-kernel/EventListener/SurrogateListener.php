...
use RectorPrefix20210608\Symfony\Component\HttpKernel\HttpCache\HttpCache;
use RectorPrefix20210608\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface;
 ...
 * @final
 */
class SurrogateListener implements \RectorPrefix20210608\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $surrogate;
    public function __construct(\RectorPrefix20210608\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null)
    {
    ...
    public function onKernelResponse(\RectorPrefix20210608\Symfony\Component\HttpKernel\Event\ResponseEvent $event)
    {
        ...
        if ($kernel instanceof \RectorPrefix20210608\Symfony\Component\HttpKernel\HttpCache\HttpCache) {
