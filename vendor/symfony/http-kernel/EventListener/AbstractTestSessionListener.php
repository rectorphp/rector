...
use RectorPrefix20210608\Symfony\Component\HttpFoundation\Session\Session;
 ...
 * @internal
 */
abstract class AbstractTestSessionListener implements \RectorPrefix20210608\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $sessionId;
    ...
    public function onKernelResponse(\RectorPrefix20210608\Symfony\Component\HttpKernel\Event\ResponseEvent $event)
    {
        ...
        if ($session instanceof \RectorPrefix20210608\Symfony\Component\HttpFoundation\Session\Session ? !$session->isEmpty() || null !== $this->sessionId && $session->getId() !== $this->sessionId : $wasStarted) {
            ...
            $event->getResponse()->headers->setCookie(new \RectorPrefix20210608\Symfony\Component\HttpFoundation\Cookie($session->getName(), $session->getId(), 0 === $params['lifetime'] ? 0 : \time() + $params['lifetime'], $params['path'], $params['domain'], $params['secure'], $params['httponly'], \false, $params['samesite'] ?: null));
            $this->sessionId = $session->getId();
        }
    }
    public static function getSubscribedEvents() : array
    {
        return [\RectorPrefix20210608\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 192], \RectorPrefix20210608\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -128]];
    }
    /**
