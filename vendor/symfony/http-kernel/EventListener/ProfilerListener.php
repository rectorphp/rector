...
use RectorPrefix20210822\Symfony\Component\HttpFoundation\RequestMatcherInterface;
...
use RectorPrefix20210822\Symfony\Component\HttpKernel\Event\TerminateEvent;
use RectorPrefix20210822\Symfony\Component\HttpKernel\KernelEvents;
use RectorPrefix20210822\Symfony\Component\HttpKernel\Profiler\Profiler;
/**
 ...
 * @final
 */
class ProfilerListener implements \RectorPrefix20210822\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $profiler;
    protected $matcher;
     ...
     */
    public function __construct(\RectorPrefix20210822\Symfony\Component\HttpKernel\Profiler\Profiler $profiler, \RectorPrefix20210822\Symfony\Component\HttpFoundation\RequestStack $requestStack, \RectorPrefix20210822\Symfony\Component\HttpFoundation\RequestMatcherInterface $matcher = null, bool $onlyException = \false, bool $onlyMainRequests = \false)
    {
    ...
    {
        return [\RectorPrefix20210822\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -100], \RectorPrefix20210822\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => ['onKernelException', 0], \RectorPrefix20210822\Symfony\Component\HttpKernel\KernelEvents::TERMINATE => ['onKernelTerminate', -1024]];
    }
}
