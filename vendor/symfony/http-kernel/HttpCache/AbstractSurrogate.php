 ...
 */
abstract class AbstractSurrogate implements \RectorPrefix20211025\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \RectorPrefix20211025\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
    ...
    {
        $subRequest = \RectorPrefix20211025\Symfony\Component\HttpFoundation\Request::create($uri, \RectorPrefix20211025\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \RectorPrefix20211025\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
