 ...
 */
abstract class AbstractSurrogate implements \RectorPrefix20210821\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \RectorPrefix20210821\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
    ...
    {
        $subRequest = \RectorPrefix20210821\Symfony\Component\HttpFoundation\Request::create($uri, \RectorPrefix20210821\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \RectorPrefix20210821\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
