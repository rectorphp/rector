 ...
 */
abstract class AbstractSurrogate implements \RectorPrefix20210731\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        $subRequest = \RectorPrefix20210731\Symfony\Component\HttpFoundation\Request::create($uri, \RectorPrefix20210731\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \RectorPrefix20210731\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
