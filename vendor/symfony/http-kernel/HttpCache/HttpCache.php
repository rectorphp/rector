...
use RectorPrefix20210811\Symfony\Component\HttpKernel\TerminableInterface;
/**
 * Cache provides HTTP caching.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HttpCache implements \RectorPrefix20210811\Symfony\Component\HttpKernel\HttpKernelInterface, \RectorPrefix20210811\Symfony\Component\HttpKernel\TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     *                            (see RFC 5861).
     */
    public function __construct(\RectorPrefix20210811\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \RectorPrefix20210811\Symfony\Component\HttpKernel\HttpCache\StoreInterface $store, \RectorPrefix20210811\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, array $options = [])
    {
        $this->store = $store;
        $this->kernel = $kernel;
    ...
    private function addTraces(\RectorPrefix20210811\Symfony\Component\HttpFoundation\Response $response)
    {
        $traceString = null;
    ...
    public function handle($request, $type = \RectorPrefix20210811\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, $catch = \true)
    {
        ...
        if (\RectorPrefix20210811\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST === $type) {
            $this->traces = [];
    ...
    {
        if ($this->getKernel() instanceof \RectorPrefix20210811\Symfony\Component\HttpKernel\TerminableInterface) {
            ...
            try {
                ...
                foreach (['Location', 'Content-Location'] as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \RectorPrefix20210811\Symfony\Component\HttpFoundation\Request::create($uri, 'get', [], [], [], $request->server->all());
    ...
    protected function forward($request, $catch = \false, $entry = null)
    {
        ...
        $response = \RectorPrefix20210811\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler::handle($this->kernel, $request, \RectorPrefix20210811\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, $catch);
        /*
     ...
     */
    private function restoreResponseBody(\RectorPrefix20210811\Symfony\Component\HttpFoundation\Request $request, \RectorPrefix20210811\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function isPrivateRequest(\RectorPrefix20210811\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     */
    private function record(\RectorPrefix20210811\Symfony\Component\HttpFoundation\Request $request, string $event)
    {
     ...
     */
    private function getTraceKey(\RectorPrefix20210811\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function mayServeStaleWhileRevalidate(\RectorPrefix20210811\Symfony\Component\HttpFoundation\Response $entry) : bool
    {
     ...
     */
    private function waitForLock(\RectorPrefix20210811\Symfony\Component\HttpFoundation\Request $request) : bool
    {
        $wait = 0;
