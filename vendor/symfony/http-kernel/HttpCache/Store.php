 ...
 */
class Store implements \RectorPrefix20210924\Symfony\Component\HttpKernel\HttpCache\StoreInterface
{
    protected $root;
    private $keyCache;
    private $locks;
    ...
    {
        $key = $this->getCacheKey(\RectorPrefix20210924\Symfony\Component\HttpFoundation\Request::create($url));
        if (isset($this->locks[$key])) {
            \flock($this->locks[$key], \LOCK_UN);
            \fclose($this->locks[$key]);
            unset($this->locks[$key]);
     ...
     */
    private function getCacheKey(\RectorPrefix20210924\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function persistRequest(\RectorPrefix20210924\Symfony\Component\HttpFoundation\Request $request) : array
    {
     ...
     */
    private function persistResponse(\RectorPrefix20210924\Symfony\Component\HttpFoundation\Response $response) : array
    {
     ...
     */
    private function restoreResponse(array $headers, string $path = null) : \RectorPrefix20210924\Symfony\Component\HttpFoundation\Response
    {
        ...
        return new \RectorPrefix20210924\Symfony\Component\HttpFoundation\Response($path, $status, $headers);
    }
}
