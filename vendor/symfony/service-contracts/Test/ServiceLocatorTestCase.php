...
use RectorPrefix202310\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\RectorPrefix202310\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\RectorPrefix202310\Psr\Container\ContainerExceptionInterface::class);
