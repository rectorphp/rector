...
use RectorPrefix202309\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\RectorPrefix202309\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\RectorPrefix202309\Psr\Container\ContainerExceptionInterface::class);
