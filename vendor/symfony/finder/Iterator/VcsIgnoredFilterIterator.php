 ...
 */
namespace RectorPrefix20220101\Symfony\Component\Finder\Iterator;

use RectorPrefix20220101\Symfony\Component\Finder\Gitignore;
final class VcsIgnoredFilterIterator extends \FilterIterator
{
    ...
    private function readGitignoreFile(string $path) : ?array
    {
        ...
        return $this->gitignoreFilesCache[$path] = [\RectorPrefix20220101\Symfony\Component\Finder\Gitignore::toRegex($gitignoreFileContent), \RectorPrefix20220101\Symfony\Component\Finder\Gitignore::toRegexMatchingNegatedPatterns($gitignoreFileContent)];
    }
