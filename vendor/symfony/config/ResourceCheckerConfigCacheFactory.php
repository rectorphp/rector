 ...
 */
class ResourceCheckerConfigCacheFactory implements \RectorPrefix20220128\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    ...
    {
        $cache = new \RectorPrefix20220128\Symfony\Component\Config\ResourceCheckerConfigCache($file, $this->resourceCheckers);
        if (!$cache->isFresh()) {
            $callable($cache);
        }
        return $cache;
