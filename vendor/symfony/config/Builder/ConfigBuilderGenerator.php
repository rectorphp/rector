...
use RectorPrefix202211\Symfony\Component\Config\Definition\VariableNode;
use RectorPrefix202211\Symfony\Component\Config\Loader\ParamConfigurator;
/**
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('RectorPrefix202211\\Symfony\\Config', $rootNode->getName());
