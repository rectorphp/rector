...
use RectorPrefix202208\Symfony\Component\Config\Definition\FloatNode;
use RectorPrefix202208\Symfony\Component\Config\Definition\IntegerNode;
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('RectorPrefix202208\\Symfony\\Config', $rootNode->getName());
