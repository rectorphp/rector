...
use RectorPrefix202303\Symfony\Component\Config\Definition\Builder\ExprBuilder;
...
use RectorPrefix202303\Symfony\Component\Config\Definition\FloatNode;
use RectorPrefix202303\Symfony\Component\Config\Definition\IntegerNode;
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('RectorPrefix202303\\Symfony\\Config', $rootNode->getName());
