...
use RectorPrefix20220608\Symfony\Component\Config\Definition\FloatNode;
use RectorPrefix20220608\Symfony\Component\Config\Definition\IntegerNode;
...
use RectorPrefix20220608\Symfony\Component\Config\Loader\ParamConfigurator;
/**
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('RectorPrefix20220608\\Symfony\\Config', $rootNode->getName());
