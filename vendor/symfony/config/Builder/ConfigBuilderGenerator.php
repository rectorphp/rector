...
use RectorPrefix20220607\Symfony\Component\Config\Definition\FloatNode;
use RectorPrefix20220607\Symfony\Component\Config\Definition\IntegerNode;
...
use RectorPrefix20220607\Symfony\Component\Config\Loader\ParamConfigurator;
/**
 * Generate ConfigBuilders to help create valid config.
 *
 * @author Tobias Nyholm <tobias.nyholm@gmail.com>
 */
class ConfigBuilderGenerator implements \RectorPrefix20220607\Symfony\Component\Config\Builder\ConfigBuilderGeneratorInterface
{
    /**
     * @var ClassBuilder[]
     */
    ...
    public function build(\RectorPrefix20220607\Symfony\Component\Config\Definition\ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new \RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder('RectorPrefix20220607\\Symfony\\Config', $rootNode->getName());
        ...
        if (!\is_file($path)) {
            ...
            $rootClass->addImplements(\RectorPrefix20220607\Symfony\Component\Config\Builder\ConfigBuilderInterface::class);
...
public function NAME(): string
{
    ...
    private function getFullPath(\RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder $class) : string
    {
    ...
    private function buildNode(\RectorPrefix20220607\Symfony\Component\Config\Definition\NodeInterface $node, \RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder $class, string $namespace) : void
    {
        if (!$node instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\ArrayNode) {
        ...
        foreach ($node->getChildren() as $child) {
            switch (\true) {
                case $child instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\ScalarNode:
                    $this->handleScalarNode($child, $class);
                    break;
                case $child instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\PrototypedArrayNode:
                    $this->handlePrototypedArrayNode($child, $class, $namespace);
                    break;
                case $child instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\VariableNode:
                    $this->handleVariableNode($child, $class);
                    break;
                case $child instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\ArrayNode:
    ...
    private function handleArrayNode(\RectorPrefix20220607\Symfony\Component\Config\Definition\ArrayNode $node, \RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder $class, string $namespace) : void
    {
        $childClass = new \RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder($namespace, $node->getName());
...
COMMENTpublic function NAME(array $value = []): CLASS
{
    ...
    return $this->PROPERTY;
        ...
        $class->addUse(\RectorPrefix20220607\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException::class);
        $class->addMethod($node->getName(), $body, ['COMMENT' => $comment, 'PROPERTY' => $property->getName(), 'CLASS' => $childClass->getFqcn()]);
        $this->buildNode($node, $childClass, $this->getSubNamespace($childClass));
    }
    private function handleVariableNode(\RectorPrefix20220607\Symfony\Component\Config\Definition\VariableNode $node, \RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder $class) : void
    {
        $comment = $this->getComment($node);
        $property = $class->addProperty($node->getName());
        $class->addUse(\RectorPrefix20220607\Symfony\Component\Config\Loader\ParamConfigurator::class);
        $body = '
/**
COMMENT *
 * @return $this
...
public function NAME(mixed $valueDEFAULT): static
{
    ...
    private function handlePrototypedArrayNode(\RectorPrefix20220607\Symfony\Component\Config\Definition\PrototypedArrayNode $node, \RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder $class, string $namespace) : void
    {
        ...
        if (null !== $parameterType || $prototype instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\ScalarNode) {
            $class->addUse(\RectorPrefix20220607\Symfony\Component\Config\Loader\ParamConfigurator::class);
            $property = $class->addProperty($node->getName());
...
public function NAME(string $VAR, TYPE $VALUE): static
{
    ...
    return $this;
        ...
        $childClass = new \RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder($namespace, $name);
        if ($prototype instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\ArrayNode) {
...
COMMENTpublic function NAME(string $VAR, array $VALUE = []): CLASS
{
    ...
    private function handleScalarNode(\RectorPrefix20220607\Symfony\Component\Config\Definition\ScalarNode $node, \RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder $class) : void
    {
        $comment = $this->getComment($node);
        $property = $class->addProperty($node->getName());
        $class->addUse(\RectorPrefix20220607\Symfony\Component\Config\Loader\ParamConfigurator::class);
...
public function NAME($value): static
{
    ...
    private function getParameterType(\RectorPrefix20220607\Symfony\Component\Config\Definition\NodeInterface $node) : ?string
    {
        if ($node instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\BooleanNode) {
            return 'bool';
        }
        if ($node instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\IntegerNode) {
            return 'int';
        }
        if ($node instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\FloatNode) {
            return 'float';
        }
        if ($node instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\EnumNode) {
            return '';
        }
        if ($node instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\PrototypedArrayNode && $node->getPrototype() instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\ScalarNode) {
            // This is just an array of variables
            return 'array';
        }
        if ($node instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\VariableNode) {
            // mixed
            return '';
        }
        return null;
    }
    private function getComment(\RectorPrefix20220607\Symfony\Component\Config\Definition\BaseNode $node) : string
    {
        $comment = '';
     ...
     */
    private function getSingularName(\RectorPrefix20220607\Symfony\Component\Config\Definition\PrototypedArrayNode $node) : string
    {
        $name = $node->getName();
        ...
        $mappings = $parent instanceof \RectorPrefix20220607\Symfony\Component\Config\Definition\ArrayNode ? $parent->getXmlRemappings() : [];
    ...
    private function buildToArray(\RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder $class) : void
    {
        $body = '$output = [];';
...
public function NAME(): array
{
    ...
    private function buildConstructor(\RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder $class) : void
    {
        $body = '';
        foreach ($class->getProperties() as $p) {
            $code = '$value[\'ORG_NAME\']';
...
{' . $body . '
    ...
    private function buildSetExtraKey(\RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder $class) : void
    {
        if (!$class->shouldAllowExtraKeys()) {
            return;
        }
...
public function NAME(string $key, mixed $value): static
{
    ...
    private function getSubNamespace(\RectorPrefix20220607\Symfony\Component\Config\Builder\ClassBuilder $rootClass) : string
    {
        return \sprintf('%s\\%s', $rootClass->getNamespace(), \substr($rootClass->getName(), 0, -6));
    }
    private function hasNormalizationClosures(\RectorPrefix20220607\Symfony\Component\Config\Definition\NodeInterface $node) : bool
    {
        try {
