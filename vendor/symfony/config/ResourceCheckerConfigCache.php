 ...
 */
class ResourceCheckerConfigCache implements \RectorPrefix20210707\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \RectorPrefix20210707\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\RectorPrefix20210707\Symfony\Component\Filesystem\Exception\IOException $e) {
