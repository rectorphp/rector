 ...
 */
class ResourceCheckerConfigCache implements \RectorPrefix20220601\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \RectorPrefix20220601\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\RectorPrefix20220601\Symfony\Component\Filesystem\Exception\IOException $exception) {
