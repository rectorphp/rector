 ...
 */
class ResourceCheckerConfigCache implements \RectorPrefix20210706\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \RectorPrefix20210706\Symfony\Component\Filesystem\Filesystem();
