...
class NodeBuilder implements \RectorPrefix20210904\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    ...
    {
        if ($node instanceof \RectorPrefix20210904\Symfony\Component\Config\Definition\Builder\BuilderAwareInterface) {
            $builder = clone $this;
