...
class NodeBuilder implements \RectorPrefix20220107\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
     ...
     * @return $this
     */
    public function setParent(\RectorPrefix20220107\Symfony\Component\Config\Definition\Builder\ParentNodeDefinitionInterface $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
    ...
    {
        if ($node instanceof \RectorPrefix20220107\Symfony\Component\Config\Definition\Builder\BuilderAwareInterface) {
            $builder = clone $this;
