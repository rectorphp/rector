...
class NodeBuilder implements \RectorPrefix20210731\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    ...
    {
        if ($node instanceof \RectorPrefix20210731\Symfony\Component\Config\Definition\Builder\BuilderAwareInterface) {
            $builder = clone $this;
