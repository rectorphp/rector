 ...
 */
class GlobResource implements \IteratorAggregate, \RectorPrefix20220528\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var string
     */
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\RectorPrefix20220528\Symfony\Component\Finder\Finder::class)) {
        ...
        $regex = \RectorPrefix20220528\Symfony\Component\Finder\Glob::toRegex($pattern);
        if ($this->recursive) {
            $regex = \substr_replace($regex, '(/|$)', -2, 1);
        }
        $prefixLen = \strlen($prefix);
        yield from (new \RectorPrefix20220528\Symfony\Component\Finder\Finder())->followLinks()->filter(function (\SplFileInfo $info) use($regex, $prefixLen, $prefix) {
