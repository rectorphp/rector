 ...
 */
class GlobResource implements \IteratorAggregate, \RectorPrefix20220326\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var string
     */
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\RectorPrefix20220326\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \RectorPrefix20220326\Symfony\Component\Finder\Finder();
        $regex = \RectorPrefix20220326\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
