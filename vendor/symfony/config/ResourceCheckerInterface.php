...
interface ResourceCheckerInterface
{
     ...
     * @return bool
     */
    public function supports(\RectorPrefix20220518\Symfony\Component\Config\Resource\ResourceInterface $metadata);
    /**
     ...
     * @return bool
     */
    public function isFresh(\RectorPrefix20220518\Symfony\Component\Config\Resource\ResourceInterface $resource, int $timestamp);
}
