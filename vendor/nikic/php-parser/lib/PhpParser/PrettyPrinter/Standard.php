...
class Standard extends \PhpParser\PrettyPrinterAbstract
{
    ...
    /**
     * @param \PhpParser\Node\VariadicPlaceholder $node
     */
    protected function pVariadicPlaceholder($node)
    {
        return '...';
    }
    /**
    ...
    /**
     * @param \PhpParser\Node\IntersectionType $node
     */
    protected function pIntersectionType($node)
    {
        return $this->pImplode($node->types, '&');
    }
    /**
