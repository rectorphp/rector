...
final class BuilderHelpers
{
    ...
    public static function normalizeIdentifier($name) : \PhpParser\Node\Identifier
    {
        ...
        throw new \LogicException('RectorPrefix20210926\\Expected string or instance of Node\\Identifier');
    }
    /**
    ...
    public static function normalizeIdentifierOrExpr($name)
    {
        ...
        throw new \LogicException('RectorPrefix20210926\\Expected string or instance of Node\\Identifier or Node\\Expr');
    }
    /**
    ...
    private static function normalizeNameCommon($name, bool $allowExpr)
    {
        ...
        if ($allowExpr) {
            ...
            throw new \LogicException('RectorPrefix20210926\\Name must be a string or an instance of Node\\Name or Node\\Expr');
        }
        throw new \LogicException('RectorPrefix20210926\\Name must be a string or an instance of Node\\Name');
    }
    /**
    ...
    public static function normalizeDocComment($docComment) : \PhpParser\Comment\Doc
    {
        ...
        throw new \LogicException('RectorPrefix20210926\\Doc comment must be a string or an instance of PhpParser\\Comment\\Doc');
    }
    /**
    ...
    public static function normalizeAttribute($attribute) : \PhpParser\Node\AttributeGroup
    {
        ...
        if (!$attribute instanceof \PhpParser\Node\Attribute) {
            throw new \LogicException('RectorPrefix20210926\\Attribute must be an instance of PhpParser\\Node\\Attribute or PhpParser\\Node\\AttributeGroup');
        }
