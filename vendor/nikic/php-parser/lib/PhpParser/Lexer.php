...
class Lexer
{
    ...
    protected function createTokenMap() : array
    {
        ...
        if (\defined('RectorPrefix202306\\T_ONUMBER')) {
            $tokenMap[\RectorPrefix202306\T_ONUMBER] = Tokens::T_DNUMBER;
        }
        // HHVM also has a separate token for the __COMPILER_HALT_OFFSET__ constant
        if (\defined('RectorPrefix202306\\T_COMPILER_HALT_OFFSET')) {
            $tokenMap[\RectorPrefix202306\T_COMPILER_HALT_OFFSET] = Tokens::T_STRING;
        }
