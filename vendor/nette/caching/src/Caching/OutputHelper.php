...
class OutputHelper
{
    ...
    /** @var string */
    private $key;
    public function __construct(\RectorPrefix20210530\Nette\Caching\Cache $cache, $key)
    {
        $this->cache = $cache;
        $this->key = $key;
        \ob_start();
    ...
    {
        if ($this->cache === null) {
            throw new \RectorPrefix20210530\Nette\InvalidStateException('Output cache has already been saved.');
        }
