...
class Image
{
    ...
    {
        if (!$image instanceof \RectorPrefix20210510\GdImage && !(\is_resource($image) && \get_resource_type($image) === 'gd')) {
    ...
    public function __call(string $name, array $args)
    {
        ...
        return $res instanceof \RectorPrefix20210510\GdImage || \is_resource($res) && \get_resource_type($res) === 'gd' ? $this->setImageResource($res) : $res;
    }
