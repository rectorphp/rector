...
class Helpers
{
    ...
    public static function getLastError() : string
    {
        ...
        $message = \ini_get('html_errors') ? \RectorPrefix20220303\Nette\Utils\Html::htmlToText($message) : $message;
    ...
    {
        if ($min > $max) {
            throw new \RectorPrefix20220303\Nette\InvalidArgumentException("Minimum ({$min}) is not less than maximum ({$max}).");
        }
