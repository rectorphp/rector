...
class CachingIterator extends \CachingIterator implements \Countable
{
    ...
    public function __construct($iterator)
    {
        if (\is_array($iterator) || $iterator instanceof \stdClass) {
            ...
            throw new \RectorPrefix20220418\Nette\InvalidArgumentException(\sprintf('Invalid argument passed to %s; array or Traversable expected, %s given.', self::class, \is_object($iterator) ? \get_class($iterator) : \gettype($iterator)));
        }
    ...
    public function count() : int
    {
        ...
        if ($inner instanceof \Countable) {
            ...
            throw new \RectorPrefix20220418\Nette\NotSupportedException('Iterator is not countable.');
        }
    }
    /**
