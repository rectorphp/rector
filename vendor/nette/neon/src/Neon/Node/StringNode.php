...
/** @internal */
final class StringNode extends \RectorPrefix20211122\Nette\Neon\Node
{
    /** @var string */
    public $value;
    ...
    public function toString() : string
    {
        ...
        if ($res === \false) {
            throw new \RectorPrefix20211122\Nette\Neon\Exception('Invalid UTF-8 sequence: ' . $this->value);
        }
