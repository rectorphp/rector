...
use RectorPrefix20211105\Nette\Neon;
use RectorPrefix20211105\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \RectorPrefix20211105\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \RectorPrefix20211105\Nette\Neon\Entity
    {
        ...
        return new \RectorPrefix20211105\Nette\Neon\Entity(\RectorPrefix20211105\Nette\Neon\Neon::CHAIN, $entities);
    }
