...
final class Neon
{
    public const BLOCK = \RectorPrefix20210804\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \RectorPrefix20210804\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \RectorPrefix20210804\Nette\Neon\Decoder();
