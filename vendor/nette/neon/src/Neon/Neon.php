...
final class Neon
{
    public const BLOCK = \RectorPrefix20220429\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \RectorPrefix20220429\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \RectorPrefix20220429\Nette\Neon\Decoder();
    ...
    {
        if (!\is_file($file)) {
            throw new \RectorPrefix20220429\Nette\Neon\Exception("File '{$file}' does not exist.");
        }
