...
final class Neon
{
    public const BLOCK = \RectorPrefix20210827\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \RectorPrefix20210827\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \RectorPrefix20210827\Nette\Neon\Decoder();
