...
final class Neon
{
    ...
    {
        $encoder = new \RectorPrefix20220420\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \RectorPrefix20220420\Nette\Neon\Decoder();
    ...
    {
        if (!\is_file($file)) {
            throw new \RectorPrefix20220420\Nette\Neon\Exception("File '{$file}' does not exist.");
        }
