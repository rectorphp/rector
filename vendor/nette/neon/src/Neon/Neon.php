...
final class Neon
{
    public const BLOCK = \RectorPrefix20211102\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \RectorPrefix20211102\Nette\Neon\Encoder();
    ...
    public static function decode(string $input)
    {
        ...
        $decoder = new \RectorPrefix20211102\Nette\Neon\Decoder();
