...
final class Neon
{
    public const BLOCK = \RectorPrefix20211019\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \RectorPrefix20211019\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \RectorPrefix20211019\Nette\Neon\Decoder();
