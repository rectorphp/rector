...
final class Neon
{
    public const BLOCK = \RectorPrefix20220430\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \RectorPrefix20220430\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \RectorPrefix20220430\Nette\Neon\Decoder();
    ...
    {
        if (!\is_file($file)) {
            throw new \RectorPrefix20220430\Nette\Neon\Exception("File '{$file}' does not exist.");
        }
