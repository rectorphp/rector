...
final class Neon
{
    public const BLOCK = \RectorPrefix20210803\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \RectorPrefix20210803\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \RectorPrefix20210803\Nette\Neon\Decoder();
