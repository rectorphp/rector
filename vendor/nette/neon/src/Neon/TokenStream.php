...
final class TokenStream
{
    ...
    public function consume(...$types) : ?\RectorPrefix20220107\Nette\Neon\Token
    {
        return $this->isNext(...$types) ? $this->tokens[$this->pos++] : null;
    }
    public function getIndentation() : string
    {
        return \in_array($this->tokens[$this->pos - 2]->type ?? null, [\RectorPrefix20220107\Nette\Neon\Token::NEWLINE, null], \true) && ($this->tokens[$this->pos - 1]->type ?? null) === \RectorPrefix20220107\Nette\Neon\Token::WHITESPACE ? $this->tokens[$this->pos - 1]->value : '';
    }
    /** @return never */
    public function error(string $message = null, int $pos = null) : void
    {
        ...
        throw new \RectorPrefix20220107\Nette\Neon\Exception("{$message} on line {$line}, column {$col}.");
    }
}
