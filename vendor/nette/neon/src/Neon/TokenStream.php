...
final class TokenStream
{
    ...
    public function consume(...$types) : ?\RectorPrefix20220420\Nette\Neon\Token
    {
    ...
    public function error(string $message = null, int $pos = null) : void
    {
        ...
        throw new \RectorPrefix20220420\Nette\Neon\Exception("{$message} on line {$line}, column {$col}.");
    }
}
