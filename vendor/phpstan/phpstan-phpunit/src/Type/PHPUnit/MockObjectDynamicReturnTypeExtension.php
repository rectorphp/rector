...
class MockObjectDynamicReturnTypeExtension implements \PHPStan\Type\DynamicMethodReturnTypeExtension
{
    ...
    {
        return \RectorPrefix20220328\PHPUnit\Framework\MockObject\MockObject::class;
    }
    ...
    public function getTypeFromMethodCall(\PHPStan\Reflection\MethodReflection $methodReflection, \PhpParser\Node\Expr\MethodCall $methodCall, \PHPStan\Analyser\Scope $scope) : \PHPStan\Type\Type
    {
        ...
        return new \PHPStan\Type\Generic\GenericObjectType(\RectorPrefix20220328\PHPUnit\Framework\MockObject\Builder\InvocationMocker::class, $mockClasses);
    }
}
