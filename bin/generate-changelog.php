...
use RectorPrefix20211127\Httpful\Request;
...
use RectorPrefix20211127\Symfony\Component\Console\Input\InputArgument;
...
use RectorPrefix20211127\Symfony\Component\Process\Process;
 ...
 */
final class GenerateChangelogCommand extends \RectorPrefix20211127\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    {
        $this->setName(\RectorPrefix20211127\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
        $this->addArgument(self::OPTION_FROM_COMMIT, \RectorPrefix20211127\Symfony\Component\Console\Input\InputArgument::REQUIRED);
        $this->addArgument(self::OPTION_TO_COMMIT, \RectorPrefix20211127\Symfony\Component\Console\Input\InputArgument::REQUIRED);
    }
    /**
    ...
    protected function execute($input, $output) : int
    {
        ...
        foreach ($commits as $commit) {
            ...
            $searchPullRequestsResponse = \RectorPrefix20211127\Httpful\Request::get($searchPullRequestsUri)->sendsAndExpectsType('application/json')->basicAuth('tomasvotruba', \getenv('GITHUB_TOKEN'))->send();
            ...
            $searchIssuesResponse = \RectorPrefix20211127\Httpful\Request::get($searchIssuesUri)->sendsAndExpectsType('application/json')->basicAuth('tomasvotruba', \getenv('GITHUB_TOKEN'))->send();
            ...
            $commitMatch = \RectorPrefix20211127\Nette\Utils\Strings::match($commit['message'], '#(.*?)( \\(\\#\\d+\\))?$#ms');
    ...
    {
        $process = new \RectorPrefix20211127\Symfony\Component\Process\Process($commandParts);
        $process->run();
...
$generateChangelogCommand = new \RectorPrefix20211127\GenerateChangelogCommand();
$application = new \RectorPrefix20211127\Symfony\Component\Console\Application();
$application->add($generateChangelogCommand);
$application->setDefaultCommand(\RectorPrefix20211127\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(\get_class($generateChangelogCommand)), \true);
$application->run();
