...
use RectorPrefix20211211\Httpful\Request;
 ...
 */
final class GenerateChangelogCommand extends \RectorPrefix20211211\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    {
        $this->setName(\RectorPrefix20211211\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
        $this->addArgument(self::OPTION_FROM_COMMIT, \RectorPrefix20211211\Symfony\Component\Console\Input\InputArgument::REQUIRED);
        $this->addArgument(self::OPTION_TO_COMMIT, \RectorPrefix20211211\Symfony\Component\Console\Input\InputArgument::REQUIRED);
    }
    protected function execute(\RectorPrefix20211211\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20211211\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        foreach ($commits as $commit) {
            ...
            $searchPullRequestsResponse = \RectorPrefix20211211\Httpful\Request::get($searchPullRequestsUri)->sendsAndExpectsType('application/json')->basicAuth('tomasvotruba', \getenv('GITHUB_TOKEN'))->send();
            ...
            $searchIssuesResponse = \RectorPrefix20211211\Httpful\Request::get($searchIssuesUri)->sendsAndExpectsType('application/json')->basicAuth('tomasvotruba', \getenv('GITHUB_TOKEN'))->send();
            ...
            $commitMatch = \RectorPrefix20211211\Nette\Utils\Strings::match($commit['message'], '#(.*?)( \\(\\#\\d+\\))?$#ms');
    ...
    {
        $process = new \RectorPrefix20211211\Symfony\Component\Process\Process($commandParts);
        $process->run();
...
$generateChangelogCommand = new \RectorPrefix20211211\GenerateChangelogCommand();
$application = new \RectorPrefix20211211\Symfony\Component\Console\Application();
$application->add($generateChangelogCommand);
$application->setDefaultCommand(\RectorPrefix20211211\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(\get_class($generateChangelogCommand)), \true);
$application->run();
