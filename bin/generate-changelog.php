 ...
 */
final class GenerateChangelogCommand extends \RectorPrefix20211115\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::OPTION_FROM_COMMIT, \RectorPrefix20211115\Symfony\Component\Console\Input\InputArgument::REQUIRED);
        $this->addArgument(self::OPTION_TO_COMMIT, \RectorPrefix20211115\Symfony\Component\Console\Input\InputArgument::REQUIRED);
    }
    /**
...
$generateChangelogCommand = new \RectorPrefix20211115\GenerateChangelogCommand();
$application = new \RectorPrefix20211115\Symfony\Component\Console\Application();
$application->add($generateChangelogCommand);
$application->setDefaultCommand(\RectorPrefix20211115\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(\get_class($generateChangelogCommand)), \true);
$application->run();
