...
$autoloadIncluder = new \RectorPrefix20210609\AutoloadIncluder();
...
} elseif (\RectorPrefix20210609\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210609\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210609\\AutoloadIncluder', 'AutoloadIncluder', \false);
