...
$autoloadIncluder = new \RectorPrefix20210630\AutoloadIncluder();
...
} elseif (\RectorPrefix20210630\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210630\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
try {
    ...
    exit(\RectorPrefix20210630\Symplify\PackageBuilder\Console\ShellCode::ERROR);
}
...
\class_alias('RectorPrefix20210630\\AutoloadIncluder', 'AutoloadIncluder', \false);
