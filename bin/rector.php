...
$autoloadIncluder = new \RectorPrefix20210627\AutoloadIncluder();
...
} elseif (\RectorPrefix20210627\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210627\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210627\\AutoloadIncluder', 'AutoloadIncluder', \false);
