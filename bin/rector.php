...
$autoloadIncluder = new \RectorPrefix20210623\AutoloadIncluder();
...
} elseif (\RectorPrefix20210623\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210623\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210623\\AutoloadIncluder', 'AutoloadIncluder', \false);
