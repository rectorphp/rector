...
$autoloadIncluder = new \RectorPrefix20210513\AutoloadIncluder();
...
} elseif (\RectorPrefix20210513\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210513\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210513\\AutoloadIncluder', 'AutoloadIncluder', \false);
