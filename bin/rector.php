...
$autoloadIncluder = new \RectorPrefix20210703\AutoloadIncluder();
...
} elseif (\RectorPrefix20210703\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210703\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210703\\AutoloadIncluder', 'AutoloadIncluder', \false);
