...
$autoloadIncluder = new \RectorPrefix20210611\AutoloadIncluder();
...
} elseif (\RectorPrefix20210611\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210611\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210611\\AutoloadIncluder', 'AutoloadIncluder', \false);
