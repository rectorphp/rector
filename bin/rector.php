...
$autoloadIncluder = new \RectorPrefix20210515\AutoloadIncluder();
...
} elseif (\RectorPrefix20210515\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210515\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210515\\AutoloadIncluder', 'AutoloadIncluder', \false);
