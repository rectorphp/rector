...
$autoloadIncluder = new \RectorPrefix20210602\AutoloadIncluder();
...
} elseif (\RectorPrefix20210602\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210602\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210602\\AutoloadIncluder', 'AutoloadIncluder', \false);
