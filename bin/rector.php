...
$autoloadIncluder = new \RectorPrefix20210705\AutoloadIncluder();
...
} elseif (\RectorPrefix20210705\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210705\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210705\\AutoloadIncluder', 'AutoloadIncluder', \false);
