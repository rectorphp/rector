...
$autoloadIncluder = new \RectorPrefix20210624\AutoloadIncluder();
...
} elseif (\RectorPrefix20210624\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210624\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210624\\AutoloadIncluder', 'AutoloadIncluder', \false);
