...
$autoloadIncluder = new \RectorPrefix20210617\AutoloadIncluder();
...
} elseif (\RectorPrefix20210617\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210617\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210617\\AutoloadIncluder', 'AutoloadIncluder', \false);
