...
$autoloadIncluder = new \RectorPrefix20210615\AutoloadIncluder();
...
} elseif (\RectorPrefix20210615\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210615\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210615\\AutoloadIncluder', 'AutoloadIncluder', \false);
