...
$autoloadIncluder = new \RectorPrefix20220531\AutoloadIncluder();
...
\class_alias('RectorPrefix20220531\\AutoloadIncluder', 'AutoloadIncluder', \false);
...
try {
    ...
    if ($outputFormat === \Rector\ChangesReporting\Output\JsonOutputFormatter::NAME) {
        echo \RectorPrefix20220531\Nette\Utils\Json::encode(['fatal_errors' => [$throwable->getMessage()]]);
    } else {
        // report fatal errors in console format
        $rectorConsoleOutputStyleFactory = new \Rector\Core\Console\Style\RectorConsoleOutputStyleFactory(new \RectorPrefix20220531\Symplify\PackageBuilder\Reflection\PrivatesCaller());
