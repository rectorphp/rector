...
$autoloadIncluder = new \RectorPrefix20210524\AutoloadIncluder();
...
} elseif (\RectorPrefix20210524\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210524\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210524\\AutoloadIncluder', 'AutoloadIncluder', \false);
