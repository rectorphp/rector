...
$autoloadIncluder = new \RectorPrefix20210529\AutoloadIncluder();
...
} elseif (\RectorPrefix20210529\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210529\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210529\\AutoloadIncluder', 'AutoloadIncluder', \false);
