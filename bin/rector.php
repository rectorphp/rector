...
$autoloadIncluder = new \RectorPrefix20210608\AutoloadIncluder();
...
} elseif (\RectorPrefix20210608\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210608\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210608\\AutoloadIncluder', 'AutoloadIncluder', \false);
