...
$autoloadIncluder = new \RectorPrefix20210601\AutoloadIncluder();
...
} elseif (\RectorPrefix20210601\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210601\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210601\\AutoloadIncluder', 'AutoloadIncluder', \false);
