...
$autoloadIncluder = new \RectorPrefix20210621\AutoloadIncluder();
...
} elseif (\RectorPrefix20210621\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210621\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210621\\AutoloadIncluder', 'AutoloadIncluder', \false);
