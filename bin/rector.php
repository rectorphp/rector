...
$autoloadIncluder = new \RectorPrefix20210530\AutoloadIncluder();
...
} elseif (\RectorPrefix20210530\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210530\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210530\\AutoloadIncluder', 'AutoloadIncluder', \false);
