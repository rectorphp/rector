...
$autoloadIncluder = new \RectorPrefix20210512\AutoloadIncluder();
...
} elseif (\RectorPrefix20210512\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210512\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210512\\AutoloadIncluder', 'AutoloadIncluder', \false);
