...
$autoloadIncluder = new \RectorPrefix20210610\AutoloadIncluder();
...
} elseif (\RectorPrefix20210610\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210610\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210610\\AutoloadIncluder', 'AutoloadIncluder', \false);
