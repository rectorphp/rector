...
$autoloadIncluder = new \RectorPrefix20210511\AutoloadIncluder();
...
} elseif (\RectorPrefix20210511\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210511\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210511\\AutoloadIncluder', 'AutoloadIncluder', \false);
