...
$autoloadIncluder = new \RectorPrefix20210514\AutoloadIncluder();
...
} elseif (\RectorPrefix20210514\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210514\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210514\\AutoloadIncluder', 'AutoloadIncluder', \false);
