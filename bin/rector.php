...
$autoloadIncluder = new \RectorPrefix20210626\AutoloadIncluder();
...
} elseif (\RectorPrefix20210626\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210626\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210626\\AutoloadIncluder', 'AutoloadIncluder', \false);
