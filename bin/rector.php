...
$autoloadIncluder = new \RectorPrefix20210622\AutoloadIncluder();
...
} elseif (\RectorPrefix20210622\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210622\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210622\\AutoloadIncluder', 'AutoloadIncluder', \false);
