...
$autoloadIncluder = new \RectorPrefix20210612\AutoloadIncluder();
...
} elseif (\RectorPrefix20210612\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210612\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210612\\AutoloadIncluder', 'AutoloadIncluder', \false);
