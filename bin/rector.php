...
$autoloadIncluder = new \RectorPrefix20210604\AutoloadIncluder();
...
} elseif (\RectorPrefix20210604\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210604\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210604\\AutoloadIncluder', 'AutoloadIncluder', \false);
