...
$autoloadIncluder = new \RectorPrefix20210702\AutoloadIncluder();
...
} elseif (\RectorPrefix20210702\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210702\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210702\\AutoloadIncluder', 'AutoloadIncluder', \false);
