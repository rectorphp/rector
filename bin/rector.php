...
$autoloadIncluder = new \RectorPrefix20210625\AutoloadIncluder();
...
} elseif (\RectorPrefix20210625\should_include_preload()) {
...
$symfonyStyleFactory = new \Rector\Core\Console\Style\SymfonyStyleFactory(new \RectorPrefix20210625\Symplify\PackageBuilder\Reflection\PrivatesCaller());
...
\class_alias('RectorPrefix20210625\\AutoloadIncluder', 'AutoloadIncluder', \false);
