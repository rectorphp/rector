...
return [
    ...
    ScoperOption::PATCHERS => [
        ...
        function (string $filePath, string $prefix, string $content): string {
            ...
            if (! Strings::match($filePath, '#vendor/symfony/polyfill-php\d{2}/Resources/stubs#') && ! Strings::endsWith($filePath, 'vendor/symplify/package-builder/src/Testing/AbstractKernelTestCase.php') && ! Strings::endsWith($filePath, 'vendor/phpunit/phpunit/src/Framework/TestCase.php')) {
                return $content;
            }
