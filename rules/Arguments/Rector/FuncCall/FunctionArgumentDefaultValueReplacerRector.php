...
, [self::REPLACED_ARGUMENTS => [new \Rector\Arguments\ValueObject\FuncCallArgumentDefaultValueReplacer('version_compare', 2, 'gte', 'ge')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20210606\Webmozart\Assert\Assert::allIsInstanceOf($replacedArguments, \Rector\Arguments\ValueObject\FuncCallArgumentDefaultValueReplacer::class);
