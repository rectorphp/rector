...
, [new \Rector\Arguments\ValueObject\ReplaceArgumentDefaultValue('SomeClass', 'someMethod', 0, 'SomeClass::OLD_CONSTANT', \false)])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220210\Webmozart\Assert\Assert::isArray($replacedArguments);
        \RectorPrefix20220210\Webmozart\Assert\Assert::allIsAOf($replacedArguments, \Rector\Arguments\ValueObject\ReplaceArgumentDefaultValue::class);
