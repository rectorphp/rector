...
final class ArgumentAdderRector extends AbstractRector implements ConfigurableRectorInterface
{
    ...
    {
        $exampleConfiguration = [self::ADDED_ARGUMENTS => [new ArgumentAdder('SomeExampleClass', 'someMethod', 0, 'someArgument', \true, 'SomeType')]];
...
CODE_SAMPLE
, $exampleConfiguration), new ConfiguredCodeSample(<<<'CODE_SAMPLE'
