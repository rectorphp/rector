...
final class PSR4NamespaceMatcher implements \Rector\PSR4\Contract\PSR4AutoloadNamespaceMatcherInterface
{
    ...
    {
        $extraNamespace = \RectorPrefix20220316\Nette\Utils\Strings::substring($smartFileInfo->getRelativeDirectoryPath(), \RectorPrefix20220316\Nette\Utils\Strings::length($path) + 1);
        $extraNamespace = \RectorPrefix20220316\Nette\Utils\Strings::replace($extraNamespace, '#/#', '\\');
