...
final class OrderMethodsByVisibilityRector extends AbstractRector
{
     ...
     * @var string[]
     */
    private const PREFERRED_ORDER = [MethodName::CONSTRUCT, MethodName::DESCTRUCT, '__call', '__callStatic', '__get', '__set', '__isset', '__unset', '__sleep', '__wakeup', '__serialize', '__unserialize', '__toString', '__invoke', MethodName::SET_STATE, MethodName::CLONE, 'setUpBeforeClass', 'tearDownAfterClass', MethodName::SET_UP, MethodName::TEAR_DOWN];
    /**
    ...
    {
        return new RuleDefinition('Orders method by visibility', [new CodeSample(<<<'CODE_SAMPLE'
class SomeClass
{
