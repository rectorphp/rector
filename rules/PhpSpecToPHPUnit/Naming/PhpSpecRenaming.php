...
use RectorPrefix20220120\Symplify\PackageBuilder\Strings\StringFormatConverter;
final class PhpSpecRenaming
{
    ...
    public function __construct(\Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20220120\Symplify\PackageBuilder\Strings\StringFormatConverter $stringFormatConverter, \Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder)
    {
