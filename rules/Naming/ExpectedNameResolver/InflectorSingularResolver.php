...
use RectorPrefix20211026\Doctrine\Inflector\Inflector;
...
final class InflectorSingularResolver
{
    ...
    {
        $matchBy = \RectorPrefix20211026\Nette\Utils\Strings::match($currentName, self::BY_MIDDLE_REGEX);
        if ($matchBy) {
            return \RectorPrefix20211026\Nette\Utils\Strings::substring($currentName, 0, -\strlen($matchBy['by']));
        }
