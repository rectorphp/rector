...
final class StringClassNameToClassConstantRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\AllowEmptyConfigurableRectorInterface, \Rector\VersionBonding\Contract\MinPhpVersionInterface
{
    ...
    public function __construct(\RectorPrefix20220206\Symplify\PackageBuilder\Reflection\ClassLikeExistenceChecker $classLikeExistenceChecker)
    {
...
, ['ClassName', 'AnotherClassName'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220206\Webmozart\Assert\Assert::isArray($classesToSkip);
        \RectorPrefix20220206\Webmozart\Assert\Assert::allString($classesToSkip);
