...
, [self::STATIC_CALLS_TO_METHOD_CALLS => [new \Rector\Transform\ValueObject\StaticCallToMethodCall('Nette\\Utils\\FileSystem', 'write', 'Symplify\\SmartFileSystem\\SmartFileSystem', 'dumpFile')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211129\Webmozart\Assert\Assert::isArray($staticCallsToMethodCalls);
        \RectorPrefix20211129\Webmozart\Assert\Assert::allIsAOf($staticCallsToMethodCalls, \Rector\Transform\ValueObject\StaticCallToMethodCall::class);
