...
, [self::STATIC_CALLS_TO_METHOD_CALLS => [new \Rector\Transform\ValueObject\StaticCallToMethodCall('Nette\\Utils\\FileSystem', 'write', 'Symplify\\SmartFileSystem\\SmartFileSystem', 'dumpFile')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211113\Webmozart\Assert\Assert::isArray($staticCallsToMethodCalls);
        \RectorPrefix20211113\Webmozart\Assert\Assert::allIsInstanceOf($staticCallsToMethodCalls, \Rector\Transform\ValueObject\StaticCallToMethodCall::class);
