...
, [new \Rector\Transform\ValueObject\UnsetAndIssetToMethodCall('SomeContainer', 'hasService', 'removeService')])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220213\Webmozart\Assert\Assert::isArray($issetUnsetToMethodCalls);
        \RectorPrefix20220213\Webmozart\Assert\Assert::allIsAOf($issetUnsetToMethodCalls, \Rector\Transform\ValueObject\UnsetAndIssetToMethodCall::class);
