...
, [self::ISSET_UNSET_TO_METHOD_CALL => [$unsetAndIssetToMethodCall]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211204\Webmozart\Assert\Assert::isArray($issetUnsetToMethodCalls);
        \RectorPrefix20211204\Webmozart\Assert\Assert::allIsAOf($issetUnsetToMethodCalls, \Rector\Transform\ValueObject\UnsetAndIssetToMethodCall::class);
