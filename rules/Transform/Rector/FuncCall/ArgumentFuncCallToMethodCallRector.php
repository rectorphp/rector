...
, [new \Rector\Transform\ValueObject\ArgumentFuncCallToMethodCall('view', 'Illuminate\\Contracts\\View\\Factory', 'make')])]);
    ...
    public function configure($configuration) : void
    {
        ...
        \RectorPrefix20211210\Webmozart\Assert\Assert::isArray($functionToMethodCalls);
        \RectorPrefix20211210\Webmozart\Assert\Assert::allIsAOf($functionToMethodCalls, \Rector\Transform\Contract\ValueObject\ArgumentFuncCallToMethodCallInterface::class);
