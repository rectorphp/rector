...
, [self::FUNC_CALL_TO_CLASS_METHOD_CALL => [new \Rector\Transform\ValueObject\FuncCallToMethodCall('view', 'Namespaced\\SomeRenderer', 'render')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211122\Webmozart\Assert\Assert::isArray($funcCallsToClassMethodCalls);
        \RectorPrefix20211122\Webmozart\Assert\Assert::allIsInstanceOf($funcCallsToClassMethodCalls, \Rector\Transform\ValueObject\FuncCallToMethodCall::class);
