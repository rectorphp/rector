...
, [new \Rector\Transform\ValueObject\FuncCallToMethodCall('view', 'Namespaced\\SomeRenderer', 'render')])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211228\Webmozart\Assert\Assert::isArray($funcCallsToClassMethodCalls);
        \RectorPrefix20211228\Webmozart\Assert\Assert::allIsAOf($funcCallsToClassMethodCalls, \Rector\Transform\ValueObject\FuncCallToMethodCall::class);
