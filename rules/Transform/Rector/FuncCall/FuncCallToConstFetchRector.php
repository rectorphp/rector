...
, [self::FUNCTIONS_TO_CONSTANTS => ['php_sapi_name' => 'PHP_SAPI']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211127\Webmozart\Assert\Assert::allString($functionsToConstants);
        \RectorPrefix20211127\Webmozart\Assert\Assert::allString(\array_keys($functionsToConstants));
