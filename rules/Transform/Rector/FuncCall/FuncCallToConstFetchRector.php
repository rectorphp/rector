...
, [self::FUNCTIONS_TO_CONSTANTS => ['php_sapi_name' => 'PHP_SAPI']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211205\Webmozart\Assert\Assert::isArray($functionsToConstants);
        \RectorPrefix20211205\Webmozart\Assert\Assert::allString($functionsToConstants);
        \RectorPrefix20211205\Webmozart\Assert\Assert::allString(\array_keys($functionsToConstants));
