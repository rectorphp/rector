...
, ['php_sapi_name' => 'PHP_SAPI'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220126\Webmozart\Assert\Assert::isArray($functionsToConstants);
        \RectorPrefix20220126\Webmozart\Assert\Assert::allString($functionsToConstants);
        \RectorPrefix20220126\Webmozart\Assert\Assert::allString(\array_keys($functionsToConstants));
