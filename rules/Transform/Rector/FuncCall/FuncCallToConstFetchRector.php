...
, ['php_sapi_name' => 'PHP_SAPI'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211229\Webmozart\Assert\Assert::isArray($functionsToConstants);
        \RectorPrefix20211229\Webmozart\Assert\Assert::allString($functionsToConstants);
        \RectorPrefix20211229\Webmozart\Assert\Assert::allString(\array_keys($functionsToConstants));
