...
, [new \Rector\Transform\ValueObject\ServiceGetterToConstructorInjection('FirstService', 'getAnotherService', 'AnotherService')])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220216\Webmozart\Assert\Assert::isArray($methodCallToServices);
        \RectorPrefix20220216\Webmozart\Assert\Assert::allIsAOf($methodCallToServices, \Rector\Transform\ValueObject\ServiceGetterToConstructorInjection::class);
