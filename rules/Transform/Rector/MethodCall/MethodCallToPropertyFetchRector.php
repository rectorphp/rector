...
, ['someMethod' => 'someProperty'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220217\Webmozart\Assert\Assert::allString(\array_keys($methodCallToPropertyFetchCollection));
        \RectorPrefix20220217\Webmozart\Assert\Assert::allString($methodCallToPropertyFetchCollection);
