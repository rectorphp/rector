...
, ['someMethod' => 'someProperty'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211208\Webmozart\Assert\Assert::allString(\array_keys($methodCallToPropertyFetchCollection));
        \RectorPrefix20211208\Webmozart\Assert\Assert::allString($methodCallToPropertyFetchCollection);
