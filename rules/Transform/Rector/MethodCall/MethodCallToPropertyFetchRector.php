...
, ['someMethod' => 'someProperty'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211227\Webmozart\Assert\Assert::allString(\array_keys($methodCallToPropertyFetchCollection));
        \RectorPrefix20211227\Webmozart\Assert\Assert::allString($methodCallToPropertyFetchCollection);
