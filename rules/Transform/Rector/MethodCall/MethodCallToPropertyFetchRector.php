...
, ['someMethod' => 'someProperty'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220205\Webmozart\Assert\Assert::allString(\array_keys($methodCallToPropertyFetchCollection));
        \RectorPrefix20220205\Webmozart\Assert\Assert::allString($methodCallToPropertyFetchCollection);
