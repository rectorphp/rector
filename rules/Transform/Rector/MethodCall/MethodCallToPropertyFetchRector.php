...
, [self::METHOD_CALL_TO_PROPERTY_FETCHES => ['someMethod' => 'someProperty']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211129\Webmozart\Assert\Assert::allString(\array_keys($methodCallToPropertyFetchCollection));
        \RectorPrefix20211129\Webmozart\Assert\Assert::allString($methodCallToPropertyFetchCollection);
