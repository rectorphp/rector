...
, [new \Rector\Transform\ValueObject\MethodCallToStaticCall('AnotherDependency', 'process', 'StaticCaller', 'anotherMethod')])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211210\Webmozart\Assert\Assert::isArray($methodCallsToStaticCalls);
        \RectorPrefix20211210\Webmozart\Assert\Assert::allIsAOf($methodCallsToStaticCalls, \Rector\Transform\ValueObject\MethodCallToStaticCall::class);
