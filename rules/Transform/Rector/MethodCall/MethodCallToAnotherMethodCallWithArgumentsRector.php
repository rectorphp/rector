...
, [new \Rector\Transform\ValueObject\MethodCallToAnotherMethodCallWithArguments('Nette\\DI\\ServiceDefinition', 'setInject', 'addTag', ['inject'])])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211211\Webmozart\Assert\Assert::isArray($methodCallRenamesWithAddedArguments);
        \RectorPrefix20211211\Webmozart\Assert\Assert::allIsAOf($methodCallRenamesWithAddedArguments, \Rector\Transform\ValueObject\MethodCallToAnotherMethodCallWithArguments::class);
