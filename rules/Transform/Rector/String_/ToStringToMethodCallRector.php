...
, ['SomeObject' => 'getPath'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220117\Webmozart\Assert\Assert::allString(\array_keys($methodNamesByType));
        \RectorPrefix20220117\Webmozart\Assert\Assert::allString($methodNamesByType);
