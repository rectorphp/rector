...
, ['SomeObject' => 'getPath'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220112\Webmozart\Assert\Assert::allString(\array_keys($methodNamesByType));
        \RectorPrefix20220112\Webmozart\Assert\Assert::allString($methodNamesByType);
