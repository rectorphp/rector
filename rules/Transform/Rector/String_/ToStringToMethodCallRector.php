...
, ['SomeObject' => 'getPath'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211224\Webmozart\Assert\Assert::allString(\array_keys($methodNamesByType));
        \RectorPrefix20211224\Webmozart\Assert\Assert::allString($methodNamesByType);
