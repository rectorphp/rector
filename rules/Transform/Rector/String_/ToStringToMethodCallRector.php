...
, ['SomeObject' => 'getPath'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211212\Webmozart\Assert\Assert::allString(\array_keys($methodNamesByType));
        \RectorPrefix20211212\Webmozart\Assert\Assert::allString($methodNamesByType);
