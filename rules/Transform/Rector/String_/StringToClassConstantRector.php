...
, [new \Rector\Transform\ValueObject\StringToClassConstant('compiler.post_dump', 'Yet\\AnotherClass', 'CONSTANT')])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220128\Webmozart\Assert\Assert::isArray($stringToClassConstants);
        \RectorPrefix20220128\Webmozart\Assert\Assert::allIsAOf($stringToClassConstants, \Rector\Transform\ValueObject\StringToClassConstant::class);
