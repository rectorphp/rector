...
, [self::NEWS_TO_METHOD_CALLS => [new \Rector\Transform\ValueObject\NewToMethodCall('MyClass', 'MyClassFactory', 'create')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211130\Webmozart\Assert\Assert::isArray($newsToMethodCalls);
        \RectorPrefix20211130\Webmozart\Assert\Assert::allIsAOf($newsToMethodCalls, \Rector\Transform\ValueObject\NewToMethodCall::class);
