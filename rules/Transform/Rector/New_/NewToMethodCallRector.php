...
, [new \Rector\Transform\ValueObject\NewToMethodCall('MyClass', 'MyClassFactory', 'create')])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220126\Webmozart\Assert\Assert::isArray($newsToMethodCalls);
        \RectorPrefix20220126\Webmozart\Assert\Assert::allIsAOf($newsToMethodCalls, \Rector\Transform\ValueObject\NewToMethodCall::class);
