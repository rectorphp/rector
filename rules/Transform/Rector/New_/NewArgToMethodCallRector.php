...
, [new \Rector\Transform\ValueObject\NewArgToMethodCall('Dotenv', \true, 'usePutenv')])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220128\Webmozart\Assert\Assert::isArray($newArgsToMethodCalls);
        \RectorPrefix20220128\Webmozart\Assert\Assert::allIsAOf($newArgsToMethodCalls, \Rector\Transform\ValueObject\NewArgToMethodCall::class);
