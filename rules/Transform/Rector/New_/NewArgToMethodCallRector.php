...
, [self::NEW_ARGS_TO_METHOD_CALLS => [new \Rector\Transform\ValueObject\NewArgToMethodCall('Dotenv', \true, 'usePutenv')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211204\Webmozart\Assert\Assert::isArray($newArgsToMethodCalls);
        \RectorPrefix20211204\Webmozart\Assert\Assert::allIsAOf($newArgsToMethodCalls, \Rector\Transform\ValueObject\NewArgToMethodCall::class);
