...
, [self::TYPE_TO_STATIC_CALLS => [new \Rector\Transform\ValueObject\NewToStaticCall('Cookie', 'Cookie', 'create')]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211204\Webmozart\Assert\Assert::isArray($typeToStaticCalls);
        \RectorPrefix20211204\Webmozart\Assert\Assert::allIsAOf($typeToStaticCalls, \Rector\Transform\ValueObject\NewToStaticCall::class);
