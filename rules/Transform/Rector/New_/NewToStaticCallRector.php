...
, [new \Rector\Transform\ValueObject\NewToStaticCall('Cookie', 'Cookie', 'create')])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211228\Webmozart\Assert\Assert::isArray($typeToStaticCalls);
        \RectorPrefix20211228\Webmozart\Assert\Assert::allIsAOf($typeToStaticCalls, \Rector\Transform\ValueObject\NewToStaticCall::class);
