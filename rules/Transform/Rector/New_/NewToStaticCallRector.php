...
, [new \Rector\Transform\ValueObject\NewToStaticCall('Cookie', 'Cookie', 'create')])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211206\Webmozart\Assert\Assert::isArray($typeToStaticCalls);
        \RectorPrefix20211206\Webmozart\Assert\Assert::allIsAOf($typeToStaticCalls, \Rector\Transform\ValueObject\NewToStaticCall::class);
