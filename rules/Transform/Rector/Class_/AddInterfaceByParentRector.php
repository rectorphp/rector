...
, ['SomeParent' => 'SomeInterface'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220128\Webmozart\Assert\Assert::isArray($interfaceByParent);
        \RectorPrefix20220128\Webmozart\Assert\Assert::allString(\array_keys($interfaceByParent));
        \RectorPrefix20220128\Webmozart\Assert\Assert::allString($interfaceByParent);
