...
, ['SomeParent' => 'SomeInterface'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220211\Webmozart\Assert\Assert::isArray($interfaceByParent);
        \RectorPrefix20220211\Webmozart\Assert\Assert::allString(\array_keys($interfaceByParent));
        \RectorPrefix20220211\Webmozart\Assert\Assert::allString($interfaceByParent);
