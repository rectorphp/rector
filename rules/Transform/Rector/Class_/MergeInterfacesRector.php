...
, ['SomeOldInterface' => 'SomeInterface'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220216\Webmozart\Assert\Assert::isArray($oldToNewInterfaces);
        \RectorPrefix20220216\Webmozart\Assert\Assert::allString(\array_keys($oldToNewInterfaces));
        \RectorPrefix20220216\Webmozart\Assert\Assert::allString($oldToNewInterfaces);
