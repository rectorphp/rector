...
, ['SomeOldInterface' => 'SomeInterface'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220207\Webmozart\Assert\Assert::isArray($oldToNewInterfaces);
        \RectorPrefix20220207\Webmozart\Assert\Assert::allString(\array_keys($oldToNewInterfaces));
        \RectorPrefix20220207\Webmozart\Assert\Assert::allString($oldToNewInterfaces);
