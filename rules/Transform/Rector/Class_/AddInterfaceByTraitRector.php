...
, ['SomeTrait' => 'SomeInterface'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220129\Webmozart\Assert\Assert::isArray($interfaceByTrait);
        \RectorPrefix20220129\Webmozart\Assert\Assert::allString(\array_keys($interfaceByTrait));
        \RectorPrefix20220129\Webmozart\Assert\Assert::allString($interfaceByTrait);
