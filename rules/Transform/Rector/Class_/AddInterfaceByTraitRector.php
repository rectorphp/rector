...
, [self::INTERFACE_BY_TRAIT => ['SomeTrait' => 'SomeInterface']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211202\Webmozart\Assert\Assert::isArray($interfaceByTrait);
        \RectorPrefix20211202\Webmozart\Assert\Assert::allString(\array_keys($interfaceByTrait));
        \RectorPrefix20211202\Webmozart\Assert\Assert::allString($interfaceByTrait);
