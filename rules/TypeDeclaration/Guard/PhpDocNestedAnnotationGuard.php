...
final class PhpDocNestedAnnotationGuard
{
    ...
    {
        $originalAnnotationCount = \count(\RectorPrefix20220427\Nette\Utils\Strings::matchAll($originalPhpDocText, self::SIMPLE_ANNOTATION_REGEX));
        $reconstructedAnnotationCount = \count(\RectorPrefix20220427\Nette\Utils\Strings::matchAll($updatedPhpDocText, self::SIMPLE_ANNOTATION_REGEX));
