...
, [new \Rector\TypeDeclaration\ValueObject\AddParamTypeDeclaration('SomeClass', 'process', 0, new \PHPStan\Type\StringType())])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211214\Webmozart\Assert\Assert::isArray($parameterTypehints);
        \RectorPrefix20211214\Webmozart\Assert\Assert::allIsAOf($parameterTypehints, \Rector\TypeDeclaration\ValueObject\AddParamTypeDeclaration::class);
