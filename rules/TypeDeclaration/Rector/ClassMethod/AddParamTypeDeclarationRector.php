...
, $configuration)]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211202\Webmozart\Assert\Assert::isArray($parameterTypehints);
        \RectorPrefix20211202\Webmozart\Assert\Assert::allIsAOf($parameterTypehints, \Rector\TypeDeclaration\ValueObject\AddParamTypeDeclaration::class);
