...
, [new \Rector\TypeDeclaration\ValueObject\AddReturnTypeDeclaration('SomeClass', 'getData', $arrayType)])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220215\Webmozart\Assert\Assert::isArray($methodReturnTypes);
        \RectorPrefix20220215\Webmozart\Assert\Assert::allIsAOf($methodReturnTypes, \Rector\TypeDeclaration\ValueObject\AddReturnTypeDeclaration::class);
