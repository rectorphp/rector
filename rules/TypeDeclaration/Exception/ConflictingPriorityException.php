...
{
    public function __construct(PriorityAwareTypeInfererInterface $firstPriorityAwareTypeInferer, PriorityAwareTypeInfererInterface $secondPriorityAwareTypeInferer)
    {
