...
final class AutowiredClassMethodOrPropertyAnalyzer
{
    ...
    public function detect($node) : bool
    {
        ...
        return $this->phpAttributeAnalyzer->hasPhpAttributes($node, [\RectorPrefix20220217\Symfony\Contracts\Service\Attribute\Required::class, 'Nette\\DI\\Attributes\\Inject']);
    }
}
