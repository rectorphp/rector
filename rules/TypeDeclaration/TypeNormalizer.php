...
final class TypeNormalizer
{
    ...
    public function __construct(\Rector\NodeTypeResolver\PHPStan\Type\TypeFactory $typeFactory, \RectorPrefix20220531\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor)
    {
    ...
    public function normalizeArrayOfUnionToUnionArray(\PHPStan\Type\Type $type, int $arrayNesting = 1) : \PHPStan\Type\Type
    {
        ...
        if ($type instanceof \PHPStan\Type\Constant\ConstantArrayType && $arrayNesting === 1) {
            return $type;
        }
