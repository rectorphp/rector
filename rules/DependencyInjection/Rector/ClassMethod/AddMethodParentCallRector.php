...
, [self::METHODS_BY_PARENT_TYPES => ['ParentClassWithNewConstructor' => \Rector\Core\ValueObject\MethodName::CONSTRUCT]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211205\Webmozart\Assert\Assert::allString(\array_keys($methodsByParentTypes));
        \RectorPrefix20211205\Webmozart\Assert\Assert::allString($methodsByParentTypes);
