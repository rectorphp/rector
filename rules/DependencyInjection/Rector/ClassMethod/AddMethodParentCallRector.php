...
, ['ParentClassWithNewConstructor' => \Rector\Core\ValueObject\MethodName::CONSTRUCT])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220128\Webmozart\Assert\Assert::allString(\array_keys($methodsByParentTypes));
        \RectorPrefix20220128\Webmozart\Assert\Assert::allString($methodsByParentTypes);
