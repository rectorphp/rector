...
, [self::RESERVED_NAMES_TO_NEW_ONES => ['fn' => 'someFunctionName']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211204\Webmozart\Assert\Assert::allString(\array_keys($reservedNamesToNewOnes));
        \RectorPrefix20211204\Webmozart\Assert\Assert::allString($reservedNamesToNewOnes);
