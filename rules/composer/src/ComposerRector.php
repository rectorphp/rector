...
use Rector\Composer\ComposerChanger\ComposerChangerInterface;
...
final class ComposerRector
{
    ...
    /** @var ComposerChangerInterface[] */
    private $configuration = [];

    public function configure(array $configuration): void
    {
        Assert::allIsInstanceOf($configuration, ComposerChangerInterface::class);
    ...
    public function process(string $content): string
    {
        ...
        foreach ($this->configuration as $composerChanger) {
            $composerData = $composerChanger->process($composerData);
        }
