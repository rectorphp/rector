...
use RectorPrefix20211127\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder;
...
, [self::USE_IMPORTS_TO_RESTORE => [new \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation('Doctrine\\ORM\\Mapping', 'ORM')]])]);
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        foreach ($this->useImportsToRestore as $useImportToRestore) {
            ...
            if (!\RectorPrefix20211127\Nette\Utils\Strings::match($printedClass, $annotationToSeek)) {
                continue;
            }
    ...
    {
        $useBuilder = new \RectorPrefix20211127\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder($completeImportForPartialAnnotation->getUse());
