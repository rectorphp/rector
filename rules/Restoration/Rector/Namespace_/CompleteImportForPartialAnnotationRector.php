...
use RectorPrefix20220426\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder;
...
, [new \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation('Doctrine\\ORM\\Mapping', 'ORM')])]);
    ...
    {
        \RectorPrefix20220426\Webmozart\Assert\Assert::allIsAOf($configuration, \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation::class);
    ...
    {
        $useBuilder = new \RectorPrefix20220426\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder($completeImportForPartialAnnotation->getUse());
