...
use RectorPrefix20210510\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder;
...
CODE_SAMPLE
, [self::USE_IMPORTS_TO_RESTORE => [new CompleteImportForPartialAnnotation('Doctrine\\ORM\\Mapping', 'ORM')]])]);
    }
    /**
