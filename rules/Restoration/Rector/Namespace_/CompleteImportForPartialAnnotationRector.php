...
use RectorPrefix20220105\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder;
...
, [new \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation('Doctrine\\ORM\\Mapping', 'ORM')])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220105\Webmozart\Assert\Assert::allIsAOf($useImportsToRestore, \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation::class);
    ...
    {
        $useBuilder = new \RectorPrefix20220105\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder($completeImportForPartialAnnotation->getUse());
