...
use RectorPrefix20210801\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder;
...
, [self::USE_IMPORTS_TO_RESTORE => [new \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation('Doctrine\\ORM\\Mapping', 'ORM')]])]);
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        foreach ($this->useImportsToRestore as $useImportToRestore) {
            ...
            if (!\RectorPrefix20210801\Nette\Utils\Strings::match($printedClass, $annotationToSeek)) {
                continue;
            }
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20210801\Webmozart\Assert\Assert::allIsInstanceOf($useImportsToRestore, \Rector\Restoration\ValueObject\CompleteImportForPartialAnnotation::class);
    ...
    {
        $useBuilder = new \RectorPrefix20210801\Symplify\Astral\ValueObject\NodeBuilder\UseBuilder($completeImportForPartialAnnotation->getUse());
