...
, [self::RESERVED_KEYWORDS_TO_REPLACEMENTS => ['ReservedObject' => 'SmartObject', 'Object' => 'AnotherSmartObject']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211206\Webmozart\Assert\Assert::isArray($reservedKeywordsToReplacements);
        \RectorPrefix20211206\Webmozart\Assert\Assert::allString(\array_keys($reservedKeywordsToReplacements));
        \RectorPrefix20211206\Webmozart\Assert\Assert::allString($reservedKeywordsToReplacements);
