...
, ['ReservedObject' => 'SmartObject', 'Object' => 'AnotherSmartObject'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220113\Webmozart\Assert\Assert::isArray($reservedKeywordsToReplacements);
        \RectorPrefix20220113\Webmozart\Assert\Assert::allString(\array_keys($reservedKeywordsToReplacements));
        \RectorPrefix20220113\Webmozart\Assert\Assert::allString($reservedKeywordsToReplacements);
