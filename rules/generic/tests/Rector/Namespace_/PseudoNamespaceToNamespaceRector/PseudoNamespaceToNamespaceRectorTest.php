...
namespace Rector\Generic\Tests\Rector\Namespace_\PseudoNamespaceToNamespaceRector;
        ...
        return [
            PseudoNamespaceToNamespaceRector::class => [
                PseudoNamespaceToNamespaceRector::NAMESPACE_PREFIXES_WITH_EXCLUDED_CLASSES => [
                    ...
                    'ChangeMe_' => ['KeepMe_'],
                    'Rector_Generic_Tests_Rector_Namespace__PseudoNamespaceToNamespaceRector_Fixture_' => [],
                ],
            ],
        ];
    }
