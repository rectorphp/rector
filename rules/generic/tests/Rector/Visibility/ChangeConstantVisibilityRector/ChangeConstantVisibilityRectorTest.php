...
namespace Rector\Generic\Tests\Rector\Visibility\ChangeConstantVisibilityRector;

use Iterator;
use Rector\Core\Testing\PHPUnit\AbstractRectorTestCase;
use Rector\Generic\Rector\Visibility\ChangeConstantVisibilityRector;
use Rector\Generic\Tests\Rector\Visibility\ChangeConstantVisibilityRector\Source\ParentObject;
        ...
        return [
            ChangeConstantVisibilityRector::class => [
                ChangeConstantVisibilityRector::CONSTANT_TO_VISIBILITY_BY_CLASS => [
                    ...
                    'Rector\Generic\Tests\Rector\Visibility\ChangePropertyVisibilityRector\Source\AnotherClassWithInvalidConstants' => [
                        'TO_BE_PRIVATE_CONSTANT' => 'private',
                    ],
                ],
            ],
