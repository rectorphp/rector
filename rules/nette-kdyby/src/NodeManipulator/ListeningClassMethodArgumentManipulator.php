...
final class ListeningClassMethodArgumentManipulator
{
    ...
    {
        foreach ($classMethodsByEventClass as $singleClassMethodsByEventClass) {
            // are attributes already replaced
            $classMethod = $singleClassMethodsByEventClass->getClassMethod();
            ...
            $eventClass = $eventAndListenerTree !== null ? $eventAndListenerTree->getEventClassName() : $singleClassMethodsByEventClass->getEventClass();
