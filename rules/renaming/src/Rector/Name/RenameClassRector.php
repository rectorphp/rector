...
CODE_SAMPLE
    ...
    /**
     * @param \PhpParser\Node\FunctionLike|Name|\PhpParser\Node\Stmt\ClassLike|\PhpParser\Node\Stmt\Expression|\PhpParser\Node\Stmt\Namespace_|Property|FileWithoutNamespace $node
     */
