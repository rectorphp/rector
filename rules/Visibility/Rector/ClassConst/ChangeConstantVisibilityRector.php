...
, [new \Rector\Visibility\ValueObject\ChangeConstantVisibility('ParentObject', 'SOME_CONSTANT', \Rector\Core\ValueObject\Visibility::PROTECTED)])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220104\Webmozart\Assert\Assert::isArray($classConstantVisibilityChanges);
        \RectorPrefix20220104\Webmozart\Assert\Assert::allIsAOf($classConstantVisibilityChanges, \Rector\Visibility\ValueObject\ChangeConstantVisibility::class);
