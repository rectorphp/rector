...
, [self::CLASS_CONSTANT_VISIBILITY_CHANGES => [new \Rector\Visibility\ValueObject\ChangeConstantVisibility('ParentObject', 'SOME_CONSTANT', \Rector\Core\ValueObject\Visibility::PROTECTED)]])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211108\Webmozart\Assert\Assert::isArray($classConstantVisibilityChanges);
        \RectorPrefix20211108\Webmozart\Assert\Assert::allIsInstanceOf($classConstantVisibilityChanges, \Rector\Visibility\ValueObject\ChangeConstantVisibility::class);
