...
final class ReplacePackageAndVersionComposerRector implements \Rector\Composer\Contract\Rector\ComposerRectorInterface
{
    ...
    public function refactor(\RectorPrefix20220607\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
...
, [new \Rector\Composer\ValueObject\ReplacePackageAndVersion('symfony/console', 'symfony/http-kernel', '^4.4')])]);
    ...
    {
        \RectorPrefix20220607\Webmozart\Assert\Assert::allIsAOf($configuration, \Rector\Composer\ValueObject\ReplacePackageAndVersion::class);
