...
final class RenameClassRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    public function __construct(\Rector\Core\Configuration\RenamedClassesDataCollector $renamedClassesDataCollector, \Rector\Renaming\NodeManipulator\ClassRenamer $classRenamer, \RectorPrefix20220415\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
...
, ['App\\SomeOldClass' => 'App\\SomeNewClass'])]);
    ...
    {
        \RectorPrefix20220415\Webmozart\Assert\Assert::allString(\array_keys($oldToNewClasses));
        \RectorPrefix20220415\Webmozart\Assert\Assert::allString($oldToNewClasses);
