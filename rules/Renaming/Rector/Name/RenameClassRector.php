...
, ['App\\SomeOldClass' => 'App\\SomeNewClass'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220118\Webmozart\Assert\Assert::isArray($oldToNewClasses);
        \RectorPrefix20220118\Webmozart\Assert\Assert::allString($oldToNewClasses);
    ...
    {
        \RectorPrefix20220118\Webmozart\Assert\Assert::allString(\array_keys($oldToNewClasses));
        \RectorPrefix20220118\Webmozart\Assert\Assert::allString($oldToNewClasses);
