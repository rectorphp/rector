...
, [self::OLD_TO_NEW_CLASSES => ['App\\SomeOldClass' => 'App\\SomeNewClass']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        foreach ($classMapFiles as $classMapFile) {
            \RectorPrefix20210903\Webmozart\Assert\Assert::fileExists($classMapFile);
    ...
    {
        \RectorPrefix20210903\Webmozart\Assert\Assert::allString(\array_keys($oldToNewClasses));
        \RectorPrefix20210903\Webmozart\Assert\Assert::allString($oldToNewClasses);
