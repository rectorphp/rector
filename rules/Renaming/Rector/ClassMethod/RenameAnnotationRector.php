...
, [new \Rector\Renaming\ValueObject\RenameAnnotationByType('PHPUnit\\Framework\\TestCase', 'test', 'scenario')])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220125\Webmozart\Assert\Assert::isArray($renamedAnnotations);
        \RectorPrefix20220125\Webmozart\Assert\Assert::allIsAOf($renamedAnnotations, \Rector\Renaming\Contract\RenameAnnotationInterface::class);
