...
final class RenameNamespaceRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211207\Webmozart\Assert\Assert::allString(\array_keys($oldToNewNamespaces));
        \RectorPrefix20211207\Webmozart\Assert\Assert::allString($oldToNewNamespaces);
    ...
    private function resolvePartialNewName(\PhpParser\Node\Name $name, \Rector\Renaming\ValueObject\RenamedNamespace $renamedNamespace) : string
    {
        ...
        $cutOffFromTheLeft = \RectorPrefix20211207\Nette\Utils\Strings::length($nameInNewNamespace) - \RectorPrefix20211207\Nette\Utils\Strings::length($name->toString());
        return \RectorPrefix20211207\Nette\Utils\Strings::substring($nameInNewNamespace, $cutOffFromTheLeft);
    }
}
