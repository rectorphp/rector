...
final class RenameNamespaceRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    {
        \RectorPrefix20220528\Webmozart\Assert\Assert::allStringNotEmpty(\array_keys($configuration));
        \RectorPrefix20220528\Webmozart\Assert\Assert::allStringNotEmpty($configuration);
