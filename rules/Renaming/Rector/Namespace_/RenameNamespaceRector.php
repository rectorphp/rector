...
final class RenameNamespaceRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220217\Webmozart\Assert\Assert::allString(\array_keys($oldToNewNamespaces));
        \RectorPrefix20220217\Webmozart\Assert\Assert::allString($oldToNewNamespaces);
