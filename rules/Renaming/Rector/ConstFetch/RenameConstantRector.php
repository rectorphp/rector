...
, ['MYSQL_ASSOC' => 'MYSQLI_ASSOC', 'OLD_CONSTANT' => 'NEW_CONSTANT'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220212\Webmozart\Assert\Assert::allString(\array_keys($oldToNewConstants));
        \RectorPrefix20220212\Webmozart\Assert\Assert::allString($oldToNewConstants);
