...
, ['ROLE_PREVIOUS_ADMIN' => 'IS_IMPERSONATOR'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20220131\Webmozart\Assert\Assert::isArray($stringChanges);
        \RectorPrefix20220131\Webmozart\Assert\Assert::allString(\array_keys($stringChanges));
        \RectorPrefix20220131\Webmozart\Assert\Assert::allString($stringChanges);
