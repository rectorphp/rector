...
use RectorPrefix20211128\Nette\Utils\JsonException;
...
CODE_SAMPLE
    ...
    private function isJsonString(string $stringValue) : bool
    {
        ...
        try {
            return (bool) \RectorPrefix20211128\Nette\Utils\Json::decode($stringValue, \RectorPrefix20211128\Nette\Utils\Json::FORCE_ARRAY);
        } catch (\RectorPrefix20211128\Nette\Utils\JsonException $exception) {
            return \false;
        }
    }
    ...
    {
        $stringValue = \RectorPrefix20211128\Nette\Utils\Strings::replace($stringValue, self::UNQUOTED_OBJECT_HASH_REGEX, '$1"$2"');
