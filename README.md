...
* [Configuration](#configuration)
    ...
    * [Exclude Rectors](#exclude-rectors)
    * [Define the PHP version](#define-the-php-version)
* [Usage](#usage)
    * [A. Prepared Sets](#a-prepared-sets)
    * [B. Custom Sets](#b-custom-sets)
* [Create your own Rector (in 3 steps)](#create-your-own-rector-in-3-steps)
    * [1. Create](#1-create)
...
* [Contribute](#contribute)
    ...
    * [Auto fix coding standards](#auto-fix-coding-standards)
* [Docker](#docker)
* [Community](#community)
