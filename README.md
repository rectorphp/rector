...
<p align="center">
    <a href="/src/config/levels/symfony"><img src="/docs/images/symfony.png"></a>
    <img src="/docs/images/space.png" width=20>
    <a href="/src/config/levels/nette"><img src="/docs/images/nette.png" height="50"></a>
    <img src="/docs/images/space.png" width=20>
    <a href="/src/config/levels/phpunit"><img src="/docs/images/phpunit.jpg"></a>
    <img src="/docs/images/space.png" width=20>
    <a href="/src/config/levels/twig"><img src="/docs/images/twig.png"></a>
</p>
...
Featured open-source projects have **prepared sets**. You'll find them in [`/src/config/levels`](/src/config/levels).
...
1. Run rector on your `/src` directory:
    ...
    ```bash
    vendor/bin/rector process src --config vendor/rector/rector/src/config/levels/symfony/symfony40.yml
    ```
