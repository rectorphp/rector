...
trait MovingFilesTrait
{
    ...
    {
        \RectorPrefix20220424\Webmozart\Assert\Assert::allIsAOf($expectedAddedFileWithContents, \Rector\FileSystemRector\ValueObject\AddedFileWithContent::class);
        ...
        \RectorPrefix20220424\Webmozart\Assert\Assert::notEmpty($addedFilePathsWithContents);
