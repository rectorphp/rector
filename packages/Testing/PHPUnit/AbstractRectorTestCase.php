...
use RectorPrefix20210612\Symplify\EasyTesting\DataProvider\StaticFixtureFinder;
use RectorPrefix20210612\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater;
...
abstract class AbstractRectorTestCase extends \Rector\Testing\PHPUnit\AbstractTestCase implements \Rector\Testing\Contract\RectorTestInterface
{
    ...
    protected function setUp() : void
    {
        ...
        $this->parameterProvider = $this->getService(\RectorPrefix20210612\Symplify\PackageBuilder\Parameter\ParameterProvider::class);
    ...
    {
        return \RectorPrefix20210612\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectoryExclusively($directory, $suffix);
    }
    protected function doTestFileInfo(\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        $inputFileInfoAndExpectedFileInfo = \RectorPrefix20210612\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpectedFileInfos($fixtureFileInfo);
    ...
    private function doTestFileMatchesExpectedContent(\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, \Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, \Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
        ...
        try {
            ...
            \RectorPrefix20210612\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater::updateFixtureContent($originalFileInfo, $changedContent, $fixtureFileInfo);
    ...
    {
        return \RectorPrefix20210612\Nette\Utils\Strings::replace($string, '#\\r\\n|\\r|\\n#', "\n");
    }
