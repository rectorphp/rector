...
use Rector\AttributeAwarePhpDoc\ValueObject\Type\BetterUnionTypeNode;
...
final class IterableTypeMapper implements TypeMapperInterface
{
    ...
    public function mapToPHPStanPhpDocTypeNode(Type $type): TypeNode
    {
        ...
        return new BetterArrayTypeNode($itemTypeNode);
    }
    ...
    private function convertUnionArrayTypeNodesToArrayTypeOfUnionTypeNodes(
        ...
        return new BetterUnionTypeNode($unionedArrayType);
    }
}
