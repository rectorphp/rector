...
final class UnionTypeMapper implements TypeMapperInterface
{
    ...
    private function matchPhpParserUnionType(UnionType $unionType, TypeKind $typeKind) : ?PhpParserUnionType
    {
        ...
        foreach ($unionType->getTypes() as $unionedType) {
             ...
             */
            $phpParserNode = $unionedType instanceof NullType && $typeKind->equals(TypeKind::PROPERTY()) ? new Name('null') : $this->phpStanStaticTypeMapper->mapToPhpParserNode($unionedType, $typeKind);
