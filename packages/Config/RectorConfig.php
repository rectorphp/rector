...
final class RectorConfig extends \Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator
{
    ...
    {
        \RectorPrefix20220520\Webmozart\Assert\Assert::allString($paths);
    ...
    {
        \RectorPrefix20220520\Webmozart\Assert\Assert::allString($sets);
        foreach ($sets as $set) {
            \RectorPrefix20220520\Webmozart\Assert\Assert::fileExists($set);
            $this->import($set);
        }
    }
    ...
    {
        \RectorPrefix20220520\Webmozart\Assert\Assert::fileExists($filePath);
        $parameters = $this->parameters();
    ...
    {
        \RectorPrefix20220520\Webmozart\Assert\Assert::isAOf($rectorClass, \Rector\Core\Contract\Rector\RectorInterface::class);
        \RectorPrefix20220520\Webmozart\Assert\Assert::isAOf($rectorClass, \Rector\Core\Contract\Rector\ConfigurableRectorInterface::class);
    ...
    {
        \RectorPrefix20220520\Webmozart\Assert\Assert::allString($rectorClasses);
    ...
    {
        \RectorPrefix20220520\Webmozart\Assert\Assert::allString($autoloadPaths);
        $parameters = $this->parameters();
