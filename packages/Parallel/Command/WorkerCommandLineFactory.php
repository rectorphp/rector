...
final class WorkerCommandLineFactory
{
    ...
    public function create(string $mainScript, string $originalCommandName, string $workerCommandName, ?string $projectConfigFile, \RectorPrefix20211125\Symfony\Component\Console\Input\InputInterface $input, string $identifier, int $port) : string
    {
     ...
     * @return string[]
     */
    private function createProcessCommandOptions(\RectorPrefix20211125\Symfony\Component\Console\Input\InputInterface $input, array $checkCommandOptionNames) : array
    {
    ...
    private function shouldSkipOption(\RectorPrefix20211125\Symfony\Component\Console\Input\InputInterface $input, string $optionName) : bool
    {
