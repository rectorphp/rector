...
use RectorPrefix20220521\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException;
use RectorPrefix20220521\Symplify\EasyParallel\Reflection\CommandFromReflectionFactory;
/**
...
final class WorkerCommandLineFactory
{
    ...
    {
        $this->commandFromReflectionFactory = new \RectorPrefix20220521\Symplify\EasyParallel\Reflection\CommandFromReflectionFactory();
    }
    /**
     * @param class-string<Command> $mainCommandClass
     */
    public function create(string $mainScript, string $mainCommandClass, string $workerCommandName, \RectorPrefix20220521\Symfony\Component\Console\Input\InputInterface $input, string $identifier, int $port) : string
    {
        ...
        if ($mainCommand->getName() === null) {
            ...
            throw new \RectorPrefix20220521\Symplify\EasyParallel\Exception\ParallelShouldNotHappenException($errorMessage);
        }
    ...
    private function shouldSkipOption(\RectorPrefix20220521\Symfony\Component\Console\Input\InputInterface $input, string $optionName) : bool
    {
     ...
     * @return string[]
     */
    private function getCommandOptionNames(\RectorPrefix20220521\Symfony\Component\Console\Command\Command $command) : array
    {
     ...
     * @return string[]
     */
    private function mirrorCommandOptions(\RectorPrefix20220521\Symfony\Component\Console\Input\InputInterface $input, array $mainCommandOptionNames) : array
    {
