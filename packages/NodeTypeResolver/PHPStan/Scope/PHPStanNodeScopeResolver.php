...
use RectorPrefix20220606\PHPStan\Node\UnreachableStatementNode;
use RectorPrefix20220606\PHPStan\Reflection\BetterReflection\Reflector\MemoizingReflector;
use RectorPrefix20220606\PHPStan\Reflection\ClassReflection;
use RectorPrefix20220606\PHPStan\Reflection\ReflectionProvider;
use RectorPrefix20220606\Rector\Caching\Detector\ChangedFilesDetector;
use RectorPrefix20220606\Rector\Caching\FileSystem\DependencyResolver;
use RectorPrefix20220606\Rector\Core\Exception\ShouldNotHappenException;
use RectorPrefix20220606\Rector\Core\StaticReflection\SourceLocator\ParentAttributeSourceLocator;
use RectorPrefix20220606\Rector\Core\StaticReflection\SourceLocator\RenamedClassesSourceLocator;
use RectorPrefix20220606\Rector\Core\Util\StringUtils;
use RectorPrefix20220606\Rector\NodeTypeResolver\Node\AttributeKey;
use RectorPrefix20220606\Rector\NodeTypeResolver\PHPStan\Scope\NodeVisitor\RemoveDeepChainMethodCallNodeVisitor;
...
final class PHPStanNodeScopeResolver
{
    ...
    public function __construct(ChangedFilesDetector $changedFilesDetector, DependencyResolver $dependencyResolver, NodeScopeResolver $nodeScopeResolver, ReflectionProvider $reflectionProvider, RemoveDeepChainMethodCallNodeVisitor $removeDeepChainMethodCallNodeVisitor, ScopeFactory $scopeFactory, PrivatesAccessor $privatesAccessor, RenamedClassesSourceLocator $renamedClassesSourceLocator, ParentAttributeSourceLocator $parentAttributeSourceLocator)
    {
