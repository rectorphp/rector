...
final class YamlFileFormatter implements \Rector\FileFormatter\Contract\Formatter\FileFormatterInterface
{
    ...
    {
        $yaml = \RectorPrefix20211212\Symfony\Component\Yaml\Yaml::parse($file->getFileContent(), \RectorPrefix20211212\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS);
        $newFileContent = \RectorPrefix20211212\Symfony\Component\Yaml\Yaml::dump($yaml, 99, $editorConfigConfiguration->getIndentSize());
