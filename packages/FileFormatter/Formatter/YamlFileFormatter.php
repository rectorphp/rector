...
final class YamlFileFormatter implements \Rector\FileFormatter\Contract\Formatter\FileFormatterInterface
{
    ...
    {
        $yaml = \RectorPrefix20220520\Symfony\Component\Yaml\Yaml::parse($file->getFileContent(), \RectorPrefix20220520\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS);
        $newFileContent = \RectorPrefix20220520\Symfony\Component\Yaml\Yaml::dump($yaml, 99, $editorConfigConfiguration->getIndentSize());
