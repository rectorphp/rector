...
final class NewLine
{
    ...
    {
        $matches = \RectorPrefix20210717\Nette\Utils\Strings::match($content, self::VALID_NEWLINE_REGEX);
        if ($matches === null) {
    ...
    {
        $match = \RectorPrefix20210717\Nette\Utils\Strings::match($content, self::NEWLINE_REGEX);
