...
final class NewLine
{
    ...
    {
        $matches = \RectorPrefix20211115\Nette\Utils\Strings::match($content, self::VALID_NEWLINE_REGEX);
        if ($matches === null) {
    ...
    {
        $match = \RectorPrefix20211115\Nette\Utils\Strings::match($content, self::NEWLINE_REGEX);
