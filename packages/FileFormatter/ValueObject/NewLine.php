...
final class NewLine
{
    ...
    {
        $matches = \RectorPrefix20211013\Nette\Utils\Strings::match($content, self::VALID_NEWLINE_REGEX);
        if ($matches === null) {
    ...
    {
        $match = \RectorPrefix20211013\Nette\Utils\Strings::match($content, self::NEWLINE_REGEX);
