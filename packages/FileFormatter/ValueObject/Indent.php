...
final class Indent
{
    ...
    {
        $match = \RectorPrefix20220508\Nette\Utils\Strings::match($content, self::VALID_INDENT_REGEX);
        if ($match === null) {
    ...
    {
        $match = \RectorPrefix20220508\Nette\Utils\Strings::match($content, self::PARSE_INDENT_REGEX);
