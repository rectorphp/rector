...
final class Indent
{
    ...
    {
        $match = \RectorPrefix20210702\Nette\Utils\Strings::match($content, self::VALID_INDENT_REGEX);
        if ($match === null) {
    ...
    {
        $match = \RectorPrefix20210702\Nette\Utils\Strings::match($content, self::PARSE_INDENT_REGEX);
