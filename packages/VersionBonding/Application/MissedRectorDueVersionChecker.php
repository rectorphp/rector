...
final class MissedRectorDueVersionChecker
{
    ...
    public function __construct(\Rector\Core\Php\PhpVersionProvider $phpVersionProvider, \RectorPrefix20210827\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    private function reportMissedRectors(array $minPhpVersions) : void
    {
        ...
        foreach ($minPhpVersions as $minPhpVersion) {
            ...
            $shortRectorClass = \RectorPrefix20210827\Nette\Utils\Strings::after(\get_class($minPhpVersion), '\\', -1);
