...
final class RectorWithLineChange implements \RectorPrefix20220529\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
     */
    ...
    public static function decode(array $json) : \RectorPrefix20220529\Symplify\EasyParallel\Contract\SerializableInterface
    {
        ...
        \RectorPrefix20220529\Webmozart\Assert\Assert::string($rectorClass);
        $line = $json[self::KEY_LINE];
        \RectorPrefix20220529\Webmozart\Assert\Assert::integer($line);
