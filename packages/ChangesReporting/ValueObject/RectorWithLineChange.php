...
final class RectorWithLineChange implements \RectorPrefix20220521\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
     */
    ...
    public static function decode(array $json) : \RectorPrefix20220521\Symplify\EasyParallel\Contract\SerializableInterface
    {
        ...
        \RectorPrefix20220521\Webmozart\Assert\Assert::string($rectorClass);
        $line = $json[self::KEY_LINE];
        \RectorPrefix20220521\Webmozart\Assert\Assert::integer($line);
