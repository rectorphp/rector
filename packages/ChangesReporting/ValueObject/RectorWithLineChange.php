...
final class RectorWithLineChange implements \RectorPrefix20211229\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
     */
    ...
    public static function decode(array $json) : \RectorPrefix20211229\Symplify\EasyParallel\Contract\SerializableInterface
    {
        ...
        \RectorPrefix20211229\Webmozart\Assert\Assert::string($rectorClass);
        $line = $json[self::KEY_LINE];
        \RectorPrefix20211229\Webmozart\Assert\Assert::integer($line);
