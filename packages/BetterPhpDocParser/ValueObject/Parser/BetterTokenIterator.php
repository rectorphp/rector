...
use RectorPrefix20211103\Symplify\PackageBuilder\Reflection\PrivatesAccessor;
final class BetterTokenIterator extends \PHPStan\PhpDocParser\Parser\TokenIterator
{
    ...
    {
        $this->privatesAccessor = new \RectorPrefix20211103\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        if ($tokens === []) {
