...
use RectorPrefix20220114\Symplify\PackageBuilder\Reflection\PrivatesAccessor;
final class BetterTokenIterator extends \PHPStan\PhpDocParser\Parser\TokenIterator
{
    ...
    {
        $this->privatesAccessor = new \RectorPrefix20220114\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        if ($tokens === []) {
