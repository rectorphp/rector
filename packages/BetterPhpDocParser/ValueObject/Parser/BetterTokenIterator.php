...
use RectorPrefix20211122\Symplify\PackageBuilder\Reflection\PrivatesAccessor;
final class BetterTokenIterator extends \PHPStan\PhpDocParser\Parser\TokenIterator
{
    ...
    {
        $this->privatesAccessor = new \RectorPrefix20211122\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        if ($tokens === []) {
