...
use RectorPrefix20220223\Symplify\PackageBuilder\Reflection\PrivatesAccessor;
final class BetterTokenIterator extends \PHPStan\PhpDocParser\Parser\TokenIterator
{
    ...
    {
        $this->privatesAccessor = new \RectorPrefix20220223\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        if ($tokens === []) {
