...
use RectorPrefix20211123\Symplify\PackageBuilder\Reflection\PrivatesAccessor;
final class BetterTokenIterator extends \PHPStan\PhpDocParser\Parser\TokenIterator
{
    ...
    {
        $this->privatesAccessor = new \RectorPrefix20211123\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        if ($tokens === []) {
