...
use RectorPrefix20220221\Symplify\PackageBuilder\Reflection\PrivatesAccessor;
final class BetterTokenIterator extends \PHPStan\PhpDocParser\Parser\TokenIterator
{
    ...
    {
        $this->privatesAccessor = new \RectorPrefix20220221\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        if ($tokens === []) {
