...
use RectorPrefix20211101\Symplify\PackageBuilder\Reflection\PrivatesAccessor;
final class BetterTokenIterator extends \PHPStan\PhpDocParser\Parser\TokenIterator
{
    ...
    {
        $this->privatesAccessor = new \RectorPrefix20211101\Symplify\PackageBuilder\Reflection\PrivatesAccessor();
        if ($tokens === []) {
