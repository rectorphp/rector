...
final class DoctrineAnnotationDecorator
{
    ...
    private function mergeNestedDoctrineAnnotations(\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocNode $phpDocNode) : void
    {
        ...
        foreach ($phpDocNode->children as $key => $phpDocChildNode) {
            ...
            while (isset($phpDocNode->children[$key])) {
                ...
                if ($nextPhpDocChildNode instanceof \PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTextNode && \RectorPrefix20211126\Nette\Utils\Strings::match($nextPhpDocChildNode->text, self::NESTED_ANNOTATION_END_REGEX)) {
    ...
    {
        $match = \RectorPrefix20211126\Nette\Utils\Strings::match($phpDocTextNode->text, self::LONG_ANNOTATION_REGEX);
