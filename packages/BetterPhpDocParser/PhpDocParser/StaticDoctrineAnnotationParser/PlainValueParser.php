...
namespace RectorPrefix20220606\Rector\BetterPhpDocParser\PhpDocParser\StaticDoctrineAnnotationParser;
...
use RectorPrefix20220606\Rector\BetterPhpDocParser\PhpDocParser\StaticDoctrineAnnotationParser;
...
final class PlainValueParser
{
     ...
     * @required
     */
    public function autowire(StaticDoctrineAnnotationParser $staticDoctrineAnnotationParser, ArrayParser $arrayParser) : void
    {
