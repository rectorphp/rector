...
final class NetteCacheFactory
{
    ...
    public function create() : \RectorPrefix20210519\Nette\Caching\Cache
    {
        ...
        $fileStorage = new \RectorPrefix20210519\Nette\Caching\Storages\FileStorage($cacheDirectory);
        // namespace is unique per project
        return new \RectorPrefix20210519\Nette\Caching\Cache($fileStorage, \getcwd());
    }
}
