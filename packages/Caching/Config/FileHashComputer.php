...
use RectorPrefix20211231\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
...
final class FileHashComputer
{
    ...
    private function createFileLoader(string $filePath, \RectorPrefix20211231\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : \RectorPrefix20211231\Symfony\Component\Config\Loader\LoaderInterface
    {
        $fileLocator = new \RectorPrefix20211231\Symfony\Component\Config\FileLocator([$filePath]);
        $fileLoaders = [new \RectorPrefix20211231\Symfony\Component\DependencyInjection\Loader\GlobFileLoader($containerBuilder, $fileLocator), new \RectorPrefix20211231\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, $fileLocator)];
        $loaderResolver = new \RectorPrefix20211231\Symfony\Component\Config\Loader\LoaderResolver($fileLoaders);
