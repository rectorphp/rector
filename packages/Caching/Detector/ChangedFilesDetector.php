...
final class ChangedFilesDetector
{
     ...
     */
    private $cache;
    public function __construct(\Rector\Caching\Config\FileHashComputer $fileHashComputer, \RectorPrefix20210512\Nette\Caching\Cache $cache)
    {
    ...
    {
        $this->cache->clean([\RectorPrefix20210512\Nette\Caching\Cache::ALL => \true]);
    }
    /**
    ...
    {
        $key = self::CONFIGURATION_HASH_KEY . '_' . \RectorPrefix20210512\Nette\Utils\Strings::webalize($fileInfo->getRealPath());
