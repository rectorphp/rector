...
final class FixtureFinder
{
    ...
    public function findFixtureFileInfos(): array
    {
        ...
        $finder = $finder->files()
            ...
            ->in(__DIR__ . '/../../../../rules/nette-utils-code-quality')
            ->in(__DIR__ . '/../../../../rules/order')
            ...
            ->in(__DIR__ . '/../../../../rules/php55')
            ->in(__DIR__ . '/../../../../rules/php56')
            ->in(__DIR__ . '/../../../../rules/php70')
            ->in(__DIR__ . '/../../../../rules/php71')
            ->in(__DIR__ . '/../../../../rules/php72')
            ->in(__DIR__ . '/../../../../rules/php73')
            ->in(__DIR__ . '/../../../../rules/php74')
            ->in(__DIR__ . '/../../../../rules/php80')
