...
final class FileCacheStorage implements CacheStorageInterface
{
     ...
     * @readonly
     */
    private \RectorPrefix202607\Symfony\Component\Filesystem\Filesystem $filesystem;
    public function __construct(string $directory, \RectorPrefix202607\Symfony\Component\Filesystem\Filesystem $filesystem)
    {
