...
final class FileCacheStorage implements CacheStorageInterface
{
     ...
     * @readonly
     */
    private \RectorPrefix202507\Symfony\Component\Filesystem\Filesystem $filesystem;
    public function __construct(string $directory, \RectorPrefix202507\Symfony\Component\Filesystem\Filesystem $filesystem)
    {
