...
final class ConfigurationFactory
{
     ...
     */
    public function createFromInput(\RectorPrefix20220211\Symfony\Component\Console\Input\InputInterface $input) : \Rector\Core\ValueObject\Configuration
    {
    ...
    private function shouldShowProgressBar(\RectorPrefix20220211\Symfony\Component\Console\Input\InputInterface $input, string $outputFormat) : bool
    {
     ...
     * @return string[]|mixed[]
     */
    private function resolvePaths(\RectorPrefix20220211\Symfony\Component\Console\Input\InputInterface $input) : array
    {
