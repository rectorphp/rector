...
final class ConfigurationFactory
{
    ...
    public function __construct(\RectorPrefix20211123\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20211123\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
     ...
     */
    public function createFromInput(\RectorPrefix20211123\Symfony\Component\Console\Input\InputInterface $input) : \Rector\Core\ValueObject\Configuration
    {
        ...
        return new \Rector\Core\ValueObject\Configuration($isDryRun, $showProgressBar, $shouldClearCache, $outputFormat, $fileExtensions, $paths, $showDiffs, null, $parallelPort, $parallelIdentifier);
    }
    private function shouldShowProgressBar(\RectorPrefix20211123\Symfony\Component\Console\Input\InputInterface $input, string $outputFormat) : bool
    {
     ...
     * @return string[]|mixed[]
     */
    private function resolvePaths(\RectorPrefix20211123\Symfony\Component\Console\Input\InputInterface $input) : array
    {
