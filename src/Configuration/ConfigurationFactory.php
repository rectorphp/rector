...
final class ConfigurationFactory
{
    ...
    public function __construct(\RectorPrefix20210814\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210814\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
     ...
     */
    public function createFromInput(\RectorPrefix20210814\Symfony\Component\Console\Input\InputInterface $input) : \Rector\Core\ValueObject\Configuration
    {
    ...
    private function shouldShowProgressBar(\RectorPrefix20210814\Symfony\Component\Console\Input\InputInterface $input, string $outputFormat) : bool
    {
     ...
     * @return string[]|mixed[]
     */
    private function resolvePaths(\RectorPrefix20210814\Symfony\Component\Console\Input\InputInterface $input) : array
    {
