...
final class ConfigurationFactory
{
    ...
    public function __construct(\RectorPrefix20220215\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Rector\Core\Contract\Console\OutputStyleInterface $rectorOutputStyle)
    {
     ...
     */
    public function createFromInput(\RectorPrefix20220215\Symfony\Component\Console\Input\InputInterface $input) : \Rector\Core\ValueObject\Configuration
    {
    ...
    private function shouldShowProgressBar(\RectorPrefix20220215\Symfony\Component\Console\Input\InputInterface $input, string $outputFormat) : bool
    {
     ...
     * @return string[]|mixed[]
     */
    private function resolvePaths(\RectorPrefix20220215\Symfony\Component\Console\Input\InputInterface $input) : array
    {
