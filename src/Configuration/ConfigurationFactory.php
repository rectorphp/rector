...
final class ConfigurationFactory
{
     ...
     */
    public function createFromInput(\RectorPrefix20210627\Symfony\Component\Console\Input\InputInterface $input) : \Rector\Core\ValueObject\Configuration
    {
    ...
    private function shouldShowProgressBar(\RectorPrefix20210627\Symfony\Component\Console\Input\InputInterface $input, string $outputFormat) : bool
    {
     ...
     * @return string[]|mixed[]
     */
    private function resolvePaths(\RectorPrefix20210627\Symfony\Component\Console\Input\InputInterface $input) : array
    {
