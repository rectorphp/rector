...
final class ConfigurationFactory
{
    ...
    public function __construct(\RectorPrefix20210703\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \RectorPrefix20210703\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    public function createForTests() : \Rector\Core\ValueObject\Configuration
    {
        ...
        return new \Rector\Core\ValueObject\Configuration(\true, \true, \false, 'console', $fileExtensions, array(), \true);
    }
    /**
     * Needs to run in the start of the life cycle, since the rest of workflow uses it.
     */
    public function createFromInput(\RectorPrefix20210703\Symfony\Component\Console\Input\InputInterface $input) : \Rector\Core\ValueObject\Configuration
    {
    ...
    private function shouldShowProgressBar(\RectorPrefix20210703\Symfony\Component\Console\Input\InputInterface $input, string $outputFormat) : bool
    {
     ...
     * @return string[]|mixed[]
     */
    private function resolvePaths(\RectorPrefix20210703\Symfony\Component\Console\Input\InputInterface $input) : array
    {
