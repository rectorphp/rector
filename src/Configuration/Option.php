...
use RectorPrefix20210904\Symplify\Skipper\ValueObject\Option as SkipperOption;
#[Immutable]
final class Option
{
    /**
     ...
     * @var string
     */
    public const SKIP = \RectorPrefix20210904\Symplify\Skipper\ValueObject\Option::SKIP;
    /**
     * @var string
     */
