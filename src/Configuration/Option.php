...
use RectorPrefix20210703\JetBrains\PhpStorm\Immutable;
use RectorPrefix20210703\Symplify\Skipper\ValueObject\Option as SkipperOption;
#[Immutable]
final class Option
{
    /**
     ...
     * @var string
     */
    public const SKIP = \RectorPrefix20210703\Symplify\Skipper\ValueObject\Option::SKIP;
    /**
     * @var string
     */
