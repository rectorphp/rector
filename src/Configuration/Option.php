...
use RectorPrefix20220602\Symplify\Skipper\ValueObject\Option as SkipperOption;
final class Option
{
    /**
     * @var string
     ...
     * @var string
     */
    public const SKIP = \RectorPrefix20220602\Symplify\Skipper\ValueObject\Option::SKIP;
    /**
