...
use RectorPrefix20220228\JetBrains\PhpStorm\Immutable;
use Rector\Caching\Contract\ValueObject\Storage\CacheStorageInterface;
use Rector\Caching\ValueObject\Storage\FileCacheStorage;
use RectorPrefix20220228\Symplify\Skipper\ValueObject\Option as SkipperOption;
#[Immutable]
final class Option
{
    /**
     ...
     * @var string
     */
    public const SKIP = \RectorPrefix20220228\Symplify\Skipper\ValueObject\Option::SKIP;
    /**
     * @var string
     */
