...
use RectorPrefix20220208\Symplify\Skipper\ValueObject\Option as SkipperOption;
#[Immutable]
final class Option
{
    /**
     ...
     * @var string
     */
    public const SKIP = \RectorPrefix20220208\Symplify\Skipper\ValueObject\Option::SKIP;
    /**
     * @var string
     */
