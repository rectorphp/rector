...
use RectorPrefix20220515\Symfony\Component\DependencyInjection\Loader\Configurator\InlineServiceConfigurator;
final class ValueObjectInliner
{
    ...
    private static function inlineSingle(object $object) : \RectorPrefix20220515\Symfony\Component\DependencyInjection\Loader\Configurator\InlineServiceConfigurator
    {
        $reflectionClass = new \ReflectionClass($object);
        $className = $reflectionClass->getName();
        $argumentValues = self::resolveArgumentValues($reflectionClass, $object);
        $inlineServiceConfigurator = new \RectorPrefix20220515\Symfony\Component\DependencyInjection\Loader\Configurator\InlineServiceConfigurator(new \RectorPrefix20220515\Symfony\Component\DependencyInjection\Definition($className));
        if ($argumentValues !== []) {
