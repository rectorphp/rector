...
final class Configuration
{
     ...
     */
    public function resolveFromInput(\RectorPrefix20210521\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    private function canShowProgressBar(\RectorPrefix20210521\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function correctBashSpacePaths(array $commandLinePaths) : array
    {
        ...
        foreach ($commandLinePaths as $commandLinePath) {
            if (\RectorPrefix20210521\Nette\Utils\Strings::contains($commandLinePath, ' ')) {
