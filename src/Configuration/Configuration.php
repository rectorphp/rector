...
final class Configuration
{
     ...
     */
    public function resolveFromInput(\RectorPrefix20210515\Symfony\Component\Console\Input\InputInterface $input) : void
    {
    ...
    private function canShowProgressBar(\RectorPrefix20210515\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function correctBashSpacePaths(array $commandLinePaths) : array
    {
        ...
        foreach ($commandLinePaths as $commandLinePath) {
            if (\RectorPrefix20210515\Nette\Utils\Strings::contains($commandLinePath, ' ')) {
