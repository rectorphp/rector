...
use RectorPrefix20211027\Symplify\Astral\ValueObject\NodeBuilder\ParamBuilder;
use RectorPrefix20211027\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder;
/**
...
final class NodeFactory
{
    ...
    {
        $methodBuilder = new \RectorPrefix20211027\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder($name);
    ...
    {
        $propertyBuilder = new \RectorPrefix20211027\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder($name);
    ...
    {
        $methodBuilder = new \RectorPrefix20211027\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('get' . \ucfirst($propertyName));
        $methodBuilder->makePublic();
    ...
    {
        $methodBuilder = new \RectorPrefix20211027\Symplify\Astral\ValueObject\NodeBuilder\MethodBuilder('set' . \ucfirst($propertyName));
        $methodBuilder->makePublic();
        $variable = new \PhpParser\Node\Expr\Variable($propertyName);
