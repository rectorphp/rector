...
final class NodeFactory
{
     ...
     */
    public function createClassConstFetch($className, string $constantName) : ClassConstFetch
    {
     ...
     * @param string|\Rector\Core\Enum\ObjectReference $className
     */
    public function createClassConstReference($className) : ClassConstFetch
    {
    ...
    {
        return new StaticCall(new Name(ObjectReference::PARENT()->getValue()), new Identifier(MethodName::CONSTRUCT), $this->createArgsFromParams($params));
    }
     ...
     */
    public function createStaticCall($class, string $method, array $args = []) : StaticCall
    {
    ...
    public function createClassConstFetchFromName(Name $className, string $constantName) : ClassConstFetch
    {
        ...
        if (\in_array($classNameString, [ObjectReference::SELF()->getValue(), ObjectReference::STATIC()->getValue()], \true)) {
