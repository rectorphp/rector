...
use RectorPrefix20211004\Symplify\PackageBuilder\Php\TypeChecker;
use RectorPrefix20211004\Webmozart\Assert\Assert;
/**
...
final class BetterNodeFinder
{
    ...
    {
        \RectorPrefix20211004\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
    ...
    {
        \RectorPrefix20211004\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
        foreach ($types as $type) {
