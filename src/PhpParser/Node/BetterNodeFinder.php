...
use RectorPrefix20211017\Symplify\PackageBuilder\Php\TypeChecker;
use RectorPrefix20211017\Webmozart\Assert\Assert;
/**
...
final class BetterNodeFinder
{
    ...
    public function __construct(\PhpParser\NodeFinder $nodeFinder, \Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20211017\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \Rector\Core\PhpParser\Comparing\NodeComparator $nodeComparator, \Rector\Core\NodeAnalyzer\ClassAnalyzer $classAnalyzer, \Rector\NodeNestingScope\ParentScopeFinder $parentScopeFinder)
    {
    ...
    {
        \RectorPrefix20211017\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
    ...
    {
        \RectorPrefix20211017\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
        foreach ($types as $type) {
