...
use RectorPrefix20210809\Symplify\PackageBuilder\Php\TypeChecker;
use RectorPrefix20210809\Webmozart\Assert\Assert;
/**
...
final class BetterNodeFinder
{
    ...
    {
        \RectorPrefix20210809\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
    ...
    {
        \RectorPrefix20210809\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
        foreach ($types as $type) {
