...
use RectorPrefix20210924\Symplify\PackageBuilder\Php\TypeChecker;
...
final class BetterNodeFinder
{
    ...
    {
        \RectorPrefix20210924\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
