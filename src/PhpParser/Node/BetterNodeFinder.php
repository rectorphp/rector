...
use RectorPrefix20210913\Symplify\PackageBuilder\Php\TypeChecker;
use RectorPrefix20210913\Webmozart\Assert\Assert;
/**
...
final class BetterNodeFinder
{
    ...
    {
        \RectorPrefix20210913\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
    ...
    {
        \RectorPrefix20210913\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
        foreach ($types as $type) {
