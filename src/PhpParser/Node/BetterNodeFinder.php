...
use RectorPrefix20210711\Webmozart\Assert\Assert;
/**
...
final class BetterNodeFinder
{
    ...
    public function __construct(\PhpParser\NodeFinder $nodeFinder, \Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20210711\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \Rector\Core\PhpParser\Comparing\NodeComparator $nodeComparator, \Rector\Core\NodeAnalyzer\ClassAnalyzer $classAnalyzer)
    {
    ...
    {
        \RectorPrefix20210711\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
    ...
    {
        \RectorPrefix20210711\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
        $parent = $node->getAttribute(\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
        if (!$parent instanceof \PhpParser\Node) {
            return null;
        }
