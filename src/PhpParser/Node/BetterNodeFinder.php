...
use RectorPrefix20210520\Symplify\PackageBuilder\Php\TypeChecker;
...
final class BetterNodeFinder
{
    ...
    public function __construct(\PhpParser\NodeFinder $nodeFinder, \Rector\NodeNameResolver\NodeNameResolver $nodeNameResolver, \RectorPrefix20210520\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \Rector\Core\PhpParser\Comparing\NodeComparator $nodeComparator, \Rector\Core\NodeAnalyzer\ClassAnalyzer $classAnalyzer)
    {
    ...
    {
        \RectorPrefix20210520\Webmozart\Assert\Assert::isAOf($type, \PhpParser\Node::class);
    ...
    {
        \RectorPrefix20210520\Webmozart\Assert\Assert::allIsAOf($types, \PhpParser\Node::class);
        $parent = $node->getAttribute(\Rector\NodeTypeResolver\Node\AttributeKey::PARENT_NODE);
        if (!$parent instanceof \PhpParser\Node) {
            return null;
        }
