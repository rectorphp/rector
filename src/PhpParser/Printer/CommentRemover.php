...
/**
 * @see\Rector\Core\Tests\PhpParser\Printer\CommentRemover\CommentRemoverTest\Rector\Core\Tests\PhpParser\Printer\CommentRemover\CommentRemoverTest
 * @see \Rector\Core\Tests\PhpParser\Printer\CommentRemover\CommentRemoverTest
 */
final class CommentRemover
{
    /**
     * @seehttpshttps://regex101.com/r/mpKusH/1
     * @var string
     */
    private const START_COMMENT_REGEX = '#\/*\*(.*?)\*\/#s';

    /**
     * @seehttpshttps://regex101.com/r/YOXUuD/1
     * @var string
     */
    private const START_GRID_COMMENT_REGEX = '#^(\s+)?\#(.*?)$#m';

    /**
     * @seehttpshttps://regex101.com/r/zTLygY/3
     * @var string
     */
