...
final class BetterStandardPrinter extends \PhpParser\PrettyPrinter\Standard
{
    ...
    public function printFormatPreserving($stmts, $origStmts, $origTokens) : string
    {
        ...
        if (\count($stmts) !== \count($origStmts) && !(bool) \RectorPrefix20210705\Nette\Utils\Strings::match($content, self::NEWLINE_END_REGEX)) {
            $content .= $this->nl;
        }
        return $content;
    }
    ...
    protected function pArray($nodes, $origNodes, &$pos, $indentAdjustment, $parentNodeType, $subNodeName, $fixup) : ?string
    {
        ...
        return \RectorPrefix20210705\Nette\Utils\Strings::replace($content, self::EXTRA_SPACE_BEFORE_NOP_REGEX, '');
    }
    /**
    ...
    {
        return "'" . \RectorPrefix20210705\Nette\Utils\Strings::replace($string, self::QUOTED_SLASH_REGEX, '\\\\$0') . "'";
    }
    /**
    ...
    protected function pExpr_Closure($closure) : string
    {
        ...
        return \RectorPrefix20210705\Nette\Utils\Strings::replace($closureContent, self::USE_REGEX, '$1 (');
    }
    /**
    ...
    protected function pStmt_ClassMethod($classMethod) : string
    {
        ...
        return \RectorPrefix20210705\Nette\Utils\Strings::replace($content, self::REPLACE_COLON_WITH_SPACE_REGEX, '$1: ');
    }
    /**
    ...
    protected function pStmt_Declare($declare) : string
    {
        ...
        return \RectorPrefix20210705\Nette\Utils\Strings::replace($declareString, '#\\s+#', '');
    }
    /**
