...
final class ContentPatcher
{
    ...
    /**
     * @see https://regex101.com/r/EA1xRY/5
     * @var string
     */
    public const VALID_ANNOTATION_VAR_RETURN_EXPLICIT_FORMAT_REGEX = '#\* @(var|return)\s+(\(.*\)|(".*")(\|".*")|("?.*"?){1,})$#msU';

    /**
     * @see https://regex101.com/r/LprF44/7
     * @var string
     */
    public const INVALID_ANNOTATION_VAR_RETURN_EXPLICIT_FORMAT_REGEX = '#\* @(var|return)([^\s].*|\s[^"\s]*|([^"]*[^"]))$#msU';
