...
final class ClassLikeAstResolver
{
    ...
    public function __construct(\RectorPrefix20211116\Symplify\Astral\PhpParser\SmartPhpParser $smartPhpParser, \Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder)
    {
