...
use RectorPrefix20220416\Symplify\Astral\PhpParser\SmartPhpParser;
final class ClassLikeAstResolver
{
    ...
    public function __construct(\RectorPrefix20220416\Symplify\Astral\PhpParser\SmartPhpParser $smartPhpParser, \Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder)
    {
