...
final class ClassLikeAstResolver
{
    ...
    public function __construct(\RectorPrefix20220531\Symplify\Astral\PhpParser\SmartPhpParser $smartPhpParser, \Rector\Core\PhpParser\Node\BetterNodeFinder $betterNodeFinder)
    {
