...
final class ApplicationFileProcessor
{
     ...
     */
    public function __construct(\RectorPrefix20211227\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\Core\Application\FileDecorator\FileDiffFileDecorator $fileDiffFileDecorator, \Rector\FileFormatter\FileFormatter $fileFormatter, \Rector\Core\Application\FileSystem\RemovedAndAddedFilesProcessor $removedAndAddedFilesProcessor, \RectorPrefix20211227\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \RectorPrefix20211227\Symplify\PackageBuilder\Yaml\ParametersMerger $parametersMerger, array $fileProcessors = [])
    {
    ...
    public function run(array $files, \Rector\Core\ValueObject\Configuration $configuration) : array
    {
        ...
        $systemErrorsAndFileDiffs['system_errors'] = \array_merge($systemErrorsAndFileDiffs['system_errors'], $this->systemErrors);
    ...
    private function configureCustomErrorHandler() : void
    {
        $errorHandlerCallback = function (int $code, string $message, string $file, int $line) : bool {
            ...
            $this->systemErrors[] = new \Rector\Core\ValueObject\Application\SystemError($message, $file, $line);
            return \true;
        };
