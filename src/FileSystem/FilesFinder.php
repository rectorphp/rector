...
use RectorPrefix20220105\Symfony\Component\Finder\Finder;
use RectorPrefix20220105\Symfony\Component\Finder\SplFileInfo;
use RectorPrefix20220105\Symplify\Skipper\SkipCriteriaResolver\SkippedPathsResolver;
use RectorPrefix20220105\Symplify\SmartFileSystem\FileSystemFilter;
use RectorPrefix20220105\Symplify\SmartFileSystem\Finder\FinderSanitizer;
...
final class FilesFinder
{
    ...
    private function findInDirectories(array $directories, array $suffixes) : array
    {
        ...
        $finder = \RectorPrefix20220105\Symfony\Component\Finder\Finder::create()->followLinks()->files()->size('> 0')->in($directories)->sortByName();
        if ($suffixes !== []) {
    ...
    private function addFilterWithExcludedPaths(\RectorPrefix20220105\Symfony\Component\Finder\Finder $finder) : void
    {
        $excludePaths = $this->skippedPathsResolver->resolve();
        if ($excludePaths === []) {
            return;
        }
        $finder->filter(function (\RectorPrefix20220105\Symfony\Component\Finder\SplFileInfo $splFileInfo) use($excludePaths) : bool {
