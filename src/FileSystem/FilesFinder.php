...
use RectorPrefix20220601\Symfony\Component\Finder\Finder;
...
use RectorPrefix20220601\Symplify\Skipper\SkipCriteriaResolver\SkippedPathsResolver;
use RectorPrefix20220601\Symplify\SmartFileSystem\FileSystemFilter;
use RectorPrefix20220601\Symplify\SmartFileSystem\Finder\FinderSanitizer;
...
final class FilesFinder
{
    ...
    public function __construct(\Rector\Core\FileSystem\FilesystemTweaker $filesystemTweaker, \RectorPrefix20220601\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \RectorPrefix20220601\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter, \RectorPrefix20220601\Symplify\Skipper\SkipCriteriaResolver\SkippedPathsResolver $skippedPathsResolver, \Rector\Caching\UnchangedFilesFilter $unchangedFilesFilter, \RectorPrefix20220601\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
    ...
    private function findInDirectories(array $directories, array $suffixes) : array
    {
        ...
        $finder = \RectorPrefix20220601\Symfony\Component\Finder\Finder::create()->files()->size('> 0')->in($directories)->sortByName();
    ...
    private function addFilterWithExcludedPaths(\RectorPrefix20220601\Symfony\Component\Finder\Finder $finder) : void
    {
        $excludePaths = $this->skippedPathsResolver->resolve();
        if ($excludePaths === []) {
            return;
        }
        $finder->filter(function (\RectorPrefix20220601\Symfony\Component\Finder\SplFileInfo $splFileInfo) use($excludePaths) : bool {
