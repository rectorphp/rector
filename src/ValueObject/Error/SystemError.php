...
use RectorPrefix20220301\Symplify\EasyParallel\Contract\SerializableInterface;
final class SystemError implements \RectorPrefix20220301\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @readonly
     * @var string
     ...
     * @param mixed[] $json
     */
    public static function decode(array $json) : \RectorPrefix20220301\Symplify\EasyParallel\Contract\SerializableInterface
    {
