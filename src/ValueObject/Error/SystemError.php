...
use RectorPrefix20211210\Symplify\EasyParallel\Contract\SerializableInterface;
final class SystemError implements \RectorPrefix20211210\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @readonly
     * @var int
