...
final class SystemError implements \RectorPrefix20220521\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @readonly
     * @var string
     ...
     * @param mixed[] $json
     */
    public static function decode(array $json) : \RectorPrefix20220521\Symplify\EasyParallel\Contract\SerializableInterface
    {
