...
final class SystemError implements \RectorPrefix20220529\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @readonly
     * @var string
     ...
     * @param mixed[] $json
     */
    public static function decode(array $json) : \RectorPrefix20220529\Symplify\EasyParallel\Contract\SerializableInterface
    {
