...
use RectorPrefix20211126\Symplify\EasyParallel\Contract\SerializableInterface;
final class SystemError implements \RectorPrefix20211126\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var int
     */
     ...
     * @param mixed[] $json
     */
    public static function decode($json) : \RectorPrefix20211126\Symplify\EasyParallel\Contract\SerializableInterface
    {
