...
final class FileDiff implements \RectorPrefix20211126\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    {
        $match = \RectorPrefix20211126\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
