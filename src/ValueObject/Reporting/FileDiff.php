...
final class FileDiff implements \RectorPrefix20220513\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    public function __construct(string $relativeFilePath, string $diff, string $diffConsoleFormatted, array $rectorsWithLineChanges = [])
    {
        ...
        \RectorPrefix20220513\Webmozart\Assert\Assert::allIsAOf($rectorsWithLineChanges, \Rector\ChangesReporting\ValueObject\RectorWithLineChange::class);
    }
    ...
    {
        $match = \RectorPrefix20220513\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
