...
final class FileDiff implements \RectorPrefix20211216\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    {
        $match = \RectorPrefix20211216\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
