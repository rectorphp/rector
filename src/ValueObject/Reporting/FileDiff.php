...
final class FileDiff implements \RectorPrefix20211219\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    {
        $match = \RectorPrefix20211219\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
