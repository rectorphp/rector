...
final class FileDiff implements \RectorPrefix20211224\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    {
        $match = \RectorPrefix20211224\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
