...
final class FileDiff implements \RectorPrefix20211127\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    {
        $match = \RectorPrefix20211127\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
