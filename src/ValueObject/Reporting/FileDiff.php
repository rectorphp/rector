...
final class FileDiff implements \RectorPrefix20211130\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    {
        $match = \RectorPrefix20211130\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
