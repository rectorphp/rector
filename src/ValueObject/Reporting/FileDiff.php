...
final class FileDiff implements \RectorPrefix20220323\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    public function __construct(string $relativeFilePath, string $diff, string $diffConsoleFormatted, array $rectorsWithLineChanges = [])
    {
        ...
        \RectorPrefix20220323\Webmozart\Assert\Assert::allIsAOf($rectorsWithLineChanges, \Rector\ChangesReporting\ValueObject\RectorWithLineChange::class);
    }
    ...
    {
        $match = \RectorPrefix20220323\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
