...
final class FileDiff implements \RectorPrefix20211226\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    {
        $match = \RectorPrefix20211226\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
