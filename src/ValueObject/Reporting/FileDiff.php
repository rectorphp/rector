...
final class FileDiff implements \RectorPrefix20211214\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    {
        $match = \RectorPrefix20211214\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
