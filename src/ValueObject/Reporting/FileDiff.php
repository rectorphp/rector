...
final class FileDiff implements \RectorPrefix20211206\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    {
        $match = \RectorPrefix20211206\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
