...
use RectorPrefix20220125\Symplify\Astral\ValueObject\AstralConfig;
...
use RectorPrefix20220125\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig;
use RectorPrefix20220125\Symplify\ConsoleColorDiff\ValueObject\ConsoleColorDiffConfig;
use RectorPrefix20220125\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use RectorPrefix20220125\Symplify\SimplePhpDocParser\ValueObject\SimplePhpDocParserConfig;
use RectorPrefix20220125\Symplify\Skipper\ValueObject\SkipperConfig;
...
final class RectorKernel implements \RectorPrefix20220125\Symplify\SymplifyKernel\Contract\LightKernelInterface
{
    /**
     * @readonly
    ...
    public function getContainer() : \RectorPrefix20220125\Psr\Container\ContainerInterface
    {
    ...
    private function createCompilerPasses() : array
    {
        ...
        $compilerPasses[] = new \RectorPrefix20220125\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\Rector\Core\Contract\Rector\RectorInterface::class]);
    ...
    private function createDefaultConfigFiles() : array
    {
        ...
        $configFiles[] = \RectorPrefix20220125\Symplify\Astral\ValueObject\AstralConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20220125\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20220125\Symplify\ConsoleColorDiff\ValueObject\ConsoleColorDiffConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20220125\Symplify\SimplePhpDocParser\ValueObject\SimplePhpDocParserConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20220125\Symplify\Skipper\ValueObject\SkipperConfig::FILE_PATH;
        return $configFiles;
    }
}
