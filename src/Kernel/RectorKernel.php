...
use RectorPrefix20211102\Symplify\Astral\ValueObject\AstralConfig;
...
use RectorPrefix20211102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig;
use RectorPrefix20211102\Symplify\ConsoleColorDiff\ValueObject\ConsoleColorDiffConfig;
use RectorPrefix20211102\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use RectorPrefix20211102\Symplify\SimplePhpDocParser\ValueObject\SimplePhpDocParserConfig;
use RectorPrefix20211102\Symplify\Skipper\ValueObject\SkipperConfig;
...
final class RectorKernel implements \RectorPrefix20211102\Symplify\SymplifyKernel\Contract\LightKernelInterface
{
    /**
    ...
    public function createFromConfigs($configFiles) : \RectorPrefix20211102\Psr\Container\ContainerInterface
    {
        ...
        $containerBuilderFactory = new \RectorPrefix20211102\Symplify\SymplifyKernel\ContainerBuilderFactory($configureCallMergingLoaderFactory);
    ...
    private function createCompilerPasses() : array
    {
        ...
        $compilerPasses[] = new \RectorPrefix20211102\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\Rector\Core\Contract\Rector\RectorInterface::class]);
    ...
    private function createDefaultConfigFiles() : array
    {
        ...
        $configFiles[] = \RectorPrefix20211102\Symplify\Astral\ValueObject\AstralConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20211102\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20211102\Symplify\ConsoleColorDiff\ValueObject\ConsoleColorDiffConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20211102\Symplify\SimplePhpDocParser\ValueObject\SimplePhpDocParserConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20211102\Symplify\Skipper\ValueObject\SkipperConfig::FILE_PATH;
        return $configFiles;
    }
}
