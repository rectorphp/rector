...
use RectorPrefix20220218\Symplify\Astral\ValueObject\AstralConfig;
use RectorPrefix20220218\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass;
use RectorPrefix20220218\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig;
use RectorPrefix20220218\Symplify\ConsoleColorDiff\ValueObject\ConsoleColorDiffConfig;
use RectorPrefix20220218\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use RectorPrefix20220218\Symplify\SimplePhpDocParser\ValueObject\SimplePhpDocParserConfig;
use RectorPrefix20220218\Symplify\Skipper\ValueObject\SkipperConfig;
...
final class RectorKernel implements \RectorPrefix20220218\Symplify\SymplifyKernel\Contract\LightKernelInterface
{
    /**
     * @readonly
     ...
     */
    public function createFromConfigs(array $configFiles) : \RectorPrefix20220218\Psr\Container\ContainerInterface
    {
        ...
        $containerBuilderFactory = new \RectorPrefix20220218\Symplify\SymplifyKernel\ContainerBuilderFactory($configureCallMergingLoaderFactory);
    ...
    public function getContainer() : \RectorPrefix20220218\Psr\Container\ContainerInterface
    {
    ...
    private function createCompilerPasses() : array
    {
        ...
        $compilerPasses[] = new \RectorPrefix20220218\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\Rector\Core\Contract\Rector\RectorInterface::class]);
        ...
        $compilerPasses[] = new \RectorPrefix20220218\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass();
    ...
    private function createDefaultConfigFiles() : array
    {
        ...
        $configFiles[] = \RectorPrefix20220218\Symplify\Astral\ValueObject\AstralConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20220218\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20220218\Symplify\ConsoleColorDiff\ValueObject\ConsoleColorDiffConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20220218\Symplify\SimplePhpDocParser\ValueObject\SimplePhpDocParserConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20220218\Symplify\Skipper\ValueObject\SkipperConfig::FILE_PATH;
        return $configFiles;
    }
}
