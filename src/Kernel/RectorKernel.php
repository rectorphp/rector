...
use RectorPrefix20211216\Symplify\Astral\ValueObject\AstralConfig;
use RectorPrefix20211216\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass;
use RectorPrefix20211216\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig;
use RectorPrefix20211216\Symplify\ConsoleColorDiff\ValueObject\ConsoleColorDiffConfig;
use RectorPrefix20211216\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use RectorPrefix20211216\Symplify\SimplePhpDocParser\ValueObject\SimplePhpDocParserConfig;
use RectorPrefix20211216\Symplify\Skipper\ValueObject\SkipperConfig;
use RectorPrefix20211216\Symplify\SymplifyKernel\ContainerBuilderFactory;
use RectorPrefix20211216\Symplify\SymplifyKernel\Contract\LightKernelInterface;
final class RectorKernel implements \RectorPrefix20211216\Symplify\SymplifyKernel\Contract\LightKernelInterface
{
    /**
     * @readonly
    ...
    public function createFromConfigs(array $configFiles) : \RectorPrefix20211216\Psr\Container\ContainerInterface
    {
        ...
        $containerBuilderFactory = new \RectorPrefix20211216\Symplify\SymplifyKernel\ContainerBuilderFactory($configureCallMergingLoaderFactory);
    ...
    private function createCompilerPasses() : array
    {
        ...
        $compilerPasses[] = new \RectorPrefix20211216\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\Rector\Core\Contract\Rector\RectorInterface::class]);
        ...
        $compilerPasses[] = new \RectorPrefix20211216\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass();
    ...
    private function createDefaultConfigFiles() : array
    {
        ...
        $configFiles[] = \RectorPrefix20211216\Symplify\Astral\ValueObject\AstralConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20211216\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20211216\Symplify\ConsoleColorDiff\ValueObject\ConsoleColorDiffConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20211216\Symplify\SimplePhpDocParser\ValueObject\SimplePhpDocParserConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20211216\Symplify\Skipper\ValueObject\SkipperConfig::FILE_PATH;
        return $configFiles;
    }
}
