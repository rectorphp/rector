...
use RectorPrefix20220608\Symplify\Astral\ValueObject\AstralConfig;
use RectorPrefix20220608\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass;
use RectorPrefix20220608\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig;
use RectorPrefix20220608\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use RectorPrefix20220608\Symplify\PackageBuilder\ValueObject\ConsoleColorDiffConfig;
use RectorPrefix20220608\Symplify\Skipper\ValueObject\SkipperConfig;
use RectorPrefix20220608\Symplify\SymplifyKernel\ContainerBuilderFactory;
...
final class RectorKernel implements LightKernelInterface
{
     ...
     */
    public function createFromConfigs(array $configFiles) : \RectorPrefix20220608\Psr\Container\ContainerInterface
    {
    ...
    public function getContainer() : \RectorPrefix20220608\Psr\Container\ContainerInterface
    {
