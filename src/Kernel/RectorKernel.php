...
use RectorPrefix20220604\Symplify\Astral\ValueObject\AstralConfig;
use RectorPrefix20220604\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass;
use RectorPrefix20220604\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig;
use RectorPrefix20220604\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use RectorPrefix20220604\Symplify\PackageBuilder\ValueObject\ConsoleColorDiffConfig;
use RectorPrefix20220604\Symplify\Skipper\ValueObject\SkipperConfig;
use RectorPrefix20220604\Symplify\SymplifyKernel\ContainerBuilderFactory;
use RectorPrefix20220604\Symplify\SymplifyKernel\Contract\LightKernelInterface;
final class RectorKernel implements \RectorPrefix20220604\Symplify\SymplifyKernel\Contract\LightKernelInterface
{
    /**
     * @readonly
    ...
    public function createFromConfigs(array $configFiles) : \RectorPrefix20220604\Psr\Container\ContainerInterface
    {
        ...
        $containerBuilderFactory = new \RectorPrefix20220604\Symplify\SymplifyKernel\ContainerBuilderFactory($configureCallMergingLoaderFactory);
    ...
    private function createCompilerPasses() : array
    {
        return [
            ...
            new \RectorPrefix20220604\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\Rector\Core\Contract\Rector\RectorInterface::class]),
            ...
            new \RectorPrefix20220604\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass(),
        ];
    }
    /**
     * @return string[]
    ...
    {
        return [__DIR__ . '/../../config/config.php', \RectorPrefix20220604\Symplify\Astral\ValueObject\AstralConfig::FILE_PATH, \RectorPrefix20220604\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig::FILE_PATH, \RectorPrefix20220604\Symplify\Skipper\ValueObject\SkipperConfig::FILE_PATH, \RectorPrefix20220604\Symplify\PackageBuilder\ValueObject\ConsoleColorDiffConfig::FILE_PATH];
    }
}
