...
use RectorPrefix20220322\Symplify\Astral\ValueObject\AstralConfig;
use RectorPrefix20220322\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass;
use RectorPrefix20220322\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig;
use RectorPrefix20220322\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use RectorPrefix20220322\Symplify\PackageBuilder\ValueObject\ConsoleColorDiffConfig;
use RectorPrefix20220322\Symplify\Skipper\ValueObject\SkipperConfig;
use RectorPrefix20220322\Symplify\SymplifyKernel\ContainerBuilderFactory;
use RectorPrefix20220322\Symplify\SymplifyKernel\Contract\LightKernelInterface;
final class RectorKernel implements \RectorPrefix20220322\Symplify\SymplifyKernel\Contract\LightKernelInterface
{
    /**
     * @readonly
    ...
    public function createFromConfigs(array $configFiles) : \RectorPrefix20220322\Psr\Container\ContainerInterface
    {
        ...
        $containerBuilderFactory = new \RectorPrefix20220322\Symplify\SymplifyKernel\ContainerBuilderFactory($configureCallMergingLoaderFactory);
    ...
    private function createCompilerPasses() : array
    {
        ...
        $compilerPasses[] = new \RectorPrefix20220322\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\Rector\Core\Contract\Rector\RectorInterface::class]);
        ...
        $compilerPasses[] = new \RectorPrefix20220322\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass();
    ...
    private function createDefaultConfigFiles() : array
    {
        ...
        $configFiles[] = \RectorPrefix20220322\Symplify\Astral\ValueObject\AstralConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20220322\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonManipulatorConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20220322\Symplify\Skipper\ValueObject\SkipperConfig::FILE_PATH;
        $configFiles[] = \RectorPrefix20220322\Symplify\PackageBuilder\ValueObject\ConsoleColorDiffConfig::FILE_PATH;
        return $configFiles;
    }
}
