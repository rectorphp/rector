...
final class EmptyConfigurableRectorChecker
{
    ...
    public function __construct(\Rector\Core\Validation\Collector\EmptyConfigurableRectorCollector $emptyConfigurableRectorCollector, \RectorPrefix20211013\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle)
    {
    ...
    private function reportEmptyConfigurableMessage(array $emptyConfigurableRectors) : void
    {
        ...
        foreach ($emptyConfigurableRectors as $emptyConfigurableRector) {
            $shortRectorClass = \RectorPrefix20211013\Nette\Utils\Strings::after(\get_class($emptyConfigurableRector), '\\', -1);
