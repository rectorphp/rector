...
use RectorPrefix20220530\Webmozart\Assert\InvalidArgumentException;
/**
...
final class RectorAssert
{
    ...
    public static function className(string $className) : void
    {
        ...
        throw new \RectorPrefix20220530\Webmozart\Assert\InvalidArgumentException($errorMessage);
    }
}
