...
use RectorPrefix20220119\Webmozart\Assert\InvalidArgumentException;
/**
...
final class RectorAssert
{
    ...
    public static function className(string $className) : void
    {
        ...
        throw new \RectorPrefix20220119\Webmozart\Assert\InvalidArgumentException($errorMessage);
    }
}
