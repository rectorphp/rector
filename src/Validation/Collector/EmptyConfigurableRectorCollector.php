...
final class EmptyConfigurableRectorCollector
{
    ...
    public function __construct(\RectorPrefix20220506\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
    ...
    private function hasConfigureMethodCall(\RectorPrefix20220506\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
