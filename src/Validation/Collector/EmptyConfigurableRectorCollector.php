...
final class EmptyConfigurableRectorCollector
{
    ...
    public function __construct(\RectorPrefix20220407\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
    ...
    private function hasConfigureMethodCall(\RectorPrefix20220407\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
