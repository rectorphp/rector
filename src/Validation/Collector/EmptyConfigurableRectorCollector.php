...
final class EmptyConfigurableRectorCollector
{
    ...
    public function __construct(\RectorPrefix20211204\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor, \Rector\Naming\Naming\PropertyNaming $propertyNaming)
    {
