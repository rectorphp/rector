...
final class EmptyConfigurableRectorCollector
{
    ...
    public function __construct(\RectorPrefix20211026\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor, \Rector\Naming\Naming\PropertyNaming $propertyNaming)
    {
