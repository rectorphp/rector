...
final class EmptyConfigurableRectorCollector
{
    ...
    public function __construct(\RectorPrefix20220118\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder)
    {
    ...
    private function hasConfigureMethodCall(\RectorPrefix20220118\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
