...
use RectorPrefix20220604\Nette\Utils\FileSystem;
...
{
    public function createFromBootstrapConfigs(\Rector\Core\ValueObject\Bootstrap\BootstrapConfigs $bootstrapConfigs) : \RectorPrefix20220604\Psr\Container\ContainerInterface
    {
        ...
        if ($mainConfigFile !== null) {
            ...
            $fileContents = \RectorPrefix20220604\Nette\Utils\FileSystem::read($mainConfigFile);
     ...
     * @api
     */
    private function createFromConfigs(array $configFiles) : \RectorPrefix20220604\Psr\Container\ContainerInterface
    {
