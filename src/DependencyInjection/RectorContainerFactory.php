...
{
    public function createFromBootstrapConfigs(\Rector\Core\ValueObject\Bootstrap\BootstrapConfigs $bootstrapConfigs) : \RectorPrefix20220207\Psr\Container\ContainerInterface
    {
     ...
     * @api
     */
    private function createFromConfigs(array $configFiles) : \RectorPrefix20220207\Psr\Container\ContainerInterface
    {
