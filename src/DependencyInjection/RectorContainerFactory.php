...
{
    public function createFromBootstrapConfigs(\Rector\Core\ValueObject\Bootstrap\BootstrapConfigs $bootstrapConfigs) : \RectorPrefix20220105\Psr\Container\ContainerInterface
    {
     ...
     * @api
     */
    private function createFromConfigs(array $configFiles) : \RectorPrefix20220105\Psr\Container\ContainerInterface
    {
