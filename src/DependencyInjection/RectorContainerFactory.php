...
use RectorPrefix20220530\Nette\Utils\FileSystem;
...
{
    public function createFromBootstrapConfigs(\Rector\Core\ValueObject\Bootstrap\BootstrapConfigs $bootstrapConfigs) : \RectorPrefix20220530\Psr\Container\ContainerInterface
    {
        ...
        if ($mainConfigFile !== null) {
            ...
            $fileContents = \RectorPrefix20220530\Nette\Utils\FileSystem::read($mainConfigFile);
     ...
     * @api
     */
    private function createFromConfigs(array $configFiles) : \RectorPrefix20220530\Psr\Container\ContainerInterface
    {
