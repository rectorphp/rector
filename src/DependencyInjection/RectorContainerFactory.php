...
use RectorPrefix20220504\Nette\Utils\FileSystem;
...
{
    public function createFromBootstrapConfigs(\Rector\Core\ValueObject\Bootstrap\BootstrapConfigs $bootstrapConfigs) : \RectorPrefix20220504\Psr\Container\ContainerInterface
    {
        ...
        if ($mainConfigFile !== null) {
            ...
            $fileContents = \RectorPrefix20220504\Nette\Utils\FileSystem::read($mainConfigFile);
     ...
     * @api
     */
    private function createFromConfigs(array $configFiles) : \RectorPrefix20220504\Psr\Container\ContainerInterface
    {
