...
use RectorPrefix20210605\Symplify\PackageBuilder\Yaml\ParametersMerger;
final class ConfigureCallValuesCollector
{
    ...
    {
        $this->parametersMerger = new \RectorPrefix20210605\Symplify\PackageBuilder\Yaml\ParametersMerger();
    }
    /**
     * @return mixed[]
     */
    ...
    public function collectFromServiceAndClassName(string $className, \RectorPrefix20210605\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
