...
use RectorPrefix20210610\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
...
final class MergeImportedRectorConfigureCallValuesCompilerPass implements \RectorPrefix20210610\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * @var string
     */
    ...
    public function process(\RectorPrefix20210610\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        foreach ($containerBuilder->getDefinitions() as $id => $definition) {
            $this->completeCollectedArguments($id, $definition);
        }
    }
    private function completeCollectedArguments(string $serviceClass, \RectorPrefix20210610\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
