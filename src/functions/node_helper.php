...
if (!\function_exists('dn')) {
    ...
    {
        \RectorPrefix20211106\dump_node($node, $depth);
    }
}
if (!\function_exists('dump_node')) {
    ...
    function dump_node($node, int $depth = 2) : void
    {
        ...
        foreach ($nodes as $node) {
            \RectorPrefix20211106\Tracy\Dumper::dump($node, [\RectorPrefix20211106\Tracy\Dumper::DEPTH => $depth]);
        }
    }
}
if (!\function_exists('print_node')) {
    ...
    function print_node($node) : void
    {
        ...
        foreach ($nodes as $node) {
            ...
            \RectorPrefix20211106\Tracy\Dumper::dump($printedContent);
        }
    }
}
