...
if (!\function_exists('dump_with_depth')) {
    ...
    {
        \RectorPrefix20220607\Tracy\Dumper::dump($value, [\RectorPrefix20220607\Tracy\Dumper::DEPTH => $depth]);
    }
}
if (!\function_exists('dn')) {
    function dn(\PhpParser\Node $node, int $depth = 2) : void
    {
        \RectorPrefix20220607\dump_node($node, $depth);
    }
}
if (!\function_exists('dump_node')) {
    ...
    function dump_node($node, int $depth = 2) : void
    {
        ...
        foreach ($nodes as $node) {
            \RectorPrefix20220607\Tracy\Dumper::dump($node, [\RectorPrefix20220607\Tracy\Dumper::DEPTH => $depth]);
        }
    }
}
if (!\function_exists('print_node')) {
    ...
    function print_node($node) : void
    {
        ...
        foreach ($nodes as $node) {
            ...
            \RectorPrefix20220607\Tracy\Dumper::dump($printedContent);
        }
    }
}
