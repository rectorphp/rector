...
final class BootstrapFilesIncluder
{
    ...
    public function __construct(\RectorPrefix20220116\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
    ...
    public function includeBootstrapFiles() : void
    {
        ...
        \RectorPrefix20220116\Webmozart\Assert\Assert::allString($bootstrapFiles);
