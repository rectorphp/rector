...
final class BootstrapFilesIncluder
{
    ...
    public function __construct(\RectorPrefix20210817\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
    ...
    public function includeBootstrapFiles() : void
    {
        ...
        \RectorPrefix20210817\Webmozart\Assert\Assert::allString($bootstrapFiles);
