...
final class BootstrapFilesIncluder
{
     ...
     */
    private $filesFinder;
    public function __construct(\RectorPrefix20220528\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Rector\Core\FileSystem\FilesFinder $filesFinder)
    {
