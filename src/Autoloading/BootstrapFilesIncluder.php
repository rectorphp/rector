...
final class BootstrapFilesIncluder
{
    ...
    public function __construct(\RectorPrefix20210825\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
    ...
    public function includeBootstrapFiles() : void
    {
        ...
        \RectorPrefix20210825\Webmozart\Assert\Assert::allString($bootstrapFiles);
