...
final class BootstrapFilesIncluder
{
     ...
     */
    private $filesFinder;
    public function __construct(\RectorPrefix20220517\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Rector\Core\FileSystem\FilesFinder $filesFinder)
    {
    ...
    public function includeBootstrapFiles() : void
    {
        ...
        \RectorPrefix20220517\Webmozart\Assert\Assert::allString($bootstrapFiles);
