...
final class BootstrapFilesIncluder
{
     ...
     */
    private $filesFinder;
    public function __construct(\RectorPrefix20220529\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Rector\Core\FileSystem\FilesFinder $filesFinder)
    {
