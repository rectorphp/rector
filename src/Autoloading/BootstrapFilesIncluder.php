...
final class BootstrapFilesIncluder
{
    ...
    public function __construct(\RectorPrefix20211126\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
    ...
    public function includeBootstrapFiles() : void
    {
        ...
        \RectorPrefix20211126\Webmozart\Assert\Assert::allString($bootstrapFiles);
