...
final class BootstrapFilesIncluder
{
    ...
    public function __construct(\RectorPrefix20220129\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
    ...
    public function includeBootstrapFiles() : void
    {
        ...
        \RectorPrefix20220129\Webmozart\Assert\Assert::allString($bootstrapFiles);
