...
final class AdditionalAutoloader
{
    ...
    public function __construct(\RectorPrefix20220521\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard, \RectorPrefix20220521\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Rector\Core\StaticReflection\DynamicSourceLocatorDecorator $dynamicSourceLocatorDecorator)
    {
        $this->fileSystemGuard = $fileSystemGuard;
        $this->parameterProvider = $parameterProvider;
        $this->dynamicSourceLocatorDecorator = $dynamicSourceLocatorDecorator;
    }
    public function autoloadInput(\RectorPrefix20220521\Symfony\Component\Console\Input\InputInterface $input) : void
    {
