...
use RectorPrefix20211224\Symfony\Component\Config\Loader\DelegatingLoader;
use RectorPrefix20211224\Symfony\Component\Config\Loader\GlobFileLoader;
...
final class ConfigureCallMergingLoaderFactory implements \RectorPrefix20211224\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface
{
    /**
     * @readonly
    ...
    {
        $fileLocator = new \RectorPrefix20211224\Symfony\Component\Config\FileLocator([$currentWorkingDirectory]);
        $loaderResolver = new \RectorPrefix20211224\Symfony\Component\Config\Loader\LoaderResolver([new \RectorPrefix20211224\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($containerBuilder, $fileLocator, $this->configureCallValuesCollector)]);
        return new \RectorPrefix20211224\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
