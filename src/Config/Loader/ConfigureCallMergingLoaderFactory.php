...
use RectorPrefix20211210\Symfony\Component\Config\Loader\DelegatingLoader;
use RectorPrefix20211210\Symfony\Component\Config\Loader\GlobFileLoader;
...
final class ConfigureCallMergingLoaderFactory implements \RectorPrefix20211210\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface
{
    /**
     * @readonly
    ...
    public function create($containerBuilder, $currentWorkingDirectory) : \RectorPrefix20211210\Symfony\Component\Config\Loader\LoaderInterface
    {
        ...
        return new \RectorPrefix20211210\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
