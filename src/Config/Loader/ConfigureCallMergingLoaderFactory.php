...
use RectorPrefix20220526\Symfony\Component\Config\Loader\DelegatingLoader;
use RectorPrefix20220526\Symfony\Component\Config\Loader\GlobFileLoader;
...
final class ConfigureCallMergingLoaderFactory implements \RectorPrefix20220526\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface
{
    /**
     * @readonly
    ...
    {
        $fileLocator = new \RectorPrefix20220526\Symfony\Component\Config\FileLocator([$currentWorkingDirectory]);
        $loaderResolver = new \RectorPrefix20220526\Symfony\Component\Config\Loader\LoaderResolver([new \RectorPrefix20220526\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($containerBuilder, $fileLocator, $this->configureCallValuesCollector)]);
        return new \RectorPrefix20220526\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
