...
use RectorPrefix20210712\Symfony\Component\Config\Loader\GlobFileLoader;
...
use RectorPrefix20210712\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle;
use RectorPrefix20210712\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle;
use RectorPrefix20210712\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass;
use RectorPrefix20210712\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle;
use RectorPrefix20210712\Symplify\Skipper\Bundle\SkipperBundle;
use Symplify\SmartFileSystem\SmartFileInfo;
/**
 * @todo possibly remove symfony/http-kernel and use the container build only
 */
final class RectorKernel extends \RectorPrefix20210712\Symfony\Component\HttpKernel\Kernel
{
    /**
    ...
    {
        return [new \RectorPrefix20210712\Symplify\ConsoleColorDiff\Bundle\ConsoleColorDiffBundle(), new \RectorPrefix20210712\Symplify\ComposerJsonManipulator\Bundle\ComposerJsonManipulatorBundle(), new \RectorPrefix20210712\Symplify\Skipper\Bundle\SkipperBundle(), new \RectorPrefix20210712\Symplify\SimplePhpDocParser\Bundle\SimplePhpDocParserBundle()];
    }
    /**
    ...
    protected function build($containerBuilder) : void
    {
        ...
        $containerBuilder->addCompilerPass(new \RectorPrefix20210712\Symplify\PackageBuilder\DependencyInjection\CompilerPass\AutowireInterfacesCompilerPass([\Rector\Core\Contract\Rector\RectorInterface::class]));
     ...
     */
    protected function getContainerLoader($container) : \RectorPrefix20210712\Symfony\Component\Config\Loader\DelegatingLoader
    {
        $fileLocator = new \RectorPrefix20210712\Symfony\Component\HttpKernel\Config\FileLocator($this);
        $loaderResolver = new \RectorPrefix20210712\Symfony\Component\Config\Loader\LoaderResolver([new \RectorPrefix20210712\Symfony\Component\Config\Loader\GlobFileLoader($fileLocator), new \Rector\Core\DependencyInjection\Loader\ConfigurableCallValuesCollectingPhpFileLoader($container, $fileLocator, $this->configureCallValuesCollector)]);
        return new \RectorPrefix20210712\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
