...
final class RectorConfigsResolver
{
    ...
    private function resolveRectorRecipeConfig(\RectorPrefix20211107\Symfony\Component\Console\Input\ArgvInput $argvInput) : ?string
    {
    ...
    private function resolveFromInput(\RectorPrefix20211107\Symfony\Component\Console\Input\ArgvInput $argvInput) : ?string
    {
        ...
        if (!\file_exists($configFile)) {
            ...
            throw new \RectorPrefix20211107\Symplify\SmartFileSystem\Exception\FileNotFoundException($message);
        }
        return \realpath($configFile);
    }
    private function resolveFromInputWithFallback(\RectorPrefix20211107\Symfony\Component\Console\Input\ArgvInput $argvInput, string $fallbackFile) : ?string
    {
     ...
     */
    private function getOptionValue(\RectorPrefix20211107\Symfony\Component\Console\Input\ArgvInput $argvInput, array $optionNames) : ?string
    {
