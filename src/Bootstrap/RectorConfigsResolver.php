...
final class RectorConfigsResolver
{
    ...
    private function resolveRectorRecipeConfig(\RectorPrefix20210527\Symfony\Component\Console\Input\ArgvInput $argvInput) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    private function resolveFromInput(\RectorPrefix20210527\Symfony\Component\Console\Input\ArgvInput $argvInput) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
        ...
        if (!\file_exists($configValue)) {
            ...
            throw new \RectorPrefix20210527\Symplify\SmartFileSystem\Exception\FileNotFoundException($message);
        }
        return new \Symplify\SmartFileSystem\SmartFileInfo($configValue);
    }
    private function resolveFromInputWithFallback(\RectorPrefix20210527\Symfony\Component\Console\Input\ArgvInput $argvInput, string $fallbackFile) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
     ...
     */
    private function getOptionValue(\RectorPrefix20210527\Symfony\Component\Console\Input\ArgvInput $argvInput, array $optionNames) : ?string
    {
