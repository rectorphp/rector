...
use RectorPrefix20210509\Symfony\Component\Console\Input\ArgvInput;
use RectorPrefix20210509\Symplify\SetConfigResolver\ConfigResolver;
...
final class RectorConfigsResolver
{
    ...
    public function __construct()
    {
        ...
        $this->configResolver = new \RectorPrefix20210509\Symplify\SetConfigResolver\ConfigResolver();
    }
    /**
    ...
    {
        $argvInput = new \RectorPrefix20210509\Symfony\Component\Console\Input\ArgvInput();
     ...
     * @return SmartFileInfo[]
     */
    private function appendRectorRecipeConfig(\RectorPrefix20210509\Symfony\Component\Console\Input\ArgvInput $argvInput, array $configFileInfos) : array
    {
