...
final class RectorConfigsResolver
{
    ...
    private function resolveRectorRecipeConfig(\RectorPrefix20211017\Symfony\Component\Console\Input\ArgvInput $argvInput) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    private function resolveFromInput(\RectorPrefix20211017\Symfony\Component\Console\Input\ArgvInput $argvInput) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
        ...
        if (!\file_exists($configValue)) {
            ...
            throw new \RectorPrefix20211017\Symplify\SmartFileSystem\Exception\FileNotFoundException($message);
        }
        return new \Symplify\SmartFileSystem\SmartFileInfo($configValue);
    }
    private function resolveFromInputWithFallback(\RectorPrefix20211017\Symfony\Component\Console\Input\ArgvInput $argvInput, string $fallbackFile) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {
     ...
     */
    private function getOptionValue(\RectorPrefix20211017\Symfony\Component\Console\Input\ArgvInput $argvInput, array $optionNames) : ?string
    {
