...
final class Application extends SymfonyApplication
{
     ...
     */
    public function __construct(Configuration $configuration, NoRectorsLoadedReporter $noRectorsLoadedReporter, array $commands = [])
    {
        try {
    ...
    {
        if (is_a($e, NoRectorsLoadedException::class)) {
            $this->noRectorsLoadedReporter->report();
            return;
        }
        parent::renderThrowable($e, $output); // TODO: Change the autogenerated stub
    }
}
