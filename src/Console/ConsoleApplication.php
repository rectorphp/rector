...
use RectorPrefix20220530\Composer\XdebugHandler\XdebugHandler;
...
final class ConsoleApplication extends \RectorPrefix20220530\Symfony\Component\Console\Application
{
    /**
     * @var string
     */
    ...
    public function __construct(array $commands = [])
    {
        ...
        $this->setDefaultCommand(\RectorPrefix20220530\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(\Rector\Core\Console\Command\ProcessCommand::class));
    }
    public function doRun(\RectorPrefix20220530\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20220530\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        // @fixes https://github.com/rectorphp/rector/issues/2205
        $isXdebugAllowed = $input->hasParameterOption('--xdebug');
        if (!$isXdebugAllowed) {
            $xdebugHandler = new \RectorPrefix20220530\Composer\XdebugHandler\XdebugHandler('rector');
            $xdebugHandler->check();
            unset($xdebugHandler);
        }
    ...
    protected function getDefaultInputDefinition() : \RectorPrefix20220530\Symfony\Component\Console\Input\InputDefinition
    {
    ...
    private function removeUnusedOptions(\RectorPrefix20220530\Symfony\Component\Console\Input\InputDefinition $inputDefinition) : void
    {
        $options = $inputDefinition->getOptions();
        unset($options['quiet'], $options['no-interaction']);
        $inputDefinition->setOptions($options);
    }
    private function addCustomOptions(\RectorPrefix20220530\Symfony\Component\Console\Input\InputDefinition $inputDefinition) : void
    {
        $inputDefinition->addOption(new \RectorPrefix20220530\Symfony\Component\Console\Input\InputOption(\Rector\Core\Configuration\Option::CONFIG, 'c', \RectorPrefix20220530\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to config file', $this->getDefaultConfigPath()));
