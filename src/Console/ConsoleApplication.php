...
use RectorPrefix20210622\Composer\XdebugHandler\XdebugHandler;
...
use RectorPrefix20210622\Symplify\PackageBuilder\Console\Command\CommandNaming;
final class ConsoleApplication extends \RectorPrefix20210622\Symfony\Component\Console\Application
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(\RectorPrefix20210622\Symplify\PackageBuilder\Console\Command\CommandNaming $commandNaming, array $commands = [])
    {
        ...
        $this->setDefaultCommand(\RectorPrefix20210622\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(\Rector\Core\Console\Command\ProcessCommand::class));
    }
    public function doRun(\RectorPrefix20210622\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20210622\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        // @fixes https://github.com/rectorphp/rector/issues/2205
        $isXdebugAllowed = $input->hasParameterOption('--xdebug');
        if (!$isXdebugAllowed) {
            $xdebugHandler = new \RectorPrefix20210622\Composer\XdebugHandler\XdebugHandler('rector');
            $xdebugHandler->check();
            unset($xdebugHandler);
        }
    ...
    protected function getDefaultInputDefinition() : \RectorPrefix20210622\Symfony\Component\Console\Input\InputDefinition
    {
    ...
    private function getNewWorkingDir(\RectorPrefix20210622\Symfony\Component\Console\Input\InputInterface $input) : string
    {
    ...
    private function shouldPrintMetaInformation(\RectorPrefix20210622\Symfony\Component\Console\Input\InputInterface $input) : bool
    {
    ...
    private function removeUnusedOptions(\RectorPrefix20210622\Symfony\Component\Console\Input\InputDefinition $inputDefinition) : void
    {
