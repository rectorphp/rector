...
final class ProcessCommand extends \Rector\Core\Console\Command\AbstractProcessCommand
{
    ...
    {
        $this->setName(\RectorPrefix20220108\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
    ...
    protected function execute(\RectorPrefix20220108\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20220108\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        if ($configuration->getOutputFormat() === \Rector\ChangesReporting\Output\JsonOutputFormatter::NAME) {
            $this->symfonyStyle->setVerbosity(\RectorPrefix20220108\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
    ...
    protected function initialize(\RectorPrefix20220108\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20220108\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
        $application = $this->getApplication();
        if (!$application instanceof \RectorPrefix20220108\Symfony\Component\Console\Application) {
    ...
    private function resolveReturnCode(\Rector\Core\ValueObject\ProcessResult $processResult, \Rector\Core\ValueObject\Configuration $configuration) : int
    {
        ...
        if ($processResult->getErrors() !== []) {
            return \RectorPrefix20220108\Symfony\Component\Console\Command\Command::FAILURE;
        }
        // inverse error code for CI dry-run
        if (!$configuration->isDryRun()) {
            return \RectorPrefix20220108\Symfony\Component\Console\Command\Command::SUCCESS;
        }
        return $processResult->getFileDiffs() === [] ? \RectorPrefix20220108\Symfony\Component\Console\Command\Command::SUCCESS : \RectorPrefix20220108\Symfony\Component\Console\Command\Command::FAILURE;
    }
}
