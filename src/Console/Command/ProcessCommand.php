...
final class ProcessCommand extends \Rector\Core\Console\Command\AbstractProcessCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(\Rector\Core\Configuration\Option::OUTPUT_FORMAT, \Rector\Core\Configuration\Option::OUTPUT_FORMAT_SHORT, \RectorPrefix20211211\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL, $description, \Rector\ChangesReporting\Output\ConsoleOutputFormatter::NAME);
        parent::configure();
    }
    protected function execute(\RectorPrefix20211211\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20211211\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        if ($configuration->getOutputFormat() === \Rector\ChangesReporting\Output\JsonOutputFormatter::NAME) {
            $this->symfonyStyle->setVerbosity(\RectorPrefix20211211\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
    ...
    protected function initialize(\RectorPrefix20211211\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20211211\Symfony\Component\Console\Output\OutputInterface $output) : void
    {
        $application = $this->getApplication();
        if (!$application instanceof \RectorPrefix20211211\Symfony\Component\Console\Application) {
    ...
    private function resolveReturnCode(\Rector\Core\ValueObject\ProcessResult $processResult, \Rector\Core\ValueObject\Configuration $configuration) : int
    {
        ...
        if ($processResult->getErrors() !== []) {
            return \RectorPrefix20211211\Symfony\Component\Console\Command\Command::FAILURE;
        }
        // inverse error code for CI dry-run
        if (!$configuration->isDryRun()) {
            return \RectorPrefix20211211\Symfony\Component\Console\Command\Command::SUCCESS;
        }
        return $processResult->getFileDiffs() === [] ? \RectorPrefix20211211\Symfony\Component\Console\Command\Command::SUCCESS : \RectorPrefix20211211\Symfony\Component\Console\Command\Command::FAILURE;
    }
    /**
     * @param File[] $files
     */
