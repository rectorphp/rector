...
final class InitCommand extends \RectorPrefix20220109\Symfony\Component\Console\Command\Command
{
    /**
     * @readonly
     ...
     */
    public function __construct(\RectorPrefix20220109\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard, \RectorPrefix20220109\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \RectorPrefix20220109\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, array $templateResolvers, \Rector\Core\Php\PhpVersionProvider $phpVersionProvider)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(\Rector\Core\Configuration\Option::TEMPLATE_TYPE, null, \RectorPrefix20220109\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL, 'A template type like default, nette, doctrine etc.', \Rector\Core\Template\DefaultResolver::TYPE);
    }
    protected function execute(\RectorPrefix20220109\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20220109\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        if ($doesFileExist) {
            ...
            $phpVersion = \RectorPrefix20220109\Nette\Utils\Strings::substring($fullPHPVersion, 0, 1) . \RectorPrefix20220109\Nette\Utils\Strings::substring($fullPHPVersion, 2, 1);
