...
final class InitCommand extends \RectorPrefix20220222\Symfony\Component\Console\Command\Command
{
    /**
     * @readonly
     ...
     */
    public function __construct(\RectorPrefix20220222\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard, \RectorPrefix20220222\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \Rector\Core\Contract\Console\OutputStyleInterface $rectorOutputStyle, array $templateResolvers, \Rector\Core\Php\PhpVersionProvider $phpVersionProvider)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(\Rector\Core\Configuration\Option::TEMPLATE_TYPE, null, \RectorPrefix20220222\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL, 'A template type like default, nette, doctrine etc.', \Rector\Core\Template\DefaultResolver::TYPE);
    }
    protected function execute(\RectorPrefix20220222\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20220222\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        if ($doesFileExist) {
            ...
            $phpVersion = \RectorPrefix20220222\Nette\Utils\Strings::substring($fullPHPVersion, 0, 1) . \RectorPrefix20220222\Nette\Utils\Strings::substring($fullPHPVersion, 2, 1);
