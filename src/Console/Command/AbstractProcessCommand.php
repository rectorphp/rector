...
abstract class AbstractProcessCommand extends \RectorPrefix20220125\Symfony\Component\Console\Command\Command
{
    /**
    ...
    {
        $this->addArgument(\Rector\Core\Configuration\Option::SOURCE, \RectorPrefix20220125\Symfony\Component\Console\Input\InputArgument::OPTIONAL | \RectorPrefix20220125\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Files or directories to be upgraded.');
        $this->addOption(\Rector\Core\Configuration\Option::DRY_RUN, \Rector\Core\Configuration\Option::DRY_RUN_SHORT, \RectorPrefix20220125\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Only see the diff of changes, do not save them to files.');
        $this->addOption(\Rector\Core\Configuration\Option::AUTOLOAD_FILE, \Rector\Core\Configuration\Option::AUTOLOAD_FILE_SHORT, \RectorPrefix20220125\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to file with extra autoload (will be included)');
