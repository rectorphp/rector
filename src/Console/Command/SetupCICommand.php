...
use RectorPrefix202508\Nette\Utils\FileSystem;
use RectorPrefix202508\OndraM\CiDetector\CiDetector;
...
final class SetupCICommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $noteMessage = sprintf('Only GitHub and GitLab are currently supported.%s Contribute your CI template to Rector to make this work: %s', "\n", 'https://github.com/rectorphp/rector-src/');
