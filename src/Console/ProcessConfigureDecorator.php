...
final class ProcessConfigureDecorator
{
    public static function decorate(Command $command): void
    {
        ...
        $command->addOption(Option::FILTER, null, InputOption::VALUE_REQUIRED, 'Keep only files matching all comma-separated patterns: "/Controller/" (path substring), "*Repository.php" (basename glob), "tests" (Test.php and TestCase.php files)');
