...
final class RectorConsoleOutputStyle extends \RectorPrefix20220209\Symfony\Component\Console\Style\SymfonyStyle
{
    /**
     * @var bool|null
     */
    ...
    private function isCiDetected() : bool
    {
        if ($this->isCiDetected === null) {
            $ciDetector = new \RectorPrefix20220209\OndraM\CiDetector\CiDetector();
