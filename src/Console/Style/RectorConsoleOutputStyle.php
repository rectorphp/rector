...
final class RectorConsoleOutputStyle extends \RectorPrefix20220217\Symfony\Component\Console\Style\SymfonyStyle
{
    /**
    ...
    private function isCiDetected() : bool
    {
        if ($this->isCiDetected === null) {
            $ciDetector = new \RectorPrefix20220217\OndraM\CiDetector\CiDetector();
