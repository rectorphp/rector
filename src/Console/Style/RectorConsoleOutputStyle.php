...
final class RectorConsoleOutputStyle extends \RectorPrefix20220418\Symfony\Component\Console\Style\SymfonyStyle
{
    /**
    ...
    public function __construct(\RectorPrefix20220418\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20220418\Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        if (\defined('PHPUNIT_COMPOSER_INSTALL')) {
            $this->setVerbosity(\RectorPrefix20220418\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }
    }
    /**
