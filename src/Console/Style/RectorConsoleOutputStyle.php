...
final class RectorConsoleOutputStyle extends \RectorPrefix20220210\Symfony\Component\Console\Style\SymfonyStyle
{
    /**
     * @var bool|null
     */
    ...
    private function isCiDetected() : bool
    {
        if ($this->isCiDetected === null) {
            $ciDetector = new \RectorPrefix20220210\OndraM\CiDetector\CiDetector();
