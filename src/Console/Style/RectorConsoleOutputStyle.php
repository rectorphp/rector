...
final class RectorConsoleOutputStyle extends \RectorPrefix20220218\Symfony\Component\Console\Style\SymfonyStyle
{
    /**
    ...
    private function isCiDetected() : bool
    {
        if ($this->isCiDetected === null) {
            $ciDetector = new \RectorPrefix20220218\OndraM\CiDetector\CiDetector();
